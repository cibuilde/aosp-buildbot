...
mkdir -p prebuiltlibs/bionic/libc/libc/ && rsync -ar out/soong/.intermediates/bionic/libc/libc/android_vendor.31_x86_64_shared/gen prebuiltlibs/bionic/libc/libc/
