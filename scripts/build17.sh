...
./prebuilts/build-tools/linux-x86/bin/ninja -f out/soong/build.ninja \
  out/soong/.intermediates/frameworks/base/cmds/app_process/app_process/android_x86_64/app_process64 \
  out/soong/.intermediates/frameworks/base/cmds/app_process/app_process/android_x86_x86_64/app_process32 \
  out/soong/.intermediates/frameworks/base/cmds/bootanimation/bootanimation/android_x86_64/bootanimation \
  

mkdir -p prebuiltlibs/frameworks/base/cmds/app_process/app_process/android_x86_64/ && mv out/soong/.intermediates/frameworks/base/cmds/app_process/app_process/android_x86_64/app_process64 prebuiltlibs/frameworks/base/cmds/app_process/app_process/android_x86_64/app_process
mkdir -p prebuiltlibs/frameworks/base/cmds/app_process/app_process/android_x86_x86_64/ && mv out/soong/.intermediates/frameworks/base/cmds/app_process/app_process/android_x86_x86_64/app_process32 prebuiltlibs/frameworks/base/cmds/app_process/app_process/android_x86_x86_64/app_process
mkdir -p prebuiltlibs/frameworks/base/cmds/bootanimation/bootanimation/android_x86_64/ && mv out/soong/.intermediates/frameworks/base/cmds/bootanimation/bootanimation/android_x86_64/bootanimation prebuiltlibs/frameworks/base/cmds/bootanimation/bootanimation/android_x86_64/bootanimation

printf "cc_prebuilt_binary {\n  name: \"app_process\",\n  multilib: {\n    lib32: {\n      suffix: \"32\",\n    },\n    lib64: {\n      suffix: \"64\",\n    },\n  },\n  version_script: \"version-script.txt\",\n  shared_libs: [\"libandroid_runtime\",\"libbinder\",\"libcutils\",\"libdl\",\"libhidlbase\",\"liblog\",\"libnativeloader\",\"libsigchain\",\"libutils\",\"libwilhelm\"],\n  compile_multilib: \"both\",\n  symlink_preferred_arch: true,\n  sanitize: {\n    memtag_heap: true,\n  },\n  strip: {\n    none: true,\n  },\n  multiple_variants: true,\n  prefer: true,\n  srcs: [\"app_process\"],\n}\n" >> prebuiltlibs/frameworks/base/cmds/app_process/Android.bp
printf "cc_prebuilt_binary {\n  name: \"bootanimation\",\n  shared_libs: [\"libandroidfw\",\"libbase\",\"libbinder\",\"libcutils\",\"liblog\",\"libutils\",\"libOpenSLES\",\"libbootanimation\"],\n  init_rc: [\"bootanim.rc\"],\n  strip: {\n    none: true,\n  },\n  multiple_variants: true,\n  prefer: true,\n  srcs: [\"bootanimation\"],\n}\n" >> prebuiltlibs/frameworks/base/cmds/bootanimation/Android.bp

df -h
clean_out_intermediates
mkdir -p prebuiltlibs/frameworks/base/ninja && rsync -ar out/soong/ninja/frameworks/base/ prebuiltlibs/frameworks/base/ninja/frameworks_base-17
touch prebuiltlibs/frameworks/base/ninja/.find-ignore
tar cfJ frameworks_base-17.tar.xz -C prebuiltlibs/frameworks/base/ .
ls -l frameworks_base-17.tar.xz
end=`date +%s`
echo $((end-start))
