...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint-bootstrap-bpdoc,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint-deptools,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint-parser,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint-pathtools,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint-proptools,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja blueprint,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja bpmodify,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/build/blueprint/bpmodify^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/build/blueprint/bpmodify^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/blueprint/bpmodify^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/build/blueprint/bpmodify^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/build/blueprint/bpmodify^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/build/blueprint/bpmodify^linux_glibc_x86_64/addition_copy_files.output
