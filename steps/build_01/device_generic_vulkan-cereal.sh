...
echo "entering device/generic/vulkan-cereal"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_angle_stub,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_angle_stub,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_apigen_codec_common,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_apigen_codec_common,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_astc_codec,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_astc_codec,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_base,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_base,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_compressedTextures,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_compressedTextures,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_dispatch,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_dispatch,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_gles1_dec,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_gles1_dec,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_gles2_dec,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_gles2_dec,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_glsnapshot,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_glsnapshot,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_host_common,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_host_common,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_lz4,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_lz4,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_renderControl_dec,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_renderControl_dec,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_egl,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_egl,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glcommon,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glcommon,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glescm,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glescm,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glesv2,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_translator_glesv2,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_vulkan_cereal_host,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_vulkan_cereal_host,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_vulkan_server,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja gfxstream_vulkan_server,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-libperfettobase,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-libperfettobase,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-libprotozero,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-libprotozero,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-tracing-only,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja perfetto-tracing-only,android_x86_64_static_apex10000
