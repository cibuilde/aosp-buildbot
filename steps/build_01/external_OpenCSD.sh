...
cd $GITHUB_WORKSPACE/
tar cfJ external_OpenCSD.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/OpenCSD/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_OpenCSD.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_OpenCSD.tar.zst -C $GITHUB_WORKSPACE/aosp/external/OpenCSD/ .
fi
