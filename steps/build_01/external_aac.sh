...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libFraunhoferAAC,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libFraunhoferAAC,android_x86_64_static_cfi_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libFraunhoferAAC,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_aac.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/aac/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_aac.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_aac.tar.xz -C $GITHUB_WORKSPACE/aosp/external/aac/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
