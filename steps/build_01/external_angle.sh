...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_preprocessor,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_preprocessor,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_image_util,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/angle/angle_image_util^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/angle/angle_image_util^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/angle/angle_image_util^android_x86_64_static/addition_copy_files.output

echo "building angle_image_util^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_image_util,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_gpu_info_util,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_gpu_info_util,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja chrome_zlib,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/angle/chrome_zlib^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_64_static/addition_copy_files.output

echo "building chrome_zlib^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja chrome_zlib,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/angle/chrome_zlib^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_x86_64_static/addition_copy_files.output

echo "building third_party_zlib_google_compression_utils_portable^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja third_party_zlib_google_compression_utils_portable,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja third_party_zlib_google_compression_utils_portable,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_common,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja angle_common,android_x86_x86_64_static
