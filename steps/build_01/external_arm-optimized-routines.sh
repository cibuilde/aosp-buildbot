...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_native_bridge_arm64_armv8-a_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_native_bridge_arm_armv7-a-neon_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_vendor_ramdisk_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_native_bridge_arm64_armv8-a_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_native_bridge_arm_armv7-a-neon_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_vendor_ramdisk_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_x86_64_static_apex10000
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_arm-optimized-routines.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_arm-optimized-routines.tar.xz -C $GITHUB_WORKSPACE/aosp/external/arm-optimized-routines/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
