...
echo "entering external/arm-optimized-routines"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_native_bridge_arm64_armv8-a_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm64_armv8-a_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm64_armv8-a_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm64_armv8-a_static/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_native_bridge_arm_armv7-a-neon_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_native_bridge_arm_armv7-a-neon_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm_armv7-a-neon_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm_armv7-a-neon_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm_armv7-a-neon_static/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_recovery_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_recovery_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_vendor_ramdisk_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_vendor_ramdisk_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_vendor_ramdisk_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_vendor_ramdisk_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_vendor_ramdisk_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_64_static_apex10000/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-math^android_x86_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-math,android_x86_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-math^android_x86_x86_64_static_apex10000/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_native_bridge_arm64_armv8-a_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_native_bridge_arm64_armv8-a_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm64_armv8-a_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm64_armv8-a_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm64_armv8-a_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_native_bridge_arm_armv7-a-neon_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_native_bridge_arm_armv7-a-neon_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm_armv7-a-neon_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm_armv7-a-neon_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_native_bridge_arm_armv7-a-neon_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_recovery_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_recovery_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_vendor_ramdisk_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_vendor_ramdisk_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_vendor_ramdisk_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_vendor_ramdisk_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_vendor_ramdisk_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_64_static_apex10000/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static/addition_copy_files.output

echo "building libarm-optimized-routines-string^android_x86_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libarm-optimized-routines-string,android_x86_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/libarm-optimized-routines-string^android_x86_x86_64_static_apex10000/addition_copy_files.output

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_arm-optimized-routines.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/arm-optimized-routines/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_arm-optimized-routines.tar.zst --clobber

du -ah -d1 external_arm-optimized-routines*.tar.zst | sort -h
