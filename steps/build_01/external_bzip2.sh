...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libbz,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libbz,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_bzip2.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/bzip2/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_bzip2.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_bzip2.tar.zst -C $GITHUB_WORKSPACE/aosp/external/bzip2/ .
fi
