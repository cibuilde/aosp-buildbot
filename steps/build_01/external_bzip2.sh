...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libbz,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libbz,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_bzip2.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/bzip2/ .
