...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdng_sdk,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdng_sdk,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_dng_sdk.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/dng_sdk/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_dng_sdk.tar.xz" ]; then
  echo "Compressing external/dng_sdk -> external_dng_sdk.tar.xz"
