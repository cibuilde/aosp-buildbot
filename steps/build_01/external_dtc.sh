...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfdt,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfdt,android_x86_64_static_apex10000
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_dtc.tar.xz" ]; then
  echo "Compressing external/dtc -> external_dtc.tar.xz"
