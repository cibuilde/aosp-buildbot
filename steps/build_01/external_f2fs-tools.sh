...
echo "Preparing for external/f2fs-tools"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libf2fs_fmt,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/f2fs-tools/libf2fs_fmt^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt^android_recovery_x86_64_static/addition_copy_files.output

echo "building libf2fs_fmt^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libf2fs_fmt,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/f2fs-tools/libf2fs_fmt^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt^android_x86_64_static/addition_copy_files.output

echo "building libf2fs_fmt_host^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libf2fs_fmt_host,linux_glibc_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/f2fs-tools/libf2fs_fmt_host^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt_host^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/libf2fs_fmt_host^linux_glibc_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_f2fs-tools.tar.zst --clobber
