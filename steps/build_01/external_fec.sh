...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfec_rs,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfec_rs,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfec_rs,linux_glibc_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfec_rs,linux_glibc_x86_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_fec.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/fec/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_fec.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_fec.tar.zst -C $GITHUB_WORKSPACE/aosp/external/fec/ .
fi
