...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libFLAC,android_x86_64_static_cfi_apex29
...
cd $GITHUB_WORKSPACE/
tar cfJ external_flac.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/flac/ .
