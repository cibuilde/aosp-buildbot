...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libfsverity,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_fsverity-utils.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/fsverity-utils/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_fsverity-utils.tar.xz" ]; then
  echo "Compressing external/fsverity-utils -> external_fsverity-utils.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/external_fsverity-utils.tar.xz -C $GITHUB_WORKSPACE/aosp/external/fsverity-utils/ .
fi
