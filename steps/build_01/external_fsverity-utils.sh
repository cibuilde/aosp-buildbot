...
cd $GITHUB_WORKSPACE/
tar cfJ external_fsverity-utils.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/fsverity-utils/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_fsverity-utils.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_fsverity-utils.tar.zst -C $GITHUB_WORKSPACE/aosp/external/fsverity-utils/ .
fi
