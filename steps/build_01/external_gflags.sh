...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_vendor_ramdisk_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_gflags.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/gflags/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_gflags.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_gflags.tar.xz -C $GITHUB_WORKSPACE/aosp/external/gflags/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
