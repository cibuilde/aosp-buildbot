...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_vendor_ramdisk_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgflags,android_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_gflags.tar.xz" ]; then
  echo "Compressing external/gflags -> external_gflags.tar.xz"
