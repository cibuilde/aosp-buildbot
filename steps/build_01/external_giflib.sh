...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_64_static_lto-thin
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_x86_64_static_lto-thin
...
cd $GITHUB_WORKSPACE/
tar cfJ external_giflib.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/giflib/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_giflib.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_giflib.tar.xz -C $GITHUB_WORKSPACE/aosp/external/giflib/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
