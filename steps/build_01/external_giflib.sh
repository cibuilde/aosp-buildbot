...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_64_static_lto-thin
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgif,android_x86_x86_64_static_lto-thin
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_giflib.tar.xz" ]; then
  echo "Compressing external/giflib -> external_giflib.tar.xz"
