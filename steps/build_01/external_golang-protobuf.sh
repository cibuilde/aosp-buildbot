...
echo "Preparing for external/golang-protobuf"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja golang-protobuf-proto,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/golang-protobuf/golang-protobuf-proto^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/golang-protobuf/golang-protobuf-proto^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/golang-protobuf/golang-protobuf-proto^linux_glibc_x86_64/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_golang-protobuf.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/golang-protobuf/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_golang-protobuf.tar.zst --clobber

du -ah -d1 external_golang-protobuf*.tar.zst | sort -h
