...
cd $GITHUB_WORKSPACE/
tar cfJ external_google-fruit.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/google-fruit/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_google-fruit.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_google-fruit.tar.zst -C $GITHUB_WORKSPACE/aosp/external/google-fruit/ .
fi
