...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgtest,linux_glibc_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_googletest.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/googletest/ .
