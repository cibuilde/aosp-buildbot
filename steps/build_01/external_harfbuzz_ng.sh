...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libharfbuzz_ng,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_static/addition_copy_files.output

echo "building libharfbuzz_ng^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libharfbuzz_ng,android_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_harfbuzz_ng.tar.zst --clobber
