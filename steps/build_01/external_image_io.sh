...
cd $GITHUB_WORKSPACE/
tar cfJ external_image_io.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/image_io/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_image_io.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_image_io.tar.zst -C $GITHUB_WORKSPACE/aosp/external/image_io/ .
fi
