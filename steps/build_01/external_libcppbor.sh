...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcppbor_external,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libcppbor.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libcppbor/ .
