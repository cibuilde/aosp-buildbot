...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdrm,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdrm,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdrm,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdrm,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libdrm.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/libdrm/ .
