...
echo "Preparing for external/libepoxy"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libepoxy,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libepoxy/libepoxy^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/external/libepoxy/libepoxy^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/external/libepoxy/libepoxy^android_x86_64_static_apex10000/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libepoxy.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libepoxy/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libepoxy.tar.zst --clobber

du -ah -d1 external_libepoxy*.tar.zst | sort -h
