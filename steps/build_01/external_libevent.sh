...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libevent.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/libevent/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libevent.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_libevent.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libevent/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
