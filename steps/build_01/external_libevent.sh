...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libevent,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libevent.tar.xz" ]; then
  echo "Compressing external/libevent -> external_libevent.tar.xz"
