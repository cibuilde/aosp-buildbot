...
echo "Preparing for external/libgav1"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libgav1,android_x86_64_static_cfi_apex29
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libgav1/libgav1^android_x86_64_static_cfi_apex29.output $GITHUB_WORKSPACE/artifacts/external/libgav1/libgav1^android_x86_64_static_cfi_apex29 $GITHUB_WORKSPACE/artifacts/external/libgav1/libgav1^android_x86_64_static_cfi_apex29/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libgav1.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libgav1/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libgav1.tar.zst --clobber

du -ah -d1 external_libgav1*.tar.zst | sort -h
