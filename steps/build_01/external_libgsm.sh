...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_64_static_cfi_apex29
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libgsm.tar.xz" ]; then
  echo "Compressing external/libgsm -> external_libgsm.tar.xz"
