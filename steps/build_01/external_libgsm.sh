...
echo "Preparing for external/libgsm"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libgsm/libgsm^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_64_static/addition_copy_files.output

echo "building libgsm^android_x86_64_static_cfi_apex29"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_64_static_cfi_apex29
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libgsm/libgsm^android_x86_64_static_cfi_apex29.output $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_64_static_cfi_apex29 $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_64_static_cfi_apex29/addition_copy_files.output

echo "building libgsm^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsm,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libgsm/libgsm^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libgsm/libgsm^android_x86_x86_64_static/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libgsm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libgsm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libgsm.tar.zst --clobber

du -ah -d1 external_libgsm*.tar.zst | sort -h
