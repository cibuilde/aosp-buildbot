...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libmpeg2.tar.xz" ]; then
  echo "Compressing external/libmpeg2 -> external_libmpeg2.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/external_libmpeg2.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libmpeg2/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
