...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmpeg2dec,android_x86_64_static_apex29
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libmpeg2.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libmpeg2/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libmpeg2.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libmpeg2.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libmpeg2/ .
fi
