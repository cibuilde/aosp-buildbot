...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libmpeg2dec,android_x86_64_static_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libmpeg2.tar.zst --clobber
