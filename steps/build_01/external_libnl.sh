...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libnl,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libnl,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libnl.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/libnl/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libnl.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_libnl.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libnl/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
