...
cd $GITHUB_WORKSPACE/
tar cfJ external_libpcap.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libpcap/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libpcap.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libpcap.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libpcap/ .
fi
