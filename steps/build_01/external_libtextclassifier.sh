...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libtextclassifier_hash_static,android_x86_64_static_apex30
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libtextclassifier/libtextclassifier_hash_static^android_x86_64_static_apex30.output $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier_hash_static^android_x86_64_static_apex30 $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier_hash_static^android_x86_64_static_apex30/addition_copy_files.output

echo "building libtextclassifier_hash_static^android_x86_x86_64_static_apex30"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libtextclassifier_hash_static,android_x86_x86_64_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libtextclassifier.tar.zst --clobber
