...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libtextclassifier_hash_static,android_x86_64_static_apex30
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libtextclassifier_hash_static,android_x86_x86_64_static_apex30
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libtextclassifier.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libtextclassifier.tar.xz" ]; then
  echo "Compressing external/libtextclassifier -> external_libtextclassifier.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/external_libtextclassifier.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libtextclassifier/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
