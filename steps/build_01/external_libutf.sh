...
cd $GITHUB_WORKSPACE/
tar cfJ external_libutf.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libutf/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libutf.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libutf.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libutf/ .
fi
