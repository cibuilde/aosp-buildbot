...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libvpx,android_x86_64_static_cfi_apex29
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_64_static_cfi
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_64_static_cfi_apex29
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_x86_64_static_cfi
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libvpx.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libvpx/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libvpx.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libvpx.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libvpx/ .
fi
