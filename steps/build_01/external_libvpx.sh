...
echo "building libvpx^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libvpx,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/external/libvpx/libvpx^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^linux_glibc_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/libvpx/libvpx^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^linux_glibc_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_libvpx.tar.zst --clobber
