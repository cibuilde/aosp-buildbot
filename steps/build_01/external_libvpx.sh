...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libvpx,android_x86_64_static_cfi_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_64_static_cfi
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_64_static_cfi_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebm,android_x86_x86_64_static_cfi
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libvpx.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_libvpx.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libvpx/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
