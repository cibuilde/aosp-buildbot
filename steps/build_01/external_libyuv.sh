...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static_cfi
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static_cfi_apex29
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_x86_64_static_cfi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libjpeg-turbo.tar.xz" ]; then
  echo "Compressing external/libjpeg-turbo -> external_libjpeg-turbo.tar.xz"
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libyuv.tar.xz" ]; then
  echo "Compressing external/libyuv -> external_libyuv.tar.xz"
