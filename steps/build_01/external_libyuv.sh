...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static_cfi
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_64_static_cfi_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libyuv,android_x86_x86_64_static_cfi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libyuv.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_libyuv.tar.xz -C $GITHUB_WORKSPACE/aosp/external/libyuv/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
