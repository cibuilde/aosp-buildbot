...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmdnssd,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmdnssd,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmdnssd,android_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmdnssd,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_mdnsresponder.tar.xz" ]; then
  echo "Compressing external/mdnsresponder -> external_mdnsresponder.tar.xz"
