...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_recovery_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_vendor.31_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_vendor.31_x86_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_x86_64_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_constants_obj,android_x86_64_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_recovery_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_vendor.31_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_vendor.31_x86_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_x86_64_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminijail_gen_syscall_obj,android_x86_64_apex29
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_minijail.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_minijail.tar.xz -C $GITHUB_WORKSPACE/aosp/external/minijail/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
