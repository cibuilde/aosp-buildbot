...
echo "Preparing for external/mksh"

clone_depth_platform external/mksh


echo "building mkshrc^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja mkshrc,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/mksh/mkshrc^android_x86_64.output $GITHUB_WORKSPACE/artifacts/external/mksh/mkshrc^android_x86_64 $GITHUB_WORKSPACE/artifacts/external/mksh/mkshrc^android_x86_64/addition_copy_files.output

echo "building mkshrc_vendor^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja mkshrc_vendor,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/mksh/mkshrc_vendor^android_x86_64.output $GITHUB_WORKSPACE/artifacts/external/mksh/mkshrc_vendor^android_x86_64 $GITHUB_WORKSPACE/artifacts/external/mksh/mkshrc_vendor^android_x86_64/addition_copy_files.output
