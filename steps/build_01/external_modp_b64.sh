...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_modp_b64.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/modp_b64/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_modp_b64.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_modp_b64.tar.xz -C $GITHUB_WORKSPACE/aosp/external/modp_b64/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
