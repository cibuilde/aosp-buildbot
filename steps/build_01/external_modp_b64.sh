...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmodpb64,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_modp_b64.tar.xz" ]; then
  echo "Compressing external/modp_b64 -> external_modp_b64.tar.xz"
