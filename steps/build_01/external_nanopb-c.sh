...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libprotobuf-c-nano,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libprotobuf-c-nano,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_nanopb-c.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/nanopb-c/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_nanopb-c.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_nanopb-c.tar.xz -C $GITHUB_WORKSPACE/aosp/external/nanopb-c/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
