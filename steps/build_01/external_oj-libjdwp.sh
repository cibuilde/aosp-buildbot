...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libnpt,android_x86_64_static_apex31
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libnpt,android_x86_x86_64_static_apex31
...
cd $GITHUB_WORKSPACE/
tar cfJ external_oj-libjdwp.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/ .
