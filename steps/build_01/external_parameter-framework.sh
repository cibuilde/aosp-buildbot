...
echo "Preparing for external/parameter-framework"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libparameter,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libparameter^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_static/addition_copy_files.output

echo "building libparameter^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libparameter,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libparameter^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_static/addition_copy_files.output

echo "building libpfw_utility^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libpfw_utility,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libpfw_utility^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_64_static/addition_copy_files.output

echo "building libpfw_utility^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libpfw_utility,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libpfw_utility^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_x86_64_static/addition_copy_files.output

echo "building libremote-processor^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libremote-processor,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libremote-processor^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_static/addition_copy_files.output

echo "building libremote-processor^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libremote-processor,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/parameter-framework/libremote-processor^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_parameter-framework.tar.zst --clobber
