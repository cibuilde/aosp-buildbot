...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_lazy_static.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/lazy_static/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_lazy_static.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_lazy_static.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/lazy_static/ .
fi
