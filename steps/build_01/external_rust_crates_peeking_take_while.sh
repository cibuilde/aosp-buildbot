...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libpeeking_take_while,linux_glibc_x86_64_rlib_rlib-std
