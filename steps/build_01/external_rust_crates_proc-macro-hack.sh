...
echo "Preparing for external/rust/crates/proc-macro-hack"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libproc_macro_hack,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/rust/crates/proc-macro-hack/libproc_macro_hack^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-hack/libproc_macro_hack^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-hack/libproc_macro_hack^linux_glibc_x86_64/addition_copy_files.output
...
du -ah -d1 external_rust_crates_proc-macro-hack*.tar.zst | sort -h
