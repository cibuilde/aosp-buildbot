...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_rustc-hash.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/rustc-hash/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_rustc-hash.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_rustc-hash.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/rustc-hash/ .
fi
