...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcxxbridge05,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcxxbridge05,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_cxx.tar.xz" ]; then
  echo "Compressing external/rust/cxx -> external_rust_cxx.tar.xz"
