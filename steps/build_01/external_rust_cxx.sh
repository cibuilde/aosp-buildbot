...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcxxbridge05,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcxxbridge05,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_cxx.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/rust/cxx/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_cxx.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_cxx.tar.xz -C $GITHUB_WORKSPACE/aosp/external/rust/cxx/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
