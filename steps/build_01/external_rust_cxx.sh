...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_cxx.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/cxx/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_cxx.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_cxx.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/cxx/ .
fi
