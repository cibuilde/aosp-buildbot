...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libscrypt_static,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libscrypt_static,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_scrypt.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/scrypt/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/external_scrypt.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/external_scrypt.tar.xz -C $GITHUB_WORKSPACE/aosp/external/scrypt/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
