...
cd $GITHUB_WORKSPACE/
tar cfJ external_scrypt.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/scrypt/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_scrypt.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_scrypt.tar.zst -C $GITHUB_WORKSPACE/aosp/external/scrypt/ .
fi
