...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libscrypt_static,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libscrypt_static,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_scrypt.tar.xz" ]; then
  echo "Compressing external/scrypt -> external_scrypt.tar.xz"
