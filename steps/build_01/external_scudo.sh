...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_native_bridge_arm64_armv8-a_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static.output . $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static.output $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm64_armv8-a_static/addition_copy_files.output

echo "building libscudo^android_native_bridge_arm_armv7-a-neon_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_native_bridge_arm_armv7-a-neon_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static.output . $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static.output $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static $GITHUB_WORKSPACE/artifacts/external/scudo/libscudo^android_native_bridge_arm_armv7-a-neon_static/addition_copy_files.output

echo "building libscudo^android_recovery_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_vendor_ramdisk_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libscudo,android_x86_x86_64_static_apex10000
