...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsepol,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsepol,linux_glibc_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_selinux.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/selinux/ .
