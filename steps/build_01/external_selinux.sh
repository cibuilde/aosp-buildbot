...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsepol,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsepol,linux_glibc_x86_64_static
