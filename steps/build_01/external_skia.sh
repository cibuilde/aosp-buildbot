...
echo "Preparing for external/skia"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libskia_renderengine,android_x86_64_static_lto-thin
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/skia/libskia_renderengine^android_x86_64_static_lto-thin.output $GITHUB_WORKSPACE/artifacts/external/skia/libskia_renderengine^android_x86_64_static_lto-thin $GITHUB_WORKSPACE/artifacts/external/skia/libskia_renderengine^android_x86_64_static_lto-thin/addition_copy_files.output

echo "building libskia^android_x86_64_static_lto-thin"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libskia,android_x86_64_static_lto-thin
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/skia/libskia^android_x86_64_static_lto-thin.output $GITHUB_WORKSPACE/artifacts/external/skia/libskia^android_x86_64_static_lto-thin $GITHUB_WORKSPACE/artifacts/external/skia/libskia^android_x86_64_static_lto-thin/addition_copy_files.output

echo "building libskia^android_x86_x86_64_static_lto-thin"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libskia,android_x86_x86_64_static_lto-thin
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/external/skia/libskia^android_x86_x86_64_static_lto-thin.output $GITHUB_WORKSPACE/artifacts/external/skia/libskia^android_x86_x86_64_static_lto-thin $GITHUB_WORKSPACE/artifacts/external/skia/libskia^android_x86_x86_64_static_lto-thin/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_skia.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/skia/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_skia.tar.zst --clobber

du -ah -d1 external_skia*.tar.zst | sort -h
