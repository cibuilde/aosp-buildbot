...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsqlite3_android,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsqlite3_android,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsqlite3_android,linux_glibc_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_sqlite.tar.xz -C $GITHUB_WORKSPACE/artifacts/external/sqlite/ .
