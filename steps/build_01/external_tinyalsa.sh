...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libtinyalsa,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libtinyalsa,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_tinyalsa.tar.xz" ]; then
  echo "Compressing external/tinyalsa -> external_tinyalsa.tar.xz"
