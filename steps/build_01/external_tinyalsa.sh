...
cd $GITHUB_WORKSPACE/
tar cfJ external_tinyalsa.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/tinyalsa/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_tinyalsa.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_tinyalsa.tar.zst -C $GITHUB_WORKSPACE/aosp/external/tinyalsa/ .
fi
