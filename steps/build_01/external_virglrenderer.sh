...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libepoxy.tar.xz" ]; then
  echo "Compressing external/libepoxy -> external_libepoxy.tar.xz"
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_virglrenderer.tar.xz" ]; then
  echo "Compressing external/virglrenderer -> external_virglrenderer.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/external_virglrenderer.tar.xz -C $GITHUB_WORKSPACE/aosp/external/virglrenderer/ .
fi
