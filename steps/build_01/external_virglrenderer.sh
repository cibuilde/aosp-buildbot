...
cd $GITHUB_WORKSPACE/
tar cfJ external_virglrenderer.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/virglrenderer/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libepoxy.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libepoxy.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libepoxy/ .
fi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_virglrenderer.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_virglrenderer.tar.zst -C $GITHUB_WORKSPACE/aosp/external/virglrenderer/ .
fi
