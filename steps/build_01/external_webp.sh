...
echo "Preparing for external/webp"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebp-decode,android_x86_64_static_lto-thin
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebp-decode,android_x86_x86_64_static_lto-thin
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebp-encode,android_x86_64_static_lto-thin
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libwebp-encode,android_x86_x86_64_static_lto-thin
...
cd $GITHUB_WORKSPACE/
tar -cf external_webp.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/webp/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 external_webp.tar.zst --clobber

du -ah -d1 external_webp*.tar.zst | sort -h
