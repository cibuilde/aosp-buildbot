...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminikin,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminikin,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ frameworks_minikin.tar.zst -C $GITHUB_WORKSPACE/artifacts/frameworks/minikin/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_harfbuzz_ng.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_harfbuzz_ng.tar.zst -C $GITHUB_WORKSPACE/aosp/external/harfbuzz_ng/ .
fi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/frameworks_minikin.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/frameworks_minikin.tar.zst -C $GITHUB_WORKSPACE/aosp/frameworks/minikin/ .
fi
