...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminikin,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libminikin,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ frameworks_minikin.tar.xz -C $GITHUB_WORKSPACE/artifacts/frameworks/minikin/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/frameworks_minikin.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/frameworks_minikin.tar.xz -C $GITHUB_WORKSPACE/aosp/frameworks/minikin/ .
fi
mkdir -p $GITHUB_WORKSPACE/cache
