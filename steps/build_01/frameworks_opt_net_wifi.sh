...
cd $GITHUB_WORKSPACE/
tar cfJ frameworks_opt_net_wifi.tar.zst -C $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/frameworks_opt_net_wifi.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/frameworks_opt_net_wifi.tar.zst -C $GITHUB_WORKSPACE/aosp/frameworks/opt/net/wifi/ .
fi
