...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja rsg-generator,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/frameworks/rs/rsg-generator^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/frameworks/rs/rsg-generator^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/frameworks/rs/rsg-generator^linux_glibc_x86_64/addition_copy_files.output

echo "building libRSDispatch^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libRSDispatch,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/frameworks/rs/libRSDispatch^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRSDispatch^android_x86_64_static $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRSDispatch^android_x86_64_static/addition_copy_files.output

echo "building libRSDispatch^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libRSDispatch,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/frameworks/rs/libRSDispatch^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRSDispatch^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRSDispatch^android_x86_x86_64_static/addition_copy_files.output
