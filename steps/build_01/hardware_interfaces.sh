...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 hardware_interfaces.tar.zst --clobber
...
if [ ! -f "$GITHUB_WORKSPACE/cache/hardware_interfaces.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/hardware_interfaces.tar.zst -C $GITHUB_WORKSPACE/aosp/hardware/interfaces/ .
fi
