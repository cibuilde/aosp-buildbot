...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja com.android.os.statsd.init.rc,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/packages/modules/StatsD/com.android.os.statsd.init.rc^android_x86_64.output $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/apex/com.android.os.statsd.init.rc^android_x86_64 $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/apex/com.android.os.statsd.init.rc^android_x86_64/addition_copy_files.output

echo "building libkll-encoder^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libkll-encoder,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/packages/modules/StatsD/libkll-encoder^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_64_static $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_64_static/addition_copy_files.output

echo "building libkll-encoder^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libkll-encoder,android_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 packages_modules_StatsD.tar.zst --clobber
