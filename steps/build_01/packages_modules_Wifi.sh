...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja wifi.rc,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/packages/modules/Wifi/wifi.rc^android_x86_64.output $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/wifi.rc^android_x86_64 $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/wifi.rc^android_x86_64/addition_copy_files.output
