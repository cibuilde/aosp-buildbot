...
clone_depth_platform platform/art
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/veridex-appcompat^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/tools/veridex/veridex-appcompat^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libsigchain_fake^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain_fake^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libsigchain^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libsigchain^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libprofiled^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofiled^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libprofile^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libprofile^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libprofile^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libodrstatslog^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/odrefresh/libodrstatslog^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativeloader_lazy^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativeloader/libnativeloader_lazy^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativeloader_lazy^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativeloader/libnativeloader_lazy^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativeloader^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativeloader/libnativeloader^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativebridge_lazy^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge_lazy^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativebridge_lazy^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge_lazy^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativebridge^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativebridge^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libnativebridge^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libelffiled^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libelffile/libelffiled^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libelffile^android_x86_x86_64_static_lto-thin_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libelffile/libelffile^android_x86_x86_64_static_lto-thin_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libelffile^android_x86_64_static_lto-thin_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libelffile/libelffile^android_x86_64_static_lto-thin_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdt_fd_forward^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dt_fd_forward/libdt_fd_forward^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdt_fd_forward^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dt_fd_forward/libdt_fd_forward^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support_static^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support_static^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libdexfile_support^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile_support^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libartpalette^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libartpalette/libartpalette^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libartpalette^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartpalette/libartpalette^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libartpalette^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartpalette/libartpalette^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libartd-disassembler^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/disassembler/libartd-disassembler^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libartd-dexlayout^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/dexlayout/libartd-dexlayout^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libart-disassembler^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/disassembler/libart-disassembler^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libart-disassembler^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/disassembler/libart-disassembler^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libart-dexlayout^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dexlayout/libart-dexlayout^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/libart-dexlayout^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dexlayout/libart-dexlayout^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/asm_defines.s^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/asm_defines.s^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/asm_defines.s^android_x86_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/asm_defines.s^android_x86_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/art/asm_defines.s^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/asm_defines.s^android_x86_64_apex31

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/art/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_art.tar.zst --clobber

du -ah -d1 platform_art*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_art.tar.zst" ]; then
  echo "Compressing platform/art -> platform_art.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/art/ .
fi
