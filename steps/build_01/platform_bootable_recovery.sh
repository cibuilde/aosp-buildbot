...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/librecovery_ui_default^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui_default^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/librecovery_ui^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/librecovery_fastboot^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/librecovery_fastboot^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libotautil^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/otautil/libotautil^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libotautil^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/otautil/libotautil^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libfusesideload^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/fuse_sideload/libfusesideload^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libbootloader_message_vendor^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message_vendor^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libbootloader_message^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/libbootloader_message^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/bootable/recovery/init_recovery.rc^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/init_recovery.rc^android_recovery_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_bootable_recovery.tar.zst --clobber
