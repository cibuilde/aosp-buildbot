...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/third_party_zlib_google_compression_utils_portable^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/third_party_zlib_google_compression_utils_portable^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/third_party_zlib_google_compression_utils_portable^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/third_party_zlib_google_compression_utils_portable^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/chrome_zlib^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/chrome_zlib^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/chrome_zlib^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_preprocessor^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_preprocessor^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_preprocessor^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_preprocessor^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_image_util^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_image_util^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_image_util^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_image_util^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_gpu_info_util^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_gpu_info_util^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_gpu_info_util^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_gpu_info_util^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_common^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_common^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/angle/angle_common^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/angle/angle_common^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_angle.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/angle/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_angle.tar.zst --clobber
