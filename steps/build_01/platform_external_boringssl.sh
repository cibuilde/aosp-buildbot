...
clone_depth_platform platform/external/boringssl
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libssl^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto_static^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto_static^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto_static^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto_static^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto_static^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto_static^android_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto_static^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto_static^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bssl_fipscommon^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bssl_fipscommon^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bssl_ar^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bssl_ar^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^linux_glibc_x86.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^linux_glibc_x86
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto^linux_glibc_x86_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^linux_glibc_x86_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/libcrypto^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bssl_inject_hash^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bssl_inject_hash^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_x86_64_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_64_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_vendor.31_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_vendor.31_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/boringssl/bcm_object^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_recovery_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_boringssl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/boringssl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_boringssl.tar.zst --clobber

du -ah -d1 platform_external_boringssl*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_boringssl.tar.zst" ]; then
  echo "Compressing platform/external/boringssl -> platform_external_boringssl.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_boringssl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/boringssl/ .
fi
