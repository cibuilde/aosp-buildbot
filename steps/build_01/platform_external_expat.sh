...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/expat/libexpat^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/expat/libexpat^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/expat/libexpat^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/expat/libexpat^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/expat/libexpat^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_expat.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/expat/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_expat.tar.zst --clobber
