...
clone_depth_platform platform/external/parameter-framework
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libremote-processor^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libremote-processor^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libpfw_utility^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libpfw_utility^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libparameter^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/parameter-framework/libparameter^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_parameter-framework.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/parameter-framework/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_parameter-framework.tar.zst --clobber

du -ah -d1 platform_external_parameter-framework*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_parameter-framework.tar.zst" ]; then
  echo "Compressing platform/external/parameter-framework -> platform_external_parameter-framework.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_parameter-framework.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/parameter-framework/ .
fi
