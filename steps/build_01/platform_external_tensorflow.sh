...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/tensorflow/libtflite_kernel_utils^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/tensorflow/tensorflow/lite/kernels/libtflite_kernel_utils^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/tensorflow/libtflite_kernel_utils^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/tensorflow/tensorflow/lite/kernels/libtflite_kernel_utils^android_x86_64_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_tensorflow.tar.zst --clobber
