...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja minigzip,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/zlib/minigzip^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/minigzip^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/zlib/minigzip^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz_headers^.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^linux_glibc_x86_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^linux_glibc_x86_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^linux_glibc_x86_64_static

echo "building libz^linux_glibc_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libz,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/zlib/libz^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_vendor_ramdisk_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor_ramdisk_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_native_bridge_arm_armv7-a-neon_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_native_bridge_arm_armv7-a-neon_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/external/zlib/libz^android_native_bridge_arm64_armv8-a_static.output . $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_native_bridge_arm64_armv8-a_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_zlib.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/zlib/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_external_zlib.tar.zst --clobber
