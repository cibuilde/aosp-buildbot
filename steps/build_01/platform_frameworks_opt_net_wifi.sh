...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/frameworks/opt/net/wifi/libwifi-system-iface^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_frameworks_opt_net_wifi.tar.zst --clobber
