...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/hardware/interfaces/libhealthloop^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/health/utils/libhealthloop/libhealthloop^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/hardware/interfaces/libhealthloop^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/health/utils/libhealthloop/libhealthloop^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/hardware/interfaces/android.hardware.identity_credential.xml^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/identity/aidl/default/android.hardware.identity_credential.xml^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/hardware/interfaces/android.hardware.hardware_keystore.xml^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/security/keymint/aidl/default/android.hardware.hardware_keystore.xml^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_hardware_interfaces.tar.zst --clobber
