...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/packages/modules/StatsD/libkll-encoder^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/packages/modules/StatsD/libkll-encoder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/packages/modules/StatsD/com.android.os.statsd.init.rc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/apex/com.android.os.statsd.init.rc^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_packages_modules_StatsD.tar.zst --clobber
