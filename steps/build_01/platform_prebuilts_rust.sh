...
clone_depth_platform platform/prebuilts/rust
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunwind.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunwind.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunwind.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunwind.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunwind.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunwind.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libunicode_width.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libtest^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libterm^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liblibc.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liblibc.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libtest^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libterm^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liblibc.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liblibc.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libstd^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libterm^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liblibc.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liblibc.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libtest^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcore.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcore.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libprofiler_builtins.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liballoc.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liballoc.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libhashbrown.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libstd^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/librustc_demangle.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libgetopts^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libgetopts^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libgetopts^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcore.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcore.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libpanic_abort.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libstd^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcore.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcore.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcompiler_builtins.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libcfg_if.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_sys.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_64_rlib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libbacktrace_rs.rust_sysroot^android_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liballoc.rust_sysroot^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liballoc.rust_sysroot^android_x86_x86_64_rlib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/prebuilts/rust/liballoc.rust_sysroot^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/liballoc.rust_sysroot^android_x86_64_rlib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/prebuilts/rust/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_prebuilts_rust.tar.zst --clobber

du -ah -d1 platform_prebuilts_rust*.tar.zst | sort -h

if [ ! -f "$GITHUB_WORKSPACE/cache/libcore.tar.zst" ]; then
  echo "Compressing libcore -> libcore.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/libcore/ .
fi
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_prebuilts_rust.tar.zst" ]; then
  echo "Compressing platform/prebuilts/rust -> platform_prebuilts_rust.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/prebuilts/rust/ .
fi
