...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/keymaster/libsoft_attestation_cert^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libsoft_attestation_cert^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/keymaster/libpuresoftkeymasterdevice^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libpuresoftkeymasterdevice^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/keymaster/libkeymaster_portable^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_portable^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/keymaster/libcppcose_rkp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libcppcose_rkp^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_keymaster.tar.zst --clobber
