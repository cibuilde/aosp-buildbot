...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libassemblevintf,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libassemblevintf^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/libvintf/libassemblevintf^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libassemblevintf^linux_glibc_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_libvintf.tar.zst --clobber
