...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/logtagd.rc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logd/logtagd.rc^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/logpersist.start^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logcat/logpersist.start^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/logcatd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logcat/logcatd^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblogwrap^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblogwrap^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblogwrap^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblogd^android_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/system/logging/logd/liblogd^android_x86_64_static_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog_ndk_headers^.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog_ndk_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^linux_glibc_x86_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^linux_glibc_x86_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_x86_64_static_cfi_lto-thin.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_x86_64_static_cfi_lto-thin
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_vendor_ramdisk_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_vendor_ramdisk_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/logging/liblog^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_recovery_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_logging.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/logging/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_logging.tar.zst --clobber
