...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libsndfile^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libsndfile^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libfifo^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libfifo^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils_fixedfft^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils_fixedfft^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils_fixedfft^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils_fixedfft^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils_fixedfft^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils_fixedfft^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/media/libaudioutils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_media.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/media/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_media.tar.zst --clobber
