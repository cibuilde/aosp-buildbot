...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libkeystore2_vintf_cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/vintf/libkeystore2_vintf_cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/security/libkeystore2_vintf_cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/vintf/libkeystore2_vintf_cpp^android_x86_64_static

echo "building libkeystore2_crypto^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libkeystore2_crypto,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/crypto/libkeystore2_crypto^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/security/libkeystore2_crypto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/crypto/libkeystore2_crypto^android_x86_64_static

echo "building libkeystore2_aaid^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libkeystore2_aaid,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aaid/libkeystore2_aaid^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/security/libkeystore2_aaid^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aaid/libkeystore2_aaid^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_security.tar.zst --clobber
