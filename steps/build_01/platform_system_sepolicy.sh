...
clone_depth_platform platform/system/sepolicy
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/vendor_service_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/vendor_service_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/vendor_hwservice_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/vendor_hwservice_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/userdebug_plat_sepolicy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/userdebug_plat_sepolicy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_service_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_service_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_sepolicy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_sepolicy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_pub_policy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_pub_policy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_property_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_property_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_hwservice_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_hwservice_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_30.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_30.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_29.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_29.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_28.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_28.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_27.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_27.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/system_ext_26.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_26.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/reqd_policy_mask.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/reqd_policy_mask.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/pub_policy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/pub_policy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/product_service_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_service_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/product_sepolicy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_sepolicy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/product_property_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_property_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/product_hwservice_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_hwservice_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_service_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_service_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_sepolicy_vers.txt^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy_vers.txt^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_sepolicy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_pub_policy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_pub_policy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_property_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_property_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_keystore2_key_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_keystore2_key_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_hwservice_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_hwservice_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/plat_30.0.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_30.0.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/odm_property_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/odm_property_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/microdroid_vendor_sepolicy.conf^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.conf^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/microdroid_plat_sepolicy_vers.txt^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_plat_sepolicy_vers.txt^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/30.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/30.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/29.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/29.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/28.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/28.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/27.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/27.0.compat.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/platform/system/sepolicy/26.0.compat.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/26.0.compat.cil^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_sepolicy.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/sepolicy/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 platform_system_sepolicy.tar.zst --clobber

du -ah -d1 platform_system_sepolicy*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_sepolicy.tar.zst" ]; then
  echo "Compressing platform/system/sepolicy -> platform_system_sepolicy.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_sepolicy.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/sepolicy/ .
fi
