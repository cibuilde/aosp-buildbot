...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libwificond_nl,android_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_connectivity_wificond.tar.xz" ]; then
  echo "Compressing system/connectivity/wificond -> system_connectivity_wificond.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/system_connectivity_wificond.tar.xz -C $GITHUB_WORKSPACE/aosp/system/connectivity/wificond/ .
fi
