...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsi,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libgsi,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ system_gsid.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/gsid/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_gsid.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/system_gsid.tar.zst -C $GITHUB_WORKSPACE/aosp/system/gsid/ .
fi
