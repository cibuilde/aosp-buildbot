...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libincfs-utils,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/incremental_delivery/libincfs-utils^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs-utils^android_x86_64_static $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs-utils^android_x86_64_static/addition_copy_files.output

echo "building libincfs-utils^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libincfs-utils,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/incremental_delivery/libincfs-utils^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs-utils^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs-utils^android_x86_x86_64_static/addition_copy_files.output

echo "building libincfs-utils^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libincfs-utils,linux_glibc_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libdataloader,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libdataloader,android_x86_x86_64_static
