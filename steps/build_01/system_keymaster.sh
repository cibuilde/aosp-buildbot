...
cd $GITHUB_WORKSPACE/
tar cfJ system_keymaster.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/keymaster/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libcppbor.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libcppbor.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libcppbor/ .
fi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_keymaster.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/system_keymaster.tar.zst -C $GITHUB_WORKSPACE/aosp/system/keymaster/ .
fi
