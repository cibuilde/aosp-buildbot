...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libcppcose_rkp,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libkeymaster_portable,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libpuresoftkeymasterdevice,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libsoft_attestation_cert,android_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libcppbor.tar.xz" ]; then
  echo "Compressing external/libcppbor -> external_libcppbor.tar.xz"
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_keymaster.tar.xz" ]; then
  echo "Compressing system/keymaster -> system_keymaster.tar.xz"
