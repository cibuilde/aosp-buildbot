...
cd $GITHUB_WORKSPACE/
tar cfJ system_libfmq.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/libfmq/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_libfmq.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/system_libfmq.tar.zst -C $GITHUB_WORKSPACE/aosp/system/libfmq/ .
fi
