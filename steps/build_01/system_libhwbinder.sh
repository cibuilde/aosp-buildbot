...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_64_static_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_64_static_apex30
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_64_static_cfi_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libhwbinder-impl-internal,android_x86_x86_64_static_apex30
...
cd $GITHUB_WORKSPACE/
tar cfJ system_libhwbinder.tar.xz -C $GITHUB_WORKSPACE/artifacts/system/libhwbinder/ .
