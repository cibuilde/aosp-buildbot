...
echo "Preparing for system/libprocinfo"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_recovery_x86_64_static/addition_copy_files.output

echo "building libprocinfo^android_vendor_ramdisk_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_vendor_ramdisk_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_vendor_ramdisk_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor_ramdisk_x86_64_static $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor_ramdisk_x86_64_static/addition_copy_files.output

echo "building libprocinfo^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_static_apex10000/addition_copy_files.output

echo "building libprocinfo^android_x86_64_static_apex31"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_64_static_apex31
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_x86_64_static_apex31.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_static_apex31 $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_static_apex31/addition_copy_files.output

echo "building libprocinfo^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static/addition_copy_files.output

echo "building libprocinfo^android_x86_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex10000/addition_copy_files.output

echo "building libprocinfo^android_x86_x86_64_static_apex31"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,android_x86_x86_64_static_apex31
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex31.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex31 $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_static_apex31/addition_copy_files.output

echo "building libprocinfo^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libprocinfo,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^linux_glibc_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 system_libprocinfo.tar.zst --clobber
