...
cd $GITHUB_WORKSPACE/
tar cfJ system_memory_libdmabufheap.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libdmabufheap.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/system_memory_libdmabufheap.tar.zst -C $GITHUB_WORKSPACE/aosp/system/memory/libdmabufheap/ .
fi
