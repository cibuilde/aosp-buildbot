...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_64_static_apex29
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libion.tar.xz" ]; then
  echo "Compressing system/memory/libion -> system_memory_libion.tar.xz"
