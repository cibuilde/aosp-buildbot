...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_64_static_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libion,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ system_memory_libion.tar.xz -C $GITHUB_WORKSPACE/artifacts/system/memory/libion/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libion.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/system_memory_libion.tar.xz -C $GITHUB_WORKSPACE/aosp/system/memory/libion/ .
fi
rm -rf aosp