...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdmabufinfo,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdmabufinfo,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmeminfo,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmeminfo,android_x86_x86_64_static
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libmeminfo.tar.xz" ]; then
  echo "Compressing system/memory/libmeminfo -> system_memory_libmeminfo.tar.xz"
