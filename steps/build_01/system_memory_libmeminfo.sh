...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdmabufinfo,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libdmabufinfo,android_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmeminfo,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmeminfo,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ system_memory_libmeminfo.tar.xz -C $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libmeminfo.tar.xz" ]; then
  tar cfJ $GITHUB_WORKSPACE/cache/system_memory_libmeminfo.tar.xz -C $GITHUB_WORKSPACE/aosp/system/memory/libmeminfo/ .
fi
rm -rf aosp