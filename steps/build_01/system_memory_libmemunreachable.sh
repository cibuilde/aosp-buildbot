...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmemunreachable,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja libmemunreachable,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ system_memory_libmemunreachable.tar.xz -C $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/ .
...
mkdir -p $GITHUB_WORKSPACE/cache
if [ ! -f "$GITHUB_WORKSPACE/cache/system_memory_libmemunreachable.tar.xz" ]; then
  echo "Compressing system/memory/libmemunreachable -> system_memory_libmemunreachable.tar.xz"
  tar cfJ $GITHUB_WORKSPACE/cache/system_memory_libmemunreachable.tar.xz -C $GITHUB_WORKSPACE/aosp/system/memory/libmemunreachable/ .
fi
