...
echo "Preparing for test/vts-testcase/hal"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_01.ninja libvts_vintf_test_common,linux_glibc_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_01/test/vts-testcase/hal/libvts_vintf_test_common^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/test/vts-testcase/hal/treble/vintf/libvts_vintf_test_common/libvts_vintf_test_common^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/test/vts-testcase/hal/treble/vintf/libvts_vintf_test_common/libvts_vintf_test_common^linux_glibc_x86_64_static/addition_copy_files.output


rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf test_vts-testcase_hal.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/test/vts-testcase/hal/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_01 test_vts-testcase_hal.tar.zst --clobber

du -ah -d1 test_vts-testcase_hal*.tar.zst | sort -h
