...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja slicer,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_01.ninja slicer_ndk_no_rtti,android_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ tools_dexter.tar.zst -C $GITHUB_WORKSPACE/artifacts/tools/dexter/ .
