...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm64_armv8-a_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/arm-optimized-routines/libarm-optimized-routines-math^android_native_bridge_arm_armv7-a-neon_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_native_bridge_arm64_armv8-a_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_native_bridge_arm64_armv8-a_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm64_armv8-a_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm64_armv8-a_static/addition_copy_files.output

echo "building libm^android_native_bridge_arm_armv7-a-neon_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_native_bridge_arm_armv7-a-neon_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_native_bridge_arm_armv7-a-neon_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm_armv7-a-neon_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm_armv7-a-neon_static/addition_copy_files.output

echo "building libm^android_recovery_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_recovery_x86_64_static/addition_copy_files.output

echo "building libm^android_vendor_ramdisk_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_vendor_ramdisk_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_vendor_ramdisk_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_vendor_ramdisk_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_vendor_ramdisk_x86_64_static/addition_copy_files.output

echo "building libm^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static/addition_copy_files.output

echo "building libm^android_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static_apex10000/addition_copy_files.output

echo "building libm^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static/addition_copy_files.output

echo "building libm^android_x86_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libm,android_x86_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libm^android_x86_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static_apex10000/addition_copy_files.output

echo "building libsystemproperties^android_native_bridge_arm64_armv8-a_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_native_bridge_arm64_armv8-a_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_native_bridge_arm64_armv8-a_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm64_armv8-a_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm64_armv8-a_static/addition_copy_files.output

echo "building libsystemproperties^android_native_bridge_arm_armv7-a-neon_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_native_bridge_arm_armv7-a-neon_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_native_bridge_arm_armv7-a-neon_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm_armv7-a-neon_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm_armv7-a-neon_static/addition_copy_files.output

echo "building libsystemproperties^android_recovery_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_recovery_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_recovery_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_recovery_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_recovery_x86_64_static/addition_copy_files.output

echo "building libsystemproperties^android_vendor_ramdisk_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_vendor_ramdisk_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_vendor_ramdisk_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_vendor_ramdisk_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_vendor_ramdisk_x86_64_static/addition_copy_files.output

echo "building libsystemproperties^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static/addition_copy_files.output

echo "building libsystemproperties^android_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_x86_64_static_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_x86_64_static_apex10000.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static_apex10000 $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static_apex10000/addition_copy_files.output

echo "building libsystemproperties^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/bionic/libsystemproperties^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_x86_64_static/addition_copy_files.output

echo "building libsystemproperties^android_x86_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libsystemproperties,android_x86_x86_64_static_apex10000
