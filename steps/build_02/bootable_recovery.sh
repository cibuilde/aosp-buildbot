...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libminui,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libminui,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ bootable_recovery.tar.zst -C $GITHUB_WORKSPACE/artifacts/bootable/recovery/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/bootable_recovery.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/bootable_recovery.tar.zst -C $GITHUB_WORKSPACE/aosp/bootable/recovery/ .
fi
