...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja bssl_inject_hash,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libcrypto,linux_glibc_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libcrypto,linux_glibc_x86_static
