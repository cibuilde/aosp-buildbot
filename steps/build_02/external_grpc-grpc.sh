...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_01 --pattern external_grpc-grpc.tar.zst --skip-existing
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc
tar xf $GITHUB_WORKSPACE/external_grpc-grpc.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libalts_frame_protector,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc++_base,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc++_base,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_trace,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_trace,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_transport_chttp2,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_transport_chttp2,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libtsi,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libtsi,android_x86_x86_64_static
...
cd $GITHUB_WORKSPACE/
tar cfJ external_grpc-grpc.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_grpc-grpc.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_grpc-grpc.tar.zst -C $GITHUB_WORKSPACE/aosp/external/grpc-grpc/ .
fi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_nanopb-c.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_nanopb-c.tar.zst -C $GITHUB_WORKSPACE/aosp/external/nanopb-c/ .
fi
