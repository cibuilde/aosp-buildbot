...
echo "Preparing for external/rust/crates/fallible-iterator"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libfallible_iterator,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/external/rust/crates/fallible-iterator/libfallible_iterator^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/fallible-iterator/libfallible_iterator^android_x86_64_rlib_rlib-std
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_02/external/rust/crates/fallible-iterator/libfallible_iterator^android_x86_64_rlib_rlib-std.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/fallible-iterator/libfallible_iterator^android_x86_64_rlib_rlib-std $GITHUB_WORKSPACE/artifacts/external/rust/crates/fallible-iterator/libfallible_iterator^android_x86_64_rlib_rlib-std/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 external_rust_crates_fallible-iterator.tar.zst --clobber
