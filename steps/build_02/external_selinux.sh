...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libselinux,linux_glibc_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja secilc,linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 external_selinux.tar.zst --clobber
