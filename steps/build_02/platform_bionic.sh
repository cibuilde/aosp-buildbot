...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_vendor_ramdisk_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_vendor_ramdisk_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_native_bridge_arm_armv7-a-neon_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm_armv7-a-neon_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libsystemproperties^android_native_bridge_arm64_armv8-a_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/system_properties/libsystemproperties^android_native_bridge_arm64_armv8-a_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_vendor_ramdisk_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_vendor_ramdisk_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_native_bridge_arm_armv7-a-neon_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm_armv7-a-neon_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/bionic/libm^android_native_bridge_arm64_armv8-a_static.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_native_bridge_arm64_armv8-a_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_bionic.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/bionic/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 platform_bionic.tar.zst --clobber
