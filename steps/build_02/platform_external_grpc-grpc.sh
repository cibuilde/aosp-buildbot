...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_base_c,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static

echo "building libgrpc_base_c^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_base_c,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc_base_c^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_64_static

echo "building libgrpc_base^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_base,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc_base^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base^android_x86_x86_64_static

echo "building libgrpc_base^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc_base,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc_base^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base^android_x86_64_static

echo "building libgrpc^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc^android_x86_x86_64_static

echo "building libgrpc^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libgrpc,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/external/grpc-grpc/libgrpc^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 platform_external_grpc-grpc.tar.zst --clobber
