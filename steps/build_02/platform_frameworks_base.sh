...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/incremental_delivery/incfs/libincfs-utils^linux_glibc_x86_64_static/ .

echo "building libandroidfw^linux_glibc_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libandroidfw,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/platform/frameworks/base/libandroidfw^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^linux_glibc_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 platform_frameworks_base.tar.zst --clobber
