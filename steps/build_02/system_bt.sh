...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libbt_hci_custom_types,android_x86_64_rlib_rlib-std
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_02.ninja libbt_hci_custom_types,android_x86_x86_64_rlib_rlib-std
