...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/system/media/libaudioutils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_static

echo "building libaudioutils^android_x86_64_static_cfi_apex29"
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libaudioutils,android_x86_64_static_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_static_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/system/media/libaudioutils^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_static_cfi_apex29

echo "building libaudioutils^android_x86_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_02.ninja libaudioutils,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_02/system/media/libaudioutils^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ system_media.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/media/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_02 system_media.tar.zst --clobber
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_speex.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_speex.tar.zst -C $GITHUB_WORKSPACE/aosp/external/speex/ .
fi
