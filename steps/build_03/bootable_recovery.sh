...
rsync -a -r $GITHUB_WORKSPACE/downloads/bootable/recovery/applypatch/libimgdiff^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/bootable/recovery/otautil/libotautil^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/brotli/libbrotli^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/bsdiff/libbsdiff^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/bzip2/libbz^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libcxx/libc++^linux_glibc_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libdivsufsort/libdivsufsort^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libdivsufsort/libdivsufsort64^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/zlib/libz_stable^linux_glibc_x86_64_static/ .
...
echo "building imgdiff^linux_glibc_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja imgdiff,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/imgdiff^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/bootable/recovery/imgdiff^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/imgdiff^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/bootable/recovery/imgdiff^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/imgdiff^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/imgdiff^linux_glibc_x86_64/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 bootable_recovery.tar.zst --clobber
