...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja dep_fixer,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja extract_jar_packages,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja merge_zips,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja sbox,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja soong-zip,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja zip2zip,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja zipsync,linux_glibc_x86_64
