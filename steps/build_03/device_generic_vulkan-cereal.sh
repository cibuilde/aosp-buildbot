...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja perfetto-tracing-only,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/device/generic/vulkan-cereal/perfetto-tracing-only^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/third-party/perfetto-tracing-only/perfetto-tracing-only^android_x86_64_static

echo "building perfetto-tracing-only^android_x86_64_static_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja perfetto-tracing-only,android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/device/generic/vulkan-cereal/perfetto-tracing-only^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/third-party/perfetto-tracing-only/perfetto-tracing-only^android_x86_64_static_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 device_generic_vulkan-cereal.tar.zst --clobber
