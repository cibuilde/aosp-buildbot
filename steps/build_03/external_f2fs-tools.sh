...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja make_f2fs,linux_glibc_x86_64
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja sload_f2fs,linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 external_f2fs-tools.tar.zst --clobber
