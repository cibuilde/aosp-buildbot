...
ninja -f $GITHUB_WORKSPACE/steps/build_03.ninja libgrpc_base_c,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/grpc-grpc/libgrpc_base_c^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_64_static

echo "building libgrpc_base_c^android_x86_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_03.ninja libgrpc_base_c,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_base_c^android_x86_x86_64_static

echo "building libgrpc_secure^android_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_03.ninja libgrpc_secure,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_secure^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/grpc-grpc/libgrpc_secure^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_secure^android_x86_64_static

echo "building libgrpc_secure^android_x86_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_03.ninja libgrpc_secure,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_secure^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/grpc-grpc/libgrpc_secure^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc_secure^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ external_grpc-grpc.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 external_grpc-grpc.tar.zst --clobber
