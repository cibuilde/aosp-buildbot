...
echo "Preparing for external/javapoet"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja javapoet,linux_glibc_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 external_javapoet.tar.zst --clobber

du -ah -d1 external_javapoet*.tar.zst | sort -h
