...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja jni_generator,linux_glibc_x86_64_PY2
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja jni_registration_generator,linux_glibc_x86_64_PY2
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libmojo_jni_headers,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libmojo_jni_registration_headers,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libchrome-include,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libchrome,android_recovery_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libchrome,android_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libchrome,android_x86_x86_64_static
...
echo "building libchrome^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libchrome,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/libchrome/libchrome^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^linux_glibc_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/external/libchrome/libchrome^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^linux_glibc_x86_64_static/addition_copy_files.output
