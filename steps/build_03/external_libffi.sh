...
echo "Preparing for external/libffi"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja ffi_header,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libffi,android_x86_64_static_apex10000
...
echo "building libffi^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libffi,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/libffi/libffi^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^linux_glibc_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/external/libffi/libffi^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^linux_glibc_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 external_libffi.tar.zst --clobber

du -ah -d1 external_libffi*.tar.zst | sort -h
