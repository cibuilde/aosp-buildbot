...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja py2-launcher-autorun,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64/addition_copy_files.output

echo "building py2-stdlib^linux_glibc_x86_64_PY2"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja py2-stdlib,linux_glibc_x86_64_PY2
mkdir -p $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/external/python/cpython2/py2-stdlib^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/external/python/cpython2/py2-stdlib^linux_glibc_x86_64_PY2.output $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2 $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 external_python_cpython2.tar.zst --clobber
