...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_env_logger.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/env_logger/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_env_logger.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_env_logger.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/env_logger/ .
fi
