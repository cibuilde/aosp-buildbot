...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libselinux,linux_glibc_x86_64_shared
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja sefcontext_compile,linux_glibc_x86_64
