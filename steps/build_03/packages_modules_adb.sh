...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadbconnection_client,android_x86_x86_64_shared_current
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadbd_fs,android_x86_64_shared_current
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadb_pairing_server,android_x86_64_shared_current
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadb_pairing_server,android_x86_x86_64_shared_current
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadb_pairing_connection,android_x86_64_shared_current
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libadb_pairing_connection,android_x86_x86_64_shared_current
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 packages_modules_adb.tar.zst --clobber
