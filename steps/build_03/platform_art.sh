...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/profman^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/profman/profman^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libsigchain^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libsigchain^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libprofman_static^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/profman/libprofman_static^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libopenjdkjvmti^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libopenjdkjvmti^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libopenjdkjvm^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvm/libopenjdkjvm^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libopenjdkjvm^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvm/libopenjdkjvm^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libnativeloader^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/art/libnativeloader/libnativeloader^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libnativeloader^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/art/libnativeloader/libnativeloader^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libdexfiled^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfiled^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libdexfile^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/veridex^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/tools/veridex/veridex^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libdexfile^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libdexfile^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/libdexfile^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartd^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/runtime/libartd^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartd-dex2oat^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/libartd-dex2oat^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartd-compiler^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/compiler/libartd-compiler^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libdex2oatd_static^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/libdex2oatd_static^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartbase^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libartbase/libartbase^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartbase^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartbase/libartbase^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartbase^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartbase/libartbase^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libart_mterp.x86^.output . $GITHUB_WORKSPACE/artifacts/art/runtime/libart_mterp.x86^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/cpp-define-generator-asm-support^android_x86_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/cpp-define-generator-asm-support^android_x86_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libadbconnection^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/adbconnection/libadbconnection^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art_libartbase_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/libartbase/art_libartbase_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libartbased^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/art/libartbase/libartbased^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libart_mterp.x86_64ng^.output . $GITHUB_WORKSPACE/artifacts/art/runtime/libart_mterp.x86_64ng^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libart_mterp.x86_64^.output . $GITHUB_WORKSPACE/artifacts/art/runtime/libart_mterp.x86_64^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libart-dex2oat^android_x86_x86_64_static_lto-thin_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/libart-dex2oat^android_x86_x86_64_static_lto-thin_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/hiddenapi^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/tools/hiddenapi/hiddenapi^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/generate_operator_out^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/art/tools/generate_operator_out^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/dexfile_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/libdexfile/dexfile_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/cpp-define-generator-asm-support^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/cpp-define-generator-asm-support^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/dex2oatd^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/dex2oatd^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/cpp-define-generator-asm-support^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/tools/cpp-define-generator/cpp-define-generator-asm-support^android_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libart-dex2oat^android_x86_64_static_lto-thin_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/libart-dex2oat^android_x86_64_static_lto-thin_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/libadbconnection^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/adbconnection/libadbconnection^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art_perfetto_hprof_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/perfetto_hprof/art_perfetto_hprof_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/runtime/art_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art_dex2oat_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/art_dex2oat_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art_compiler_operator_srcs^.output . $GITHUB_WORKSPACE/artifacts/art/compiler/art_compiler_operator_srcs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/art/art-odrefresh-operator-srcs^.output . $GITHUB_WORKSPACE/artifacts/art/odrefresh/art-odrefresh-operator-srcs^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/art/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_art.tar.zst --clobber
