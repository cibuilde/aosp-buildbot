...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/zipalign^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/zipalign/zipalign^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/releasetools_verity_utils^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/releasetools/releasetools_verity_utils^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/releasetools_common^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/releasetools/releasetools_common^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/post_process_props^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/post_process_props^linux_glibc_x86_64_PY3
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_gen_vendor^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_gen_vendor^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_vendor^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_vendor^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_system^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_system^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_odm^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_odm^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_gen_system_ext^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_gen_system_ext^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_system_ext^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_system_ext^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_gen_product^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_gen_product^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_product^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_product^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_gen_system^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_gen_system^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/passwd_gen_odm^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/passwd_gen_odm^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/libzipalign^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/zipalign/libzipalign^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_gen_vendor^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_gen_vendor^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_vendor^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_vendor^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_product^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_product^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_odm^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_odm^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_gen_system_ext^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_gen_system_ext^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_system_ext^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_system_ext^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_gen_system^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_gen_system^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_system^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_system^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_gen_product^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_gen_product^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/build/group_gen_odm^.output . $GITHUB_WORKSPACE/artifacts/build/make/tools/fs_config/group_gen_odm^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_build.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/build/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_build.tar.zst --clobber
