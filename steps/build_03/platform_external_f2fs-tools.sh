...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/f2fs-tools/sload_f2fs^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/sload_f2fs^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/f2fs-tools/make_f2fs^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/make_f2fs^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_f2fs-tools.tar.zst --clobber
