...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicuuc^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/icu/icu4c/source/common/libicuuc^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicui18n^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/icu/icu4c/source/i18n/libicui18n^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libicu.ndk^android_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu.ndk^android_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libandroidicu^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/icu/libandroidicu^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_64_shared_current

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_icu.tar.zst --clobber
