...
clone_depth_platform platform/external/libchrome
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libmojo_jni_headers^.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libmojo_jni_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libchrome-include^.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome-include^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libchrome^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libchrome^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libchrome^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/jni_registration_generator^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/jni_registration_generator^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/libmojo_jni_registration_headers^.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libmojo_jni_registration_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/libchrome/jni_generator^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/jni_generator^linux_glibc_x86_64_PY2

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_libchrome.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/libchrome/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_libchrome.tar.zst --clobber

du -ah -d1 platform_external_libchrome*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_libchrome.tar.zst" ]; then
  echo "Compressing platform/external/libchrome -> platform_external_libchrome.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_libchrome.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/libchrome/ .
fi
