...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/protoc-gen-javanano^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/protoc-gen-javanano^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/protoc-gen-javamicro^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/protoc-gen-javamicro^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/aprotoc^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/aprotoc^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/libprotobuf-python^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-python^linux_glibc_x86_64_PY3
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/libprotobuf-python^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-python^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/libprotobuf-java-full^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-java-full^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/libprotobuf-cpp-lite^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-lite^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/protobuf/libprotobuf-cpp-full^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-full^linux_glibc_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_protobuf.tar.zst --clobber
