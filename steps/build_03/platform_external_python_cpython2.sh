...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/boringssl/libcrypto_static^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/python/cpython2/py2-launcher-lib^linux_glibc_x86_64_static/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja py2-stdlib,linux_glibc_x86_64_PY2
mkdir -p $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/python/cpython2/py2-stdlib^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/python/cpython2/Lib/py2-stdlib^linux_glibc_x86_64_PY2

echo "building py2-launcher-autorun^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja py2-launcher-autorun,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/python/cpython2/py2-launcher-autorun^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_python_cpython2.tar.zst --clobber
