...
clone_depth_platform platform/external/rust/crates/lock_api
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja liblock_api,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/lock_api/liblock_api^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/rust/crates/lock_api/liblock_api^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/lock_api/liblock_api^android_x86_x86_64_rlib_rlib-std

echo "building liblock_api^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja liblock_api,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/lock_api/liblock_api^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/rust/crates/lock_api/liblock_api^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/lock_api/liblock_api^android_x86_64_rlib_rlib-std

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_rust_crates_lock_api.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/rust/crates/lock_api/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_rust_crates_lock_api.tar.zst --clobber

du -ah -d1 platform_external_rust_crates_lock_api*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_rust_crates_lock_api.tar.zst" ]; then
  echo "Compressing platform/external/rust/crates/lock_api -> platform_external_rust_crates_lock_api.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_rust_crates_lock_api.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/rust/crates/lock_api/ .
fi
