...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/selinux/libselinux^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/selinux/libselinux^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/external/selinux/checkpolicy^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/selinux/checkpolicy/checkpolicy^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_external_selinux.tar.zst --clobber
