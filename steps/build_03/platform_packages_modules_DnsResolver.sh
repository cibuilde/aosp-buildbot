...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libnetd_resolv,android_x86_64_shared_current
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_shared_current
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_shared_current
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_packages_modules_DnsResolver.tar.zst --clobber
