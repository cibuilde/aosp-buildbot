...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libstatssocket,android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/StatsD/libstatssocket^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_x86_64_shared_current

echo "building libstatssocket^android_x86_64_shared_current"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libstatssocket,android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/StatsD/libstatssocket^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared_current

echo "building libstatssocket^android_x86_64_shared_30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libstatssocket,android_x86_64_shared_30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared_30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/StatsD/libstatssocket^android_x86_64_shared_30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared_30

echo "building libstatspull^android_x86_x86_64_shared_current"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libstatspull,android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/StatsD/libstatspull^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_x86_64_shared_current

echo "building libstatspull^android_x86_64_shared_current"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja libstatspull,android_x86_64_shared_current
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_64_shared_current
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/StatsD/libstatspull^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_64_shared_current
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_packages_modules_StatsD.tar.zst --clobber
