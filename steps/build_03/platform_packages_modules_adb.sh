...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadbd_fs^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadbconnection_client^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/adbconnection/libadbconnection_client^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadbconnection_client^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/adbconnection/libadbconnection_client^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadb_pairing_server^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_server^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadb_pairing_server^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_server^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadb_pairing_connection^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_connection^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/packages/modules/adb/libadb_pairing_connection^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_connection^android_x86_64_shared_current
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_packages_modules_adb.tar.zst --clobber
