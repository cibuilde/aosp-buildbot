...
clone_depth_platform platform/prebuilts/tools
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/xerial-sqlite-jdbc^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/xerial-sqlite-jdbc^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/symbol-processing-api^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/symbol-processing-api^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/metalava-tools-common-m2-deps^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/metalava-tools-common-m2-deps^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/kotlinx-metadata-jvm^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-metadata-jvm^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/kotlinx-coroutines-core-nodeps^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-core-nodeps^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/kotlinx-coroutines-core-nodeps^android_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-core-nodeps^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/kotlinx-coroutines-android-nodeps^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-android-nodeps^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/kotlinx-coroutines-android-nodeps^android_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-android-nodeps^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/jetbrains-annotations^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/jetbrains-annotations^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/javapoet-prebuilt-jar^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/javapoet-prebuilt-jar^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/guava-listenablefuture-prebuilt-jar^android_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/guava-listenablefuture-prebuilt-jar^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/gson-prebuilt-jar^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/gson-prebuilt-jar^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/prebuilts/tools/commons-codec^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/commons-codec^linux_glibc_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_prebuilts_tools.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/prebuilts/tools/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_prebuilts_tools.tar.zst --clobber

du -ah -d1 platform_prebuilts_tools*.tar.zst | sort -h

if [ ! -f "$GITHUB_WORKSPACE/cache/platform_prebuilts_tools.tar.zst" ]; then
  echo "Compressing platform/prebuilts/tools -> platform_prebuilts_tools.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_prebuilts_tools.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/prebuilts/tools/ .
fi
