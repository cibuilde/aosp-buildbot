...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/toolbox_input_labels^.output . $GITHUB_WORKSPACE/artifacts/system/core/toolbox/toolbox_input_labels^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/mkbootfs^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/mkbootfs/mkbootfs^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libvndksupport^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libvndksupport/libvndksupport^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libvndksupport^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libvndksupport/libvndksupport^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libvndksupport^android_x86_64_shared_29.output . $GITHUB_WORKSPACE/artifacts/system/core/libvndksupport/libvndksupport^android_x86_64_shared_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libvndksupport^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libvndksupport/libvndksupport^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libvndksupport^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libvndksupport/libvndksupport^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_x86_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_x86_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_vendor_ramdisk_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_vendor_ramdisk_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libtombstoned_client_static^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libtombstoned_client_static^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_30.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_29.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_28.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_28
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_27.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_27
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_x86_64_sdk_shared_26.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_x86_64_sdk_shared_26
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_30.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_29.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_28.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_28
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_27.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_27
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libsync.ndk^android_x86_64_sdk_shared_26.output . $GITHUB_WORKSPACE/artifacts/system/core/libsync/libsync.ndk^android_x86_64_sdk_shared_26
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libcgrouprc^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libprocessgroup/cgrouprc/libcgrouprc^android_x86_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libcgrouprc^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/core/libprocessgroup/cgrouprc/libcgrouprc^android_x86_64_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libcgrouprc^android_x86_64_shared_29.output . $GITHUB_WORKSPACE/artifacts/system/core/libprocessgroup/cgrouprc/libcgrouprc^android_x86_64_shared_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libcgrouprc^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libprocessgroup/cgrouprc/libcgrouprc^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/libcgrouprc^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libprocessgroup/cgrouprc/libcgrouprc^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/img2simg^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/libsparse/img2simg^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/core/generated_stub_builtin_function_map^.output . $GITHUB_WORKSPACE/artifacts/system/core/init/generated_stub_builtin_function_map^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_system_core.tar.zst --clobber
