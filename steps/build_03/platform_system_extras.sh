...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_64_sdk_shared_current.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_64_sdk_shared_current
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_64_sdk_shared_REL.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_64_sdk_shared_REL
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/libnativehelper.ndk^android_x86_64_sdk_shared_31.output . $GITHUB_WORKSPACE/artifacts/system/extras/module_ndk_libs/libnativehelper/libnativehelper.ndk^android_x86_64_sdk_shared_31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/fec^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/verity/fec/fec^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/extras/fec^linux_glibc_x86.output . $GITHUB_WORKSPACE/artifacts/system/extras/verity/fec/fec^linux_glibc_x86

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_system_extras.tar.zst --clobber
