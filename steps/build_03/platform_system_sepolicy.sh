...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/sepolicy/vendor_property_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/vendor_property_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/sepolicy/insertkeys.py^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/tools/insertkeys.py^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/sepolicy/checkfc^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/tools/checkfc^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/sepolicy/check_prop_prefix^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/tests/check_prop_prefix^linux_glibc_x86_64_PY3
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_03/platform/system/sepolicy/build_sepolicy^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/build/build_sepolicy^linux_glibc_x86_64_PY2
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_03 platform_system_sepolicy.tar.zst --clobber
