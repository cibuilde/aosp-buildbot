...
echo "Preparing for prebuilts/gradle-plugin"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja metalava-gradle-plugin-deps,linux_glibc_common
