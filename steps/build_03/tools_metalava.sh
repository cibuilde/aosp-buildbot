...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_03.ninja stub-annotations,linux_glibc_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_03/tools/metalava/stub-annotations^linux_glibc_common.output $GITHUB_WORKSPACE/artifacts/tools/metalava/stub-annotations^linux_glibc_common $GITHUB_WORKSPACE/artifacts/tools/metalava/stub-annotations^linux_glibc_common/addition_copy_files.output
