...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja generated_android_ids,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libc.x86.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libc.x86_64.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libdl.x86.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libdl.x86_64.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libm.x86.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libm.x86_64.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libstdc++.x86.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libstdc++.x86_64.map,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja syscalls-arm.S,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja syscalls-arm64.S,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja syscalls-x86.S,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja syscalls-x86_64.S,
