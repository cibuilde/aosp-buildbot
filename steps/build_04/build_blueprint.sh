...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja blueprint-bootstrap-bpdoc,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/build/blueprint/blueprint-bootstrap-bpdoc^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/build/blueprint/blueprint-bootstrap-bpdoc^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/build/blueprint/blueprint-bootstrap-bpdoc^linux_glibc_x86_64
