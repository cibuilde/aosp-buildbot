...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja gfxstream_base,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/base/gfxstream_base^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/device/generic/vulkan-cereal/gfxstream_base^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/base/gfxstream_base^android_x86_64_static

echo "building gfxstream_base^android_x86_64_static_apex10000"
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja gfxstream_base,android_x86_64_static_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/base/gfxstream_base^android_x86_64_static_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/device/generic/vulkan-cereal/gfxstream_base^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/base/gfxstream_base^android_x86_64_static_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ device_generic_vulkan-cereal.tar.zst -C $GITHUB_WORKSPACE/artifacts/device/generic/vulkan-cereal/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 device_generic_vulkan-cereal.tar.zst --clobber
