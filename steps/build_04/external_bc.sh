...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja bc-bc_help.c,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja bc-lib.c,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja bc-version.h,
