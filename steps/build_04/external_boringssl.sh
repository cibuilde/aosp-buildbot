...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libcrypto,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/boringssl/libcrypto^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^linux_glibc_x86_64_shared
