...
echo "building gpu_display_server_protocol_headers^"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja gpu_display_server_protocol_headers,
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_server_protocol_headers^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/crosvm/gpu_display_server_protocol_headers^.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_server_protocol_headers^
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/crosvm/gpu_display_server_protocol_headers^.output $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_server_protocol_headers^ $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_server_protocol_headers^/addition_copy_files.output

echo "building libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libwayland_crosvm_gpu_display_extension_server_protocols,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/crosvm/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/crosvm/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/libwayland_crosvm_gpu_display_extension_server_protocols^linux_glibc_x86_64_static/addition_copy_files.output

echo "building libdisplay_wl^android_x86_64_static_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libdisplay_wl,android_x86_64_static_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja gpu_display_protocol_sources,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja gpu_display_client_protocol_headers,
