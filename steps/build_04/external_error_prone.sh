...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja error_prone_annotations,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja error_prone_annotations,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja error_prone_core,linux_glibc_common
