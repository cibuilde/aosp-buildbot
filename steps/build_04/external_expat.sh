...
echo "Preparing for external/expat"
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/expat/libexpat^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/expat/libexpat^android_vendor.31_x86_x86_64_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_vendor.31_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libexpat^android_vendor.31_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_vendor.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libexpat^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_vendor.31_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building libexpat^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_vendor.31_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_vendor.31_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_vendor.31_x86_x86_64_static/addition_copy_files.output

echo "building libexpat^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_shared/addition_copy_files.output

echo "building libexpat^android_x86_64_shared_apex31"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_x86_64_shared_apex31
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_x86_64_shared_apex31.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_shared_apex31 $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_64_shared_apex31/addition_copy_files.output

echo "building libexpat^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_shared/addition_copy_files.output

echo "building libexpat^android_x86_x86_64_shared_apex31"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libexpat,android_x86_x86_64_shared_apex31
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/expat/libexpat^android_x86_x86_64_shared_apex31.output $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_shared_apex31 $GITHUB_WORKSPACE/artifacts/external/expat/libexpat^android_x86_x86_64_shared_apex31/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 external_expat.tar.zst --clobber

du -ah -d1 external_expat*.tar.zst | sort -h
