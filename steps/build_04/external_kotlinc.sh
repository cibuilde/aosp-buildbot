...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-annotations,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-reflect,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib-jdk7,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib-jdk7,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib-jdk8,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib-jdk8,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja kotlin-stdlib,linux_glibc_common
