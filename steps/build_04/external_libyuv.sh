...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv_static^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv_static^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libyuv_static^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libyuv_static,android_vendor.31_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv_static^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv_static^android_vendor.31_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv_static^android_vendor.31_x86_x86_64_static/addition_copy_files.output

echo "building libyuv^android_vendor.31_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libyuv,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/libyuv/libyuv^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libyuv^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libyuv,android_vendor.31_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 external_libyuv.tar.zst --clobber
