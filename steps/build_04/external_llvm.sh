...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja llvm-tblgen,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/llvm/utils/TableGen/llvm-tblgen^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/external/llvm/llvm-tblgen^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/llvm/utils/TableGen/llvm-tblgen^linux_glibc_x86_64
