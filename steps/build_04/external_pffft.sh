...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libpffft,android_vendor.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/pffft/libpffft^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/pffft/libpffft^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/pffft/libpffft^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libpffft^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libpffft,android_vendor.31_x86_x86_64_static
