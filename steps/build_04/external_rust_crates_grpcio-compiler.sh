...
echo "Preparing for external/rust/crates/grpcio-compiler"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja grpc_rust_plugin,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64/addition_copy_files.output

echo "building libgrpcio_compiler^linux_glibc_x86_64_rlib_rlib-std"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libgrpcio_compiler,linux_glibc_x86_64_rlib_rlib-std
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/rust/crates/grpcio-compiler/libgrpcio_compiler^linux_glibc_x86_64_rlib_rlib-std.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/libgrpcio_compiler^linux_glibc_x86_64_rlib_rlib-std $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/libgrpcio_compiler^linux_glibc_x86_64_rlib_rlib-std/addition_copy_files.output
