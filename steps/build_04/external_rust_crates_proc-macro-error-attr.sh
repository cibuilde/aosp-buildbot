...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja libproc_macro_error_attr,linux_glibc_x86_64
...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_proc-macro-error-attr.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-error-attr/ .
