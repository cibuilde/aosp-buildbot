...
echo "entering external/rust/crates/proc-macro-error-attr"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libproc_macro_error_attr,linux_glibc_x86_64
