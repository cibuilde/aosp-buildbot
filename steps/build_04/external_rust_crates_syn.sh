...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja libsyn,linux_glibc_x86_64_rlib_rlib-std
...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_syn.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/syn/ .
