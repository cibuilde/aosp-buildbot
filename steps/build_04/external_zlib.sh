...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_recovery_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_recovery_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_recovery_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_recovery_x86_64_shared/addition_copy_files.output

echo "building libz^android_vendor.31_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_vendor.31_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libz^android_vendor.31_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_vendor.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libz^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_vendor.31_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building libz^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_vendor.31_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_vendor.31_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor.31_x86_x86_64_static/addition_copy_files.output

echo "building libz^android_vendor_ramdisk_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_vendor_ramdisk_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_vendor_ramdisk_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor_ramdisk_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_vendor_ramdisk_x86_64_shared/addition_copy_files.output

echo "building libz^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_64_shared/addition_copy_files.output

echo "building libz^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz^android_x86_x86_64_shared/addition_copy_files.output

echo "building libz_stable^android_vendor.31_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz_stable,android_vendor.31_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz_stable^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz_stable^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/zlib/libz_stable^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libz_stable^android_vendor.31_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libz_stable,android_vendor.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/external/zlib/libz_stable^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/external/zlib/libz_stable^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/external/zlib/libz_stable^android_vendor.31_x86_64_static/addition_copy_files.output
