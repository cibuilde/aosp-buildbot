...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libstats_proto_host,linux_glibc_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/frameworks/proto_logging/libstats_proto_host^linux_glibc_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/libstats_proto_host^linux_glibc_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/libstats_proto_host^linux_glibc_x86_64_shared/addition_copy_files.output

echo "building libbt-platform-protos-lite^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libbt-platform-protos-lite,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/frameworks/proto_logging/libbt-platform-protos-lite^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/bluetooth/libbt-platform-protos-lite^android_x86_64_static $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/bluetooth/libbt-platform-protos-lite^android_x86_64_static/addition_copy_files.output

echo "building libbt-platform-protos-lite^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libbt-platform-protos-lite,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/frameworks/proto_logging/libbt-platform-protos-lite^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/bluetooth/libbt-platform-protos-lite^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/bluetooth/libbt-platform-protos-lite^android_x86_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 frameworks_proto_logging.tar.zst --clobber
