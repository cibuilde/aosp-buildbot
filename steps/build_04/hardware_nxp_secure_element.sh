...
echo "Preparing for hardware/nxp/secure_element"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja vendor.nxp.nxpese@1.0-inheritance-hierarchy,
