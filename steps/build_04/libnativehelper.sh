...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libnativehelper,android_x86_64_shared_apex31
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libnativehelper,android_x86_x86_64_shared_apex31
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 libnativehelper.tar.zst --clobber
