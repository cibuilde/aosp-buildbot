...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja stats_proto,android_x86_64_static_cfi_apex29
...
cd $GITHUB_WORKSPACE/
tar cfJ packages_modules_DnsResolver.tar.zst -C $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/ .
