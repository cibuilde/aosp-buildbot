...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja lib_microdroid_signature_proto_lite,android_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja microdroid_uboot_env_gen_x86_64,
