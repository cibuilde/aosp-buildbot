...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libotautil^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/otautil/libotautil^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libedify^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/edify/libedify^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libbootloader_message_vendor^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message_vendor^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libbootloader_message_vendor^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message_vendor^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libapplypatch_modes^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/libapplypatch_modes^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/bootable/recovery/libapplypatch^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/applypatch/libapplypatch^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_bootable_recovery.tar.zst --clobber
