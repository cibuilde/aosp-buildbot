...
clone_depth_platform platform/external/clang
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja clang-tblgen,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/clang/utils/TableGen/clang-tblgen^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-tblgen^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/clang/utils/TableGen/clang-tblgen^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-statnodes^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-statnodes^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-options^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-options^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-html-tags^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-html-tags^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-diagnostics^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-diagnostics^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-declnodes^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-declnodes^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-comment-nodes^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-comment-nodes^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-comment-html-named-character-references^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-comment-html-named-character-references^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-comment-commands^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-comment-commands^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-checkers^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-checkers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-attributes^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-attributes^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/clang/clang-gen-arm-neon^.output . $GITHUB_WORKSPACE/artifacts/external/clang/clang-gen-arm-neon^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_clang.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/clang/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_clang.tar.zst --clobber

du -ah -d1 platform_external_clang*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_clang.tar.zst" ]; then
  echo "Compressing platform/external/clang -> platform_external_clang.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_clang.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/clang/ .
fi
