...
clone_depth_platform platform/external/conscrypt
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/conscrypt/conscrypt_generated_constants^.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt_generated_constants^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/conscrypt/conscrypt-unbundled_generated_constants^.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt-unbundled_generated_constants^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/conscrypt/conscrypt-unbundled^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt-unbundled^linux_glibc_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_conscrypt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/conscrypt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_conscrypt.tar.zst --clobber

du -ah -d1 platform_external_conscrypt*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_conscrypt.tar.zst" ]; then
  echo "Compressing platform/external/conscrypt -> platform_external_conscrypt.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_conscrypt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/conscrypt/ .
fi
