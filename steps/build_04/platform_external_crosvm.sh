...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/crosvm/gpu_display_protocol_sources^.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_protocol_sources^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/crosvm/gpu_display_client_protocol_headers^.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/gpu_display_client_protocol_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/crosvm/libdisplay_wl^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/gpu_display/libdisplay_wl^android_x86_64_static_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_crosvm.tar.zst --clobber
