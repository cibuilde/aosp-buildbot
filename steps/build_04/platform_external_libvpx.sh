...
echo "building libvpx^android_vendor.31_x86_x86_64_static_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libvpx,android_vendor.31_x86_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^android_vendor.31_x86_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/libvpx/libvpx^android_vendor.31_x86_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/external/libvpx/libvpx^android_vendor.31_x86_x86_64_static_cfi
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_libvpx.tar.zst --clobber
