...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_vendor.31_x86_64_static

echo "building liblzma^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja liblzma,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/lzma/liblzma^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_recovery_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_lzma.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/lzma/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_lzma.tar.zst --clobber
