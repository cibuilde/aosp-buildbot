...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/nanopb-c/libprotobuf-c-nano-enable_malloc^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/nanopb-c/libprotobuf-c-nano-enable_malloc^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/nanopb-c/libprotobuf-c-nano-enable_malloc^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/nanopb-c/libprotobuf-c-nano-enable_malloc^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/nanopb-c/libprotobuf-c-nano-enable_malloc-32bit^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/nanopb-c/libprotobuf-c-nano-enable_malloc-32bit^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/nanopb-c/libprotobuf-c-nano-enable_malloc-32bit^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/nanopb-c/libprotobuf-c-nano-enable_malloc-32bit^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_nanopb-c.tar.zst --clobber
