...
clone_depth_platform platform/external/rust/crates/protobuf-codegen
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libprotobuf_codegen,linux_glibc_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/rust/crates/protobuf-codegen/libprotobuf_codegen^linux_glibc_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/protobuf-codegen/libprotobuf_codegen^linux_glibc_x86_64_rlib_rlib-std

echo "building protoc-gen-rust^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja protoc-gen-rust,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/protobuf-codegen/protoc-gen-rust^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/rust/crates/protobuf-codegen/protoc-gen-rust^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/protobuf-codegen/protoc-gen-rust^linux_glibc_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_rust_crates_protobuf-codegen.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/rust/crates/protobuf-codegen/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_rust_crates_protobuf-codegen.tar.zst --clobber

du -ah -d1 platform_external_rust_crates_protobuf-codegen*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_rust_crates_protobuf-codegen.tar.zst" ]; then
  echo "Compressing platform/external/rust/crates/protobuf-codegen -> platform_external_rust_crates_protobuf-codegen.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_rust_crates_protobuf-codegen.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/rust/crates/protobuf-codegen/ .
fi
