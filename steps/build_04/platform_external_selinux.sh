...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja secilc,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/selinux/secilc/secilc^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/selinux/secilc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/selinux/secilc/secilc^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_selinux.tar.zst --clobber
