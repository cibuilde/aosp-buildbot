...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/sqlite/libsqlite^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/sqlite/dist/libsqlite^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/sqlite/libsqlite^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/sqlite/dist/libsqlite^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/sqlite/libsqlite^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/sqlite/dist/libsqlite^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_sqlite.tar.zst --clobber
