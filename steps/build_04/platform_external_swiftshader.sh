...
clone_depth_platform platform/external/swiftshader
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_spirv-tools^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/SPIRV-Tools/swiftshader_spirv-tools^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_spirv-tools^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/SPIRV-Tools/swiftshader_spirv-tools^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_marl^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/marl/swiftshader_marl^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_marl^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/marl/swiftshader_marl^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_debug^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/swiftshader_debug^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_debug^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/swiftshader_debug^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_astc^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/astc-encoder/swiftshader_astc^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/swiftshader_astc^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/astc-encoder/swiftshader_astc^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/libswiftshadervk_llvm_debug^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/libswiftshadervk_llvm_debug^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/libswiftshadervk_llvm_debug^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/libswiftshadervk_llvm_debug^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/libLLVM10_swiftshader^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/llvm-10.0/libLLVM10_swiftshader^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/external/swiftshader/libLLVM10_swiftshader^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/third_party/llvm-10.0/libLLVM10_swiftshader^android_vendor.31_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_swiftshader.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/swiftshader/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_external_swiftshader.tar.zst --clobber

du -ah -d1 platform_external_swiftshader*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_swiftshader.tar.zst" ]; then
  echo "Compressing platform/external/swiftshader -> platform_external_swiftshader.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_swiftshader.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/swiftshader/ .
fi
