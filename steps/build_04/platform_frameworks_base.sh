...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja view-inspector-annotation-processor,linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/view-inspector-annotation-processor^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/processors/view_inspector/view-inspector-annotation-processor^linux_glibc_common

echo "building tv_tuner_resource_manager_aidl_interface-java-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja tv_tuner_resource_manager_aidl_interface-java-source,
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/tv_tuner_resource_manager_aidl_interface-java-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/java/android/media/tv/tunerresourcemanager/tv_tuner_resource_manager_aidl_interface-java-source^

echo "building staledataclass-annotation-processor^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja staledataclass-annotation-processor,linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/staledataclass-annotation-processor^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/processors/staledataclass/staledataclass-annotation-processor^linux_glibc_common

echo "building soundtrigger_middleware-aidl-java-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja soundtrigger_middleware-aidl-java-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/soundtrigger_middleware-aidl-java-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/soundtrigger_middleware-aidl-java-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/soundtrigger_middleware-aidl-java-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/service.incremental.proto^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental.proto^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/service.incremental.proto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental.proto^android_x86_64_static

echo "building sdkparcelables^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja sdkparcelables,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/sdkparcelables/sdkparcelables^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/sdkparcelables^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/sdkparcelables/sdkparcelables^linux_glibc_common

echo "building sdkparcelables^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja sdkparcelables,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/sdkparcelables/sdkparcelables^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/sdkparcelables^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/sdkparcelables/sdkparcelables^linux_glibc_x86_64

echo "building remote-color-resources-compile-public^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja remote-color-resources-compile-public,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-compile-public^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/remote-color-resources-compile-public^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-compile-public^

echo "building remote-color-resources-compile-colors^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja remote-color-resources-compile-colors,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-compile-colors^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/remote-color-resources-compile-colors^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-compile-colors^

echo "building remote-color-resources-arsc-zip^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja remote-color-resources-arsc-zip,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-arsc-zip^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/remote-color-resources-arsc-zip^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-arsc-zip^

echo "building remote-color-resources-apk^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja remote-color-resources-apk,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-apk^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/remote-color-resources-apk^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-apk^

echo "building remote-color-resources-arsc^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja remote-color-resources-arsc,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-arsc^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/remote-color-resources-arsc^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/remote-color-resources-arsc^

echo "building platformprotos^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja platformprotos,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/platformprotos^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/platformprotos^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/platformprotos^linux_glibc_common

echo "building protologtool-lib^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja protologtool-lib,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/protologtool/protologtool-lib^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/protologtool-lib^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/protologtool/protologtool-lib^linux_glibc_common

echo "building protologtool^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja protologtool,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/protologtool/protologtool^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/protologtool^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/protologtool/protologtool^linux_glibc_common

echo "building overlayable_policy_aidl-java-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja overlayable_policy_aidl-java-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/overlayable_policy_aidl-java-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/overlayable_policy_aidl-java-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/overlayable_policy_aidl-java-source^

echo "building mimemap-res.jar^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja mimemap-res.jar,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/mime/mimemap-res.jar^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/mimemap-res.jar^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/mime/mimemap-res.jar^android_common

echo "building media_permission-aidl-java-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja media_permission-aidl-java-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-java-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/media_permission-aidl-java-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-java-source^

echo "building media_permission-aidl-cpp-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja media_permission-aidl-cpp-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-cpp-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/media_permission-aidl-cpp-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-cpp-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/lockedregioncodeinjection^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/locked_region_code_injection/lockedregioncodeinjection^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libplatformprotos^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libplatformprotos^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libplatformprotos^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libplatformprotos^linux_glibc_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libplatformprotos^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libplatformprotos^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libplatformprotos^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libplatformprotos^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libidmap2daidl^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/libidmap2daidl^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libidmap2_protos^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/libidmap2_protos^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/libaapt2^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/aapt2/libaapt2^linux_glibc_x86_64_static

echo "building incident-section-gen^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja incident-section-gen,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/incident_section_gen/incident-section-gen^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/incident-section-gen^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/incident_section_gen/incident-section-gen^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/incidentd_section_list^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd_section_list^

echo "building incident_sections^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja incident_sections,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident/incident_sections^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/incident_sections^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident/incident_sections^

echo "building framework-javastream-protos^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja framework-javastream-protos,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-javastream-protos^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/framework-javastream-protos^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-javastream-protos^

echo "building framework-cppstream-protos^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja framework-cppstream-protos,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-cppstream-protos^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/framework-cppstream-protos^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-cppstream-protos^

echo "building codegen-version-info^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja codegen-version-info,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/codegen/codegen-version-info^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/codegen-version-info^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/codegen/codegen-version-info^linux_glibc_common

echo "building audio_common-aidl-java-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja audio_common-aidl-java-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-java-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/audio_common-aidl-java-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-java-source^

echo "building audio_common-aidl-cpp-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja audio_common-aidl-cpp-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/audio_common-aidl-cpp-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp-source^

echo "building android.os.permissions_aidl-rust-source^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja android.os.permissions_aidl-rust-source,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/android.os.permissions_aidl-rust-source^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/android.os.permissions_aidl-rust-source^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/android.os.permissions_aidl-rust-source^

echo "building android.os.permissions_aidl-rust^android_x86_64_source"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja android.os.permissions_aidl-rust,android_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/android.os.permissions_aidl-rust^android_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/android.os.permissions_aidl-rust^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/android.os.permissions_aidl-rust^android_x86_64_source

echo "building aapt2^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja aapt2,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/aapt2/aapt2^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/aapt2^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/aapt2/aapt2^linux_glibc_x86_64

echo "building SettingsLib-annotation-processor^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja SettingsLib-annotation-processor,linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/base/SettingsLib-annotation-processor^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/search/SettingsLib-annotation-processor^linux_glibc_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_frameworks_base.tar.zst --clobber
