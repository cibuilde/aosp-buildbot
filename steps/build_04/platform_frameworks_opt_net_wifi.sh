...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/opt/net/wifi/libwifi-system-iface^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/frameworks/opt/net/wifi/libwifi-system-iface^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_frameworks_opt_net_wifi.tar.zst --clobber
