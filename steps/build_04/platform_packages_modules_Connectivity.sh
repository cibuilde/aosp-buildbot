...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/Connectivity/libservice-connectivity^android_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/service/libservice-connectivity^android_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/Connectivity/libframework-connectivity-jni^android_x86_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/framework/libframework-connectivity-jni^android_x86_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/Connectivity/libframework-connectivity-jni^android_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/framework/libframework-connectivity-jni^android_x86_64_shared_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_packages_modules_Connectivity.tar.zst --clobber
