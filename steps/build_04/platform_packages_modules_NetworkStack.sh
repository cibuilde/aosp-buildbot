...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NetworkStack/networkstack-aidl-interfaces-api^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NetworkStack/common/networkstackclient/networkstack-aidl-interfaces-api^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NetworkStack/networkstack-aidl-interfaces-V10-java-source^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NetworkStack/common/networkstackclient/networkstack-aidl-interfaces-V10-java-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NetworkStack/ipmemorystore-aidl-interfaces-api^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NetworkStack/common/networkstackclient/ipmemorystore-aidl-interfaces-api^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NetworkStack/ipmemorystore-aidl-interfaces-V10-java-source^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NetworkStack/common/networkstackclient/ipmemorystore-aidl-interfaces-V10-java-source^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_packages_modules_NetworkStack.tar.zst --clobber
