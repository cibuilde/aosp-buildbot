...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NeuralNetworks/philox_random^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/common/random/philox_random^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/NeuralNetworks/neuralnetworks_supportlibrary_loader^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/shim_and_sl/neuralnetworks_supportlibrary_loader^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_packages_modules_NeuralNetworks.tar.zst --clobber
