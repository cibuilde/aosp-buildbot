...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_x86_64_static/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/statsd-aidl-ndk_platform-source^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/aidl/statsd-aidl-ndk_platform-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/statsd-aidl-ndk_platform^android_x86_x86_64_static_com.android.os.statsd.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/aidl/statsd-aidl-ndk_platform^android_x86_x86_64_static_com.android.os.statsd
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/statsd-aidl-ndk_platform^android_x86_64_static_com.android.os.statsd.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/aidl/statsd-aidl-ndk_platform^android_x86_64_static_com.android.os.statsd
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/statsd-aidl-ndk_platform^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/aidl/statsd-aidl-ndk_platform^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstatssocket^android_x86_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstatssocket^android_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstatssocket^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstatspull^android_x86_x86_64_shared_com.android.os.statsd.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_x86_64_shared_com.android.os.statsd
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstatspull^android_x86_64_shared_com.android.os.statsd.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_64_shared_com.android.os.statsd
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstats_jni^android_x86_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/framework/libstats_jni^android_x86_x86_64_shared_apex30

echo "building libstats_jni^android_x86_64_shared_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libstats_jni,android_x86_64_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/framework/libstats_jni^android_x86_64_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libstats_jni^android_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/framework/libstats_jni^android_x86_64_shared_apex30

echo "building libkll^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libkll,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libkll^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_64_static

echo "building libkll-protos^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libkll-protos,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libkll-protos^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_x86_64_static

echo "building libkll^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libkll,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libkll^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_x86_64_static

echo "building libkll-protos^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libkll-protos,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/packages/modules/StatsD/libkll-protos^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_packages_modules_StatsD.tar.zst --clobber
