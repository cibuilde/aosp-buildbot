...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/prebuilts/tools/kotlinx-coroutines-core^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-core^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/prebuilts/tools/kotlinx-coroutines-core^android_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-core^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/prebuilts/tools/kotlinx-coroutines-android^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-android^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/prebuilts/tools/kotlinx-coroutines-android^android_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/kotlinx-coroutines-android^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_prebuilts_tools.tar.zst --clobber
