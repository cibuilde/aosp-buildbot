...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/libapexutil^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/apex/libs/libapexutil/libapexutil^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_session_state_proto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_session_state_proto^android_x86_64_static

echo "building libapex^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja libapex,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapex^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/libapex^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapex^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_manifest_proto_lite^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_manifest_proto_lite^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/libapexutil^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/libs/libapexutil/libapexutil^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_manifest_proto_lite^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_manifest_proto_lite^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_manifest_proto_lite^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_manifest_proto_lite^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/libapexutil^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/libs/libapexutil/libapexutil^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_manifest_proto_lite^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_manifest_proto_lite^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/lib_apex_manifest_proto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/lib_apex_manifest_proto^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/apex_manifest_proto^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/apex_manifest_proto^linux_glibc_x86_64_PY3
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/apex_manifest_proto^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/apex_manifest_proto^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/apex_build_info_proto^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/apex/proto/apex_build_info_proto^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/apex_aidl_interface-java-source^.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/apex_aidl_interface-java-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/apex/apex_aidl_interface-cpp-source^.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/apex_aidl_interface-cpp-source^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_apex.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/apex/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_system_apex.tar.zst --clobber
