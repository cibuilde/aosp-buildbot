...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libscriptedbeaconpayload-protos-lite^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/vendor_libs/test_vendor_lib/libscriptedbeaconpayload-protos-lite^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbt-protos-lite^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/proto/libbt-protos-lite^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbt-protos-lite^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/proto/libbt-protos-lite^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbluetooth-types^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/types/libbluetooth-types^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbluetooth-types^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/types/libbluetooth-types^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbluetooth-protos^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/proto/libbluetooth-protos^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/libbluetooth-protos^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/proto/libbluetooth-protos^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/lib-bt-packets-base^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/packet/base/lib-bt-packets-base^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/lib-bt-packets-base^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/packet/base/lib-bt-packets-base^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/lib-bt-packets-avrcp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/packet/avrcp/lib-bt-packets-avrcp^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/lib-bt-packets-avrcp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/packet/avrcp/lib-bt-packets-avrcp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/async_fd_watcher^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/vendor_libs/linux/interface/async_fd_watcher^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/BluetoothGeneratedDumpsysDataSchema_h^.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/BluetoothGeneratedDumpsysDataSchema_h^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/BluetoothGeneratedDumpsysBinarySchema_bfbs^.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/BluetoothGeneratedDumpsysBinarySchema_bfbs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/BluetoothGeneratedDumpsysBundledSchema_h^.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/dumpsys/BluetoothGeneratedDumpsysBundledSchema_h^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/BluetoothGeneratedBundlerSchema_h_bfbs^.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/dumpsys/bundler/BluetoothGeneratedBundlerSchema_h_bfbs^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/bt/bluetooth_flatbuffer_bundler^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/dumpsys/bundler/bluetooth_flatbuffer_bundler^linux_glibc_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_bt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/bt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_system_bt.tar.zst --clobber
