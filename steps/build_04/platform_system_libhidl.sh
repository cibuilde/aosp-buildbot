...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.1_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager@1.1_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union-V1.0-java_gen_java^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union-V1.0-java_gen_java^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.2_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager@1.2_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.1_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager@1.1_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager-V1.2-java_gen_java^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager-V1.2-java_gen_java^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.base@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/base/1.0/android.hidl.base@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlmemory^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/libhidlbase^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-utils^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.token@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.safe_union@1.0^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_x86_64_static_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_64_static_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.memory.token@1.0^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.2_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager@1.2_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.2-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager@1.2-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.1-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager@1.1-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager@1.0-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager-V1.1-java_gen_java^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager-V1.1-java_gen_java^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.manager-V1.0-java_gen_java^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager-V1.0-java_gen_java^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.base@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/base/1.0/android.hidl.base@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.base@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/base/1.0/android.hidl.base@1.0-inheritance-hierarchy^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.base-V1.0-java_gen_java^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/base/1.0/android.hidl.base-V1.0-java_gen_java^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0_genc++_headers^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0_genc++_headers^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0_genc++^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0_genc++^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_x86_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_x86_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_x86_64_static_apex30.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_x86_64_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/libhidl/android.hidl.allocator@1.0-inheritance-hierarchy^.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/allocator/1.0/android.hidl.allocator@1.0-inheritance-hierarchy^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libhidl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libhidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_system_libhidl.tar.zst --clobber
