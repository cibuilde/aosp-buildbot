...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/userdebug_plat_sepolicy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/userdebug_plat_sepolicy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/system_ext_sepolicy_and_mapping.sha256_gen^.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_sepolicy_and_mapping.sha256_gen^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/system_ext_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/system_ext_sepolicy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_sepolicy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/system_ext_pub_policy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_pub_policy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/system_ext_mapping_file^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_mapping_file^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/reqd_policy_mask.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/reqd_policy_mask.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/pub_policy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/pub_policy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/product_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/product_sepolicy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_sepolicy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/product_mapping_file^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_mapping_file^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/product_sepolicy_and_mapping.sha256_gen^.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_sepolicy_and_mapping.sha256_gen^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/precompiled_sepolicy.system_ext_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/precompiled_sepolicy.system_ext_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/precompiled_sepolicy.product_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/precompiled_sepolicy.product_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_sepolicy_and_mapping.sha256_gen^.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy_and_mapping.sha256_gen^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/precompiled_sepolicy.plat_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/precompiled_sepolicy.plat_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_sepolicy_and_mapping.sha256^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy_and_mapping.sha256^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_sepolicy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_mapping_file^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_mapping_file^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_pub_versioned.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_pub_versioned.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/plat_pub_policy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_pub_policy.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/microdroid_vendor_sepolicy.cil.raw^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.cil.raw^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/microdroid_plat_pub_versioned.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_plat_pub_versioned.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/sepolicy/microdroid_vendor_sepolicy.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.cil^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_system_sepolicy.tar.zst --clobber
