...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/update_metadata-protos^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/update_metadata-protos^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/update_metadata-protos^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/update_metadata-protos^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libupdate_engine_stable-api^.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/stable/libupdate_engine_stable-api^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libupdate_engine_stable-V1-cpp-source^.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/stable/libupdate_engine_stable-V1-cpp-source^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libpayload_extent_utils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libpayload_extent_utils^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libpayload_extent_utils^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libpayload_extent_utils^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libpayload_extent_ranges^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libpayload_extent_ranges^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libpayload_extent_ranges^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libpayload_extent_ranges^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libcow_operation_convert^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libcow_operation_convert^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/platform/system/update_engine/libcow_operation_convert^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libcow_operation_convert^android_recovery_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 platform_system_update_engine.tar.zst --clobber
