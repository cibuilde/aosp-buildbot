...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-7.0,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-analysis-6.0,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-commons-6.0,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-commons-7.0,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-tree-6.0,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja asm-tree-7.0,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja commons-cli-1.2,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja guava-21.0,linux_glibc_common
