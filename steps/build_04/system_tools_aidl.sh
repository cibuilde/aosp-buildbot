...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja libaidl-common,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/aidl/libaidl-common^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/system/tools/aidl/libaidl-common^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/tools/aidl/libaidl-common^linux_glibc_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ system_tools_aidl.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/tools/aidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_04 system_tools_aidl.tar.zst --clobber
