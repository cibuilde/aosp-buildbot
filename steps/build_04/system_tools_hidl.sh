...
ninja -f $GITHUB_WORKSPACE/steps/build_04.ninja libhidl-gen-ast,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/libhidl-gen-ast^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_04/system/tools/hidl/libhidl-gen-ast^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/libhidl-gen-ast^linux_glibc_x86_64_static
