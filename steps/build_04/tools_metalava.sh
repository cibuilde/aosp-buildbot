...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja metalava,linux_glibc_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/tools/metalava/metalava^linux_glibc_common.output $GITHUB_WORKSPACE/artifacts/tools/metalava/metalava^linux_glibc_common $GITHUB_WORKSPACE/artifacts/tools/metalava/metalava^linux_glibc_common/addition_copy_files.output

echo "building metalava^linux_glibc_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja metalava,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/tools/metalava/metalava^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/tools/metalava/metalava^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/tools/metalava/metalava^linux_glibc_x86_64/addition_copy_files.output

echo "building private-stub-annotations^"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_04.ninja private-stub-annotations,
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_04/tools/metalava/private-stub-annotations^.output $GITHUB_WORKSPACE/artifacts/tools/metalava/private-stub-annotations^ $GITHUB_WORKSPACE/artifacts/tools/metalava/private-stub-annotations^/addition_copy_files.output
