...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/generated_android_ids^/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl.x86.map^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl.x86_64.map^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_recovery_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_vendor_ramdisk_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_x86_64_static_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libdl/libdl_static^android_x86_x86_64_static_apex10000/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/syscalls-arm.S^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/syscalls-arm64.S^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/syscalls-x86.S^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/syscalls-x86_64.S^/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja genfunctosyscallnrs,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja genseccomp,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_native_bridge_arm64_armv8-a_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_native_bridge_arm_armv7-a-neon_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_vendor_ramdisk_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_bionic_ndk,android_x86_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_native_bridge_arm64_armv8-a_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_native_bridge_arm_armv7-a-neon_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_vendor_ramdisk_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_x86_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libc_syscalls,android_x86_x86_64_static_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_recovery_x86_64_shared
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_vendor_ramdisk_x86_64_shared
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_x86_64_shared
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_x86_64_shared_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_x86_x86_64_shared
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libdl,android_x86_x86_64_shared_apex10000
