...
rsync -a -r $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/libs/image_aggregator/libcdisk_spec^android_x86_64_static_apex10000/ .

echo "building libimage_aggregator^android_x86_64_static_apex10000"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libimage_aggregator,android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/device/google/cuttlefish/libimage_aggregator^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/libs/image_aggregator/libimage_aggregator^android_x86_64_static_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ device_google_cuttlefish.tar.zst -C $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/ .
