...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja auto_android_annotation_stubs,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja auto_factory_annotations,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja auto_service_annotations,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja auto_value_annotations,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja auto_value_memoized_extension_annotations,linux_glibc_common
