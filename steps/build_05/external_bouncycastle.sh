...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja bouncycastle-unbundled,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/bouncycastle/bouncycastle-unbundled^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/bouncycastle/bouncycastle-unbundled^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/bouncycastle/bouncycastle-unbundled^linux_glibc_common
