...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/9p_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/balloon_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/battery.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/block_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/cras_audio_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/fs_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/gpu_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/input_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/net_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/null_audio_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/pmem_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/rng_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/serial.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/tpm_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/vfio_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/vhost_net_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/vhost_vsock_device.policy_inline_x86_64^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/crosvm/seccomp/video_device.policy_inline_x86_64^/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja 9p_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja balloon_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja battery.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja block_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja cras_audio_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja fs_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja gpu_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja gpu_display_client_protocol_headers,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja gpu_display_protocol_sources,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja input_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libbit_field_derive,linux_glibc_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libenumn,linux_glibc_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libpoll_token_derive,linux_glibc_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja net_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja null_audio_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja pmem_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja rng_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja serial.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja tpm_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja vfio_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja vhost_net_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja vhost_vsock_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja video_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja vios_audio_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja wl_device.policy,android_x86_64
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja xhci.policy,android_x86_64
...
cd $GITHUB_WORKSPACE/
tar cfJ external_crosvm.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/crosvm/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/device_google_cuttlefish_vmm.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/device_google_cuttlefish_vmm.tar.zst -C $GITHUB_WORKSPACE/aosp/device/google/cuttlefish_vmm/ .
fi
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_syn.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_syn.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/syn/ .
fi
