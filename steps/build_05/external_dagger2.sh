...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja dagger2-android-annotation-stubs,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-android-annotation-stubs^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/dagger2/dagger2-android-annotation-stubs^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-android-annotation-stubs^linux_glibc_common
