...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libfruit,android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_google-fruit.tar.zst --clobber
