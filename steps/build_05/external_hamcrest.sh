...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja hamcrest,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/hamcrest/hamcrest-core/hamcrest^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/hamcrest/hamcrest^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/hamcrest/hamcrest-core/hamcrest^linux_glibc_common
