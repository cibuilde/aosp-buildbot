...
echo "Preparing for external/iperf3"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja iperf3,android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_iperf3.tar.zst --clobber
