...
echo "Preparing for external/libcap"
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libcap/libcap^android_x86_64_static_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libcap/libcap^android_x86_x86_64_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libcap,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/libcap/libcap^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared/addition_copy_files.output

echo "building libcap^android_x86_64_shared_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libcap,android_x86_64_shared_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/libcap/libcap^android_x86_64_shared_apex10000.output $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex10000 $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex10000/addition_copy_files.output

echo "building libcap^android_x86_64_shared_apex29"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libcap,android_x86_64_shared_apex29
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/libcap/libcap^android_x86_64_shared_apex29.output $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex29 $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex29/addition_copy_files.output

echo "building libcap^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libcap,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/libcap/libcap^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_libcap.tar.zst --clobber

du -ah -d1 external_libcap*.tar.zst | sort -h
