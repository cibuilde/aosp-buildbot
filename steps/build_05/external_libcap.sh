...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcap/cap_names.list.h^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++^linux_glibc_x86_64_shared/ .

echo "building _makenames^linux_glibc_x86_64"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja _makenames,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libcap/_makenames^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/libcap/_makenames^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/libcap/_makenames^linux_glibc_x86_64
