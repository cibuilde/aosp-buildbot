...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja jni_generator,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja jni_registration_generator,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libchrome-include,
