...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libffi,android_x86_64_static_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^android_x86_64_static_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/libffi/libffi^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/libffi/libffi^android_x86_64_static_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libffi.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libffi/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_libffi.tar.zst --clobber
