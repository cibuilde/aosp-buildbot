...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libopus,android_x86_64_shared_apex29
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/libopus/libopus^android_x86_64_shared_apex29.output $GITHUB_WORKSPACE/artifacts/external/libopus/libopus^android_x86_64_shared_apex29 $GITHUB_WORKSPACE/artifacts/external/libopus/libopus^android_x86_64_shared_apex29/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_libopus.tar.zst --clobber
