...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_actions_actions-entity-data,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_actions_actions_model,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_annotator_datetime_datetime,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_annotator_entity-data,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_annotator_experimental_experimental,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_annotator_model,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_annotator_person_name_person_name_model,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_lang_id_common_flatbuffers_embedding-network,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_lang_id_common_flatbuffers_model,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_codepoint-range,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_container_bit-vector,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_flatbuffers_flatbuffers,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_grammar_rules,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_grammar_semantics_expression,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_i18n_language-tag,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_intents_intent-config,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_normalization,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_resources,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_tflite_text_encoder_config,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_tokenizer,
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libtextclassifier_fbgen_utils_zlib_buffer,
...
cd $GITHUB_WORKSPACE/
tar cfJ external_libtextclassifier.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libtextclassifier.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_libtextclassifier.tar.zst -C $GITHUB_WORKSPACE/aosp/external/libtextclassifier/ .
fi
