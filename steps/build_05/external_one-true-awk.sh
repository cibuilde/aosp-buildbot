...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja awk-maketab,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/one-true-awk/awk-maketab^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/one-true-awk/awk-maketab^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/one-true-awk/awk-maketab^linux_glibc_x86_64
