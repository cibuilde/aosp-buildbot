...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libprotobuf-java-full,linux_glibc_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libprotobuf-python,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libprotobuf-python,linux_glibc_x86_64_PY3
