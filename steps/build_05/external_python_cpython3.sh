...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja py3-stdlib,linux_glibc_x86_64_PY3
mkdir -p $GITHUB_WORKSPACE/artifacts/external/python/cpython3/Lib/py3-stdlib^linux_glibc_x86_64_PY3
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/python/cpython3/py3-stdlib^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/external/python/cpython3/Lib/py3-stdlib^linux_glibc_x86_64_PY3
