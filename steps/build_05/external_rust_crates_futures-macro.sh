...
cd $GITHUB_WORKSPACE/
tar cfJ external_rust_crates_futures-macro.tar.zst -C $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-macro/ .
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_futures.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_futures.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/futures/ .
fi
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_futures-macro.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_futures-macro.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/futures-macro/ .
fi
if [ ! -f "$GITHUB_WORKSPACE/cache/external_rust_crates_proc-macro-hack.tar.zst" ]; then
  ...
  tar cfJ $GITHUB_WORKSPACE/cache/external_rust_crates_proc-macro-hack.tar.zst -C $GITHUB_WORKSPACE/aosp/external/rust/crates/proc-macro-hack/ .
fi
