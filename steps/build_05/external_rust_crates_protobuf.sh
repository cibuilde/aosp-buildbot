...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libprotobuf,linux_glibc_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/protobuf/libprotobuf^linux_glibc_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/rust/crates/protobuf/libprotobuf^linux_glibc_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/protobuf/libprotobuf^linux_glibc_x86_64_rlib_rlib-std
