...
echo "Preparing for external/rust/crates/rand_chacha"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja librand_chacha,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 external_rust_crates_rand_chacha.tar.zst --clobber

du -ah -d1 external_rust_crates_rand_chacha*.tar.zst | sort -h
