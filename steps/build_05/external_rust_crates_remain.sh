...
echo "Preparing for external/rust/crates/remain"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libremain,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/rust/crates/remain/libremain^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/remain/libremain^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/rust/crates/remain/libremain^linux_glibc_x86_64/addition_copy_files.output
...
du -ah -d1 external_rust_crates_remain*.tar.zst | sort -h
