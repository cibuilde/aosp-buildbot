...
echo "Preparing for external/rust/crates/serde_derive"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libserde_derive,linux_glibc_x86_64
