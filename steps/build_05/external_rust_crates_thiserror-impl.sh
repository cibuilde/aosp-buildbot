...
echo "Preparing for external/rust/crates/thiserror-impl"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libthiserror_impl,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/rust/crates/thiserror-impl/libthiserror_impl^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/thiserror-impl/libthiserror_impl^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/rust/crates/thiserror-impl/libthiserror_impl^linux_glibc_x86_64/addition_copy_files.output
