...
echo "Preparing for external/ruy"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libruy_static,android_x86_64_sdk_static_apex30
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/external/ruy/libruy_static^android_x86_64_sdk_static_apex30.output $GITHUB_WORKSPACE/artifacts/external/ruy/libruy_static^android_x86_64_sdk_static_apex30 $GITHUB_WORKSPACE/artifacts/external/ruy/libruy_static^android_x86_64_sdk_static_apex30/addition_copy_files.output
