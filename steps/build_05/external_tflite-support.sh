...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja tflite_support_spm_config,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja tflite_support_spm_encoder_config,
