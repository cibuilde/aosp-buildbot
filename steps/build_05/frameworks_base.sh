...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libmediaparser-jni,android_x86_64_shared_apex29
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/frameworks/base/libmediaparser-jni^android_x86_64_shared_apex29.output $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/media/framework/libmediaparser-jni^android_x86_64_shared_apex29 $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/media/framework/libmediaparser-jni^android_x86_64_shared_apex29/addition_copy_files.output

echo "building libmediaparser-jni^android_x86_x86_64_shared_apex29"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libmediaparser-jni,android_x86_x86_64_shared_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja validate_input_devices_keymaps,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja platform-compat-config,
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/frameworks/base/platform-compat-config^.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/platform-compat-config^ $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/platform-compat-config^/addition_copy_files.output

echo "building platform-compat-overrides^"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja platform-compat-overrides,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja display-device-config,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja display-layout-config,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja device-state-config,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja validatekeymaps,linux_glibc_x86_64
