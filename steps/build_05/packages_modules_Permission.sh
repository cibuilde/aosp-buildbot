...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja service-permission-javastream-protos,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/service/service-permission-javastream-protos^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/packages/modules/Permission/service-permission-javastream-protos^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/service/service-permission-javastream-protos^
