...
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/encoding/libkll-encoder^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/proto/libkll-protos^android_x86_x86_64_static/ .

echo "building libkll^android_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libkll,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/packages/modules/StatsD/libkll^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_64_static

echo "building libkll^android_x86_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libkll,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/packages/modules/StatsD/libkll^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ packages_modules_StatsD.tar.zst -C $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 packages_modules_StatsD.tar.zst --clobber
