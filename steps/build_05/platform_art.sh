...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libsigchain^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libsigchain^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/sigchainlib/libsigchain^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libperfetto_hprof^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/perfetto_hprof/libperfetto_hprof^android_x86_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libperfetto_hprof^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/art/perfetto_hprof/libperfetto_hprof^android_x86_64_static_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libnativebridge^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libnativebridge^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libnativebridge/libnativebridge^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libartpalette^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartpalette/libartpalette^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/libartpalette^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libartpalette/libartpalette^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/dalvikvm^android_x86_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dalvikvm/dalvikvm^android_x86_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/dalvikvm^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dalvikvm/dalvikvm^android_x86_64_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/art/art-apex-cache-info^.output . $GITHUB_WORKSPACE/artifacts/art/odrefresh/art-apex-cache-info^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/art/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_art.tar.zst --clobber
