...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_x86_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_x86_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_vendor_ramdisk_x86_64.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_vendor_ramdisk_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/linker^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bionic/linker/linker^android_recovery_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/libc_malloc_hooks^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/libc_malloc_hooks^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtend_so^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_30_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtend_so^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtend_so^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtend_so^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_21
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbrand^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_30_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbrand^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbrand^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbrand^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_21
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbegin_so^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_30_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbegin_so^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbegin_so^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bionic/crtbegin_so^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_21

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_bionic.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/bionic/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_bionic.tar.zst --clobber
