...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bootable/recovery/librecovery_utils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_utils/librecovery_utils^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bootable/recovery/librecovery_utils^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_utils/librecovery_utils^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/bootable/recovery/libminadbd_services^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minadbd/libminadbd_services^android_recovery_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_bootable_recovery.tar.zst --clobber
