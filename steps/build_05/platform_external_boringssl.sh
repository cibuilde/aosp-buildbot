...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/boringssl/boringssl_self_test^android_x86_x86_64_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test^android_x86_x86_64_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/boringssl/boringssl_self_test^android_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test^android_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/boringssl/boringssl_self_test^android_x86_64_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test^android_x86_64_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/boringssl/boringssl_self_test^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_boringssl.tar.zst --clobber
