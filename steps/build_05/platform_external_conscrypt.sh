...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/conscrypt/libjavacrypto^android_x86_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/conscrypt/libjavacrypto^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_64_shared_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_conscrypt.tar.zst --clobber
