...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/dagger2/dagger2^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/dagger2/dagger2-producers^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-producers^linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/dagger2/dagger2-bootstrap-compiler^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-bootstrap-compiler^linux_glibc_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_dagger2.tar.zst --clobber
