...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/fmtlib/fmtlib_ndk^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/fmtlib/fmtlib_ndk^android_x86_64_sdk_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_fmtlib.tar.zst --clobber
