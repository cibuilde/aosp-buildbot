...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libjsoncpp,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/jsoncpp/libjsoncpp^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_x86_64_shared_apex10000

echo "building libjsoncpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libjsoncpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/jsoncpp/libjsoncpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_x86_64_shared

echo "building libjsoncpp^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libjsoncpp,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/jsoncpp/libjsoncpp^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/jsoncpp/libjsoncpp^android_recovery_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_jsoncpp.tar.zst --clobber
