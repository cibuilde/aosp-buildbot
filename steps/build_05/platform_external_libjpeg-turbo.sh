...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libjpeg-turbo/libjpeg_static_ndk^android_x86_64_sdk_static.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg_static_ndk^android_x86_64_sdk_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libjpeg-turbo/libjpeg^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_libjpeg-turbo.tar.zst --clobber
