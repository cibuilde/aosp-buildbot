...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libpng/libpng^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libpng/libpng^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libpng/libpng^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libpng/libpng^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/libpng/libpng^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libpng/libpng^android_recovery_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_libpng.tar.zst --clobber
