...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libnpt^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libnpt^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libnpt^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libnpt^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libjdwp^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libjdwp^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libjdwp^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libjdwp^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libdt_socket^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libdt_socket^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/oj-libjdwp/libdt_socket^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/oj-libjdwp/libdt_socket^android_x86_64_shared_apex31
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_oj-libjdwp.tar.zst --clobber
