...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/parameter-framework/libremote-processor^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/parameter-framework/libremote-processor^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/parameter-framework/libparameter^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/parameter-framework/libparameter^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_parameter-framework.tar.zst --clobber
