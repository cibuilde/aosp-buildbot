...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_protobuf.tar.zst --clobber
