...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_x86_64_source
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_64_source
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_rust_crates_grpcio-sys.tar.zst --clobber
