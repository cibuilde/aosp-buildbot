...
clone_depth_platform platform/external/rust/crates/libsqlite3-sys
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja sqlite3_bindgen_build,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/android/sqlite3_bindgen_build^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/crates/libsqlite3-sys/sqlite3_bindgen_build^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/android/sqlite3_bindgen_build^linux_glibc_x86_64

echo "building libsqlite3_bindgen^android_x86_64_source"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libsqlite3_bindgen,android_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/libsqlite3_bindgen^android_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/crates/libsqlite3-sys/libsqlite3_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/libsqlite3_bindgen^android_x86_64_source

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_rust_crates_libsqlite3-sys.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/rust/crates/libsqlite3-sys/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_rust_crates_libsqlite3-sys.tar.zst --clobber

du -ah -d1 platform_external_rust_crates_libsqlite3-sys*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_rust_crates_libsqlite3-sys.tar.zst" ]; then
  echo "Compressing platform/external/rust/crates/libsqlite3-sys -> platform_external_rust_crates_libsqlite3-sys.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_rust_crates_libsqlite3-sys.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/rust/crates/libsqlite3-sys/ .
fi
