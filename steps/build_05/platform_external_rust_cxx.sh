...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/cxx/libcxxbridge_macro^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/macro/libcxxbridge_macro^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/cxx/libcxxbridge_cmd^linux_glibc_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/gen/cmd/libcxxbridge_cmd^linux_glibc_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/cxx/cxxbridge^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/gen/cmd/cxxbridge^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/rust/cxx/cxx-bridge-header^.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/cxx-bridge-header^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_rust_cxx.tar.zst --clobber
