...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libselinux_bindgen,android_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux_bindgen^android_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/selinux/libselinux_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux_bindgen^android_x86_64_source
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_selinux.tar.zst --clobber
