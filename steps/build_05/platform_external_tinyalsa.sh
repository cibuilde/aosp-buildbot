...
clone_depth_platform platform/external/tinyalsa
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/libtinyalsa^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/libtinyalsa^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/tinyplay^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/tinyplay^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/tinypcminfo^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/tinypcminfo^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/tinymix^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/tinymix^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/tinyhostless^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/tinyhostless^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/tinycap^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/tinycap^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/tinyalsa/libtinyalsa^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyalsa/libtinyalsa^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_tinyalsa.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/tinyalsa/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_tinyalsa.tar.zst --clobber

du -ah -d1 platform_external_tinyalsa*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_tinyalsa.tar.zst" ]; then
  echo "Compressing platform/external/tinyalsa -> platform_external_tinyalsa.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_tinyalsa.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/tinyalsa/ .
fi
