...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libwire_format_derive,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/vm_tools/p9/wire_format_derive/libwire_format_derive^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/external/vm_tools/p9/libwire_format_derive^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/vm_tools/p9/wire_format_derive/libwire_format_derive^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_external_vm_tools_p9.tar.zst --clobber
