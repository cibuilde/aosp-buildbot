...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/av/media/libmediametrics/libmediametrics^android_x86_64_shared_current/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/validatekeymaps^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/validatekeymaps/validatekeymaps^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/validate_input_devices_keymaps^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/InputDevices/validate_input_devices_keymaps^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/platform-compat-overrides^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/platform-compat-overrides^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/platform-compat-config^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/platform-compat-config^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/libmediaparser-jni^android_x86_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/media/framework/libmediaparser-jni^android_x86_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/libmediaparser-jni^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/media/framework/libmediaparser-jni^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/display-layout-config^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/display-layout-config^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/display-device-config^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/display-device-config^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/base/device-state-config^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/xsd/device-state-config^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_frameworks_base.tar.zst --clobber
