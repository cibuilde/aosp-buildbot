...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja stats-log-api-gen,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/stats-log-api-gen^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/proto_logging/stats-log-api-gen^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/stats-log-api-gen^linux_glibc_x86_64

echo "building statslog.h^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja statslog.h,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/statslog.h^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/proto_logging/statslog.h^.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/statslog.h^

echo "building statslog.cpp^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja statslog.cpp,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/statslog.cpp^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/proto_logging/statslog.cpp^.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/statslog.cpp^

echo "building libstatslog^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libstatslog,android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/proto_logging/libstatslog^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_x86_64_static

echo "building libstatslog^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libstatslog,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/frameworks/proto_logging/libstatslog^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_frameworks_proto_logging.tar.zst --clobber
