...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libandroidio,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/libandroidio^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/libcore/libandroidio^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/libcore/libandroidio^android_x86_x86_64_shared_apex31

echo "building libandroidio^android_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libandroidio,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/libandroidio^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/libcore/libandroidio^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/libcore/libandroidio^android_x86_64_shared_apex31

echo "building java-current-stubs-source^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja java-current-stubs-source,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/java-current-stubs-source^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/libcore/java-current-stubs-source^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/java-current-stubs-source^android_common

echo "building art.module.intra.core.api.stubs.source^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja art.module.intra.core.api.stubs.source,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/mmodules/intracoreapi/art.module.intra.core.api.stubs.source^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/libcore/art.module.intra.core.api.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/intracoreapi/art.module.intra.core.api.stubs.source^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/libcore/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_libcore.tar.zst --clobber
