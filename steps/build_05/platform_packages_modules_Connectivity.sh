...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libtetherutilsjni,android_x86_64_sdk_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/Connectivity/libtetherutilsjni^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/libtetherutilsjni^android_x86_64_sdk_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_packages_modules_Connectivity.tar.zst --clobber
