...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadbd_fs,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadbd_fs^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_x86_x86_64_shared

echo "building libadbd_fs^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadbd_fs,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadbd_fs^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_x86_64_shared

echo "building libadbd_fs^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadbd_fs,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadbd_fs^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/libs/libadbd_fs/libadbd_fs^android_recovery_x86_64_shared

echo "building libadb_pairing_connection^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadb_pairing_connection,android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadb_pairing_connection^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_connection^android_x86_x86_64_shared_apex10000

echo "building libadb_pairing_auth^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadb_pairing_auth,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_auth/libadb_pairing_auth^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadb_pairing_auth^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_auth/libadb_pairing_auth^android_x86_64_shared_apex10000

echo "building libadb_pairing_connection^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadb_pairing_connection,android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadb_pairing_connection^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_connection/libadb_pairing_connection^android_x86_64_shared_apex10000

echo "building libadb_pairing_auth^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libadb_pairing_auth,android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/packages/modules/adb/libadb_pairing_auth^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/pairing_auth/libadb_pairing_auth^android_x86_x86_64_shared_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_packages_modules_adb.tar.zst --clobber
