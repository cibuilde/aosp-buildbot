...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/extras/schedtest^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/tests/schedtest/schedtest^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/extras/mkuserimg_mke2fs^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/extras/ext4_utils/mkuserimg_mke2fs^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/extras/libsimpleperf_profcollect_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/libsimpleperf_profcollect_bindgen^android_x86_64_source
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/extras/libext4_utils^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/ext4_utils/libext4_utils^linux_glibc_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_extras.tar.zst --clobber
