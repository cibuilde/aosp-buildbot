...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libtokenmanager,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/libtokenmanager^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/hwservicemanager/libtokenmanager^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/libtokenmanager^android_x86_64_static

echo "building libhwservicemanager^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhwservicemanager,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/libhwservicemanager^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/hwservicemanager/libhwservicemanager^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/libhwservicemanager^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_hwservicemanager.tar.zst --clobber
