...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/keymaster/libkeymint^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymint^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/keymaster/libkeymint^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymint^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/keymaster/libkeymaster_messages^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_messages^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/keymaster/lib_android_keymaster_keymint_utils^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_keymaster.tar.zst --clobber
