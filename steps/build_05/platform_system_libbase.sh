...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/fmtlib/fmtlib^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libbase/libbase^android_x86_64_static_apex31/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libbase/libbase^android_x86_x86_64_static_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libbase/libbase^android_x86_x86_64_static_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libbase/libbase^android_x86_x86_64_static_apex31/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex31
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/libbase/libbase^android_product.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_product.31_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libbase.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libbase/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_libbase.tar.zst --clobber
