...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_generator^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_generator^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_generator^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_generator^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_generator^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_generator^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_contents^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_contents^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_contents^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_contents^android_x86_64_static_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/linkerconfig/linkerconfig_contents^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_contents^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_linkerconfig.tar.zst --clobber
