...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libdmabufheap,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_memory_libdmabufheap.tar.zst --clobber
