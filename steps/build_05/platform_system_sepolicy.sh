...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/product_file_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_file_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/plat_29.0.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_29.0.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/plat_28.0.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_28.0.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/fc_sort^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/tests/fc_sort^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/vendor_file_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/vendor_file_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/system_ext_file_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_file_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/plat_file_contexts^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_file_contexts^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/combine_maps^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/tests/combine_maps^linux_glibc_x86_64_PY2
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/plat_27.0.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_27.0.cil^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/sepolicy/plat_26.0.cil^android_common.output . $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_26.0.cil^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_sepolicy.tar.zst --clobber
