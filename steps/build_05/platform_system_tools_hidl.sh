...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhidlmetadata,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/libhidlmetadata^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/hidl/libhidlmetadata^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/libhidlmetadata^linux_glibc_x86_64_shared

echo "building hidl_metadata_in_cpp^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja hidl_metadata_in_cpp,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/hidl_metadata_in_cpp^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/hidl/hidl_metadata_in_cpp^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/hidl_metadata_in_cpp^linux_glibc_x86_64

echo "building libhidlmetadata^linux_glibc_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhidlmetadata,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/libhidlmetadata^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/hidl/libhidlmetadata^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/metadata/libhidlmetadata^linux_glibc_x86_64_static

echo "building libhidl-gen-utils^linux_glibc_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhidl-gen-utils,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/utils/libhidl-gen-utils^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/hidl/libhidl-gen-utils^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/utils/libhidl-gen-utils^linux_glibc_x86_64_shared

echo "building hidl_metadata_json^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja hidl_metadata_json,
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/hidl/build/hidl_metadata_json^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/hidl/hidl_metadata_json^.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/build/hidl_metadata_json^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_tools_hidl.tar.zst --clobber
