...
clone_depth_platform platform/system/tools/sysprop
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/sysprop/sysprop_java^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/sysprop/sysprop_java^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/sysprop/sysprop_cpp^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/sysprop/sysprop_cpp^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/sysprop/sysprop_api_dump^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/sysprop/sysprop_api_dump^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/platform/system/tools/sysprop/sysprop_api_checker^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/sysprop/sysprop_api_checker^linux_glibc_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_tools_sysprop.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/tools/sysprop/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 platform_system_tools_sysprop.tar.zst --clobber

du -ah -d1 platform_system_tools_sysprop*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_tools_sysprop.tar.zst" ]; then
  echo "Compressing platform/system/tools/sysprop -> platform_system_tools_sysprop.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_tools_sysprop.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/tools/sysprop/ .
fi
