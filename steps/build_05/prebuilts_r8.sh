...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/r8/r8^linux_glibc_common/ .

echo "building d8^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja d8,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja r8-compat-proguard,linux_glibc_common
