...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbacktrace_rs.rust_sysroot,android_x86_64_rlib
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbacktrace_rs.rust_sysroot,android_x86_64_rlib_apex10000
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbacktrace_rs.rust_sysroot,android_x86_x86_64_rlib
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhashbrown.rust_sysroot,android_x86_64_rlib
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhashbrown.rust_sysroot,android_x86_64_rlib_apex10000
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libhashbrown.rust_sysroot,android_x86_x86_64_rlib
