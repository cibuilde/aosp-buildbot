...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/extras/constraint-layout-x/androidx-constraintlayout_constraintlayout-solver-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/extras/constraint-layout-x/androidx-constraintlayout_constraintlayout-solver-nodeps^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.annotation_annotation-nodeps^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.room_room-common-nodeps^linux_glibc_common/ .

echo "building android-support-annotations^android_common"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja android-support-annotations,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja androidx-constraintlayout_constraintlayout-solver,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja androidx-constraintlayout_constraintlayout-solver,android_common_apex30
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja androidx.annotation_annotation,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja androidx.annotation_annotation,android_common_apex30
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja androidx.room_room-common,linux_glibc_common
