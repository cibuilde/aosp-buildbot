...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja kotlinx-coroutines-core,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja kotlinx-coroutines-core,android_common_apex30
