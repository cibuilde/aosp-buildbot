...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_product.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/system/libbase/libbase^android_product.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_product.31_x86_64_static $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_product.31_x86_64_static/addition_copy_files.output

echo "building libbase^android_vendor.31_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_vendor.31_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_vendor.31_x86_x86_64_static
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_64_shared_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_05/system/libbase/libbase^android_x86_64_shared_apex10000.output $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex10000 $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex10000/addition_copy_files.output

echo "building libbase^android_x86_64_shared_apex29"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_64_shared_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_64_shared_apex31
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_x86_64_shared_apex10000
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_x86_64_shared_apex29
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,android_x86_x86_64_shared_apex31
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 system_libbase.tar.zst --clobber
