...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja libbase,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/system/libbase/libbase^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^linux_glibc_x86_64_shared
