...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/reqd_policy_mask.conf^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/userdebug_plat_sepolicy.conf^android_common/ .

echo "building build_sepolicy^linux_glibc_x86_64_PY2"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja build_sepolicy,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja check_prop_prefix,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja plat_sepolicy.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja reqd_policy_mask.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja userdebug_plat_sepolicy.cil,android_common
