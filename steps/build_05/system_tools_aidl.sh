...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/googletest/googletest/libgtest^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/tools/aidl/libaidl-common^linux_glibc_x86_64_static/ .

echo "building aidl-cpp^linux_glibc_x86_64"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja aidl-cpp,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/aidl/aidl-cpp^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/system/tools/aidl/aidl-cpp^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/aidl/aidl-cpp^linux_glibc_x86_64

echo "building aidl^linux_glibc_x86_64"
ninja -f $GITHUB_WORKSPACE/steps/build_05.ninja aidl,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/aidl/aidl^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_05/system/tools/aidl/aidl^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/aidl/aidl^linux_glibc_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar cfJ system_tools_aidl.tar.zst -C $GITHUB_WORKSPACE/artifacts/system/tools/aidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_05 system_tools_aidl.tar.zst --clobber
