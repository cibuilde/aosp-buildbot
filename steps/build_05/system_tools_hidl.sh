...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja hidl-gen,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_05.ninja hidl_metadata_parser,linux_glibc_x86_64
