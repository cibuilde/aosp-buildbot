...
rsync -a -r $GITHUB_WORKSPACE/artifacts/build/soong/scripts/ninja_rsp^linux_glibc_x86_64_PY3/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/build/soong/cc/symbolfile/symbolfile^linux_glibc_x86_64_PY3/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja construct_context,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja gen-kotlin-build-file.py,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja manifest_check,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja manifest_fixer,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja ndk_api_coverage_parser,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja ndkstubgen,linux_glibc_x86_64_PY3
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja soong-android,linux_glibc_x86_64
