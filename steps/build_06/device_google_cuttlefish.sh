...
rsync -a -r $GITHUB_WORKSPACE/downloads/bionic/libc/crtbegin_dynamic^android_product.31_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/bionic/libc/crtbegin_dynamic^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/bionic/libc/crtend_android^android_product.31_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/bionic/libc/crtend_android^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/bionic/libdl/libdl^android_product.31_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs_product^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/device/google/cuttlefish/host/libs/graphics_detector/libcuttlefish_graphics_detector^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/device/google/cuttlefish/host/libs/image_aggregator/libcdisk_spec^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/device/google/cuttlefish/host/libs/image_aggregator/libimage_aggregator^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/gflags/libgflags^android_product.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/gflags/libgflags^linux_glibc_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/icu/icu4c/source/common/libicuuc^linux_glibc_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/jsoncpp/libjsoncpp^android_x86_64_shared_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/jsoncpp/libjsoncpp^linux_glibc_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libcxx/libc++^android_product.31_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libcxxabi/libc++demangle^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/libcutils/libcutils^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libbase/libbase^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/logging/liblog/liblog^android_product.31_x86_64_shared/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcuttlefish_fs,android_x86_64_shared_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/libcuttlefish_fs^android_x86_64_shared_apex10000.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_x86_64_shared_apex10000 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_x86_64_shared_apex10000/addition_copy_files.output

echo "building libcuttlefish_utils^android_x86_64_shared_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcuttlefish_utils,android_x86_64_shared_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/libcuttlefish_utils^android_x86_64_shared_apex10000.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/utils/libcuttlefish_utils^android_x86_64_shared_apex10000 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/utils/libcuttlefish_utils^android_x86_64_shared_apex10000/addition_copy_files.output

echo "building tombstone_transmit^android_product.31_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja tombstone_transmit,android_product.31_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/tombstone_transmit^android_product.31_x86_64.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_transmit^android_product.31_x86_64 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_transmit^android_product.31_x86_64/addition_copy_files.output

echo "building tombstone_producer^android_product.31_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja tombstone_producer,android_product.31_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/tombstone_producer^android_product.31_x86_64.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_producer^android_product.31_x86_64 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_producer^android_product.31_x86_64/addition_copy_files.output

echo "building assemble_cvd^linux_glibc_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja assemble_cvd,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/assemble_cvd/assemble_cvd^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/assemble_cvd^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/assemble_cvd/assemble_cvd^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/assemble_cvd^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/assemble_cvd/assemble_cvd^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/assemble_cvd/assemble_cvd^linux_glibc_x86_64/addition_copy_files.output

echo "building cvd_host_bugreport^linux_glibc_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja cvd_host_bugreport,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/cvd_host_bugreport/cvd_host_bugreport^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/cvd_host_bugreport^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/cvd_host_bugreport/cvd_host_bugreport^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/cvd_host_bugreport^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/cvd_host_bugreport/cvd_host_bugreport^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/cvd_host_bugreport/cvd_host_bugreport^linux_glibc_x86_64/addition_copy_files.output

echo "building mk_cdisk^android_x86_64_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja mk_cdisk,android_x86_64_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/device/google/cuttlefish/mk_cdisk^android_x86_64_apex10000.output $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/mk_cdisk/mk_cdisk^android_x86_64_apex10000 $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/mk_cdisk/mk_cdisk^android_x86_64_apex10000/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 device_google_cuttlefish.tar.zst --clobber
