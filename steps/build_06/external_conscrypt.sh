...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^linux_glibc_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++^linux_glibc_x86_64_shared/ .

echo "building conscrypt_generate_constants^linux_glibc_x86_64"
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja conscrypt_generate_constants,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_conscrypt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/conscrypt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 external_conscrypt.tar.zst --clobber
