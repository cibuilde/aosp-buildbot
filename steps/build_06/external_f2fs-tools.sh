...
echo "building fsck.f2fs^linux_glibc_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja fsck.f2fs,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/f2fs-tools/fsck.f2fs^linux_glibc_x86_64/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 external_f2fs-tools.tar.zst --clobber
