...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libicing,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icing/libicing^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/external/icing/libicing^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icing/libicing^android_x86_64_shared_apex10000
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/external/icing/libicing^android_x86_64_shared_apex10000.output $GITHUB_WORKSPACE/artifacts/external/icing/libicing^android_x86_64_shared_apex10000 $GITHUB_WORKSPACE/artifacts/external/icing/libicing^android_x86_64_shared_apex10000/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 external_icing.tar.zst --clobber
