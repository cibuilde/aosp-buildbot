...
echo "entering external/rust/crates/hashlink"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libhashlink,android_x86_64_rlib_rlib-std
