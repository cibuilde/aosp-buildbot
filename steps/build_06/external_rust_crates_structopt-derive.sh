...
echo "Preparing for external/rust/crates/structopt-derive"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstructopt_derive,linux_glibc_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/external/rust/crates/structopt-derive/libstructopt_derive^linux_glibc_x86_64.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/structopt-derive/libstructopt_derive^linux_glibc_x86_64 $GITHUB_WORKSPACE/artifacts/external/rust/crates/structopt-derive/libstructopt_derive^linux_glibc_x86_64/addition_copy_files.output
...
du -ah -d1 external_rust_crates_structopt-derive*.tar.zst | sort -h
