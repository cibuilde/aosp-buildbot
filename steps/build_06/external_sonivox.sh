...
echo "Preparing for external/sonivox"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libsonivox,android_x86_64_shared_cfi
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libsonivox,android_x86_x86_64_shared_cfi
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 external_sonivox.tar.zst --clobber
