...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libsqlite,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/sqlite/dist/libsqlite^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/external/sqlite/libsqlite^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/sqlite/dist/libsqlite^linux_glibc_x86_64_shared
