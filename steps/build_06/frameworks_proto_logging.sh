...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja stats-log-api-gen,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/stats-log-api-gen^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/frameworks/proto_logging/stats-log-api-gen^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/stats-log-api-gen^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 frameworks_proto_logging.tar.zst --clobber
