...
echo "Preparing for packages/apps/Messaging"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libgiftranscode,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/packages/apps/Messaging/libgiftranscode^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_64_shared/addition_copy_files.output

echo "building libgiftranscode^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libgiftranscode,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/packages/apps/Messaging/libgiftranscode^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 packages_apps_Messaging.tar.zst --clobber

du -ah -d1 packages_apps_Messaging*.tar.zst | sort -h
