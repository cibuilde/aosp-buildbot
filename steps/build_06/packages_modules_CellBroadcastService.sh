...
echo "Preparing for packages/modules/CellBroadcastService"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-cellbroadcast-java-gen,
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^.output $GITHUB_WORKSPACE/artifacts/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^ $GITHUB_WORKSPACE/artifacts/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 packages_modules_CellBroadcastService.tar.zst --clobber
