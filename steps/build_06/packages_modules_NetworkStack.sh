...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja ipmemorystore-aidl-interfaces-api,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja networkstack-aidl-interfaces-api,
