...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/lz4/programs/lz4^linux_glibc_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/kernel/prebuilts/common-modules/virtual-device/5.10/x86-64/virt_device_prebuilts_kernel_modules-5.10-x86_64^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_fstab^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/core/mkbootfs/mkbootfs^linux_glibc_x86_64/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja android.system.virtmanager-rust-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja authfs_aidl_interface-rust-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja microdroid_vendor_ramdisk-5.10,android_common
