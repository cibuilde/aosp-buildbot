...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-wifi-java-gen,
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 packages_modules_Wifi.tar.zst --clobber
