...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/bootable/recovery/librecovery^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/librecovery^android_recovery_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/bootable/recovery/libinstall^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/install/libinstall^android_recovery_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_bootable_recovery.tar.zst --clobber
