...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/libcrypto^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_vendor.31_x86_x86_64_shared

echo "building libssl^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libssl,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/libcrypto^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/libssl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/boringssl_self_test_vendor^android_vendor.31_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/boringssl/boringssl_self_test_vendor^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_boringssl.tar.zst --clobber
