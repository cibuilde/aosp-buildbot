...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/dng_sdk/libdng_sdk^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/dng_sdk/libdng_sdk^android_x86_x86_64_static/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/dng_sdk/libdng_sdk^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/dng_sdk/libdng_sdk^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_dng_sdk.tar.zst --clobber
