...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libft2,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/freetype/libft2^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/freetype/libft2^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/freetype/libft2^android_x86_x86_64_shared

echo "building libft2^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libft2,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/freetype/libft2^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/freetype/libft2^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/freetype/libft2^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_freetype.tar.zst --clobber
