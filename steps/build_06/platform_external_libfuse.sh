...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libfuse,android_x86_64_sdk_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libfuse/libfuse^android_x86_64_sdk_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/libfuse/libfuse^android_x86_64_sdk_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/external/libfuse/libfuse^android_x86_64_sdk_shared_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_libfuse.tar.zst --clobber
