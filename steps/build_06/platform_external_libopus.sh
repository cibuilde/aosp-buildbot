...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libopus,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libopus/libopus^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/libopus/libopus^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libopus/libopus^android_vendor.31_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_libopus.tar.zst --clobber
