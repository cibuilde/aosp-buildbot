...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-textclassifier-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/java/statslog-textclassifier-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/libtextclassifier/statslog-textclassifier-java-gen^.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/java/statslog-textclassifier-java-gen^

echo "building libtextclassifier_hash^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtextclassifier_hash,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/libtextclassifier/libtextclassifier_hash^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier_hash^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_libtextclassifier.tar.zst --clobber
