...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/trigger_perfetto^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/trigger_perfetto^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/traced_probes^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/traced_probes^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/traced^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/traced^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/statslog_perfetto.h^.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.h^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/statslog_perfetto.cpp^.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.cpp^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/perfetto^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/perfetto^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/libstatslog_perfetto^android_x86_64_static_lto-thin.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libstatslog_perfetto^android_x86_64_static_lto-thin
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/perfetto/libperfetto^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_perfetto.tar.zst --clobber
