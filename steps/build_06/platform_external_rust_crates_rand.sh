...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja librand,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand/librand^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/rust/crates/rand/librand^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand/librand^android_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_rust_crates_rand.tar.zst --clobber
