...
echo "building libserde^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libserde,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/serde/libserde^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/rust/crates/serde/libserde^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/serde/libserde^android_x86_64_rlib_rlib-std_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_rust_crates_serde.tar.zst --clobber
