...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tensorflow/libtflite_static^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/tensorflow/tensorflow/lite/libtflite_static^android_x86_64_sdk_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_tensorflow.tar.zst --clobber
