...
clone_depth_platform platform/external/tinyxml2
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/tinyxml2/libtinyxml2^android_recovery_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/tinyxml2/libtinyxml2^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/tinyxml2/libtinyxml2^android_x86_x86_64_static/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtinyxml2,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared

echo "building libtinyxml2^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtinyxml2,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tinyxml2/libtinyxml2^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_64_shared

echo "building libtinyxml2^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtinyxml2,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared

echo "building libtinyxml2^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtinyxml2,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared

echo "building libtinyxml2^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtinyxml2,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_tinyxml2.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/tinyxml2/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_external_tinyxml2.tar.zst --clobber

du -ah -d1 platform_external_tinyxml2*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_tinyxml2.tar.zst" ]; then
  echo "Compressing platform/external/tinyxml2 -> platform_external_tinyxml2.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_tinyxml2.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/tinyxml2/ .
fi
