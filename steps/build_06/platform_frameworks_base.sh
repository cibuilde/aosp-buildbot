...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog_hwui.h^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/statslog_hwui.h^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog_hwui.cpp^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/statslog_hwui.cpp^

echo "building statslog-telephony-common-java-gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-telephony-common-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/telephony/common/statslog-telephony-common-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog-telephony-common-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/telephony/common/statslog-telephony-common-java-gen^

echo "building statslog-framework-java-gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-framework-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/statslog-framework-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog-framework-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/statslog-framework-java-gen^

echo "building statslog-art-java-gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-art-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/statslog-art-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog-art-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/statslog-art-java-gen^

echo "building statslog-appsearch-java-gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-appsearch-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/appsearch/service/statslog-appsearch-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog-appsearch-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/appsearch/service/statslog-appsearch-java-gen^

echo "building statslog-SystemUI-java-gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-SystemUI-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SystemUI/shared/statslog-SystemUI-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/statslog-SystemUI-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SystemUI/shared/statslog-SystemUI-java-gen^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/platform-systemserverclasspath^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/boot/platform-systemserverclasspath^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/lockagent_crasher^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/lock_agent/lockagent_crasher^android_x86_64

echo "building libwebviewchromium_loader^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libwebviewchromium_loader,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libwebviewchromium_loader^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/loader/libwebviewchromium_loader^android_x86_x86_64_shared

echo "building libwebviewchromium_loader^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libwebviewchromium_loader,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/loader/libwebviewchromium_loader^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libwebviewchromium_loader^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/loader/libwebviewchromium_loader^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libstatslog_hwui^android_x86_x86_64_static_lto-thin.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libstatslog_hwui^android_x86_x86_64_static_lto-thin
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libstatslog_hwui^android_x86_64_static_lto-thin.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libstatslog_hwui^android_x86_64_static_lto-thin

echo "building liblockagent^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja liblockagent,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/lock_agent/liblockagent^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/liblockagent^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/tools/lock_agent/liblockagent^android_x86_64_shared

echo "building libandroid_net^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libandroid_net,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid_net^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libandroid_net^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid_net^android_x86_x86_64_shared

echo "building libandroid_net^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libandroid_net,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid_net^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/libandroid_net^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid_net^android_x86_64_shared

echo "building framework-res^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja framework-res,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/framework-res^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/framework-res^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/framework-res^android_common

echo "building framework-res-package-jar^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja framework-res-package-jar,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/framework-res-package-jar^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/framework-res-package-jar^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/res/framework-res-package-jar^android_common

echo "building error_prone_android_framework_lib^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja error_prone_android_framework_lib,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/errorprone/error_prone_android_framework_lib^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/error_prone_android_framework_lib^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/errorprone/error_prone_android_framework_lib^linux_glibc_common

echo "building com.android.sysprop.watchdog_sysprop_library^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.watchdog_sysprop_library,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog_sysprop_library^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/com.android.sysprop.watchdog_sysprop_library^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog_sysprop_library^

echo "building com.android.sysprop.watchdog_java_gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.watchdog_java_gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog_java_gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/com.android.sysprop.watchdog_java_gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog_java_gen^

echo "building com.android.sysprop.localization_sysprop_library^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.localization_sysprop_library,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization_sysprop_library^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/com.android.sysprop.localization_sysprop_library^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization_sysprop_library^

echo "building com.android.sysprop.localization_java_gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.localization_java_gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization_java_gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/com.android.sysprop.localization_java_gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization_java_gen^

echo "building com.android.appsearch-systemserverclasspath-fragment^android_common_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.appsearch-systemserverclasspath-fragment,android_common_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/com.android.appsearch-systemserverclasspath-fragment^android_common_apex10000.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/appsearch/com.android.appsearch-systemserverclasspath-fragment^android_common_apex10000

echo "building OneHandedModeGesturalOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja OneHandedModeGesturalOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/OneHandedModeGesturalOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/OneHandedModeGesturalOverlay/OneHandedModeGesturalOverlay^android_common

echo "building NavigationBarModeGesturalOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja NavigationBarModeGesturalOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/NavigationBarModeGesturalOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/NavigationBarModeGesturalOverlay/NavigationBarModeGesturalOverlay^android_common

echo "building NavigationBarModeGesturalOverlayWideBack^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja NavigationBarModeGesturalOverlayWideBack,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/NavigationBarModeGesturalOverlayWideBack^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/NavigationBarModeGesturalOverlayWideBack/NavigationBarModeGesturalOverlayWideBack^android_common

echo "building NavigationBarModeGesturalOverlayNarrowBack^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja NavigationBarModeGesturalOverlayNarrowBack,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/NavigationBarModeGesturalOverlayNarrowBack^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/NavigationBarModeGesturalOverlayNarrowBack/NavigationBarModeGesturalOverlayNarrowBack^android_common

echo "building NavigationBarModeGesturalOverlayExtraWideBack^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja NavigationBarModeGesturalOverlayExtraWideBack,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/NavigationBarModeGesturalOverlayExtraWideBack^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/NavigationBarModeGesturalOverlayExtraWideBack/NavigationBarModeGesturalOverlayExtraWideBack^android_common

echo "building NavigationBarMode3ButtonOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja NavigationBarMode3ButtonOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/NavigationBarMode3ButtonOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/NavigationBarMode3ButtonOverlay/NavigationBarMode3ButtonOverlay^android_common

echo "building FontNotoSerifSourceOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja FontNotoSerifSourceOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/FontNotoSerifSourceOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/FontNotoSerifSourceOverlay/FontNotoSerifSourceOverlay^android_common

echo "building DisplayCutoutEmulationWaterfallOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja DisplayCutoutEmulationWaterfallOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/DisplayCutoutEmulationWaterfallOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/DisplayCutoutEmulationWaterfallOverlay/DisplayCutoutEmulationWaterfallOverlay^android_common

echo "building DisplayCutoutEmulationTallOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja DisplayCutoutEmulationTallOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/DisplayCutoutEmulationTallOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/DisplayCutoutEmulationTallOverlay/DisplayCutoutEmulationTallOverlay^android_common

echo "building DisplayCutoutEmulationHoleOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja DisplayCutoutEmulationHoleOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/DisplayCutoutEmulationHoleOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/DisplayCutoutEmulationHoleOverlay/DisplayCutoutEmulationHoleOverlay^android_common

echo "building DisplayCutoutEmulationDoubleOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja DisplayCutoutEmulationDoubleOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/DisplayCutoutEmulationDoubleOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/DisplayCutoutEmulationDoubleOverlay/DisplayCutoutEmulationDoubleOverlay^android_common

echo "building DisplayCutoutEmulationCornerOverlay^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja DisplayCutoutEmulationCornerOverlay,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/base/DisplayCutoutEmulationCornerOverlay^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/overlays/DisplayCutoutEmulationCornerOverlay/DisplayCutoutEmulationCornerOverlay^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_frameworks_base.tar.zst --clobber
