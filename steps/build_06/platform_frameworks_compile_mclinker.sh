...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/frameworks/compile/mclinker/ld.mc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/compile/mclinker/tools/mcld/ld.mc^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_frameworks_compile_mclinker.tar.zst --clobber
