...
clone_depth_platform platform/hardware/ril
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja librilutils,android_vendor.31_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/hardware/ril/librilutils^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_static

echo "building librilutils^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja librilutils,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/hardware/ril/librilutils^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_shared

echo "building librilutils^android_vendor.31_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja librilutils,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/hardware/ril/librilutils^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_static

echo "building librilutils^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja librilutils,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/hardware/ril/librilutils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_hardware_ril.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/hardware/ril/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_hardware_ril.tar.zst --clobber

du -ah -d1 platform_hardware_ril*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_hardware_ril.tar.zst" ]; then
  echo "Compressing platform/hardware/ril -> platform_hardware_ril.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_hardware_ril.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/hardware/ril/ .
fi
