...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_CellBroadcastService.tar.zst --clobber
