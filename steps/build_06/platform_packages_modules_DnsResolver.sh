...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog_resolv.h,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/statslog_resolv.h^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/statslog_resolv.h^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/statslog_resolv.h^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/statslog_resolv.cpp^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/statslog_resolv.cpp^

echo "building libstatslog_resolv^android_x86_64_static_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstatslog_resolv,android_x86_64_static_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libstatslog_resolv^android_x86_64_static_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/libstatslog_resolv^android_x86_64_static_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libstatslog_resolv^android_x86_64_static_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_static_cfi_com.android.resolv.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_static_cfi_com.android.resolv
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_shared_cfi_com.android.resolv.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/libnetd_resolv^android_x86_64_shared_cfi_com.android.resolv

echo "building com.android.resolv^android_common_cfi_com.android.resolv_image"
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/DnsResolver/com.android.resolv^android_common_cfi_com.android.resolv_image.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/apex/com.android.resolv^android_common_cfi_com.android.resolv_image
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_DnsResolver.tar.zst --clobber
