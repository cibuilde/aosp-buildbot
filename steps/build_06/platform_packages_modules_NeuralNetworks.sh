...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libneuralnetworks_common,android_x86_x86_64_static_com.android.neuralnetworks
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libneuralnetworks_common,android_vendor.31_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/NeuralNetworks/libneuralnetworks_common^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/common/libneuralnetworks_common^android_vendor.31_x86_64_static

echo "building libneuralnetworks^android_x86_x86_64_shared_com.android.neuralnetworks"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libneuralnetworks,android_x86_x86_64_shared_com.android.neuralnetworks
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/NeuralNetworks/libneuralnetworks^android_x86_64_shared_com.android.neuralnetworks.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/runtime/libneuralnetworks^android_x86_64_shared_com.android.neuralnetworks

echo "building com.android.neuralnetworks^android_common_com.android.neuralnetworks_image"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.neuralnetworks,android_common_com.android.neuralnetworks_image
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/NeuralNetworks/com.android.neuralnetworks^android_common_com.android.neuralnetworks_image.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/apex/com.android.neuralnetworks^android_common_com.android.neuralnetworks_image
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_NeuralNetworks.tar.zst --clobber
