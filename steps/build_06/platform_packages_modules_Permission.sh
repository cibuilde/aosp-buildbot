...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/Permission/statslog-permissioncontroller-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/PermissionController/statslog-permissioncontroller-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_Permission.tar.zst --clobber
