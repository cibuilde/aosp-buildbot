...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-scheduling-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Scheduling/service/statslog-scheduling-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/Scheduling/statslog-scheduling-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Scheduling/service/statslog-scheduling-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_Scheduling.tar.zst --clobber
