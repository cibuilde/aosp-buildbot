...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja microdroid_vendor_boot-5.10,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vendor_boot-5.10^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/Virtualization/microdroid_vendor_boot-5.10^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vendor_boot-5.10^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_Virtualization.tar.zst --clobber
