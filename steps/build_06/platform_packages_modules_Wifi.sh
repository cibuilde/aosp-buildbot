...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja statslog-wifi-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/statslog-wifi-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/Wifi/statslog-wifi-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/statslog-wifi-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_Wifi.tar.zst --clobber
