...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libadb_protos,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/proto/libadb_protos^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/adb/libadb_protos^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/proto/libadb_protos^android_x86_64_shared_apex10000

echo "building adbd^android_x86_64_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja adbd,android_x86_64_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/adbd^android_x86_64_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/packages/modules/adb/adbd^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/adbd^android_x86_64_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_packages_modules_adb.tar.zst --clobber
