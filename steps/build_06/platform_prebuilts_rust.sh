...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libterm,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libterm^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib_apex10000

echo "building libtest^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtest,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libtest^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib_apex10000

echo "building libstd^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstd,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libstd^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib

echo "building libterm^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libterm,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libterm^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib

echo "building libgetopts^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libgetopts,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libgetopts^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib

echo "building libtest^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libtest,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libtest^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib

echo "building libstd^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstd,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libstd^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib_apex10000

echo "building libgetopts^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libgetopts,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/prebuilts/rust/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_prebuilts_rust.tar.zst --clobber
