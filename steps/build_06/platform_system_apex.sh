...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcom.android.sysprop.apex,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/libcom.android.sysprop.apex^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/apex/libcom.android.sysprop.apex^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/libcom.android.sysprop.apex^android_x86_64_static

echo "building libcom.android.sysprop.apex^android_recovery_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcom.android.sysprop.apex,android_recovery_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/libcom.android.sysprop.apex^android_recovery_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/apex/libcom.android.sysprop.apex^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/libcom.android.sysprop.apex^android_recovery_x86_64_static

echo "building com.android.sysprop.apex_sysprop_library^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.apex_sysprop_library,
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/com.android.sysprop.apex_sysprop_library^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/apex/com.android.sysprop.apex_sysprop_library^.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/com.android.sysprop.apex_sysprop_library^

echo "building com.android.sysprop.apex_java_gen^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja com.android.sysprop.apex_java_gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/com.android.sysprop.apex_java_gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/apex/com.android.sysprop.apex_java_gen^.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/sysprop/com.android.sysprop.apex_java_gen^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_apex.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/apex/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_apex.tar.zst --clobber
