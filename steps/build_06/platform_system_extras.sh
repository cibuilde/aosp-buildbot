...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/extras/libprofcollect_libflags_bridge_code^.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libflags/libprofcollect_libflags_bridge_code^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/extras/libprofcollect_libflags^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libflags/libprofcollect_libflags^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/extras/libprofcollect_libbase_bridge_code^.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libbase/libprofcollect_libbase_bridge_code^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/extras/libprofcollect_libbase^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libbase/libprofcollect_libbase^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_extras.tar.zst --clobber
