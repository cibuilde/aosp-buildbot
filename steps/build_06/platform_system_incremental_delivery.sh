...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/incremental_delivery/libincfs^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/incremental_delivery/libincfs^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/incremental_delivery/libcom.android.sysprop.incremental^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/incremental_delivery/libcom.android.sysprop.incremental^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_incremental_delivery.tar.zst --clobber
