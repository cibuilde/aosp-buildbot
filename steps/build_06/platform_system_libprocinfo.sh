...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libprocinfo,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libprocinfo/libprocinfo^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared_apex10000

echo "building libprocinfo^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libprocinfo,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libprocinfo/libprocinfo^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_libprocinfo.tar.zst --clobber
