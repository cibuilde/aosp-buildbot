...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libvintf,linux_glibc_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^linux_glibc_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libvintf/libvintf^linux_glibc_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^linux_glibc_x86_64_shared

echo "building assemble_vintf^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja assemble_vintf,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/assemble_vintf^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libvintf/assemble_vintf^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/assemble_vintf^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_libvintf.tar.zst --clobber
