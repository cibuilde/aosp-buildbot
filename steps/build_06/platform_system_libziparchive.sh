...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libziparchive,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libziparchive/libziparchive^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_x86_64_shared_apex31

echo "building libziparchive^android_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libziparchive,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/libziparchive/libziparchive^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_64_shared_apex31
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_libziparchive.tar.zst --clobber
