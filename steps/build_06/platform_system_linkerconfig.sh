...
clone_depth_platform platform/system/linkerconfig
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja linkerconfig_modules,linux_glibc_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_modules^linux_glibc_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig_modules^linux_glibc_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_modules^linux_glibc_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig_modules^android_x86_64_static_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_modules^android_x86_64_static_apex10000

echo "building linkerconfig_modules^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja linkerconfig_modules,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_modules^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig_modules^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig_modules^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig^android_x86_64_apex10000

echo "building linkerconfig^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja linkerconfig,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/linkerconfig^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/linkerconfig^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/generate_recovery_linker_config^.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/generate_recovery_linker_config^
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/linkerconfig/ld.config.recovery.txt^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/linkerconfig/ld.config.recovery.txt^android_recovery_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_linkerconfig.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/linkerconfig/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_linkerconfig.tar.zst --clobber

du -ah -d1 platform_system_linkerconfig*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_linkerconfig.tar.zst" ]; then
  echo "Compressing platform/system/linkerconfig -> platform_system_linkerconfig.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_linkerconfig.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/linkerconfig/ .
fi
