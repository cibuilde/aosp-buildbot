...
clone_depth_platform platform/system/memory/libdmabufheap
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_memory_libdmabufheap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/memory/libdmabufheap/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_memory_libdmabufheap.tar.zst --clobber

du -ah -d1 platform_system_memory_libdmabufheap*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_memory_libdmabufheap.tar.zst" ]; then
  echo "Compressing platform/system/memory/libdmabufheap -> platform_system_memory_libdmabufheap.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_memory_libdmabufheap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/memory/libdmabufheap/ .
fi
