...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libupdate_engine_boot_control,android_recovery_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_boot_control^android_recovery_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/platform/system/update_engine/libupdate_engine_boot_control^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_boot_control^android_recovery_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 platform_system_update_engine.tar.zst --clobber
