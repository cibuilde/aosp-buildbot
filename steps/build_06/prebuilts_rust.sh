...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstd,android_x86_64_rlib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/prebuilts/rust/libstd^android_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib

echo "building libstd^android_x86_64_rlib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstd,android_x86_64_rlib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/prebuilts/rust/libstd^android_x86_64_rlib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_rlib_apex10000

echo "building libstd^android_x86_x86_64_rlib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libstd,android_x86_x86_64_rlib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_x86_64_rlib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/prebuilts/rust/libstd^android_x86_x86_64_rlib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_x86_64_rlib
