...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.concurrent_concurrent-futures-nodeps^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.room_room-common^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.room_room-migration-nodeps^linux_glibc_common/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja android-arch-core-common,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja android-arch-lifecycle-common,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja android-support-collections,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.annotation_annotation-experimental-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.annotation_annotation-experimental-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.arch.core_core-common,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.arch.core_core-common,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.arch.core_core-runtime-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.arch.core_core-runtime-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.collection_collection,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.collection_collection,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.concurrent_concurrent-futures,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.cursoradapter_cursoradapter-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.cursoradapter_cursoradapter-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.documentfile_documentfile-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.documentfile_documentfile-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.exifinterface_exifinterface-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.interpolator_interpolator-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.interpolator_interpolator-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.lifecycle_lifecycle-common,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.lifecycle_lifecycle-common,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.lifecycle_lifecycle-viewmodel-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.lifecycle_lifecycle-viewmodel-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.localbroadcastmanager_localbroadcastmanager-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.localbroadcastmanager_localbroadcastmanager-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.print_print-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.print_print-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.remotecallback_remotecallback-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.room_room-common,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.room_room-migration,linux_glibc_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.savedstate_savedstate-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.savedstate_savedstate-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.sqlite_sqlite-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.tracing_tracing-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.tracing_tracing-nodeps,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.versionedparcelable_versionedparcelable-nodeps,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja androidx.versionedparcelable_versionedparcelable-nodeps,android_common_apex30
