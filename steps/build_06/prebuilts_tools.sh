...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja kotlinx-coroutines-android,android_common
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja kotlinx-coroutines-android,android_common_apex30
