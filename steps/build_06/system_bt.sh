...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/flatbuffers/libflatbuffers-cpp^linux_glibc_x86_64_static/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja bluetooth_flatbuffer_bundler,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/dumpsys/bundler/bluetooth_flatbuffer_bundler^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_06/system/bt/bluetooth_flatbuffer_bundler^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/dumpsys/bundler/bluetooth_flatbuffer_bundler^linux_glibc_x86_64
