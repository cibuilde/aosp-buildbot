...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcgrouprc,linux_glibc_x86_64_shared
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libcutils,linux_glibc_x86_64_shared
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_recovery_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_vendor_ramdisk_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_x86_64_static_apex10000
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_x86_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdebuggerd_handler_core,android_x86_x86_64_static_apex10000
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libsparse,linux_glibc_x86_64_shared
