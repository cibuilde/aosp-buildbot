...
echo "entering system/memory/libdmabufheap"
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/memory/libdmabufheap/libdmabufheap^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdmabufheap,android_vendor.31_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libdmabufheap^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdmabufheap,android_vendor.31_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building libdmabufheap^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdmabufheap,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared/addition_copy_files.output

echo "building libdmabufheap^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_06.ninja libdmabufheap,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_06/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_06 system_memory_libdmabufheap.tar.zst --clobber
