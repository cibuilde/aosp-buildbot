...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja netd_aidl_interface-api,
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja netd_event_listener_interface-api,
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja oemnetd_aidl_interface-cpp-source,
