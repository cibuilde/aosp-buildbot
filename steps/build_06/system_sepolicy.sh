...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/tests/check_prop_prefix^linux_glibc_x86_64_PY3/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.conf^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_pub_policy.conf^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_sepolicy.cil^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/pub_policy.conf^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/reqd_policy_mask.cil^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_pub_policy.conf^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/system_ext_sepolicy.conf^android_common/ .

echo "building microdroid_vendor_sepolicy.cil.raw^android_common"
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja microdroid_vendor_sepolicy.cil.raw,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja plat_pub_policy.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja pub_policy.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja system_ext_pub_policy.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja system_ext_sepolicy.cil,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_06.ninja vendor_property_contexts,android_common
