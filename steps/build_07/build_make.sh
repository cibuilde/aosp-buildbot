...
rsync -a -r $GITHUB_WORKSPACE/artifacts/build/make/tools/releasetools/releasetools_common^linux_glibc_x86_64_PY2/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/build/make/tools/releasetools/releasetools_verity_utils^linux_glibc_x86_64_PY2/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja build_image,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja sparse_img,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja verity_utils,linux_glibc_x86_64_PY2
