...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja avbtool,linux_glibc_x86_64_PY3
mkdir -p $GITHUB_WORKSPACE/artifacts/external/avb/avbtool^linux_glibc_x86_64_PY3
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/avb/avbtool^linux_glibc_x86_64_PY3.output . $GITHUB_WORKSPACE/artifacts/external/avb/avbtool^linux_glibc_x86_64_PY3
