...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-arm-neon,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-attributes,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-checkers,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-comment-commands,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-comment-html-named-character-references,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-comment-nodes,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-declnodes,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-diagnostics,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-html-tags,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja clang-gen-statnodes,
