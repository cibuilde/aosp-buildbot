...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt_generate_constants^linux_glibc_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++^linux_glibc_x86_64_shared/ .

echo "building conscrypt-unbundled_generated_constants^"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja conscrypt-unbundled_generated_constants,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja conscrypt_generated_constants,
