...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/guice/guice_munge_manifest^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/guice/guice_munge_srcjar^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/junit/junit^linux_glibc_common/ .

echo "building guice_munge^linux_glibc_common"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja guice_munge,linux_glibc_common
