...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbrillo-stream,android_recovery_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-stream^android_recovery_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libbrillo/libbrillo-stream^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-stream^android_recovery_x86_64_static

echo "building libbrillo-stream^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbrillo-stream,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-stream^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libbrillo/libbrillo-stream^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-stream^android_x86_64_static

echo "building libbrillo^android_recovery_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbrillo,android_recovery_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo^android_recovery_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libbrillo/libbrillo^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo^android_recovery_x86_64_static

echo "building libbrillo^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbrillo,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libbrillo/libbrillo^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libbrillo.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libbrillo/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_libbrillo.tar.zst --clobber
