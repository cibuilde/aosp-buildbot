...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libchrome/libmojo_jni_headers^/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libchrome,android_recovery_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_recovery_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libchrome/libchrome^android_recovery_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_recovery_x86_64_static

echo "building libchrome^android_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libchrome,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libchrome/libchrome^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_64_static

echo "building libchrome^android_x86_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libchrome,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libchrome/libchrome^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libchrome.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libchrome/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_libchrome.tar.zst --clobber
