...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libtextclassifier,android_x86_64_sdk_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libtextclassifier/libtextclassifier^android_x86_64_sdk_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/external/libtextclassifier/libtextclassifier^android_x86_64_sdk_shared_apex30.output $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30 $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_libtextclassifier.tar.zst --clobber
