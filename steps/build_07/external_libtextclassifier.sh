...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-textclassifier-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/java/statslog-textclassifier-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/libtextclassifier/statslog-textclassifier-java-gen^.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/java/statslog-textclassifier-java-gen^
