...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja protoc-gen-nanopb,linux_glibc_x86_64_PY2
mkdir -p $GITHUB_WORKSPACE/artifacts/external/nanopb-c/generator/protoc-gen-nanopb^linux_glibc_x86_64_PY2
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/nanopb-c/protoc-gen-nanopb^linux_glibc_x86_64_PY2.output . $GITHUB_WORKSPACE/artifacts/external/nanopb-c/generator/protoc-gen-nanopb^linux_glibc_x86_64_PY2

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_nanopb-c.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/nanopb-c/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_nanopb-c.tar.zst --clobber
