...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libpdfium,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/external/pdfium/libpdfium^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/pdfium/libpdfium^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/pdfium/libpdfium^android_x86_64_shared/addition_copy_files.output

echo "building libpdfium^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libpdfium,android_x86_x86_64_shared
