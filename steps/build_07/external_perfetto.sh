...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja heapprofd_client_api,android_x86_64_shared_current
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_64_shared_current
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/heapprofd_client_api^android_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_64_shared_current

echo "building heapprofd_client_api^android_x86_x86_64_shared_current"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja heapprofd_client_api,android_x86_x86_64_shared_current
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared_current
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared_current.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared_current

echo "building libperfetto_client_experimental^android_x86_64_static"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libperfetto_client_experimental,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/libperfetto_client_experimental^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_64_static

echo "building libperfetto_client_experimental^android_x86_64_static_apex31"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libperfetto_client_experimental,android_x86_64_static_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_64_static_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/libperfetto_client_experimental^android_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_64_static_apex31

echo "building libperfetto_client_experimental^android_x86_x86_64_static_apex31"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libperfetto_client_experimental,android_x86_x86_64_static_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_x86_64_static_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/libperfetto_client_experimental^android_x86_x86_64_static_apex31.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto_client_experimental^android_x86_x86_64_static_apex31

echo "building statslog_perfetto.cpp^"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog_perfetto.cpp,
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.cpp^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/statslog_perfetto.cpp^.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.cpp^

echo "building statslog_perfetto.h^"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog_perfetto.h,
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.h^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/perfetto/statslog_perfetto.h^.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/statslog_perfetto.h^

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_perfetto.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/perfetto/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_perfetto.tar.zst --clobber
