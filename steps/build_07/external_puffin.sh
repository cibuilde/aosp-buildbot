...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libpuffpatch,android_recovery_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libpuffpatch,android_x86_64_static
