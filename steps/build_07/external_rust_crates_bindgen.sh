...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja bindgen,linux_glibc_x86_64
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbindgen_cmd,linux_glibc_x86_64_rlib_rlib-std
