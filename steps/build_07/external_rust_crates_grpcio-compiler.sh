...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja grpc_rust_plugin,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-compiler/grpc_rust_plugin^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_rust_crates_grpcio-compiler.tar.zst --clobber
