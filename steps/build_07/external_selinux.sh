...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libselinux,android_vendor.31_x86_64_shared
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libselinux,android_x86_64_shared_current
