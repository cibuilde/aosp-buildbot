...
echo "entering external/selinux"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libselinux,android_recovery_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/external/selinux/libselinux^android_recovery_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_recovery_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_recovery_x86_64_shared/addition_copy_files.output

echo "building libselinux^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libselinux,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/external/selinux/libselinux^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared/addition_copy_files.output

echo "building libselinux^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libselinux,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/external/selinux/libselinux^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_x86_64_shared/addition_copy_files.output

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_selinux.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/selinux/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 external_selinux.tar.zst --clobber
