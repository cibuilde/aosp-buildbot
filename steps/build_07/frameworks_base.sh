...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libalarm_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/frameworks/base/libalarm_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_64_shared/addition_copy_files.output

echo "building libalarm_jni^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libalarm_jni,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/frameworks/base/libalarm_jni^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_x86_64_shared/addition_copy_files.output
