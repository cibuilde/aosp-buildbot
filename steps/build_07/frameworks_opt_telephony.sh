...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-telephony-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/opt/telephony/statslog-telephony-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/frameworks/opt/telephony/statslog-telephony-java-gen^.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/telephony/statslog-telephony-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 frameworks_opt_telephony.tar.zst --clobber
