...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libhardware,android_x86_64_shared_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 hardware_libhardware.tar.zst --clobber
