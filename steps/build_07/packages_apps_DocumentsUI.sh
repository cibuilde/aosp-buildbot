...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-docsui-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/DocumentsUI/statslog-docsui-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/packages/apps/DocumentsUI/statslog-docsui-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/apps/DocumentsUI/statslog-docsui-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 packages_apps_DocumentsUI.tar.zst --clobber
