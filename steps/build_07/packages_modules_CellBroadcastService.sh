...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-cellbroadcast-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/CellBroadcastService/statslog-cellbroadcast-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 packages_modules_CellBroadcastService.tar.zst --clobber
