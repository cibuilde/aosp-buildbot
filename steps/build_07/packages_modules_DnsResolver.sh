...
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-api^/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja dnsresolver_aidl_interface-V7-cpp-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja dnsresolver_aidl_interface-V9-java-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja dnsresolver_aidl_interface-V9-ndk_platform-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libnetd_resolv,android_x86_64_shared_current
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog_resolv.cpp,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog_resolv.h,
