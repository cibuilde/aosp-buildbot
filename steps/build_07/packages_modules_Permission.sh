...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-permissioncontroller-java-gen,
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/packages/modules/Permission/statslog-permissioncontroller-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/PermissionController/statslog-permissioncontroller-java-gen^
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 packages_modules_Permission.tar.zst --clobber
