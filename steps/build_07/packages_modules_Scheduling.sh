...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja reboot-stats-parser,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-scheduling-java-gen,
