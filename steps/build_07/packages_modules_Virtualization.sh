...
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/virtmanager/aidl/android.system.virtmanager-rust-source^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/aidl/authfs_aidl_interface-rust-source^/ .

echo "building android.system.virtmanager-rust^android_x86_64_source_apex10000"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja android.system.virtmanager-rust,android_x86_64_source_apex10000
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja authfs_aidl_interface-rust,android_x86_64_source_apex10000
