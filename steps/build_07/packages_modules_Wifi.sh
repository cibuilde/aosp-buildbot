...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja coex-table-parser,
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-wifi-java-gen,
