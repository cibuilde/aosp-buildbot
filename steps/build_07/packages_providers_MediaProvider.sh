...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja statslog-mediaprovider-java-gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/providers/MediaProvider/statslog-mediaprovider-java-gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/packages/providers/MediaProvider/statslog-mediaprovider-java-gen^.output . $GITHUB_WORKSPACE/artifacts/packages/providers/MediaProvider/statslog-mediaprovider-java-gen^
