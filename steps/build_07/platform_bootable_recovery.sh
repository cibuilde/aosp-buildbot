...
clone_depth_platform platform/bootable/recovery
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja recovery-refresh,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-refresh^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/recovery-refresh^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-refresh^android_x86_64

echo "building recovery-persist^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja recovery-persist,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-persist^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/recovery-persist^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-persist^android_x86_64

echo "building librecovery_ui^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja librecovery_ui,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/librecovery_ui^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui^android_recovery_x86_64_shared

echo "building libminui^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libminui,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/libminui^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_x86_64_shared

echo "building libminui^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libminui,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/libminui^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_64_shared

echo "building libfusesideload^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libfusesideload,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/fuse_sideload/libfusesideload^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/libfusesideload^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/fuse_sideload/libfusesideload^android_recovery_x86_64_shared

echo "building libbootloader_message^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbootloader_message,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/libbootloader_message^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_x86_64_shared

echo "building libbootloader_message^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libbootloader_message,android_recovery_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/bootable/recovery/libbootloader_message^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_recovery_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_bootable_recovery.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/bootable/recovery/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_bootable_recovery.tar.zst --clobber

du -ah -d1 platform_bootable_recovery*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_bootable_recovery.tar.zst" ]; then
  echo "Compressing platform/bootable/recovery -> platform_bootable_recovery.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_bootable_recovery.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/bootable/recovery/ .
fi
