...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja dagger2-compiler-lib,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-compiler-lib^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/dagger2/dagger2-compiler-lib^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-compiler-lib^linux_glibc_common

echo "building dagger2-compiler^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja dagger2-compiler,linux_glibc_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-compiler^linux_glibc_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/dagger2/dagger2-compiler^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2-compiler^linux_glibc_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_dagger2.tar.zst --clobber
