...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libyuv,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/libyuv/libyuv^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_x86_64_shared

echo "building libyuv^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libyuv,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/libyuv/libyuv^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_libyuv.tar.zst --clobber
