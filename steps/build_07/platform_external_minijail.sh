...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libminijail,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared

echo "building libminijail^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libminijail,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/minijail/libminijail^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_minijail.tar.zst --clobber
