...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/pdfium/libpdfium^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/pdfium/libpdfium^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/pdfium/libpdfium^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/pdfium/libpdfium^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_pdfium.tar.zst --clobber
