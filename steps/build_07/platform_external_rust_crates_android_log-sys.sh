...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libandroid_log_sys,android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/crates/android_log-sys/libandroid_log_sys^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_log-sys/libandroid_log_sys^android_x86_64_dylib_apex10000

echo "building libandroid_log_sys^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libandroid_log_sys,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_log-sys/libandroid_log_sys^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/crates/android_log-sys/libandroid_log_sys^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_log-sys/libandroid_log_sys^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_rust_crates_android_log-sys.tar.zst --clobber
