...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/crates/libc/liblibc^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libc/liblibc^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/crates/libc/liblibc^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libc/liblibc^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_rust_crates_libc.tar.zst --clobber
