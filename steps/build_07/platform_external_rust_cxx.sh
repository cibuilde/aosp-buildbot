...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/cxx/libcxx^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/libcxx^android_x86_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/rust/cxx/libcxx^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/cxx/libcxx^android_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_rust_cxx.tar.zst --clobber
