...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/selinux/libselinux^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/selinux/libselinux^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/external/selinux/libselinux^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_recovery_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_external_selinux.tar.zst --clobber
