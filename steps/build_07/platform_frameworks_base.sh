...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/frameworks/base/libalarm_jni^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/frameworks/base/libalarm_jni^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_frameworks_base.tar.zst --clobber
