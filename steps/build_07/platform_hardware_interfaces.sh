...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.weaver-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.weaver-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/weaver/aidl/default/android.hardware.weaver-service.example^android_vendor.31_x86_64

echo "building android.hardware.vibrator-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.vibrator-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.vibrator-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/vibrator/aidl/default/android.hardware.vibrator-service.example^android_vendor.31_x86_64

echo "building android.hardware.rebootescrow-service.default^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.rebootescrow-service.default,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.rebootescrow-service.default^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/rebootescrow/aidl/default/android.hardware.rebootescrow-service.default^android_vendor.31_x86_64

echo "building android.hardware.power.stats-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.power.stats-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.power.stats-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/power/stats/aidl/default/android.hardware.power.stats-service.example^android_vendor.31_x86_64

echo "building android.hardware.power-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.power-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.power-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/power/aidl/default/android.hardware.power-service.example^android_vendor.31_x86_64

echo "building android.hardware.oemlock-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.oemlock-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.oemlock-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/oemlock/aidl/default/android.hardware.oemlock-service.example^android_vendor.31_x86_64

echo "building android.hardware.memtrack-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.memtrack-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.memtrack-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/memtrack/aidl/default/android.hardware.memtrack-service.example^android_vendor.31_x86_64

echo "building android.hardware.lights-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.lights-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.lights-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/light/aidl/default/android.hardware.lights-service.example^android_vendor.31_x86_64

echo "building android.hardware.identity-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.identity-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.identity-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/identity/aidl/default/android.hardware.identity-service.example^android_vendor.31_x86_64

echo "building android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.biometrics.fingerprint-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/biometrics/fingerprint/aidl/default/android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64

echo "building android.hardware.biometrics.face-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.biometrics.face-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.biometrics.face-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/biometrics/face/aidl/default/android.hardware.biometrics.face-service.example^android_vendor.31_x86_64

echo "building android.hardware.authsecret-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.authsecret-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.authsecret-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/authsecret/aidl/default/android.hardware.authsecret-service.example^android_vendor.31_x86_64

echo "building android.hardware.audio.common@7.0-enums^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.audio.common@7.0-enums,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.audio.common@7.0-enums^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/audio/common/7.0/android.hardware.audio.common@7.0-enums^android_x86_x86_64_shared

echo "building android.hardware.audio.common@7.0-enums^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.hardware.audio.common@7.0-enums,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/interfaces/android.hardware.audio.common@7.0-enums^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/audio/common/7.0/android.hardware.audio.common@7.0-enums^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_hardware_interfaces.tar.zst --clobber
