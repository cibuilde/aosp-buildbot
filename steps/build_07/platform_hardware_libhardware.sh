...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/hardware/libhardware/libhardware^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_hardware_libhardware.tar.zst --clobber
