...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/StatsD/libkll^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/StatsD/libkll^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libkll/libkll^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_packages_modules_StatsD.tar.zst --clobber
