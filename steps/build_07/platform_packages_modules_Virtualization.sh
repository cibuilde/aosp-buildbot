...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/Virtualization/mk_payload^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/signature/mk_payload^android_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/Virtualization/microdroid_vendor^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vendor^android_common

echo "building microdroid_vbmeta^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja microdroid_vbmeta,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vbmeta^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/Virtualization/microdroid_vbmeta^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vbmeta^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/packages/modules/Virtualization/libauthfs_crypto_bindgen^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/libauthfs_crypto_bindgen^android_x86_64_dylib_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_packages_modules_Virtualization.tar.zst --clobber
