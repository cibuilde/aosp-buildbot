...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/extras/lpmake^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpmake^linux_glibc_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/extras/libsimpleperf_profcollect_bindgen^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/libsimpleperf_profcollect_bindgen^android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/extras/iotop^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/iotop/iotop^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_system_extras.tar.zst --clobber
