...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/libhidlbase^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlbase^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/libhidlmemory^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/libhidlmemory/libhidlmemory^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/android.hidl.token@1.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/android.hidl.token@1.0^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/android.hidl.token@1.0-utils^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/token/1.0/utils/android.hidl.token@1.0-utils^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/android.hidl.safe_union@1.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/safe_union/1.0/android.hidl.safe_union@1.0^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/android.hidl.memory@1.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/1.0/android.hidl.memory@1.0^android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libhidl/android.hidl.memory.token@1.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/memory/token/1.0/android.hidl.memory.token@1.0^android_x86_64_shared_apex29

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libhidl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libhidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_system_libhidl.tar.zst --clobber
