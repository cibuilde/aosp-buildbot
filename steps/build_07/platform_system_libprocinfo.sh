...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libprocinfo/libprocinfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared

echo "building libprocinfo^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libprocinfo/libprocinfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared

echo "building libprocinfo^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared

echo "building libprocinfo^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_system_libprocinfo.tar.zst --clobber
