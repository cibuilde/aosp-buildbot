...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_system_memory_libmemunreachable.tar.zst --clobber
