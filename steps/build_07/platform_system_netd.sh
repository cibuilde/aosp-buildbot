...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/netd/netutils-wrapper-1.0^android_x86_64_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/netutils_wrappers/netutils-wrapper-1.0^android_x86_64_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/netd/libnetdutils^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/platform/system/netd/libnetdutils^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_64_shared_cfi

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 platform_system_netd.tar.zst --clobber
