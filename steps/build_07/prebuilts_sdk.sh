...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/r8/d8^linux_glibc_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.collection_collection-ktx-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.collection_collection-ktx-nodeps^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.collection_collection^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.collection_collection^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.lifecycle_lifecycle-common-java8-nodeps^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.lifecycle_lifecycle-common^android_common_apex30/ .

echo "building androidx.collection_collection-ktx^android_common"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja androidx.collection_collection-ktx,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja androidx.collection_collection-ktx,android_common_apex30
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja androidx.lifecycle_lifecycle-common-java8,android_common_apex30
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja sdk_public_30_core-for-system-modules,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja sdk_public_31_core-for-system-modules,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja sdk_system_current_android.net.ipsec.ike,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja sdk_system_current_android,android_common
