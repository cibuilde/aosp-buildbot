...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.system.keystore2-V1-ndk_platform,android_vendor.31_x86_64_shared
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja android.system.keystore2-V1-ndk_platform,android_vendor.31_x86_x86_64_shared
