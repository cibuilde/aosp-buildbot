...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libcom.android.sysprop.incremental,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/incremental_delivery/libcom.android.sysprop.incremental^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_64_static

echo "building libcom.android.sysprop.incremental^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libcom.android.sysprop.incremental,android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/incremental_delivery/libcom.android.sysprop.incremental^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 system_incremental_delivery.tar.zst --clobber
