...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libprocinfo^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building libprocinfo^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_64_shared/addition_copy_files.output

echo "building libprocinfo^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libprocinfo,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/libprocinfo/libprocinfo^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libprocinfo/libprocinfo^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 system_libprocinfo.tar.zst --clobber
