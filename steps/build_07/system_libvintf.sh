...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^linux_glibc_x86_64_static/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja libvintf,linux_glibc_x86_64_shared
