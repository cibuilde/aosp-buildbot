...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libmemunreachable,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared/addition_copy_files.output

echo "building libmemunreachable^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_07.ninja libmemunreachable,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_07/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_07 system_memory_libmemunreachable.tar.zst --clobber
