...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-api^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-api^/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_aidl_interface-V3-java-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_aidl_interface-V6-cpp-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_aidl_interface-V7-cpp-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_aidl_interface-V7-java-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_event_listener_interface-V1-cpp-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_event_listener_interface-V1-java-source,
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja netd_event_listener_interface-V1-ndk_platform-source,
