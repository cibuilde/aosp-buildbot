...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/product_sepolicy.conf^android_common/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja combine_maps,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja fc_sort,linux_glibc_x86_64_PY2
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja plat_mapping_file,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja product_sepolicy.cil,android_common
