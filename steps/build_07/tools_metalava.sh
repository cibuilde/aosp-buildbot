...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/kotlinc/kotlin-reflect^linux_glibc_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/gradle-plugin/metalava-gradle-plugin-deps^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/tools/common/m2/metalava-tools-common-m2-deps^linux_glibc_common/ .

echo "building metalava^linux_glibc_common"
ninja -f $GITHUB_WORKSPACE/steps/build_07.ninja metalava,linux_glibc_common
