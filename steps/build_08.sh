...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_05 --pattern system_libhidl.tar.zst --output system_libhidl-05.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/libhidl
tar xf $GITHUB_WORKSPACE/system_libhidl-05.tar.zst -C $GITHUB_WORKSPACE/downloads/system/libhidl/
...
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd
rsync -a -r $GITHUB_WORKSPACE/downloads/system/apex/apexd/apex_aidl_interface-java^android_common $GITHUB_WORKSPACE/artifacts/system/apex/apexd/
mkdir -p $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl
rsync -a -r $GITHUB_WORKSPACE/downloads/system/hardware/interfaces/suspend/aidl/android.system.suspend.control.internal-java^android_common $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl/
export OUT_DIR=out
...
time source steps/build_08/packages_modules_ModuleMetadata.sh
