...
echo "Preparing for external/android-clat"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja clatd,android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_android-clat.tar.zst --clobber
