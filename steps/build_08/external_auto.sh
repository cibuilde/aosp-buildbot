...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja auto_common,linux_glibc_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja auto_value_extension,linux_glibc_common
