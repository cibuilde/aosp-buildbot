...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_recovery_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_64_apex31/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bcm_object^android_x86_x86_64_apex31/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/bssl_inject_hash^linux_glibc_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++_static^android_x86_64_static_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++_static^android_x86_64_static_apex31/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++_static^android_x86_x86_64_static_apex29/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxx/libc++_static^android_x86_x86_64_static_apex31/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_recovery_x86_64_shared

echo "building libcrypto^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared

echo "building libcrypto^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex10000

echo "building libcrypto^android_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex29

echo "building libcrypto^android_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_64_shared_apex31

echo "building libcrypto^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared

echo "building libcrypto^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex10000

echo "building libcrypto^android_x86_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex29

echo "building libcrypto^android_x86_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libcrypto,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libcrypto^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libcrypto^android_x86_x86_64_shared_apex31

echo "building libssl^android_vendor.31_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libssl,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libssl^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_64_static

echo "building libssl^android_vendor.31_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libssl,android_vendor.31_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/boringssl/libssl^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_boringssl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/boringssl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_boringssl.tar.zst --clobber
