...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt-unbundled_generated_constants^/ .

echo "building conscrypt-unbundled^linux_glibc_common"
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja conscrypt-unbundled,linux_glibc_common
