...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libdrmhwc_utils,android_vendor.31_x86_64_static
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libdrmhwc_utils,android_vendor.31_x86_x86_64_static
