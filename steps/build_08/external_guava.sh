...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/guava/guava-android-host^linux_glibc_common/ .

echo "building guava^android_common"
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja guava,android_common
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja guava,android_common_apex30
