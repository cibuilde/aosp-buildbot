...
echo "Preparing for external/harfbuzz_ng"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libharfbuzz_ng,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/harfbuzz_ng/libharfbuzz_ng^android_x86_64_shared/addition_copy_files.output

echo "building libharfbuzz_ng^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libharfbuzz_ng,android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_harfbuzz_ng.tar.zst --clobber
