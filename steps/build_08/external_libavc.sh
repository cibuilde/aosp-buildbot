...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libavcdec,android_vendor.31_x86_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libavc/libavcdec^android_vendor.31_x86_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/libavc/libavcdec^android_vendor.31_x86_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/external/libavc/libavcdec^android_vendor.31_x86_x86_64_static_cfi

echo "building libavcenc^android_vendor.31_x86_x86_64_static_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libavcenc,android_vendor.31_x86_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libavc/libavcenc^android_vendor.31_x86_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/libavc/libavcenc^android_vendor.31_x86_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/external/libavc/libavcenc^android_vendor.31_x86_x86_64_static_cfi

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libavc.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libavc/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_libavc.tar.zst --clobber
