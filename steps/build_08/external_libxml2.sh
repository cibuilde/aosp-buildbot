...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_64_shared_current/ .
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_libxml2.tar.zst --clobber
