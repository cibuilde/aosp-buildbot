...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_dynamic^android_recovery_x86_64/ .
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_mksh.tar.zst --clobber
