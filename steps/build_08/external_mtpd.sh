...
echo "Preparing for external/mtpd"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja mtpd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/mtpd/mtpd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/mtpd/mtpd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/mtpd/mtpd^android_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/mtpd/mtpd^android_x86_64.output $GITHUB_WORKSPACE/artifacts/external/mtpd/mtpd^android_x86_64 $GITHUB_WORKSPACE/artifacts/external/mtpd/mtpd^android_x86_64/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_mtpd.tar.zst --clobber

du -ah -d1 external_mtpd*.tar.zst | sort -h
