...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja pppd,android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_ppp.tar.zst --clobber
