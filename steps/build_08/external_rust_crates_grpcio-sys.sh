...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libgrpc_bindgen,android_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_64_source

echo "building libgrpc_bindgen^android_x86_x86_64_source"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libgrpc_bindgen,android_x86_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_bindgen^android_x86_x86_64_source
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_rust_crates_grpcio-sys.tar.zst --clobber
