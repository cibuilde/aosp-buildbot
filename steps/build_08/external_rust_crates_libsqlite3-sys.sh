...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja sqlite3_bindgen_build,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/android/sqlite3_bindgen_build^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/libsqlite3-sys/sqlite3_bindgen_build^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libsqlite3-sys/android/sqlite3_bindgen_build^linux_glibc_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_rust_crates_libsqlite3-sys.tar.zst --clobber
