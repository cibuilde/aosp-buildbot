...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja liblog_rust,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/log/liblog_rust^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib/addition_copy_files.output

echo "building liblog_rust^android_x86_64_dylib_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja liblog_rust,android_x86_64_dylib_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/log/liblog_rust^android_x86_64_dylib_apex10000.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib_apex10000 $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib_apex10000/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_rust_crates_log.tar.zst --clobber
