...
echo "Preparing for external/rust/crates/macaddr"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libmacaddr,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/macaddr/libmacaddr^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/macaddr/libmacaddr^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/rust/crates/macaddr/libmacaddr^android_x86_64_dylib/addition_copy_files.output
