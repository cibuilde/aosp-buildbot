...
echo "Preparing for external/rust/crates/num-integer"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libnum_integer,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/rust/crates/num-integer/libnum_integer^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/num-integer/libnum_integer^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/rust/crates/num-integer/libnum_integer^android_x86_64_dylib/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 external_rust_crates_num-integer.tar.zst --clobber

du -ah -d1 external_rust_crates_num-integer*.tar.zst | sort -h
