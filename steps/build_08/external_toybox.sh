...
echo "Preparing for external/toybox"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja toybox,android_recovery_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/toybox/toybox^android_recovery_x86_64.output $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_recovery_x86_64 $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_recovery_x86_64/addition_copy_files.output

echo "building toybox^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja toybox,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/toybox/toybox^android_x86_64.output $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_x86_64 $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_x86_64/addition_copy_files.output

echo "building toybox_vendor^android_vendor.31_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja toybox_vendor,android_vendor.31_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/external/toybox/toybox_vendor^android_vendor.31_x86_64.output $GITHUB_WORKSPACE/artifacts/external/toybox/toybox_vendor^android_vendor.31_x86_64 $GITHUB_WORKSPACE/artifacts/external/toybox/toybox_vendor^android_vendor.31_x86_64/addition_copy_files.output
