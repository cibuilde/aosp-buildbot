...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatslog,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatslog,android_x86_x86_64_static
