...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/nanopb-c/generator/protoc-gen-nanopb^linux_glibc_x86_64_PY2/ .
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja librilutils,android_vendor.31_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja librilutils,android_vendor.31_x86_x86_64_static
