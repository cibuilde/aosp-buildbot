...
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/statsd/statslog_statsd.cpp^/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatslog_statsd,android_x86_64_static_com.android.os.statsd
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/packages/modules/StatsD/libstatslog_statsd^android_x86_64_static_com.android.os.statsd.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/statsd/libstatslog_statsd^android_x86_64_static_com.android.os.statsd

echo "building libstatssocket^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatssocket,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/packages/modules/StatsD/libstatssocket^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared

echo "building libstatssocket^android_x86_64_shared_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatssocket,android_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/packages/modules/StatsD/libstatssocket^android_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_64_shared_apex30

echo "building libstatssocket^android_x86_x86_64_shared_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatssocket,android_x86_x86_64_shared_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/packages/modules/StatsD/libstatssocket^android_x86_x86_64_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatssocket/libstatssocket^android_x86_x86_64_shared_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf packages_modules_StatsD.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 packages_modules_StatsD.tar.zst --clobber
