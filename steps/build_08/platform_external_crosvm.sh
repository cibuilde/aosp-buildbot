...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libtempfile^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libtempfile^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libsys_util^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/sys_util/libsys_util^android_x86_64_rlib_rlib-std_apex10000

echo "building libio_uring^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libio_uring,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/io_uring/libio_uring^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libio_uring^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/io_uring/libio_uring^android_x86_64_rlib_rlib-std_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libdata_model^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/crosvm/libdata_model^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_crosvm.tar.zst --clobber
