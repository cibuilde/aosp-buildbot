...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libchrome,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/libchrome/libchrome^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_x86_64_shared

echo "building libchrome^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libchrome,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/libchrome/libchrome^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libchrome/libchrome^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_libchrome.tar.zst --clobber
