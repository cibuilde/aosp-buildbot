...
echo "building libminigbm_gralloc^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libminigbm_gralloc,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_x86_64_shared

echo "building libminigbm_gralloc^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libminigbm_gralloc,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_minigbm.tar.zst --clobber
