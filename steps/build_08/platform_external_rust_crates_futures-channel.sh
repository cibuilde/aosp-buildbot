...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfutures_channel,android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/futures-channel/libfutures_channel^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-channel/libfutures_channel^android_x86_64_dylib_apex10000

echo "building libfutures_channel^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfutures_channel,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-channel/libfutures_channel^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/futures-channel/libfutures_channel^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-channel/libfutures_channel^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_rust_crates_futures-channel.tar.zst --clobber
