...
echo "building libgetrandom^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libgetrandom,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/getrandom/libgetrandom^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/getrandom/libgetrandom^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/getrandom/libgetrandom^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_rust_crates_getrandom.tar.zst --clobber
