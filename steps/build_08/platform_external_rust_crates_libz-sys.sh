...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/libz-sys/liblibz_sys^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/libz-sys/liblibz_sys^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_rust_crates_libz-sys.tar.zst --clobber
