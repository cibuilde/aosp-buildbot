...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/log/liblog_rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/external/rust/crates/log/liblog_rust^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/log/liblog_rust^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_external_rust_crates_log.tar.zst --clobber
