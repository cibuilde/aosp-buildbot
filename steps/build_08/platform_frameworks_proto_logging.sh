...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatslog,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/frameworks/proto_logging/libstatslog^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_x86_64_shared

echo "building libstatslog^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libstatslog,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/frameworks/proto_logging/libstatslog^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/stats_log_api_gen/libstatslog^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_frameworks_proto_logging.tar.zst --clobber
