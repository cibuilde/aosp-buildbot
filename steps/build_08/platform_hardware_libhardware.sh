...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/local_time.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/local_time/local_time.default^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/local_time.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/local_time/local_time.default^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/libhardware^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/libhardware^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/libhardware^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/libhardware^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/hardware/libhardware/libhardware^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_recovery_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_hardware_libhardware.tar.zst --clobber
