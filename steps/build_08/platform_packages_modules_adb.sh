...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/minijail/libminijail^android_recovery_x86_64_static/ .
...
echo "building adbd^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja adbd,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/adb/adbd^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/packages/modules/adb/adbd^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/adb/adbd^android_recovery_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_packages_modules_adb.tar.zst --clobber
