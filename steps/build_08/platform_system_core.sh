...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/run-as^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/run-as/run-as^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libutilscallstack^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libutilscallstack^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libutilscallstack^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libutilscallstack^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libdebuggerd_client^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/libdebuggerd_client^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/core/debuggerd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/debuggerd^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_core.tar.zst --clobber
