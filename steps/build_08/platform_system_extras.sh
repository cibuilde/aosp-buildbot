...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/simpleperf_app_runner^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/simpleperf_app_runner/simpleperf_app_runner^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/simpleperf^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/simpleperf^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/preopt2cachename^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/preopt2cachename/preopt2cachename^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libsquashfs_utils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/squashfs_utils/libsquashfs_utils^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libsquashfs_utils^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/squashfs_utils/libsquashfs_utils^android_recovery_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libsimpleperf_profcollect^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/libsimpleperf_profcollect^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libsimpleperf_profcollect_rust^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/simpleperf/libsimpleperf_profcollect_rust^android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libfec^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/libfec/libfec^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libf2fs_sparseblock^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/f2fs_utils/libf2fs_sparseblock^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libext4_utils^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/ext4_utils/libext4_utils^android_recovery_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libfec^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/libfec/libfec^android_recovery_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/extras/libext4_utils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/ext4_utils/libext4_utils^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_extras.tar.zst --clobber
