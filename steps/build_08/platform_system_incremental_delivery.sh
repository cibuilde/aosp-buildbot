...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/incremental_delivery/libincfs^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/incremental_delivery/libincfs^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/incremental_delivery/libdataloader^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/incremental_delivery/libdataloader^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_incremental_delivery.tar.zst --clobber
