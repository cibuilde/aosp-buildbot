...
clone_depth_platform platform/system/libartpalette
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libartpalette/libartpalette-system^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libartpalette/libartpalette-system^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libartpalette.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libartpalette/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_libartpalette.tar.zst --clobber

du -ah -d1 platform_system_libartpalette*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_libartpalette.tar.zst" ]; then
  echo "Compressing platform/system/libartpalette -> platform_system_libartpalette.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_libartpalette.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/libartpalette/ .
fi
