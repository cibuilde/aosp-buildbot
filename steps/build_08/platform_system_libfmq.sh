...
clone_depth_platform platform/system/libfmq
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libfmq/libfmq^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libfmq/libfmq^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libfmq/libfmq^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libfmq/libfmq^android_x86_x86_64_static/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfmq,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libfmq/libfmq^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_x86_x86_64_shared

echo "building libfmq^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfmq,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libfmq/libfmq^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_x86_64_shared

echo "building libfmq^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfmq,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libfmq/libfmq^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_vendor.31_x86_x86_64_shared

echo "building libfmq^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libfmq,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libfmq/libfmq^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libfmq/libfmq^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libfmq.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libfmq/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_libfmq.tar.zst --clobber

du -ah -d1 platform_system_libfmq*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_libfmq.tar.zst" ]; then
  echo "Compressing platform/system/libfmq -> platform_system_libfmq.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_libfmq.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/libfmq/ .
fi
