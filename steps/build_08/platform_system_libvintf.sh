...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libvintf,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libvintf/libvintf^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared

echo "building libvintf^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libvintf,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/libvintf/libvintf^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_libvintf.tar.zst --clobber
