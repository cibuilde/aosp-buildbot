...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/logwrapper_vendor^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper_vendor^android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/logwrapper^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/logd^android_x86_64_cfi.output . $GITHUB_WORKSPACE/artifacts/system/logging/logd/logd^android_x86_64_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/logcat^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logcat/logcat^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/liblogwrap^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/liblogwrap^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/logging/liblogwrap^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_recovery_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_logging.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/logging/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_logging.tar.zst --clobber
