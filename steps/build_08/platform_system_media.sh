...
clone_depth_platform platform/system/media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libradio_metadata^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libradio_metadata^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libradio_metadata^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libradio_metadata^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioutils^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioutils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioutils^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioutils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudiospdif^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudiospdif^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioroute^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/media/libaudioroute^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_media.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/media/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_media.tar.zst --clobber

du -ah -d1 platform_system_media*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_media.tar.zst" ]; then
  echo "Compressing platform/system/media -> platform_system_media.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_media.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/media/ .
fi
