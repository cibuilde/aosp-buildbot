...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/libmeminfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/showmap^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/showmap^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/procrank^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/procrank^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/librank^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/librank^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/libmeminfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_memory_libmeminfo.tar.zst --clobber
