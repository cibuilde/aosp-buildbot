...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/memory/lmkd/libstatslogc^android_x86_64_static/ .

echo "building lmkd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja lmkd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/lmkd/lmkd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/platform/system/memory/lmkd/lmkd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/lmkd/lmkd^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 platform_system_memory_lmkd.tar.zst --clobber
