...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/libutils/libutilscallstack^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/libutils/libutilscallstack^android_x86_x86_64_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libdebuggerd_client,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/core/libdebuggerd_client^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libdebuggerd_client^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_64_shared/addition_copy_files.output

echo "building libdebuggerd_client^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libdebuggerd_client,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libdebuggerd_client^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/libdebuggerd_client^android_x86_x86_64_shared/addition_copy_files.output

echo "building debuggerd^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja debuggerd,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/debuggerd^android_x86_64.output $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/debuggerd^android_x86_64 $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/debuggerd^android_x86_64/addition_copy_files.output

echo "building libutilscallstack^android_vendor.31_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libutilscallstack,android_vendor.31_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libutilscallstack^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libutilscallstack^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libutilscallstack,android_vendor.31_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libutilscallstack^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building libutilscallstack^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libutilscallstack,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libutilscallstack^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_64_shared/addition_copy_files.output

echo "building libutilscallstack^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libutilscallstack,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/libutilscallstack^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_x86_x86_64_shared/addition_copy_files.output

echo "building run-as^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja run-as,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/core/run-as^android_x86_64.output $GITHUB_WORKSPACE/artifacts/system/core/run-as/run-as^android_x86_64 $GITHUB_WORKSPACE/artifacts/system/core/run-as/run-as^android_x86_64/addition_copy_files.output
