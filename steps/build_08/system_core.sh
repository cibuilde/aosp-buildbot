...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/init/sysprop/com.android.sysprop.init_sysprop_library^/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja com.android.sysprop.init_java_gen,
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/init/sysprop/com.android.sysprop.init_java_gen^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/core/com.android.sysprop.init_java_gen^.output . $GITHUB_WORKSPACE/artifacts/system/core/init/sysprop/com.android.sysprop.init_java_gen^
