...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/sysprop/libcom.android.sysprop.incremental^android_x86_x86_64_static/ .

echo "building libincfs^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libincfs,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/incremental_delivery/libincfs^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_static

echo "building libincfs^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libincfs,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/incremental_delivery/libincfs^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 system_incremental_delivery.tar.zst --clobber
