...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja libincfs,android_x86_64_static
...
ninja -f $GITHUB_WORKSPACE/steps/build_08.ninja libincfs,android_x86_x86_64_static
