...
echo "Preparing for system/libartpalette"
...
clone_depth_platform system/libartpalette
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/debuggerd/libtombstoned_client^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/core/debuggerd/libtombstoned_client^android_x86_x86_64_shared/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libartpalette-system,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/libartpalette/libartpalette-system^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_64_shared/addition_copy_files.output

echo "building libartpalette-system^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libartpalette-system,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/libartpalette/libartpalette-system^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libartpalette/libartpalette-system^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 system_libartpalette.tar.zst --clobber

du -ah -d1 system_libartpalette*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/system_libartpalette.tar.zst" ]; then
  echo "Compressing system/libartpalette -> system_libartpalette.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/system_libartpalette.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/system/libartpalette/ .
fi
