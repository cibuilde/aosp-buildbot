...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/libvintf/libassemblevintf^linux_glibc_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/test/vts-testcase/hal/treble/vintf/libvts_vintf_test_common/libvts_vintf_test_common^linux_glibc_x86_64_static/ .

echo "building assemble_vintf^linux_glibc_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja assemble_vintf,linux_glibc_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/assemble_vintf^linux_glibc_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/libvintf/assemble_vintf^linux_glibc_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/assemble_vintf^linux_glibc_x86_64
