...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libvintf/libvintf^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/libvintf/libvintf^android_x86_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/tools/hidl/utils/libhidl-gen-utils^android_x86_x86_64_shared/ .

echo "building libvintf^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libvintf,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/libvintf/libvintf^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/libvintf/libvintf^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared/addition_copy_files.output

echo "building libvintf^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libvintf,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/libvintf/libvintf^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_08/system/libvintf/libvintf^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_08 system_libvintf.tar.zst --clobber
