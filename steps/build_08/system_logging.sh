...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja liblog_event_list_bindgen,android_x86_64_source
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog_event_list_bindgen^android_x86_64_source
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/logging/liblog_event_list_bindgen^android_x86_64_source.output . $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog_event_list_bindgen^android_x86_64_source
