...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libdmabufinfo,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libdmabufinfo/libdmabufinfo^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/memory/libmeminfo/libdmabufinfo^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libdmabufinfo/libdmabufinfo^android_vendor.31_x86_64_static

echo "building libmeminfo^android_vendor.31_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_08.ninja libmeminfo,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_08/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_static
