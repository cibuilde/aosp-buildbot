...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_vendor_ramdisk_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_vendor_ramdisk_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/libc^android_recovery_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/libc^android_vendor_ramdisk_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/libc^android_x86_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/libc^android_x86_x86_64_shared_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libm/libm.x86.map^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libm/libm.x86_64.map^/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtbrand,android_x86_64_sdk_21
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_21
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtbrand^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_21

echo "building crtbrand^android_x86_64_sdk_29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtbrand,android_x86_64_sdk_29
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtbrand^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29

echo "building crtbrand^android_x86_64_sdk_29_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtbrand,android_x86_64_sdk_29_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtbrand^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_29_apex30

echo "building crtbrand^android_x86_64_sdk_30_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtbrand,android_x86_64_sdk_30_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_30_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtbrand^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbrand^android_x86_64_sdk_30_apex30

echo "building crtend_so^android_x86_64_sdk_21"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtend_so,android_x86_64_sdk_21
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_21
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtend_so^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_21

echo "building crtend_so^android_x86_64_sdk_29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtend_so,android_x86_64_sdk_29
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtend_so^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29

echo "building crtend_so^android_x86_64_sdk_29_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtend_so,android_x86_64_sdk_29_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtend_so^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_29_apex30

echo "building crtend_so^android_x86_64_sdk_30_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja crtend_so,android_x86_64_sdk_30_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_30_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/crtend_so^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_so^android_x86_64_sdk_30_apex30

echo "building libm^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_recovery_x86_64_shared

echo "building libm^android_vendor_ramdisk_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_vendor_ramdisk_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_vendor_ramdisk_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_vendor_ramdisk_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_vendor_ramdisk_x86_64_shared

echo "building libm^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_shared

echo "building libm^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_64_shared_apex10000

echo "building libm^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_shared

echo "building libm^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libm,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/bionic/libm^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libm/libm^android_x86_x86_64_shared_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf bionic.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/bionic/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 bionic.tar.zst --clobber
