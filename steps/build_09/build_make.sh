...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/bouncycastle/bouncycastle-bcpkix-unbundled^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/bouncycastle/bouncycastle-unbundled^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt-unbundled^linux_glibc_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/tools/apksig/apksig^linux_glibc_common/ .
