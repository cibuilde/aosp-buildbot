...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/bcc/libbpf^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/bcc/libbpf^android_x86_x86_64_static/ .
