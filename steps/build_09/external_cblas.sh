...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/eigen/blas/libF77blas^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/eigen/blas/libF77blas^android_x86_x86_64_static/ .
