...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/flatbuffers/libflatbuffers-cpp^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/flatbuffers/libflatbuffers-cpp^android_x86_x86_64_static/ .
