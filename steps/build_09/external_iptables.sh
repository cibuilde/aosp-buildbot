...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/extensions/libext4^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/extensions/libext6^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/extensions/libext^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/libiptc/libip4tc^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/libiptc/libip6tc^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/iptables/libxtables/libxtables^android_x86_64_static/ .
