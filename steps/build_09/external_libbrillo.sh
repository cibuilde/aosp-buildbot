...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbrillo,android_x86_64_shared
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbrillo-binder,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/external/libbrillo/libbrillo-binder^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-binder^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-binder^android_x86_64_shared/addition_copy_files.output

echo "building libbrillo-stream^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbrillo-stream,android_x86_64_shared
