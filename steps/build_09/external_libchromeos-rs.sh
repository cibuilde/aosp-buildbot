...
echo "entering external/libchromeos-rs"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja liblibchromeos,android_x86_64_rlib_rlib-std_apex10000
