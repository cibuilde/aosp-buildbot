...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_x86_64_static/ .

echo "building libjpeg^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libjpeg,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/libjpeg-turbo/libjpeg^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_64_shared

echo "building libjpeg^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libjpeg,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared

echo "building libjpeg_static_ndk^android_x86_64_sdk_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libjpeg_static_ndk,android_x86_64_sdk_static
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg_static_ndk^android_x86_64_sdk_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/libjpeg-turbo/libjpeg_static_ndk^android_x86_64_sdk_static.output . $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg_static_ndk^android_x86_64_sdk_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libjpeg-turbo.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 external_libjpeg-turbo.tar.zst --clobber
