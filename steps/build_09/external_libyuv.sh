...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libyuv/files/libyuv^android_vendor.31_x86_x86_64_static/ .
