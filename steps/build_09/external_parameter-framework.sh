...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_static/ .

echo "building libremote-processor^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libremote-processor,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/parameter-framework/libremote-processor^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_shared

echo "building libremote-processor^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libremote-processor,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/parameter-framework/libremote-processor^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 external_parameter-framework.tar.zst --clobber
