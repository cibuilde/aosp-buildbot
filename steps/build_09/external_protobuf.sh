...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libprotobuf-cpp-full,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000

echo "building libprotobuf-cpp-lite^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libprotobuf-cpp-lite,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-lite^android_x86_64_shared_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_protobuf.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/protobuf/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 external_protobuf.tar.zst --clobber
