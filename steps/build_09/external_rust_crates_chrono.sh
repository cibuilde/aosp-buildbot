...
echo "Preparing for external/rust/crates/chrono"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libchrono,android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 external_rust_crates_chrono.tar.zst --clobber
