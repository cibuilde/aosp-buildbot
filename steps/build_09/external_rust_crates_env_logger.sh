...
echo "entering external/rust/crates/env_logger"
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libenv_logger,android_x86_64_dylib
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libenv_logger,android_x86_64_dylib_apex10000
