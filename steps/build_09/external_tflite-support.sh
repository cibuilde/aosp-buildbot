...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/tflite-support/tflite_support_spm_config^/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/tflite-support/tflite_support_spm_encoder_config^/ .

echo "building tflite_support^android_x86_64_sdk_static_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja tflite_support,android_x86_64_sdk_static_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tflite-support/tflite_support^android_x86_64_sdk_static_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/external/tflite-support/tflite_support^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/external/tflite-support/tflite_support^android_x86_64_sdk_static_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_tflite-support.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/tflite-support/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 external_tflite-support.tar.zst --clobber
