...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnetjniutils,android_x86_64_sdk_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/frameworks/libs/net/libnetjniutils^android_x86_64_sdk_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/libs/net/common/native/netjniutils/libnetjniutils^android_x86_64_sdk_static

echo "building libnetjniutils^android_x86_64_sdk_static_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnetjniutils,android_x86_64_sdk_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/frameworks/libs/net/libnetjniutils^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/libs/net/common/native/netjniutils/libnetjniutils^android_x86_64_sdk_static_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_libs_net.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/libs/net/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 frameworks_libs_net.tar.zst --clobber
