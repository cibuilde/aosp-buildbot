...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/minikin/libs/minikin/libminikin^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/logging/liblog/liblog^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/logging/liblog/liblog^android_x86_x86_64_shared/ .

echo "building libminikin^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libminikin,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/frameworks/minikin/libminikin^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_64_shared/addition_copy_files.output

echo "building libminikin^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libminikin,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/frameworks/minikin/libminikin^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_shared/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 frameworks_minikin.tar.zst --clobber
