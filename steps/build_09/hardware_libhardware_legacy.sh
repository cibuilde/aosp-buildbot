...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libpower,android_vendor.31_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static.output $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static/addition_copy_files.output

echo "building libpower^android_vendor.31_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libpower,android_vendor.31_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static/addition_copy_files.output

echo "building libpower^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libpower,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/hardware/libhardware_legacy/libpower^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_64_static $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_64_static/addition_copy_files.output

echo "building libpower^android_x86_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libpower,android_x86_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/hardware/libhardware_legacy/libpower^android_x86_x86_64_static.output $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_x86_64_static $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 hardware_libhardware_legacy.tar.zst --clobber
