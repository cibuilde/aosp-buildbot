...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnativehelper_compat_libc++,android_x86_64_sdk_static
mkdir -p $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static.output . $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static

echo "building libnativehelper_compat_libc++^android_x86_64_sdk_static_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnativehelper_compat_libc++,android_x86_64_sdk_static_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_static_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf libnativehelper.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/libnativehelper/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 libnativehelper.tar.zst --clobber
