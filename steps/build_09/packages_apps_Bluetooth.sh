...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbluetooth_jni,android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 packages_apps_Bluetooth.tar.zst --clobber
