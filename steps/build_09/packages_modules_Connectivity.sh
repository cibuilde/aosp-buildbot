...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libtetherutilsjni,android_x86_64_sdk_static_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/packages/modules/Connectivity/libtetherutilsjni^android_x86_64_sdk_static_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/libtetherutilsjni^android_x86_64_sdk_static_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 packages_modules_Connectivity.tar.zst --clobber
