...
rsync -a -r $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V9-ndk_platform^android_x86_64_static_cfi_com.android.resolv/ .
