...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja dnsresolver_aidl_interface-V7-cpp,android_x86_64_static
