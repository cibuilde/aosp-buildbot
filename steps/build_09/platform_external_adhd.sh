...
clone_depth_platform platform/external/adhd
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libaudio_streams,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/adhd/audio_streams/libaudio_streams^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/adhd/libaudio_streams^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/adhd/audio_streams/libaudio_streams^android_x86_64_rlib_rlib-std_apex10000

echo "building libcras_sys^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libcras_sys,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/cras-sys/libcras_sys^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/adhd/libcras_sys^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/cras-sys/libcras_sys^android_x86_64_rlib_rlib-std_apex10000

echo "building liblibcras^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja liblibcras,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/libcras/liblibcras^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/adhd/liblibcras^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/libcras/liblibcras^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_adhd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/adhd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_external_adhd.tar.zst --clobber

du -ah -d1 platform_external_adhd*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_adhd.tar.zst" ]; then
  echo "Compressing platform/external/adhd -> platform_external_adhd.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_adhd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/adhd/ .
fi
