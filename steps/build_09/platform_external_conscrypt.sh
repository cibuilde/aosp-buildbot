...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja conscrypt.module.intra.core.api.stubs.source,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt.module.intra.core.api.stubs.source^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/conscrypt/conscrypt.module.intra.core.api.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt.module.intra.core.api.stubs.source^android_common

echo "building conscrypt.module.intra.core.api.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja conscrypt.module.intra.core.api.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt.module.intra.core.api.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/conscrypt/conscrypt.module.intra.core.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/conscrypt.module.intra.core.api.stubs^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_external_conscrypt.tar.zst --clobber
