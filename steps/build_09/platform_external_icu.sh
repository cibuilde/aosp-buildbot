...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja i18n.module.intra.core.api.stubs.source,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/i18n.module.intra.core.api.stubs.source^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/icu/i18n.module.intra.core.api.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/i18n.module.intra.core.api.stubs.source^android_common

echo "building i18n.module.intra.core.api.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja i18n.module.intra.core.api.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/i18n.module.intra.core.api.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/icu/i18n.module.intra.core.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/i18n.module.intra.core.api.stubs^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_external_icu.tar.zst --clobber
