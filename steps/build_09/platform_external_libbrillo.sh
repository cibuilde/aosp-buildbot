...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/libbrillo/libbrillo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/libbrillo/libbrillo-stream^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-stream^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/libbrillo/libbrillo-binder^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libbrillo/libbrillo-binder^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_external_libbrillo.tar.zst --clobber
