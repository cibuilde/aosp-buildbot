...
clone_depth_platform platform/external/rust/crates/grpcio
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libgrpcio,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio/libgrpcio^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/rust/crates/grpcio/libgrpcio^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio/libgrpcio^android_x86_x86_64_rlib_rlib-std

echo "building libgrpcio^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libgrpcio,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio/libgrpcio^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/external/rust/crates/grpcio/libgrpcio^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio/libgrpcio^android_x86_64_rlib_rlib-std

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_rust_crates_grpcio.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/rust/crates/grpcio/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_external_rust_crates_grpcio.tar.zst --clobber

du -ah -d1 platform_external_rust_crates_grpcio*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_rust_crates_grpcio.tar.zst" ]; then
  echo "Compressing platform/external/rust/crates/grpcio -> platform_external_rust_crates_grpcio.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_rust_crates_grpcio.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/rust/crates/grpcio/ .
fi
