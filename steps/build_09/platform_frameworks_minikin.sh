...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/minikin/libminikin^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/minikin/libminikin^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_frameworks_minikin.tar.zst --clobber
