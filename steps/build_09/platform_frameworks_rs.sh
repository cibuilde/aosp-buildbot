...
clone_depth_platform platform/frameworks/rs
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libRS_internal,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRS_internal^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRS_internal^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRSCpuRef^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRSDriver^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRSCpuRef^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_64_shared

echo "building libRSDriver^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libRSDriver,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_frameworks_rs.tar.zst --clobber

du -ah -d1 platform_frameworks_rs*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_frameworks_rs.tar.zst" ]; then
  echo "Compressing platform/frameworks/rs -> platform_frameworks_rs.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/frameworks/rs/ .
fi
