...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/hardware/libhardware_legacy/libpower^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/hardware/libhardware_legacy/libpower^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_hardware_libhardware_legacy.tar.zst --clobber
