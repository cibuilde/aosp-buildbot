...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libneuralnetworks_packageinfo,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/NeuralNetworks/libneuralnetworks_packageinfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/runtime/packageinfo/libneuralnetworks_packageinfo^android_x86_x86_64_shared

echo "building libneuralnetworks_packageinfo^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libneuralnetworks_packageinfo,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/NeuralNetworks/libneuralnetworks_packageinfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/runtime/packageinfo/libneuralnetworks_packageinfo^android_x86_64_shared

echo "building android.hardware.neuralnetworks-shim-service-sample^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja android.hardware.neuralnetworks-shim-service-sample,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-shim-service-sample^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_shim/android.hardware.neuralnetworks-shim-service-sample^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_packages_modules_NeuralNetworks.tar.zst --clobber
