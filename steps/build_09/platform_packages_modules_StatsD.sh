...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libstatspull,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/StatsD/libstatspull^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/StatsD/lib/libstatspull/libstatspull^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_packages_modules_StatsD.tar.zst --clobber
