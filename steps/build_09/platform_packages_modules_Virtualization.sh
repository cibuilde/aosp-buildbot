...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/Virtualization/android.system.virtmanager-rust^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/virtmanager/aidl/android.system.virtmanager-rust^android_x86_64_rlib_rlib-std_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/Virtualization/virtmanager^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/virtmanager/virtmanager^android_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/Virtualization/authfs_aidl_interface-rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/aidl/authfs_aidl_interface-rust^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/packages/modules/Virtualization/android.system.virtmanager-rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/virtmanager/aidl/android.system.virtmanager-rust^android_x86_64_dylib_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_packages_modules_Virtualization.tar.zst --clobber
