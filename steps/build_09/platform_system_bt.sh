...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbtif,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/bt/libbtif^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_x86_64_static

echo "building libbtif^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbtif,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/bt/libbtif^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_bt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/bt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_bt.tar.zst --clobber
