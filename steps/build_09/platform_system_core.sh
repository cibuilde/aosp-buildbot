...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libstoraged,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/storaged/libstoraged^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libstoraged^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/storaged/libstoraged^android_x86_64_static

echo "building libsnapshot^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libsnapshot,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libsnapshot/libsnapshot^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libsnapshot^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libsnapshot/libsnapshot^android_x86_64_static

echo "building liblp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja liblp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/liblp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_x86_64_shared

echo "building liblp^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja liblp,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/liblp^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_recovery_x86_64_shared

echo "building libgatekeeper_aidl^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libgatekeeper_aidl,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/gatekeeperd/libgatekeeper_aidl^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libgatekeeper_aidl^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/gatekeeperd/libgatekeeper_aidl^android_x86_64_shared

echo "building libfs_mgr^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libfs_mgr,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libfs_mgr^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr^android_x86_64_shared

echo "building libfs_mgr^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libfs_mgr,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libfs_mgr^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr^android_recovery_x86_64_shared

echo "building libbinderwrapper^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libbinderwrapper,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libbinderwrapper/libbinderwrapper^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/libbinderwrapper^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libbinderwrapper/libbinderwrapper^android_x86_64_shared

echo "building init_second_stage^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja init_second_stage,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/init/init_second_stage^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/init_second_stage^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/init/init_second_stage^android_x86_64

echo "building init_second_stage^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja init_second_stage,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/init/init_second_stage^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/init_second_stage^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/init/init_second_stage^android_recovery_x86_64

echo "building bootstat^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja bootstat,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/bootstat/bootstat^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/core/bootstat^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/bootstat/bootstat^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_core.tar.zst --clobber
