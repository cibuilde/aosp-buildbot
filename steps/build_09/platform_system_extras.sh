...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/extras/profcollectd_aidl_interface-rust^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/profcollectd_aidl_interface-rust^android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/extras/libprofcollect_libflags_rust^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libflags/libprofcollect_libflags_rust^android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/extras/libprofcollect_libbase_rust^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libbase/libprofcollect_libbase_rust^android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/extras/liblpdump_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/aidl/liblpdump_interface-cpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/extras/liblpdump_interface-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/aidl/liblpdump_interface-cpp^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_extras.tar.zst --clobber
