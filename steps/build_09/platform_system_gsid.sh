...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libgsid,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/gsid/libgsid^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static

echo "building gsi_tool^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_tool,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/gsid/gsi_tool^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64

echo "building gsi_aidl_interface-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_aidl_interface-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static

echo "building gsi_aidl_interface-cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_aidl_interface-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_gsid.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/gsid/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_gsid.tar.zst --clobber
