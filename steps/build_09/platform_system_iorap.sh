...
clone_depth_platform platform/system/iorap
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libiorap-binder,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-binder^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-binder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-binder^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-serialize^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-serialize^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-prefetcher^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-prefetcher^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-perfetto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-perfetto^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-manager^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-manager^android_x86_64_static

echo "building libiorap-maintenance^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libiorap-maintenance,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-maintenance^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-maintenance^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-maintenance^android_x86_64_static

echo "building libiorap-inode2filename^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libiorap-inode2filename,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-inode2filename^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-inode2filename^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-inode2filename^android_x86_64_static

echo "building libiorap-db^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libiorap-db,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-db^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-db^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-db^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/libiorap-compiler^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-compiler^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/iorapd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorapd^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/iorap.prefetcherd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.prefetcherd^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/iorap.inode2filename^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.inode2filename^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/iorap.cmd.maintenance^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.maintenance^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/iorap/iorap.cmd.compiler^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.compiler^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_iorap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/iorap/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_iorap.tar.zst --clobber

du -ah -d1 platform_system_iorap*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_iorap.tar.zst" ]; then
  echo "Compressing platform/system/iorap -> platform_system_iorap.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_iorap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/iorap/ .
fi
