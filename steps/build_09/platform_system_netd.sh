...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/netd/libnetdbpf/libnetdbpf^android_x86_64_static_cfi/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/oemnetd_aidl_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/oemnetd_aidl_interface-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_event_listener_interface-V1-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_event_listener_interface-V1-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_aidl_interface-V7-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_aidl_interface-V7-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_aidl_interface-V6-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/netd_aidl_interface-V6-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/libnetdbpf^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/libnetdbpf^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/platform/system/netd/libnetd_server^android_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/libnetd_server^android_x86_64_static_cfi

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 platform_system_netd.tar.zst --clobber
...
if [ ! -f "$GITHUB_WORKSPACE/cache/external_libpcap.tar.zst" ]; then
  echo "Compressing external/libpcap -> external_libpcap.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/external_libpcap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/external/libpcap/ .
fi
