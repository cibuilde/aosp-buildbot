...
rsync -a -r $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.room_room-compiler-processing-nodeps^linux_glibc_common/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja androidx.room_room-compiler-processing,linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/prebuilts/sdk/androidx.room_room-compiler-processing^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/current/androidx/androidx.room_room-compiler-processing^linux_glibc_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf prebuilts_sdk.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/prebuilts/sdk/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 prebuilts_sdk.tar.zst --clobber
