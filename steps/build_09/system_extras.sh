...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja schedtest,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/extras/tests/schedtest/schedtest^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/system/extras/schedtest^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/tests/schedtest/schedtest^android_x86_64
