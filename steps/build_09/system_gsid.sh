...
echo "Preparing for system/gsid"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_aidl_interface-cpp,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_shared/addition_copy_files.output

echo "building gsi_aidl_interface-cpp^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_aidl_interface-cpp,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static/addition_copy_files.output

echo "building gsi_tool^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja gsi_tool,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/system/gsid/gsi_tool^android_x86_64.output $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64 $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64/addition_copy_files.output

echo "building libgsid^android_x86_64_static"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libgsid,android_x86_64_static
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_09/system/gsid/libgsid^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 system_gsid.tar.zst --clobber
