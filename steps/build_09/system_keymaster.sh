...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libkeymaster_messages,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_messages^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/system/keymaster/libkeymaster_messages^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_messages^android_x86_64_shared
