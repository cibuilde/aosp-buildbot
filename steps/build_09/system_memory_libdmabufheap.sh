...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_x86_64_static_apex29/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_static_apex29/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libdmabufheap,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared_apex29
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_09 system_memory_libdmabufheap.tar.zst --clobber
