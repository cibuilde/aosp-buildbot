...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_64_static_cfi/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_x86_64_static_cfi/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-ndk_platform^android_x86_64_static_cfi_com.android.resolv/ .

echo "building libnetd_client^android_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnetd_client,android_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/system/netd/libnetd_client^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_64_shared_cfi

echo "building libnetd_client^android_x86_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja libnetd_client,android_x86_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/system/netd/libnetd_client^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/client/libnetd_client^android_x86_x86_64_shared_cfi

echo "building netd_event_listener_interface-lateststable-ndk_platform^android_x86_64_static_cfi_com.android.resolv"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja netd_event_listener_interface-lateststable-ndk_platform,android_x86_64_static_cfi_com.android.resolv
