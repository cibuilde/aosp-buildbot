...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.cil.raw^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/plat_29.0.cil^android_common/ .
