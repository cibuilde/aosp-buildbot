...
rsync -a -r $GITHUB_WORKSPACE/artifacts/tools/platform-compat/java/android/processor/compat/compat-processor^linux_glibc_common/ .

echo "building compat-changeid-annotation-processor-lib^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja compat-changeid-annotation-processor-lib,linux_glibc_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_09/tools/platform-compat/compat-changeid-annotation-processor-lib^linux_glibc_common.output . $GITHUB_WORKSPACE/artifacts/tools/platform-compat/java/android/processor/compat/changeid/compat-changeid-annotation-processor-lib^linux_glibc_common

echo "building unsupportedappusage-annotation-processor-lib^linux_glibc_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_09.ninja unsupportedappusage-annotation-processor-lib,linux_glibc_common
