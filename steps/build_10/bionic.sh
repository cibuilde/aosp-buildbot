...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/crtbegin_so^android_x86_64_sdk_21.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_21

echo "building crtbegin_so^android_x86_64_sdk_29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja crtbegin_so,android_x86_64_sdk_29
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/crtbegin_so^android_x86_64_sdk_29.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29

echo "building crtbegin_so^android_x86_64_sdk_29_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja crtbegin_so,android_x86_64_sdk_29_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/crtbegin_so^android_x86_64_sdk_29_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_29_apex30

echo "building crtbegin_so^android_x86_64_sdk_30_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja crtbegin_so,android_x86_64_sdk_30_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_30_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/crtbegin_so^android_x86_64_sdk_30_apex30.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_sdk_30_apex30

echo "building libc_malloc_hooks^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libc_malloc_hooks,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/libc_malloc_hooks^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_64_shared_apex10000

echo "building libc_malloc_hooks^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libc_malloc_hooks,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/bionic/libc_malloc_hooks^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/bionic/libc/malloc_hooks/libc_malloc_hooks^android_x86_x86_64_shared_apex10000
