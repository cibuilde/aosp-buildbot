...
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_dynamic^android_product.31_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtbegin_so^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/bionic/libc/crtend_android^android_product.31_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs_product^android_product.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/gflags/libgflags^android_product.31_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxxabi/libc++demangle^android_product.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcxxabi/libc++demangle^android_x86_64_static_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/core/libcutils/libcutils^android_product.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_product.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/libbase/libbase^android_x86_64_shared_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/logging/liblog/liblog^android_product.31_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libcuttlefish_fs,android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/device/google/cuttlefish/libcuttlefish_fs^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_x86_64_shared_apex10000

echo "building tombstone_transmit^android_product.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja tombstone_transmit,android_product.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/device/google/cuttlefish/tombstone_transmit^android_product.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_transmit^android_product.31_x86_64
