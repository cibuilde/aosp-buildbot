...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_x86_x86_64_shared_apex29/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libjavacrypto,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/conscrypt/libjavacrypto^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_64_shared_apex29

echo "building libjavacrypto^android_x86_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libjavacrypto,android_x86_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/conscrypt/libjavacrypto^android_x86_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/conscrypt/libjavacrypto^android_x86_x86_64_shared_apex29

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_conscrypt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/conscrypt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_conscrypt.tar.zst --clobber
