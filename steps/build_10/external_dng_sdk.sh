...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libjpeg-turbo/libjpeg^android_x86_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libdng_sdk,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/dng_sdk/libdng_sdk^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_64_shared

echo "building libdng_sdk^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libdng_sdk,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/dng_sdk/libdng_sdk^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/dng_sdk/libdng_sdk^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_dng_sdk.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/dng_sdk/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_dng_sdk.tar.zst --clobber
