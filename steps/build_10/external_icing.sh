...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/icing/proto/icing-c-proto^android_x86_64_static_apex10000/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libutf/libutf^android_x86_64_static_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/protobuf/libprotobuf-cpp-full^android_x86_64_shared_apex10000/ .
