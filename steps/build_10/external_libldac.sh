...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_enc^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_enc^android_x86_x86_64_shared/ .

echo "building libldacBT_abr^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libldacBT_abr,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_abr^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/libldac/libldacBT_abr^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_abr^android_x86_64_shared

echo "building libldacBT_abr^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libldacBT_abr,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_abr^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/libldac/libldacBT_abr^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libldac/libldacBT_abr^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libldac.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libldac/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_libldac.tar.zst --clobber
