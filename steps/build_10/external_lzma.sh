...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja liblzma,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/lzma/liblzma^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_64_shared_apex10000

echo "building liblzma^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja liblzma,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/lzma/liblzma^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/lzma/C/liblzma^android_x86_x86_64_shared_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_lzma.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/lzma/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_lzma.tar.zst --clobber
