...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libcap/libcap^android_x86_64_shared_apex29/ .
...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail_generated^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail_generated^android_x86_64_static_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail_generated^android_x86_64_static_apex29/ .

echo "building libminijail^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libminijail,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/minijail/libminijail^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared

echo "building libminijail^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libminijail,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/minijail/libminijail^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared_apex10000

echo "building libminijail^android_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libminijail,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/minijail/libminijail^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_x86_64_shared_apex29

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_minijail.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/minijail/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_minijail.tar.zst --clobber
