...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libxml2/libxml2^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/libxml2/libxml2^android_x86_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libpfw_utility^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libremote-processor^android_x86_x86_64_shared/ .

echo "building libparameter^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libparameter,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/parameter-framework/libparameter^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_64_shared

echo "building libparameter^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libparameter,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/parameter-framework/libparameter^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/parameter-framework/libparameter^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_parameter-framework.tar.zst --clobber
