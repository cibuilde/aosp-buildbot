...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libdowncast_rs,android_x86_64_rlib_rlib-std_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/downcast-rs/libdowncast_rs^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/downcast-rs/libdowncast_rs^android_x86_64_rlib_rlib-std_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_rust_crates_downcast-rs.tar.zst --clobber
