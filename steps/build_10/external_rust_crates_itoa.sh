...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libitoa,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/itoa/libitoa^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/itoa/libitoa^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/itoa/libitoa^android_x86_64_rlib_rlib-std_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_rust_crates_itoa.tar.zst --clobber
