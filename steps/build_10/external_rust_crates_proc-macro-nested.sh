...
rsync -a -r $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-nested/copy_proc-macro-nested_build_out^/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libproc_macro_nested,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_64_rlib_rlib-std

echo "building libproc_macro_nested^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libproc_macro_nested,android_x86_64_rlib_rlib-std_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_64_rlib_rlib-std_apex10000

echo "building libproc_macro_nested^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libproc_macro_nested,android_x86_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/proc-macro-nested/libproc_macro_nested^android_x86_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_rust_crates_proc-macro-nested.tar.zst --clobber
