...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja librand_chacha,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_10/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_dylib/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 external_rust_crates_rand_chacha.tar.zst --clobber
