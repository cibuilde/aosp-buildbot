...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/external/selinux/secilc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/selinux/secilc/secilc^android_x86_64
