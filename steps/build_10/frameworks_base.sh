...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja incidentd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/frameworks/base/incidentd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_10/frameworks/base/incidentd^android_x86_64.output $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64 $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64/addition_copy_files.output
