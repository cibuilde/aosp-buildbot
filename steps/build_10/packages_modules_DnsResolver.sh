...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja dnsresolver_aidl_interface-V7-cpp,android_x86_64_shared
