...
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/core/init/init_first_stage_soong^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/core/mkbootfs/mkbootfs^linux_glibc_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_plat_pub_versioned.cil^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/artifacts/system/sepolicy/microdroid_vendor_sepolicy.cil^android_common/ .
