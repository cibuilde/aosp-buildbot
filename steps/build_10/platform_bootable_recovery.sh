...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/bootable/recovery/uncrypt^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/uncrypt/uncrypt^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/bootable/recovery/recovery^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery^android_recovery_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/bootable/recovery/minadbd^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minadbd/minadbd^android_recovery_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_bootable_recovery.tar.zst --clobber
