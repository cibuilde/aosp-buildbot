...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libfutures_executor,android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/external/rust/crates/futures-executor/libfutures_executor^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-executor/libfutures_executor^android_x86_64_dylib_apex10000

echo "building libfutures_executor^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libfutures_executor,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-executor/libfutures_executor^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/external/rust/crates/futures-executor/libfutures_executor^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/futures-executor/libfutures_executor^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_external_rust_crates_futures-executor.tar.zst --clobber
