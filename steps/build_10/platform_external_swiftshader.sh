...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/src/commit_header^/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/llvm-10.0/libLLVM10_swiftshader^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/llvm-10.0/libLLVM10_swiftshader^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/src/libswiftshadervk_llvm_debug^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/src/libswiftshadervk_llvm_debug^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/astc-encoder/swiftshader_astc^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/astc-encoder/swiftshader_astc^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/src/swiftshader_debug^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/src/swiftshader_debug^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/marl/swiftshader_marl^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/marl/swiftshader_marl^android_vendor.31_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/SPIRV-Tools/swiftshader_spirv-tools^android_vendor.31_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/swiftshader/third_party/SPIRV-Tools/swiftshader_spirv-tools^android_vendor.31_x86_x86_64_static/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja vulkan.pastel,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/external/swiftshader/vulkan.pastel^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_x86_64_shared

echo "building vulkan.pastel^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja vulkan.pastel,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/external/swiftshader/vulkan.pastel^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_external_swiftshader.tar.zst --clobber
