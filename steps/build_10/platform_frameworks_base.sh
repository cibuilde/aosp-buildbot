...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja incidentd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/frameworks/base/incidentd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_frameworks_base.tar.zst --clobber
