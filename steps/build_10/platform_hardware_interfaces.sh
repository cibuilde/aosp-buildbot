...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.hardware.security.keymint-service,android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_hardware_interfaces.tar.zst --clobber
