...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja audio.r_submix.default,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/hardware/libhardware/audio.r_submix.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio_remote_submix/audio.r_submix.default^android_vendor.31_x86_x86_64_shared

echo "building audio.r_submix.default^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja audio.r_submix.default,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/hardware/libhardware/audio.r_submix.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio_remote_submix/audio.r_submix.default^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_hardware_libhardware.tar.zst --clobber
