...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja vm,android_x86_64_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/vm/vm^android_x86_64_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/packages/modules/Virtualization/vm^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/vm/vm^android_x86_64_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_packages_modules_Virtualization.tar.zst --clobber
