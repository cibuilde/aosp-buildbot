...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja usbd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/usbd/usbd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/usbd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/usbd/usbd^android_x86_64

echo "building storaged^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja storaged,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/storaged/storaged^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/storaged^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/storaged/storaged^android_x86_64

echo "building snapshotctl^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja snapshotctl,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libsnapshot/snapshotctl^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/snapshotctl^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libsnapshot/snapshotctl^android_x86_64

echo "building set-verity-state^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja set-verity-state,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/set-verity-state/set-verity-state^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/set-verity-state^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/set-verity-state/set-verity-state^android_x86_64

echo "building libgrallocusage^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libgrallocusage,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libgrallocusage/libgrallocusage^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/libgrallocusage^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libgrallocusage/libgrallocusage^android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/libgrallocusage^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libgrallocusage/libgrallocusage^android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/libfs_mgr_binder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr_binder^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/libfs_mgr_binder^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr_binder^android_x86_64_shared

echo "building fastbootd^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja fastbootd,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fastboot/fastbootd^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/fastbootd^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/fastboot/fastbootd^android_recovery_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/clean_scratch_files^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/clean_scratch_files^android_x86_64

echo "building charger^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja charger,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/healthd/charger^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/charger^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/healthd/charger^android_x86_64

echo "building charger^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja charger,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/healthd/charger^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/core/charger^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/healthd/charger^android_recovery_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_core.tar.zst --clobber
