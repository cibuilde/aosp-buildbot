...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/extras/liblpdump^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/liblpdump^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/extras/lpdumpd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdumpd^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/extras/lpdump^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdump^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/extras/bootctl^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/bootctl/bootctl^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_extras.tar.zst --clobber
