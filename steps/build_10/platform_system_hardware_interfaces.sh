...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/hardware/interfaces/android.system.keystore2-V1-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-rust^android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/hardware/interfaces/android.system.keystore2-V1-ndk_platform^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-ndk_platform^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/hardware/interfaces/android.system.keystore2-V1-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-cpp^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_hardware_interfaces.tar.zst --clobber
