...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja lib_android_keymaster_keymint_utils,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/keymaster/lib_android_keymaster_keymint_utils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_x86_64_shared

echo "building libkeymint^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libkeymint,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymint^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/keymaster/libkeymint^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymint^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_keymaster.tar.zst --clobber
