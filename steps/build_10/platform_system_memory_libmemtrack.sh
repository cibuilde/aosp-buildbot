...
clone_depth_platform platform/system/memory/libmemtrack
...
echo "building libmemtrack^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared

echo "building libmemtrack^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/memory/libmemtrack/libmemtrack^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared

echo "building libmemtrack^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared

echo "building libmemtrack^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_memory_libmemtrack.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/memory/libmemtrack/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_memory_libmemtrack.tar.zst --clobber

du -ah -d1 platform_system_memory_libmemtrack*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_system_memory_libmemtrack.tar.zst" ]; then
  echo "Compressing platform/system/memory/libmemtrack -> platform_system_memory_libmemtrack.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_system_memory_libmemtrack.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/system/memory/libmemtrack/ .
fi
