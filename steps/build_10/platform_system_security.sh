...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libkeystore2_apc_compat,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/apc_compat/libkeystore2_apc_compat^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/libkeystore2_apc_compat^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/apc_compat/libkeystore2_apc_compat^android_x86_64_shared

echo "building libkeystore2_apc_compat-rust^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libkeystore2_apc_compat-rust,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/libkeystore2_apc_compat-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/apc_compat/libkeystore2_apc_compat-rust^android_x86_64_rlib_rlib-std

echo "building libkeystore-wifi-hidl^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libkeystore-wifi-hidl,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore/libkeystore-wifi-hidl^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/libkeystore-wifi-hidl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore/libkeystore-wifi-hidl^android_vendor.31_x86_64_shared

echo "building libcredstore_aidl^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libcredstore_aidl,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/identity/libcredstore_aidl^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/libcredstore_aidl^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/identity/libcredstore_aidl^android_x86_64_shared

echo "building credstore^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja credstore,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/identity/credstore^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/credstore^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/security/identity/credstore^android_x86_64

echo "building android.security.remoteprovisioning-rust^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.security.remoteprovisioning-rust,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/android.security.remoteprovisioning-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.remoteprovisioning-rust^android_x86_64_rlib_rlib-std

echo "building android.security.compat-rust^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.security.compat-rust,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/android.security.compat-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.compat-rust^android_x86_64_rlib_rlib-std

echo "building android.security.compat-ndk_platform^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.security.compat-ndk_platform,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/android.security.compat-ndk_platform^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.compat-ndk_platform^android_x86_64_shared

echo "building android.security.authorization-rust^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.security.authorization-rust,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/android.security.authorization-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.authorization-rust^android_x86_64_rlib_rlib-std

echo "building android.security.authorization-ndk_platform^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja android.security.authorization-ndk_platform,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/security/android.security.authorization-ndk_platform^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.authorization-ndk_platform^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_security.tar.zst --clobber
