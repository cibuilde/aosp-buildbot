...
rsync -a -r $GITHUB_WORKSPACE/downloads/hardware/interfaces/tests/lazy/1.1/android.hardware.tests.lazy@1.1^android_x86_64_shared/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/tools/hidl/hidl_lazy_test_server^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/hidl/test/lazy_test/hidl_lazy_test_server^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_tools_hidl.tar.zst --clobber
