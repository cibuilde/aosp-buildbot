...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/update_engine/update_engine_sideload^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/update_engine_sideload^android_recovery_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/update_engine/update_engine_client^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/update_engine_client^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/update_engine/libupdate_engine_boot_control^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_boot_control^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/update_engine/libupdate_engine_android^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_android^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_update_engine.tar.zst --clobber
