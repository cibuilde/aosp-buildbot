...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/vold/libvold_binder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/vold/vold_prepare_subdirs^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/vold/vold_prepare_subdirs^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/vold/vdc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/vold/vdc^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/vold/libvold_binder^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/platform/system/vold/libvold^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_vold.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/vold/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 platform_system_vold.tar.zst --clobber
