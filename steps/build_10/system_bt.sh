...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libbt_hci_custom_types,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/hci/libbt_hci_custom_types^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/bt/libbt_hci_custom_types^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/hci/libbt_hci_custom_types^android_x86_64_rlib_rlib-std

echo "building libbt_hci_custom_types^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libbt_hci_custom_types,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/hci/libbt_hci_custom_types^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/bt/libbt_hci_custom_types^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/hci/libbt_hci_custom_types^android_x86_x86_64_rlib_rlib-std
