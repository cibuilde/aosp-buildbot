...
echo "Preparing for system/memory/libmemtrack"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building libmemtrack^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_vendor.31_x86_x86_64_shared
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared/addition_copy_files.output

echo "building libmemtrack^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_10.ninja libmemtrack,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_10/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_10 system_memory_libmemtrack.tar.zst --clobber
