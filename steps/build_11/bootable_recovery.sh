...
rsync -a -r $GITHUB_WORKSPACE/downloads/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libupdate_verifier,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/bootable/recovery/libupdate_verifier^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_11/bootable/recovery/libupdate_verifier^android_x86_64_static.output $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static/addition_copy_files.output

echo "building update_verifier^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja update_verifier,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/bootable/recovery/update_verifier^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_11/bootable/recovery/update_verifier^android_x86_64.output $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64 $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 bootable_recovery.tar.zst --clobber
