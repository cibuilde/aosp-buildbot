...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libcuttlefish_utils,android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/device/google/cuttlefish/libcuttlefish_utils^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/utils/libcuttlefish_utils^android_x86_64_shared_apex10000

echo "building tombstone_producer^android_product.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja tombstone_producer,android_product.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/device/google/cuttlefish/tombstone_producer^android_product.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/monitoring/tombstone_transmit/tombstone_producer^android_product.31_x86_64
