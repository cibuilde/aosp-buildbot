...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja boringssl_self_test_vendor,android_vendor.31_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/boringssl/boringssl_self_test_vendor^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_64

echo "building boringssl_self_test_vendor^android_vendor.31_x86_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja boringssl_self_test_vendor,android_vendor.31_x86_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/boringssl/boringssl_self_test_vendor^android_vendor.31_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/selftest/boringssl_self_test_vendor^android_vendor.31_x86_x86_64

echo "building libssl^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libssl,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/boringssl/libssl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_64_shared

echo "building libssl^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libssl,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/boringssl/libssl^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_boringssl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/boringssl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_boringssl.tar.zst --clobber
