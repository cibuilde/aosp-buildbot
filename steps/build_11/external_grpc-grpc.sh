...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgrpc++,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc++^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/grpc-grpc/libgrpc++^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc++^android_x86_64_shared

echo "building libgrpc++^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgrpc++,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc++^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/grpc-grpc/libgrpc++^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/libgrpc++^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_grpc-grpc.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/grpc-grpc/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_grpc-grpc.tar.zst --clobber
