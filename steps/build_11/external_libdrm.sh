...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdrm,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libdrm/libdrm^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/libdrm/libdrm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libdrm/libdrm^android_vendor.31_x86_64_shared

echo "building libdrm^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdrm,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libdrm/libdrm^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/libdrm/libdrm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libdrm/libdrm^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libdrm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libdrm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_libdrm.tar.zst --clobber
