...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtextclassifier,android_x86_64_sdk_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/libtextclassifier/libtextclassifier^android_x86_64_sdk_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier^android_x86_64_sdk_shared_apex30

echo "building libtextclassifier_hash^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtextclassifier_hash,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/libtextclassifier/libtextclassifier_hash^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/libtextclassifier/native/libtextclassifier_hash^android_vendor.31_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_libtextclassifier.tar.zst --clobber
