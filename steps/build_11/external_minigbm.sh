...
echo "Preparing for external/minigbm"
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libdrm/libdrm^android_vendor.31_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/libdrm/libdrm^android_vendor.31_x86_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/minigbm/libminigbm_gralloc^android_vendor.31_x86_x86_64_shared/ .
...
echo "building android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared/addition_copy_files.output

echo "building android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared/addition_copy_files.output

echo "building android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.allocator@4.0-service.minigbm,android_vendor.31_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_11/external/minigbm/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64.output $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64 $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_minigbm.tar.zst --clobber

du -ah -d1 external_minigbm*.tar.zst | sort -h
