...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libperfetto,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/perfetto/libperfetto^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/libperfetto^android_x86_64_shared

echo "building perfetto^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja perfetto,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/perfetto^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/perfetto/perfetto^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/perfetto^android_x86_64

echo "building trigger_perfetto^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja trigger_perfetto,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/trigger_perfetto^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/perfetto/trigger_perfetto^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/trigger_perfetto^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_perfetto.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/perfetto/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_perfetto.tar.zst --clobber
