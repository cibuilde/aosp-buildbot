...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgetrandom,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/getrandom/libgetrandom^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/rust/crates/getrandom/libgetrandom^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/getrandom/libgetrandom^android_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_rust_crates_getrandom.tar.zst --clobber
