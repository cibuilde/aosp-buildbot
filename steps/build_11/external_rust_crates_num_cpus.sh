...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libnum_cpus,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std

echo "building libnum_cpus^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libnum_cpus,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_64_rlib_rlib-std_apex10000

echo "building libnum_cpus^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libnum_cpus,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/rust/crates/num_cpus/libnum_cpus^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/num_cpus/libnum_cpus^android_x86_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_rust_crates_num_cpus.tar.zst --clobber
