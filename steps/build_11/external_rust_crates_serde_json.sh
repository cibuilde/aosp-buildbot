...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libserde_json,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/serde_json/libserde_json^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/rust/crates/serde_json/libserde_json^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/serde_json/libserde_json^android_x86_64_rlib_rlib-std_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_rust_crates_serde_json.tar.zst --clobber
