...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtinyxml2,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_recovery_x86_64_shared

echo "building libtinyxml2^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtinyxml2,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_64_shared

echo "building libtinyxml2^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtinyxml2,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_vendor.31_x86_x86_64_shared

echo "building libtinyxml2^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtinyxml2,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/tinyxml2/libtinyxml2^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_64_shared

echo "building libtinyxml2^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libtinyxml2,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/tinyxml2/libtinyxml2^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_tinyxml2.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/tinyxml2/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 external_tinyxml2.tar.zst --clobber

du -ah -d1 external_tinyxml2*.tar.zst | sort -h
