...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja audio.primary.default,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/audio.primary.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio/audio.primary.default^android_vendor.31_x86_64_shared

echo "building audio.primary.default^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja audio.primary.default,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/audio.primary.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio/audio.primary.default^android_vendor.31_x86_x86_64_shared

echo "building libhardware^android_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libhardware,android_x86_64_shared_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/libhardware^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared_apex29

echo "building power.default^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja power.default,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/power/power.default^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/power.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/power/power.default^android_vendor.31_x86_64_shared

echo "building power.default^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja power.default,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/power/power.default^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/power.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/power/power.default^android_vendor.31_x86_x86_64_shared

echo "building vibrator.default^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja vibrator.default,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/vibrator.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/vibrator/vibrator.default^android_vendor.31_x86_64_shared

echo "building vibrator.default^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja vibrator.default,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/libhardware/vibrator.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/vibrator/vibrator.default^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_libhardware.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/libhardware/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 hardware_libhardware.tar.zst --clobber
