...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja librilutils,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/ril/librilutils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_64_shared

echo "building librilutils^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja librilutils,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/hardware/ril/librilutils^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/ril/librilutils/librilutils^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_ril.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/ril/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 hardware_ril.tar.zst --clobber
