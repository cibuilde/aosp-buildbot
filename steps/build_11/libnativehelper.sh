...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libnativehelper_compat_libc++,android_x86_64_sdk_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared.output . $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared

echo "building libnativehelper_compat_libc++^android_x86_64_sdk_shared_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libnativehelper_compat_libc++,android_x86_64_sdk_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/libnativehelper/libnativehelper_compat_libc++^android_x86_64_sdk_shared_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf libnativehelper.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/libnativehelper/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 libnativehelper.tar.zst --clobber
