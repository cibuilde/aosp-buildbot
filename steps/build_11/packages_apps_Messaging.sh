...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgiftranscode,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/packages/apps/Messaging/libgiftranscode^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_64_shared

echo "building libgiftranscode^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgiftranscode,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/packages/apps/Messaging/libgiftranscode^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/jni/libgiftranscode^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf packages_apps_Messaging.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/packages/apps/Messaging/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 packages_apps_Messaging.tar.zst --clobber
