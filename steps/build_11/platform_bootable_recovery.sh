...
echo "building libupdate_verifier^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libupdate_verifier,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/bootable/recovery/libupdate_verifier^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static

echo "building update_verifier^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja update_verifier,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/bootable/recovery/update_verifier^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/update_verifier^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_bootable_recovery.tar.zst --clobber
