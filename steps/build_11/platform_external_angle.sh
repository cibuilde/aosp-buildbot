...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libGLESv2_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libGLESv2_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libGLESv1_CM_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libGLESv1_CM_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libEGL_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/angle/libEGL_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_angle.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/angle/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_external_angle.tar.zst --clobber
