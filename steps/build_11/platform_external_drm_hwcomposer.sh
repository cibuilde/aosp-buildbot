...
clone_depth_platform platform/external/drm_hwcomposer
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja hwcomposer.drm,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared

echo "building hwcomposer.drm^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja hwcomposer.drm,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_drm_hwcomposer.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/drm_hwcomposer/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_external_drm_hwcomposer.tar.zst --clobber

du -ah -d1 platform_external_drm_hwcomposer*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_drm_hwcomposer.tar.zst" ]; then
  echo "Compressing platform/external/drm_hwcomposer -> platform_external_drm_hwcomposer.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_drm_hwcomposer.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/drm_hwcomposer/ .
fi
