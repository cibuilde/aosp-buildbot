...
clone_depth_platform platform/external/minigbm
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared

echo "building android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared

echo "building android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.graphics.allocator@4.0-service.minigbm,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/external/minigbm/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_minigbm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/minigbm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_external_minigbm.tar.zst --clobber

du -ah -d1 platform_external_minigbm*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_external_minigbm.tar.zst" ]; then
  echo "Compressing platform/external/minigbm -> platform_external_minigbm.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_external_minigbm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/external/minigbm/ .
fi
