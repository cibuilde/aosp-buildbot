...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/service.incremental^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/service.incremental^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/service.incremental^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_static

echo "building service.incremental^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja service.incremental,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/service.incremental^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/libmedia_jni_utils^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/base/libmedia_jni_utils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_frameworks_base.tar.zst --clobber
