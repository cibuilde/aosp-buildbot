...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/surfaceflinger^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/surfaceflinger/surfaceflinger^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/sensorservice^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/sensorservice^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/otapreopt_chroot^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/installd/otapreopt_chroot^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libsensorservicehidl^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/hidl/libsensorservicehidl^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libsensorservicehidl^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/hidl/libsensorservicehidl^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libsensorservice^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/libsensorservice^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libsensorservice^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/libsensorservice^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libschedulerservicehidl^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/schedulerservice/libschedulerservicehidl^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libschedulerservicehidl^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/schedulerservice/libschedulerservicehidl^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libgui^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gui/libgui^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/librenderengine^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/renderengine/librenderengine^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libgui^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gui/libgui^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libnativedisplay^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/nativedisplay/libnativedisplay^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libnativedisplay^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/nativedisplay/libnativedisplay^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/liblayers_proto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/surfaceflinger/layerproto/liblayers_proto^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/liblayers_proto^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/surfaceflinger/layerproto/liblayers_proto^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libframetimeline^android_x86_64_static_lto-thin.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/surfaceflinger/FrameTimeline/libframetimeline^android_x86_64_static_lto-thin
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libdisplayservicehidl^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/displayservice/libdisplayservicehidl^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/libcompositionengine^android_x86_64_static_lto-thin.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/surfaceflinger/CompositionEngine/libcompositionengine^android_x86_64_static_lto-thin
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/frameworks/native/dumpstate^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/dumpstate/dumpstate^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_frameworks_native.tar.zst --clobber
