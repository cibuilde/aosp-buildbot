...
clone_depth_platform platform/hardware/google/camera
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgooglecamerahwl_impl,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/libgooglecamerahwl_impl^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/devices/EmulatedCamera/hwl/libgooglecamerahwl_impl^android_vendor.31_x86_x86_64_shared

echo "building libgooglecamerahalutils^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgooglecamerahalutils,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/libgooglecamerahalutils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/hal/utils/libgooglecamerahalutils^android_vendor.31_x86_64_shared

echo "building libgooglecamerahwl_impl^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgooglecamerahwl_impl,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/libgooglecamerahwl_impl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/devices/EmulatedCamera/hwl/libgooglecamerahwl_impl^android_vendor.31_x86_64_shared

echo "building libgooglecamerahalutils^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgooglecamerahalutils,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/libgooglecamerahalutils^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/hal/utils/libgooglecamerahalutils^android_vendor.31_x86_x86_64_shared

echo "building libgooglecamerahal^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libgooglecamerahal,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/libgooglecamerahal^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/hal/google_camera_hal/libgooglecamerahal^android_vendor.31_x86_64_shared

echo "building android.hardware.camera.provider@2.7-service-google^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.camera.provider@2.7-service-google,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/google/camera/android.hardware.camera.provider@2.7-service-google^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/hal/hidl_service/android.hardware.camera.provider@2.7-service-google^android_vendor.31_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_hardware_google_camera.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/hardware/google/camera/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_hardware_google_camera.tar.zst --clobber

du -ah -d1 platform_hardware_google_camera*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_hardware_google_camera.tar.zst" ]; then
  echo "Compressing platform/hardware/google/camera -> platform_hardware_google_camera.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_hardware_google_camera.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/hardware/google/camera/ .
fi
