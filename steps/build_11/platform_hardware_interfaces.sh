...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja android.hardware.sensors@2.1-service.mock,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/hardware/interfaces/android.hardware.sensors@2.1-service.mock^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/sensors/2.1/default/android.hardware.sensors@2.1-service.mock^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_hardware_interfaces.tar.zst --clobber
