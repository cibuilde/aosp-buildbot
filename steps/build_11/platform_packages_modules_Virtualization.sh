...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja fd_server,android_x86_64_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/fd_server/fd_server^android_x86_64_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/packages/modules/Virtualization/fd_server^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/fd_server/fd_server^android_x86_64_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_packages_modules_Virtualization.tar.zst --clobber
