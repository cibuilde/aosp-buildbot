...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/system/apex/libapexservice^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexservice^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/system/apex/libapexd_checkpoint_vold^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd_checkpoint_vold^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/system/apex/libapexd^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/platform/system/apex/apexd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/apexd^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_apex.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/apex/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 platform_system_apex.tar.zst --clobber
