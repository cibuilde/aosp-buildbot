...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libstd,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/prebuilts/rust/libstd^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib

echo "building libstd^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libstd,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/prebuilts/rust/libstd^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libstd^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/prebuilts/rust/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 prebuilts_rust.tar.zst --clobber
