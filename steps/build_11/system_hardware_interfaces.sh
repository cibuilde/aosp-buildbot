...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libSuspendProperties,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/hardware/interfaces/libSuspendProperties^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/1.0/default/libSuspendProperties^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 system_hardware_interfaces.tar.zst --clobber
