...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdmabufheap,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_64_shared

echo "building libdmabufheap^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdmabufheap,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_vendor.31_x86_x86_64_shared

echo "building libdmabufheap^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdmabufheap,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_64_shared

echo "building libdmabufheap^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libdmabufheap,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libdmabufheap/libdmabufheap^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 system_memory_libdmabufheap.tar.zst --clobber
