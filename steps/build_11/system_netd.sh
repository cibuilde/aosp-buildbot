...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja ndc,android_x86_64_cfi
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 system_netd.tar.zst --clobber
