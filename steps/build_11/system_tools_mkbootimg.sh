...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libmkbootimg_abi_check,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_64_shared

echo "building libmkbootimg_abi_check^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_11.ninja libmkbootimg_abi_check,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_11/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/tools/mkbootimg/libmkbootimg_abi_check^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_tools_mkbootimg.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/tools/mkbootimg/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_11 system_tools_mkbootimg.tar.zst --clobber
