...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libbootloader_message,android_recovery_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/libbootloader_message^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_recovery_x86_64_shared

echo "building libbootloader_message^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libbootloader_message,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/libbootloader_message^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/bootloader_message/libbootloader_message^android_x86_64_shared

echo "building libfusesideload^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libfusesideload,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/fuse_sideload/libfusesideload^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/libfusesideload^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/fuse_sideload/libfusesideload^android_recovery_x86_64_shared

echo "building libminui^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libminui,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/libminui^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_64_shared

echo "building libminui^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libminui,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/libminui^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minui/libminui^android_x86_x86_64_shared

echo "building librecovery_ui^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja librecovery_ui,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/librecovery_ui^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery_ui/librecovery_ui^android_recovery_x86_64_shared

echo "building recovery-persist^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja recovery-persist,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-persist^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/recovery-persist^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-persist^android_x86_64

echo "building recovery-refresh^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja recovery-refresh,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-refresh^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/bootable/recovery/recovery-refresh^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery-refresh^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf bootable_recovery.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/bootable/recovery/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 bootable_recovery.tar.zst --clobber
