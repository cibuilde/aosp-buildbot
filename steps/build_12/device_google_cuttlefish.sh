...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcuttlefish_device_config_proto,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/libcuttlefish_device_config_proto^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/device_config/libcuttlefish_device_config_proto^android_vendor.31_x86_64_shared

echo "building libcuttlefish_device_config_proto^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcuttlefish_device_config_proto,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/libcuttlefish_device_config_proto^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/device_config/libcuttlefish_device_config_proto^android_vendor.31_x86_x86_64_shared

echo "building libcuttlefish_fs^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcuttlefish_fs,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/libcuttlefish_fs^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_vendor.31_x86_64_shared

echo "building libcuttlefish_fs^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcuttlefish_fs,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/libcuttlefish_fs^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_vendor.31_x86_x86_64_shared

echo "building libcuttlefish_fs^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcuttlefish_fs,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/libcuttlefish_fs^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/common/libs/fs/libcuttlefish_fs^android_x86_64_shared

echo "building mk_cdisk^android_x86_64_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja mk_cdisk,android_x86_64_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/mk_cdisk/mk_cdisk^android_x86_64_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/device/google/cuttlefish/mk_cdisk^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/host/commands/mk_cdisk/mk_cdisk^android_x86_64_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 device_google_cuttlefish.tar.zst --clobber
