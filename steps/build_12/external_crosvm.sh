...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libbase_rust,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libbase_rust^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib/addition_copy_files.output

echo "building libbase_rust^android_x86_64_dylib_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libbase_rust,android_x86_64_dylib_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libbase_rust^android_x86_64_dylib_apex10000.output $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib_apex10000 $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib_apex10000/addition_copy_files.output

echo "building libcros_async^android_x86_64_dylib"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcros_async,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libcros_async^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib/addition_copy_files.output

echo "building libcros_async^android_x86_64_dylib_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libcros_async,android_x86_64_dylib_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libcros_async^android_x86_64_dylib_apex10000.output $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib_apex10000 $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib_apex10000/addition_copy_files.output

echo "building libfuse_rust^android_x86_64_dylib"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libfuse_rust,android_x86_64_dylib
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libfuse_rust^android_x86_64_dylib.output $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib/addition_copy_files.output

echo "building libfuse_rust^android_x86_64_dylib_apex10000"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libfuse_rust,android_x86_64_dylib_apex10000
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_12/external/crosvm/libfuse_rust^android_x86_64_dylib_apex10000.output $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib_apex10000 $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib_apex10000/addition_copy_files.output
