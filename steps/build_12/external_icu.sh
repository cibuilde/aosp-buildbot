...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libandroidicu,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libandroidicu^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_64_shared_apex10000

echo "building libandroidicu^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libandroidicu,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libandroidicu^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/libandroidicu/libandroidicu^android_x86_x86_64_shared_apex10000

echo "building libicu^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libicu,android_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libicu^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_64_shared_apex10000

echo "building libicu^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libicu,android_x86_x86_64_shared_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_x86_64_shared_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libicu^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/libicu/libicu^android_x86_x86_64_shared_apex10000

echo "building libicu_jni^android_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libicu_jni,android_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libicu_jni^android_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/libcore_bridge/src/native/libicu_jni^android_x86_64_shared_apex10000

echo "building libicu_jni^android_x86_x86_64_shared_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libicu_jni,android_x86_x86_64_shared_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libicu_jni^android_x86_x86_64_shared_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/libcore_bridge/src/native/libicu_jni^android_x86_x86_64_shared_apex10000

echo "building libicuuc^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libicuuc,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/icu4c/source/common/libicuuc^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/icu/libicuuc^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/icu/icu4c/source/common/libicuuc^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 external_icu.tar.zst --clobber
