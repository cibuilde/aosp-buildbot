...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libminijail,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/minijail/libminijail^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_64_shared

echo "building libminijail^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libminijail,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail^android_vendor.31_x86_x86_64_shared

echo "building libminijail_rust^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libminijail_rust,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail_rust^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/minijail/libminijail_rust^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/minijail/libminijail_rust^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_minijail.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/minijail/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 external_minijail.tar.zst --clobber
