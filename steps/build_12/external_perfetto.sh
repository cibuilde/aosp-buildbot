...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja traced,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/traced^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/perfetto/traced^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/traced^android_x86_64

echo "building traced_probes^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja traced_probes,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/traced_probes^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/perfetto/traced_probes^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/traced_probes^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_perfetto.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/perfetto/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 external_perfetto.tar.zst --clobber
