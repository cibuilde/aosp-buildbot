...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libgrpc_wrap,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_64_shared

echo "building libgrpc_wrap^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libgrpc_wrap,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/grpcio-sys/libgrpc_wrap^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 external_rust_crates_grpcio-sys.tar.zst --clobber
