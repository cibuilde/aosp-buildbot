...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libselinux,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/selinux/libselinux^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_recovery_x86_64_shared

echo "building libselinux^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libselinux,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/selinux/libselinux^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_64_shared

echo "building libselinux^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libselinux,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/external/selinux/libselinux^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/selinux/libselinux/libselinux^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_selinux.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/selinux/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 external_selinux.tar.zst --clobber
