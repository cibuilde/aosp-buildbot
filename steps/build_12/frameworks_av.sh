...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libavservices_minijail,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/services/minijail/libavservices_minijail^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/av/libavservices_minijail^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/minijail/libavservices_minijail^android_x86_64_shared

echo "building libmtp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libmtp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/mtp/libmtp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/av/libmtp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/mtp/libmtp^android_x86_64_shared

echo "building libmtp^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libmtp,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/mtp/libmtp^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/av/libmtp^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/mtp/libmtp^android_x86_x86_64_shared

echo "building libstagefright_foundation^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libstagefright_foundation,android_x86_64_shared_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/av/libstagefright_foundation^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/foundation/libstagefright_foundation^android_x86_64_shared_cfi_apex29
