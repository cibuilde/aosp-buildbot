...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libalarm_jni,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/base/libalarm_jni^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_64_shared

echo "building libalarm_jni^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libalarm_jni,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/base/libalarm_jni^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/jni/libalarm_jni^android_x86_x86_64_shared
