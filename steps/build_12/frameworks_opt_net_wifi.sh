...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libwifi-system-iface,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/opt/net/wifi/libwifi-system-iface^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_vendor.31_x86_64_shared

echo "building libwifi-system-iface^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libwifi-system-iface,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/opt/net/wifi/libwifi-system-iface^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_vendor.31_x86_x86_64_shared

echo "building libwifi-system-iface^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libwifi-system-iface,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/frameworks/opt/net/wifi/libwifi-system-iface^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/libwifi_system_iface/libwifi-system-iface^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_opt_net_wifi.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/opt/net/wifi/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 frameworks_opt_net_wifi.tar.zst --clobber
