...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja microdroid_vendor,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vendor^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/packages/modules/Virtualization/microdroid_vendor^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vendor^android_common

echo "building mk_payload^android_x86_64_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja mk_payload,android_x86_64_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/packages/modules/Virtualization/mk_payload^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/signature/mk_payload^android_x86_64_apex10000
