...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libfuse_jni,android_x86_64_sdk_shared_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/providers/MediaProvider/jni/libfuse_jni^android_x86_64_sdk_shared_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/packages/providers/MediaProvider/libfuse_jni^android_x86_64_sdk_shared_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/providers/MediaProvider/jni/libfuse_jni^android_x86_64_sdk_shared_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 packages_providers_MediaProvider.tar.zst --clobber
