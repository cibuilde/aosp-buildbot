...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libfuse_rust,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libfuse_rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libfuse_rust^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/fuse/libfuse_rust^android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libcros_async^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libcros_async^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libbase_rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib_apex10000

echo "building libbase_rust^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libbase_rust,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/external/crosvm/libbase_rust^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/base/libbase_rust^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_external_crosvm.tar.zst --clobber
