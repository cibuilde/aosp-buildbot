...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libservices.core^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/jni/libservices.core^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libhwui^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libservices.core^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/jni/libservices.core^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libhwui^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libfilterfw_native^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/native/libfilterfw_native^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/base/libfilterfw_native^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/native/libfilterfw_native^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_frameworks_base.tar.zst --clobber
