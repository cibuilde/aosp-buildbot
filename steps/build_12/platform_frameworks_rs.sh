...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/rs/libRScpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/rs/libRScpp^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/rs/libRScpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/frameworks/rs/libRScpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_frameworks_rs.tar.zst --clobber
