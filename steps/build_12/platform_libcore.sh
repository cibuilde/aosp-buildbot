...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/stable.core.platform.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/stable.core.platform.api.stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/stable-core-platform-api-stubs-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/stable-core-platform-api-stubs-system-modules^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/legacy.core.platform.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/legacy.core.platform.api.stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/legacy-core-platform-api-stubs-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/legacy-core-platform-api-stubs-system-modules^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/core.module_lib.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/core.module_lib.stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/core.current.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/core.current.stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/core-module-lib-stubs-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/core-module-lib-stubs-system-modules^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/core-current-stubs-for-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/core-current-stubs-for-system-modules^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/libcore/core-current-stubs-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/core-current-stubs-system-modules^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/libcore/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_libcore.tar.zst --clobber
