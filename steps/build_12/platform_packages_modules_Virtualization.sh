...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja microdroid,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/packages/modules/Virtualization/microdroid^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/packages/modules/Virtualization/microdroid_vbmeta_system^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vbmeta_system^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/packages/modules/Virtualization/microdroid_super^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_super^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_packages_modules_Virtualization.tar.zst --clobber
