...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/system/extras/libprofcollectd^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/libprofcollectd^android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/system/extras/profcollectd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/profcollectd^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/platform/system/extras/profcollectctl^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/profcollectctl^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 platform_system_extras.tar.zst --clobber
