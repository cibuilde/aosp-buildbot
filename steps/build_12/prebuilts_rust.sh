...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libgetopts,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/prebuilts/rust/libgetopts^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib

echo "building libgetopts^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libgetopts,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libgetopts^android_x86_64_dylib_apex10000

echo "building libterm^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libterm,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/prebuilts/rust/libterm^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib

echo "building libterm^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libterm,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/prebuilts/rust/libterm^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libterm^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/prebuilts/rust/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 prebuilts_rust.tar.zst --clobber
