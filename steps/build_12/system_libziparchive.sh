...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libziparchive,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/libziparchive/libziparchive^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_recovery_x86_64_shared

echo "building libziparchive^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libziparchive,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/libziparchive/libziparchive^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_vendor.31_x86_64_shared

echo "building libziparchive^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libziparchive,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/libziparchive/libziparchive^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_vendor.31_x86_x86_64_shared

echo "building libziparchive^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libziparchive,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/libziparchive/libziparchive^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_64_shared

echo "building libziparchive^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libziparchive,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/libziparchive/libziparchive^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libziparchive/libziparchive^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_libziparchive.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/libziparchive/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 system_libziparchive.tar.zst --clobber
