...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja dmabuf_dump,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libdmabufinfo/tools/dmabuf_dump^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/memory/libmeminfo/dmabuf_dump^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libdmabufinfo/tools/dmabuf_dump^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 system_memory_libmeminfo.tar.zst --clobber
