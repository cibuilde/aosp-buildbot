...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libmemunreachable,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_64_shared

echo "building libmemunreachable^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libmemunreachable,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemunreachable/libmemunreachable^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 system_memory_libmemunreachable.tar.zst --clobber
