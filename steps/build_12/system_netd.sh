...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libnetdutils,android_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/netd/libnetdutils^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_64_shared_cfi

echo "building libnetdutils^android_x86_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja libnetdutils,android_x86_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/netd/libnetdutils^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdutils/libnetdutils^android_x86_x86_64_shared_cfi

echo "building netutils-wrapper-1.0^android_x86_64_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_12.ninja netutils-wrapper-1.0,android_x86_64_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/netutils_wrappers/netutils-wrapper-1.0^android_x86_64_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_12/system/netd/netutils-wrapper-1.0^android_x86_64_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/netutils_wrappers/netutils-wrapper-1.0^android_x86_64_cfi

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_12 system_netd.tar.zst --clobber
