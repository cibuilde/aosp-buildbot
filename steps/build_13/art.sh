...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja dexdump,android_x86_64_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/dexdump/dexdump^android_x86_64_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/art/dexdump^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dexdump/dexdump^android_x86_64_apex31

echo "building dexlist^android_x86_64_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja dexlist,android_x86_64_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/dexlist/dexlist^android_x86_64_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/art/dexlist^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dexlist/dexlist^android_x86_64_apex31

echo "building libprofile^android_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libprofile,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/art/libprofile^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_64_shared_apex31

echo "building libprofile^android_x86_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libprofile,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/art/libprofile^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/libprofile/libprofile^android_x86_x86_64_shared_apex31

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/art/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 art.tar.zst --clobber
