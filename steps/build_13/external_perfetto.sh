...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja heapprofd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/perfetto/heapprofd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd^android_x86_64

echo "building heapprofd_client_api^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja heapprofd_client_api,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/perfetto/heapprofd_client_api^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_64_shared

echo "building heapprofd_client_api^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja heapprofd_client_api,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/heapprofd_client_api^android_x86_x86_64_shared

echo "building traced_perf^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja traced_perf,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/perfetto/traced_perf^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/perfetto/traced_perf^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/perfetto/traced_perf^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_perfetto.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/perfetto/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 external_perfetto.tar.zst --clobber
