...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libandroid_logger,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_logger/libandroid_logger^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/rust/crates/android_logger/libandroid_logger^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_logger/libandroid_logger^android_x86_64_rlib_rlib-std

echo "building libandroid_logger^android_x86_64_rlib_rlib-std_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libandroid_logger,android_x86_64_rlib_rlib-std_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/rust/crates/android_logger/libandroid_logger^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_logger/libandroid_logger^android_x86_64_rlib_rlib-std_apex10000

echo "building libandroid_logger^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libandroid_logger,android_x86_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/rust/crates/android_logger/libandroid_logger^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/android_logger/libandroid_logger^android_x86_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 external_rust_crates_android_logger.tar.zst --clobber
