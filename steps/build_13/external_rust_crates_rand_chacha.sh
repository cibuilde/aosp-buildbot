...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja librand_chacha,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/rand_chacha/librand_chacha^android_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 external_rust_crates_rand_chacha.tar.zst --clobber
