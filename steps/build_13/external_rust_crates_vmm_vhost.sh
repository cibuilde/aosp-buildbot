...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libvmm_vhost,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/vmm_vhost/libvmm_vhost^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/external/rust/crates/vmm_vhost/libvmm_vhost^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/vmm_vhost/libvmm_vhost^android_x86_64_rlib_rlib-std_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 external_rust_crates_vmm_vhost.tar.zst --clobber
