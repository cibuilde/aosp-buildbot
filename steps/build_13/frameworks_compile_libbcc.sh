...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja bcc,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/compile/libbcc/tools/bcc/bcc^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/frameworks/compile/libbcc/bcc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/compile/libbcc/tools/bcc/bcc^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 frameworks_compile_libbcc.tar.zst --clobber
