...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja bugreport,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/bugreport/bugreport^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/frameworks/native/bugreport^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/bugreport/bugreport^android_x86_64

echo "building bugreportz^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja bugreportz,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/bugreportz/bugreportz^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/frameworks/native/bugreportz^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/bugreportz/bugreportz^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_native.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/native/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 frameworks_native.tar.zst --clobber
