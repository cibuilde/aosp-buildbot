...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.hardware.biometrics.face-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/interfaces/android.hardware.biometrics.face-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/biometrics/face/aidl/default/android.hardware.biometrics.face-service.example^android_vendor.31_x86_64

echo "building android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.hardware.biometrics.fingerprint-service.example,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/interfaces/android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/biometrics/fingerprint/aidl/default/android.hardware.biometrics.fingerprint-service.example^android_vendor.31_x86_64

echo "building android.hardware.graphics.common@1.0^android_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.hardware.graphics.common@1.0,android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/interfaces/android.hardware.graphics.common@1.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/graphics/common/1.0/android.hardware.graphics.common@1.0^android_x86_64_shared_apex29

echo "building android.hardware.media.bufferpool@2.0^android_x86_64_shared_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.hardware.media.bufferpool@2.0,android_x86_64_shared_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/interfaces/android.hardware.media.bufferpool@2.0^android_x86_64_shared_apex29.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/media/bufferpool/2.0/android.hardware.media.bufferpool@2.0^android_x86_64_shared_apex29

echo "building android.hardware.neuralnetworks-V1-ndk_platform^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.hardware.neuralnetworks-V1-ndk_platform,android_vendor.31_x86_64_shared
