...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libhardware,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/libhardware^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_recovery_x86_64_shared

echo "building libhardware^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libhardware,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/libhardware^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_64_shared

echo "building libhardware^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libhardware,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/libhardware^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_vendor.31_x86_x86_64_shared

echo "building libhardware^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libhardware,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/libhardware^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_64_shared

echo "building libhardware^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libhardware,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/libhardware^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/libhardware^android_x86_x86_64_shared

echo "building local_time.default^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja local_time.default,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/local_time.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/local_time/local_time.default^android_vendor.31_x86_64_shared

echo "building local_time.default^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja local_time.default,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/hardware/libhardware/local_time.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/local_time/local_time.default^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_libhardware.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/libhardware/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 hardware_libhardware.tar.zst --clobber
