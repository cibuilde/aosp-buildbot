...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja microdroid_vbmeta,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vbmeta^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/packages/modules/Virtualization/microdroid_vbmeta^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/microdroid/microdroid_vbmeta^android_x86_64
