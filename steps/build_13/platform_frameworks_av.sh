...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libstagefright^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/libstagefright^android_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/screenrecord^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/cmds/screenrecord/screenrecord^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/mediaextractor^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/mediaextractor/mediaextractor^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libstagefright^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/libstagefright^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libstagefright_httplive^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/httplive/libstagefright_httplive^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libmediaplayerservice^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmediaplayerservice/libmediaplayerservice^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/mediaserver^android_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/mediaserver/mediaserver^android_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libmediandk^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/ndk/libmediandk^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libmediandk^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/ndk/libmediandk^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libmediaextractorservice^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/mediaextractor/libmediaextractorservice^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/libcameraservice^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/camera/libcameraservice/libcameraservice^android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/av/cameraserver^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/camera/cameraserver/cameraserver^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_frameworks_av.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/frameworks/av/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 platform_frameworks_av.tar.zst --clobber
