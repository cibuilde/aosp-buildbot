...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/base/mimemap^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/mime/mimemap^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/base/libfilterfw_jni^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/base/libfilterfw_jni^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 platform_frameworks_base.tar.zst --clobber
