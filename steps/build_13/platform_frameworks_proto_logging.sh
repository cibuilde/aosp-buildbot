...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja devicepolicyprotosnano,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/frameworks/proto_logging/devicepolicyprotosnano^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/stats/devicepolicy/devicepolicyprotosnano^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 platform_frameworks_proto_logging.tar.zst --clobber
