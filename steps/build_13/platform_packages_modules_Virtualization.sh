...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/crosvm/crosvm^android_x86_64_apex10000/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_boot-5.10^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_bootloader^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_cdisk.json^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_cdisk_env.json^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_cdisk_userdata.json^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_payload.json^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_super^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_uboot_env^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_vbmeta^android_x86_64/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/microdroid_vbmeta_system^android_x86_64/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/microdroid/signature/mk_payload^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/virtmanager/virtmanager^android_x86_64_apex10000/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Virtualization/vm/vm^android_x86_64_apex10000/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja authfs,android_x86_64_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/authfs^android_x86_64_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/packages/modules/Virtualization/authfs^android_x86_64_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/authfs^android_x86_64_apex10000

echo "building com.android.virt^android_common_com.android.virt_image"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja com.android.virt,android_common_com.android.virt_image
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/platform/packages/modules/Virtualization/com.android.virt^android_common_com.android.virt_image.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/apex/com.android.virt^android_common_com.android.virt_image
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 platform_packages_modules_Virtualization.tar.zst --clobber
