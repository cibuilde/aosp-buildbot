...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libtest,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/prebuilts/rust/libtest^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib

echo "building libtest^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libtest,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/prebuilts/rust/libtest^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/prebuilts/rust/libtest^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf prebuilts_rust.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/prebuilts/rust/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 prebuilts_rust.tar.zst --clobber
