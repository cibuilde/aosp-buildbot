...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.system.keystore2-V1-ndk_platform,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/hardware/interfaces/android.system.keystore2-V1-ndk_platform^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-ndk_platform^android_vendor.31_x86_64_shared

echo "building android.system.keystore2-V1-ndk_platform^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja android.system.keystore2-V1-ndk_platform,android_vendor.31_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_hardware_interfaces.tar.zst --clobber
