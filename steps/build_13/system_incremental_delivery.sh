...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libincfs,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/incremental_delivery/libincfs^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_64_shared

echo "building libincfs^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libincfs,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/incremental_delivery/libincfs^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/incfs/libincfs^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_incremental_delivery.tar.zst --clobber
