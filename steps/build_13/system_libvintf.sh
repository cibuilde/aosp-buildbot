...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libvintf,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/libvintf/libvintf^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_64_shared

echo "building libvintf^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libvintf,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/libvintf/libvintf^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/libvintf/libvintf^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_libvintf.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/libvintf/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_libvintf.tar.zst --clobber
