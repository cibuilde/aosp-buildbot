...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja liblogwrap,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/logging/liblogwrap^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_recovery_x86_64_shared

echo "building liblogwrap^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja liblogwrap,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/logging/liblogwrap^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_64_shared

echo "building liblogwrap^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja liblogwrap,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/logging/liblogwrap^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/liblogwrap^android_x86_x86_64_shared

echo "building logwrapper^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja logwrapper,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/logging/logwrapper^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper^android_x86_64

echo "building logwrapper_vendor^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja logwrapper_vendor,android_vendor.31_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper_vendor^android_vendor.31_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/logging/logwrapper_vendor^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logwrapper/logwrapper_vendor^android_vendor.31_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_logging.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/logging/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_logging.tar.zst --clobber
