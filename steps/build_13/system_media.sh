...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libaudiospdif,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudiospdif^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libaudiospdif^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudiospdif^android_x86_64_shared

echo "building libaudioutils^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libaudioutils,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libaudioutils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_64_shared

echo "building libaudioutils^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libaudioutils,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libaudioutils^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_vendor.31_x86_x86_64_shared

echo "building libaudioutils^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libaudioutils,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libaudioutils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_64_shared

echo "building libaudioutils^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libaudioutils,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libaudioutils^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_utils/libaudioutils^android_x86_x86_64_shared

echo "building libradio_metadata^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libradio_metadata,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libradio_metadata^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_64_shared

echo "building libradio_metadata^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libradio_metadata,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libradio_metadata^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_vendor.31_x86_x86_64_shared

echo "building libradio_metadata^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libradio_metadata,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libradio_metadata^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_64_shared

echo "building libradio_metadata^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libradio_metadata,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/media/libradio_metadata^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/radio/libradio_metadata^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_media.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/media/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_media.tar.zst --clobber
