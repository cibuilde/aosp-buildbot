...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libmeminfo,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_vendor.31_x86_64_shared

echo "building libmeminfo^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libmeminfo,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/memory/libmeminfo/libmeminfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_64_shared

echo "building libmeminfo^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libmeminfo,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/memory/libmeminfo/libmeminfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/libmeminfo^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_memory_libmeminfo.tar.zst --clobber
