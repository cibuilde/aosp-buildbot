...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libbacktrace,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/libbacktrace^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_recovery_x86_64_shared

echo "building libbacktrace^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libbacktrace,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/libbacktrace^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_vendor.31_x86_64_shared

echo "building libbacktrace^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libbacktrace,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/libbacktrace^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_vendor.31_x86_x86_64_shared

echo "building libbacktrace^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libbacktrace,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/libbacktrace^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_x86_64_shared

echo "building libbacktrace^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja libbacktrace,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/libbacktrace^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libbacktrace/libbacktrace^android_x86_x86_64_shared

echo "building unwind_info^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja unwind_info,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_info^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/unwind_info^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_info^android_x86_64

echo "building unwind_reg_info^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja unwind_reg_info,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_reg_info^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/unwind_reg_info^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_reg_info^android_x86_64

echo "building unwind_symbols^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_13.ninja unwind_symbols,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_symbols^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_13/system/unwinding/unwind_symbols^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/unwinding/libunwindstack/unwind_symbols^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_unwinding.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/unwinding/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_13 system_unwinding.tar.zst --clobber
