...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroidemu,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/device/generic/goldfish-opengl/libandroidemu^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish-opengl/android-emu/libandroidemu^android_vendor.31_x86_64_shared

echo "building libandroidemu^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroidemu,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/device/generic/goldfish-opengl/libandroidemu^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish-opengl/android-emu/libandroidemu^android_vendor.31_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 device_generic_goldfish-opengl.tar.zst --clobber
