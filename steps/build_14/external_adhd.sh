...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libcras_sys,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/cras-sys/libcras_sys^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/adhd/libcras_sys^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/cras-sys/libcras_sys^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_adhd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/adhd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 external_adhd.tar.zst --clobber
