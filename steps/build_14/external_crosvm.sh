...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libassertions,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/assertions/libassertions^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libassertions^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/assertions/libassertions^android_x86_64_dylib

echo "building libassertions^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libassertions,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/assertions/libassertions^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libassertions^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/assertions/libassertions^android_x86_64_dylib_apex10000

echo "building libsync_rust^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsync_rust,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/sync/libsync_rust^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libsync_rust^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/sync/libsync_rust^android_x86_64_dylib

echo "building libsync_rust^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsync_rust,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/sync/libsync_rust^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libsync_rust^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/sync/libsync_rust^android_x86_64_dylib_apex10000

echo "building libsyscall_defines^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsyscall_defines,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/syscall_defines/libsyscall_defines^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libsyscall_defines^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/syscall_defines/libsyscall_defines^android_x86_64_dylib

echo "building libsyscall_defines^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsyscall_defines,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/syscall_defines/libsyscall_defines^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/crosvm/libsyscall_defines^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/syscall_defines/libsyscall_defines^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_crosvm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/crosvm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 external_crosvm.tar.zst --clobber
