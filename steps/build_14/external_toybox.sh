...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja toybox,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/toybox/toybox^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_recovery_x86_64

echo "building toybox^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja toybox,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/external/toybox/toybox^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/toybox/toybox^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_toybox.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/toybox/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 external_toybox.tar.zst --clobber
