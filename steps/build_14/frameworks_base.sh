...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/hwbinder-stubs-docs^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/hwui/libhwui^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/hwui/libhwui^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/hwui/libhwui^android_x86_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/hwui/libhwui^android_x86_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/input/libinputservice^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/input/libinputservice^android_x86_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/native/android/libandroid^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/native/android/libandroid^android_x86_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_x86_64_shared/ .
...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja hwbinder-stubs-docs,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/hwbinder-stubs-docs^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/hwbinder-stubs-docs^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/hwbinder-stubs-docs^android_common/addition_copy_files.output

echo "building hwbinder.stubs^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja hwbinder.stubs,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/hwbinder.stubs^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/hwbinder.stubs^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/hwbinder.stubs^android_common/addition_copy_files.output

echo "building libbootanimation^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libbootanimation,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libbootanimation^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/bootanimation/libbootanimation^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/bootanimation/libbootanimation^android_x86_64_shared/addition_copy_files.output

echo "building libhidcommand_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libhidcommand_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libhidcommand_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/hid/jni/libhidcommand_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/hid/jni/libhidcommand_jni^android_x86_64_shared/addition_copy_files.output

echo "building screencap^android_x86_64"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja screencap,android_x86_64
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/screencap^android_x86_64.output $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/screencap/screencap^android_x86_64 $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/screencap/screencap^android_x86_64/addition_copy_files.output

echo "building libuinputcommand_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libuinputcommand_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libuinputcommand_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/uinput/jni/libuinputcommand_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/uinput/jni/libuinputcommand_jni^android_x86_64_shared/addition_copy_files.output

echo "building libandroid_runtime^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid_runtime,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid_runtime^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/core/jni/libandroid_runtime^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/core/jni/libandroid_runtime^android_x86_64_shared/addition_copy_files.output

echo "building libandroid_runtime^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid_runtime,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid_runtime^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/core/jni/libandroid_runtime^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/core/jni/libandroid_runtime^android_x86_x86_64_shared/addition_copy_files.output

echo "building com.android.sysprop.localization^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja com.android.sysprop.localization,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/com.android.sysprop.localization^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.localization^android_common/addition_copy_files.output

echo "building com.android.sysprop.watchdog^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja com.android.sysprop.watchdog,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/com.android.sysprop.watchdog^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/core/sysprop/com.android.sysprop.watchdog^android_common/addition_copy_files.output

echo "building libdrmframework_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libdrmframework_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libdrmframework_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/drm/jni/libdrmframework_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/drm/jni/libdrmframework_jni^android_x86_64_shared/addition_copy_files.output

echo "building libdrmframework_jni^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libdrmframework_jni,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libdrmframework_jni^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/drm/jni/libdrmframework_jni^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/drm/jni/libdrmframework_jni^android_x86_x86_64_shared/addition_copy_files.output

echo "building updatable-driver-protos^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja updatable-driver-protos,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/updatable-driver-protos^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/graphics/proto/updatable-driver-protos^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/graphics/proto/updatable-driver-protos^android_common/addition_copy_files.output

echo "building libhwui^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libhwui,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libhwui^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_64_shared/addition_copy_files.output

echo "building libhwui^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libhwui,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libhwui^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/libhwui^android_x86_x86_64_shared/addition_copy_files.output

echo "building libinputservice^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libinputservice,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libinputservice^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/input/libinputservice^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/input/libinputservice^android_x86_64_shared/addition_copy_files.output

echo "building libinputservice^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libinputservice,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libinputservice^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/input/libinputservice^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/input/libinputservice^android_x86_x86_64_shared/addition_copy_files.output

echo "building libmedia_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libmedia_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libmedia_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni^android_x86_64_shared/addition_copy_files.output

echo "building libmedia_jni^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libmedia_jni,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libmedia_jni^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni^android_x86_x86_64_shared/addition_copy_files.output

echo "building libaudioeffect_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libaudioeffect_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libaudioeffect_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/audioeffect/libaudioeffect_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/audioeffect/libaudioeffect_jni^android_x86_64_shared/addition_copy_files.output

echo "building libaudioeffect_jni^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libaudioeffect_jni,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libaudioeffect_jni^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/audioeffect/libaudioeffect_jni^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/audioeffect/libaudioeffect_jni^android_x86_x86_64_shared/addition_copy_files.output

echo "building libsoundpool^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsoundpool,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libsoundpool^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/soundpool/libsoundpool^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/soundpool/libsoundpool^android_x86_64_shared/addition_copy_files.output

echo "building libsoundpool^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libsoundpool,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libsoundpool^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/soundpool/libsoundpool^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/soundpool/libsoundpool^android_x86_x86_64_shared/addition_copy_files.output

echo "building libfilterfw^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libfilterfw,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libfilterfw^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_64_shared/addition_copy_files.output

echo "building libfilterfw^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libfilterfw,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libfilterfw^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw^android_x86_x86_64_shared/addition_copy_files.output

echo "building libfilterpack_imageproc^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libfilterpack_imageproc,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libfilterpack_imageproc^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterpacks/libfilterpack_imageproc^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterpacks/libfilterpack_imageproc^android_x86_64_shared/addition_copy_files.output

echo "building libfilterpack_imageproc^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libfilterpack_imageproc,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libfilterpack_imageproc^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterpacks/libfilterpack_imageproc^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterpacks/libfilterpack_imageproc^android_x86_x86_64_shared/addition_copy_files.output

echo "building libamidi^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libamidi,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libamidi^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/native/midi/libamidi^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/native/midi/libamidi^android_x86_64_shared/addition_copy_files.output

echo "building libamidi^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libamidi,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libamidi^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/media/native/midi/libamidi^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/media/native/midi/libamidi^android_x86_x86_64_shared/addition_copy_files.output

echo "building libandroid^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid^android_x86_64_shared/addition_copy_files.output

echo "building libandroid^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/libandroid^android_x86_x86_64_shared/addition_copy_files.output

echo "building libjnigraphics^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libjnigraphics,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libjnigraphics^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_64_shared/addition_copy_files.output

echo "building libjnigraphics^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libjnigraphics,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libjnigraphics^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/graphics/jni/libjnigraphics^android_x86_x86_64_shared/addition_copy_files.output

echo "building libwebviewchromium_plat_support^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libwebviewchromium_plat_support,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libwebviewchromium_plat_support^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/plat_support/libwebviewchromium_plat_support^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/plat_support/libwebviewchromium_plat_support^android_x86_64_shared/addition_copy_files.output

echo "building libwebviewchromium_plat_support^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libwebviewchromium_plat_support,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libwebviewchromium_plat_support^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/plat_support/libwebviewchromium_plat_support^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/native/webview/plat_support/libwebviewchromium_plat_support^android_x86_x86_64_shared/addition_copy_files.output

echo "building libprintspooler_jni^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libprintspooler_jni,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libprintspooler_jni^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/PrintSpooler/jni/libprintspooler_jni^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/PrintSpooler/jni/libprintspooler_jni^android_x86_64_shared/addition_copy_files.output

echo "building libandroid_servers^android_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid_servers,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid_servers^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/libandroid_servers^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/services/libandroid_servers^android_x86_64_shared/addition_copy_files.output

echo "building libandroid_servers^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libandroid_servers,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_14/frameworks/base/libandroid_servers^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/libandroid_servers^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/base/services/libandroid_servers^android_x86_x86_64_shared/addition_copy_files.output
