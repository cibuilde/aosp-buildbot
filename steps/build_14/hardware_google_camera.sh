...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja lib_profiler,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/profiler/lib_profiler^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/hardware/google/camera/lib_profiler^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/profiler/lib_profiler^android_vendor.31_x86_64_shared

echo "building lib_profiler^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja lib_profiler,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/hardware/google/camera/lib_profiler^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/profiler/lib_profiler^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_google_camera.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/google/camera/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 hardware_google_camera.tar.zst --clobber
