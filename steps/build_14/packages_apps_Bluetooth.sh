...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libbluetooth_jni,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Bluetooth/libbluetooth_jni^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/packages/apps/Bluetooth/libbluetooth_jni^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Bluetooth/libbluetooth_jni^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf packages_apps_Bluetooth.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/packages/apps/Bluetooth/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 packages_apps_Bluetooth.tar.zst --clobber
