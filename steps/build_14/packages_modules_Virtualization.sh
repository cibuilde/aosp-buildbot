...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libauthfs_crypto_bindgen,android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/packages/modules/Virtualization/libauthfs_crypto_bindgen^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Virtualization/authfs/libauthfs_crypto_bindgen^android_x86_64_dylib_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 packages_modules_Virtualization.tar.zst --clobber
