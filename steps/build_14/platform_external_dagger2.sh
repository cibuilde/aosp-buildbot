...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/external/dagger2/dagger2^android_common.output . $GITHUB_WORKSPACE/artifacts/external/dagger2/dagger2^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 platform_external_dagger2.tar.zst --clobber
