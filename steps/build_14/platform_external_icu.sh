...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/external/icu/core-repackaged-icu4j^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/external/icu/core-icu4j^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-icu4j^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/external/icu/icu4j-platform-compat-config^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/icu4j-platform-compat-config^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/external/icu/core-repackaged-icu4j^android_common_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 platform_external_icu.tar.zst --clobber
