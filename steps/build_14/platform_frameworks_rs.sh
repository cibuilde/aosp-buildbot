...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRS_internal,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRS_internal^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_x86_x86_64_shared

echo "building libRS_internal^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRS_internal,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRS_internal^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS_internal^android_x86_64_shared

echo "building libRSCpuRef^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRSCpuRef,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRSCpuRef^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_x86_x86_64_shared

echo "building libRSDriver^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRSDriver,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRSDriver^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_x86_x86_64_shared

echo "building libRSCpuRef^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRSCpuRef,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRSCpuRef^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_x86_64_shared

echo "building libRSDriver^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libRSDriver,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/platform/frameworks/rs/libRSDriver^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 platform_frameworks_rs.tar.zst --clobber
