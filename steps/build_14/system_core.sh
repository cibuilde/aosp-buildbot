...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja bootstat,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/bootstat/bootstat^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/bootstat^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/bootstat/bootstat^android_x86_64

echo "building debuggerd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja debuggerd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/debuggerd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/debuggerd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/debuggerd/debuggerd^android_x86_64

echo "building liblp^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja liblp,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/liblp^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_recovery_x86_64_shared

echo "building liblp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja liblp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/liblp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/liblp/liblp^android_x86_64_shared

echo "building libutils^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libutils,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/libutils^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_recovery_x86_64_shared

echo "building libutils^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libutils,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/libutils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_x86_64_shared

echo "building libutils^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libutils,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/libutils^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutils^android_x86_x86_64_shared

echo "building libutilscallstack^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libutilscallstack,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/libutilscallstack^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_64_shared

echo "building libutilscallstack^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libutilscallstack,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/core/libutilscallstack^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/core/libutils/libutilscallstack^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_core.tar.zst --clobber
