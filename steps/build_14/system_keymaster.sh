...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_static/ .
...
echo "building lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja lib_android_keymaster_keymint_utils,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/lib_android_keymaster_keymint_utils^android_vendor.31_x86_64_shared

echo "building libkeymaster_portable^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libkeymaster_portable,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_portable^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/keymaster/libkeymaster_portable^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_portable^android_vendor.31_x86_64_shared

echo "building libkeymaster_portable^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libkeymaster_portable,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_portable^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/keymaster/libkeymaster_portable^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/keymaster/libkeymaster_portable^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_keymaster.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/keymaster/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_keymaster.tar.zst --clobber
