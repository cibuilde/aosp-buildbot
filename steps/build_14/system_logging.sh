...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja logcat,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logcat/logcat^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/logging/logcat^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/logging/logcat/logcat^android_x86_64

echo "building logd^android_x86_64_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja logd,android_x86_64_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/logging/logd/logd^android_x86_64_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/logging/logd^android_x86_64_cfi.output . $GITHUB_WORKSPACE/artifacts/system/logging/logd/logd^android_x86_64_cfi

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_logging.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/logging/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_logging.tar.zst --clobber
