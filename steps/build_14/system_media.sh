...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libaudioroute,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/media/libaudioroute^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_64_shared

echo "building libaudioroute^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libaudioroute,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/media/libaudioroute^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/media/audio_route/libaudioroute^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_media.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/media/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_media.tar.zst --clobber
