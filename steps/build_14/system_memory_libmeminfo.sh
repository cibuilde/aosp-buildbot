...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja librank,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/librank^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/memory/libmeminfo/librank^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/librank^android_x86_64

echo "building procrank^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja procrank,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/procrank^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/memory/libmeminfo/procrank^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/procrank^android_x86_64

echo "building showmap^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja showmap,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/showmap^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/memory/libmeminfo/showmap^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmeminfo/tools/showmap^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_memory_libmeminfo.tar.zst --clobber
