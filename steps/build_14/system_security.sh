...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja fsverity_init,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/fsverity_init/fsverity_init^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/security/fsverity_init^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/security/fsverity_init/fsverity_init^android_x86_64

echo "building libkeystore-engine-wifi-hidl^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libkeystore-engine-wifi-hidl,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/security/libkeystore-engine-wifi-hidl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore-engine/libkeystore-engine-wifi-hidl^android_vendor.31_x86_64_shared

echo "building libkeystore2_vintf_bindgen^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libkeystore2_vintf_bindgen,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/security/libkeystore2_vintf_bindgen^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/vintf/libkeystore2_vintf_bindgen^android_x86_64_rlib_rlib-std

echo "building libkeystore2_vintf_cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja libkeystore2_vintf_cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/vintf/libkeystore2_vintf_cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/security/libkeystore2_vintf_cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/src/vintf/libkeystore2_vintf_cpp^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_security.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/security/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_security.tar.zst --clobber
