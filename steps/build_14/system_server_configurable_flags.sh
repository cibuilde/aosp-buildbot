...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_14.ninja flags_health_check,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/server_configurable_flags/disaster_recovery/flags_health_check^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_14/system/server_configurable_flags/flags_health_check^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/server_configurable_flags/disaster_recovery/flags_health_check^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_14 system_server_configurable_flags.tar.zst --clobber
