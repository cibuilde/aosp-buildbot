...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern device_google_cuttlefish.tar.zst --output device_google_cuttlefish-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/device/google/cuttlefish
tar xf $GITHUB_WORKSPACE/device_google_cuttlefish-14.tar.zst -C $GITHUB_WORKSPACE/downloads/device/google/cuttlefish/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_07 --pattern external_freetype.tar.zst --output external_freetype-07.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/freetype
tar xf $GITHUB_WORKSPACE/external_freetype-07.tar.zst -C $GITHUB_WORKSPACE/downloads/external/freetype/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_04 --pattern frameworks_rs.tar.zst --output frameworks_rs-04.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/rs
tar xf $GITHUB_WORKSPACE/frameworks_rs-04.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/rs/
...
time source steps/build_15/external_adhd.sh
time source steps/build_15/external_conscrypt.sh
time source steps/build_15/external_crosvm.sh
time source steps/build_15/external_e2fsprogs.sh
time source steps/build_15/external_harfbuzz_ng.sh
time source steps/build_15/external_icu.sh
time source steps/build_15/external_libbrillo.sh
time source steps/build_15/external_libchromeos-rs.sh
time source steps/build_15/external_rust_crates_clap.sh
time source steps/build_15/external_rust_crates_crc32fast.sh
time source steps/build_15/external_rust_crates_futures-channel.sh
time source steps/build_15/external_rust_crates_getrandom.sh
time source steps/build_15/external_rust_crates_grpcio.sh
time source steps/build_15/external_rust_crates_intrusive-collections.sh
time source steps/build_15/external_rust_crates_libz-sys.sh
time source steps/build_15/external_rust_crates_log.sh
time source steps/build_15/external_rust_crates_macaddr.sh
time source steps/build_15/external_rust_crates_nix.sh
time source steps/build_15/external_rust_crates_num-integer.sh
time source steps/build_15/external_rust_crates_num_cpus.sh
time source steps/build_15/external_rust_crates_rusqlite.sh
time source steps/build_15/external_rust_crates_serde_json.sh
time source steps/build_15/external_rust_crates_uuid.sh
time source steps/build_15/external_rust_cxx.sh
time source steps/build_15/external_sqlite.sh
time source steps/build_15/frameworks_av.sh
time source steps/build_15/frameworks_base.sh
time source steps/build_15/frameworks_native.sh
time source steps/build_15/frameworks_rs.sh
time source steps/build_15/hardware_interfaces.sh
time source steps/build_15/hardware_libhardware_legacy.sh
time source steps/build_15/libcore.sh
time source steps/build_15/prebuilts_sdk.sh
time source steps/build_15/system_bpf.sh
time source steps/build_15/system_core.sh
time source steps/build_15/system_extras.sh
time source steps/build_15/system_hardware_interfaces.sh
time source steps/build_15/system_incremental_delivery.sh
time source steps/build_15/system_keymaster.sh
time source steps/build_15/system_libfmq.sh
time source steps/build_15/system_libhidl.sh
time source steps/build_15/system_security.sh
