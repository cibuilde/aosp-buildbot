...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja liblibcras,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/libcras/liblibcras^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/adhd/liblibcras^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/adhd/cras/client/libcras/liblibcras^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_adhd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/adhd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_adhd.tar.zst --clobber
