...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libcros_async,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/crosvm/libcros_async^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/cros_async/libcros_async^android_x86_64_rlib_rlib-std_apex10000

echo "building libdata_model^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libdata_model,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/crosvm/libdata_model^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib

echo "building libdata_model^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libdata_model,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/crosvm/libdata_model^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/data_model/libdata_model^android_x86_64_dylib_apex10000

echo "building libtempfile^android_x86_64_dylib"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libtempfile,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/crosvm/libtempfile^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib

echo "building libtempfile^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libtempfile,android_x86_64_dylib_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/crosvm/libtempfile^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/crosvm/tempfile/libtempfile^android_x86_64_dylib_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_crosvm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/crosvm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_crosvm.tar.zst --clobber
