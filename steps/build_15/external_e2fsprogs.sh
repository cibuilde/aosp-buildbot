...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja e2fsck,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/e2fsck/e2fsck^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/e2fsprogs/e2fsck^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/e2fsck/e2fsck^android_x86_64

echo "building libext2_misc^android_recovery_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libext2_misc,android_recovery_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/libext2_misc^android_recovery_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/e2fsprogs/libext2_misc^android_recovery_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/libext2_misc^android_recovery_x86_64_shared

echo "building libext2_misc^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libext2_misc,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/libext2_misc^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/e2fsprogs/libext2_misc^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/libext2_misc^android_x86_64_shared

echo "building libext2_quota^android_vendor_ramdisk_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libext2_quota,android_vendor_ramdisk_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/lib/support/libext2_quota^android_vendor_ramdisk_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/e2fsprogs/libext2_quota^android_vendor_ramdisk_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/lib/support/libext2_quota^android_vendor_ramdisk_x86_64_shared

echo "building tune2fs^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja tune2fs,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/tune2fs^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/e2fsprogs/tune2fs^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/tune2fs^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_e2fsprogs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_e2fsprogs.tar.zst --clobber
