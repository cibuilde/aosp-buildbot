...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja liblibchromeos,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/libchromeos-rs/liblibchromeos^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/libchromeos-rs/liblibchromeos^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/libchromeos-rs/liblibchromeos^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_libchromeos-rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/libchromeos-rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_libchromeos-rs.tar.zst --clobber
