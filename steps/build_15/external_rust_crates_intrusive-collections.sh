...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libintrusive_collections,android_x86_64_dylib
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/rust/crates/intrusive-collections/libintrusive_collections^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/intrusive-collections/libintrusive_collections^android_x86_64_dylib

echo "building libintrusive_collections^android_x86_64_dylib_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libintrusive_collections,android_x86_64_dylib_apex10000
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/rust/crates/intrusive-collections/libintrusive_collections^android_x86_64_dylib_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/intrusive-collections/libintrusive_collections^android_x86_64_dylib_apex10000
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_rust_crates_intrusive-collections.tar.zst --clobber
