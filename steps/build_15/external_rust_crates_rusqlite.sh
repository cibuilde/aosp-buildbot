...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja librusqlite,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/rusqlite/librusqlite^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/external/rust/crates/rusqlite/librusqlite^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/rusqlite/librusqlite^android_x86_64_rlib_rlib-std
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 external_rust_crates_rusqlite.tar.zst --clobber
