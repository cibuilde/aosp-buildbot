...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libRSCacheDir,android_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_15/frameworks/rs/libRSCacheDir^android_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSCacheDir^android_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSCacheDir^android_x86_64_shared/addition_copy_files.output

echo "building libRSCacheDir^android_x86_x86_64_shared"
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libRSCacheDir,android_x86_x86_64_shared
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_15/frameworks/rs/libRSCacheDir^android_x86_x86_64_shared.output $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSCacheDir^android_x86_x86_64_shared $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSCacheDir^android_x86_x86_64_shared/addition_copy_files.output
