...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libpower,android_vendor.31_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_64_static

echo "building libpower^android_vendor.31_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libpower,android_vendor.31_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware_legacy/libpower^android_vendor.31_x86_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 hardware_libhardware_legacy.tar.zst --clobber
