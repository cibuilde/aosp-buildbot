...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/platform/frameworks/av/libstagefright_http_support^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/http/libstagefright_http_support^android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/platform/frameworks/av/libstagefright_http_support^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/http/libstagefright_http_support^android_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/platform/frameworks/av/libcamera2ndk^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/camera/ndk/libcamera2ndk^android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/platform/frameworks/av/libcamera2ndk^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/camera/ndk/libcamera2ndk^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_frameworks_av.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/frameworks/av/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 platform_frameworks_av.tar.zst --clobber
