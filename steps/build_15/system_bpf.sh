...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libbpf_android,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bpf/libbpf_android/libbpf_android^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/system/bpf/libbpf_android^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/bpf/libbpf_android/libbpf_android^android_x86_64_shared

echo "building libbpf_android^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libbpf_android,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bpf/libbpf_android/libbpf_android^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/system/bpf/libbpf_android^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/bpf/libbpf_android/libbpf_android^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_bpf.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/bpf/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 system_bpf.tar.zst --clobber
