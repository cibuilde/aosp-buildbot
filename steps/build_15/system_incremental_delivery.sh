...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libdataloader,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/system/incremental_delivery/libdataloader^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_64_shared

echo "building libdataloader^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_15.ninja libdataloader,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_15/system/incremental_delivery/libdataloader^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/incremental_delivery/libdataloader/libdataloader^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_15 system_incremental_delivery.tar.zst --clobber
