...
download_with_retries android12-gsi_15 frameworks_av.tar.zst frameworks_av-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/av
...
download_with_retries android12-gsi_15 hardware_interfaces.tar.zst hardware_interfaces-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/hardware/interfaces
