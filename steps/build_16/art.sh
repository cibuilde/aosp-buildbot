...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja dex2oat,android_x86_64_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/dex2oat/dex2oat^android_x86_64_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/art/dex2oat^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/dex2oat^android_x86_64_apex31

echo "building dex2oat^android_x86_x86_64_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja dex2oat,android_x86_x86_64_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/dex2oat/dex2oat^android_x86_x86_64_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/art/dex2oat^android_x86_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/dex2oat/dex2oat^android_x86_x86_64_apex31

echo "building libopenjdkjvmti^android_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libopenjdkjvmti,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/art/libopenjdkjvmti^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_64_shared_apex31

echo "building libopenjdkjvmti^android_x86_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libopenjdkjvmti,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/art/libopenjdkjvmti^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/art/openjdkjvmti/libopenjdkjvmti^android_x86_x86_64_shared_apex31

echo "building oatdump^android_x86_64_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja oatdump,android_x86_64_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/art/oatdump/oatdump^android_x86_64_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/art/oatdump^android_x86_64_apex31.output . $GITHUB_WORKSPACE/artifacts/art/oatdump/oatdump^android_x86_64_apex31

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf art.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/art/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 art.tar.zst --clobber
