...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/misc/libext2_misc^android_recovery_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/misc/libext2_misc^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/support/libext2_quota^android_recovery_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/support/libext2_quota^android_vendor_ramdisk_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/support/libext2_quota^android_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/ext2fs/libext2fs^android_recovery_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/ext2fs/libext2fs^android_vendor_ramdisk_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/external/e2fsprogs/lib/ext2fs/libext2fs^android_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja e2fsck,android_vendor_ramdisk_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/e2fsck/e2fsck^android_vendor_ramdisk_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/e2fsprogs/e2fsck^android_vendor_ramdisk_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/e2fsck/e2fsck^android_vendor_ramdisk_x86_64

echo "building e2fsdroid^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja e2fsdroid,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/contrib/android/e2fsdroid^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/e2fsprogs/e2fsdroid^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/contrib/android/e2fsdroid^android_recovery_x86_64

echo "building e2fsdroid^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja e2fsdroid,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/contrib/android/e2fsdroid^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/e2fsprogs/e2fsdroid^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/contrib/android/e2fsdroid^android_x86_64

echo "building mke2fs^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja mke2fs,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/mke2fs^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/e2fsprogs/mke2fs^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/mke2fs^android_recovery_x86_64

echo "building mke2fs^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja mke2fs,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/mke2fs^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/e2fsprogs/mke2fs^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/misc/mke2fs^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_e2fsprogs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/e2fsprogs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 external_e2fsprogs.tar.zst --clobber
