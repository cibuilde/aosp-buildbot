...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libchrono,android_x86_64_dylib
mkdir -p $GITHUB_WORKSPACE/artifacts/external/rust/crates/chrono/libchrono^android_x86_64_dylib
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/rust/crates/chrono/libchrono^android_x86_64_dylib.output . $GITHUB_WORKSPACE/artifacts/external/rust/crates/chrono/libchrono^android_x86_64_dylib
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 external_rust_crates_chrono.tar.zst --clobber

du -ah -d1 external_rust_crates_chrono*.tar.zst | sort -h
