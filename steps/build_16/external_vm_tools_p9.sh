...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libp9,android_x86_64_rlib_rlib-std_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/vm_tools/p9/libp9^android_x86_64_rlib_rlib-std_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/external/vm_tools/p9/libp9^android_x86_64_rlib_rlib-std_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/vm_tools/p9/libp9^android_x86_64_rlib_rlib-std_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_vm_tools_p9.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/vm_tools/p9/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 external_vm_tools_p9.tar.zst --clobber
