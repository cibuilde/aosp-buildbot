...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja audio_common-aidl-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/audio_common-aidl-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp^android_x86_64_static

echo "building audio_common-aidl-cpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja audio_common-aidl-cpp,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/audio_common-aidl-cpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/audio_common-aidl-cpp^android_x86_x86_64_static

echo "building incident_helper^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja incident_helper,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident_helper/incident_helper^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/incident_helper^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident_helper/incident_helper^android_x86_64

echo "building lib-platform-compat-native-api^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja lib-platform-compat-native-api,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/lib-platform-compat-native-api^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/lib-platform-compat-native-api^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/lib-platform-compat-native-api^android_x86_64_shared

echo "building lib-platform-compat-native-api^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja lib-platform-compat-native-api,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/lib-platform-compat-native-api^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/native/android/lib-platform-compat-native-api^android_x86_x86_64_shared

echo "building libandroidfw^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libandroidfw,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libandroidfw^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^android_x86_64_shared

echo "building libandroidfw^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libandroidfw,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libandroidfw^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/androidfw/libandroidfw^android_x86_x86_64_shared

echo "building libincremental_aidl-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libincremental_aidl-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_aidl-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libincremental_aidl-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_aidl-cpp^android_x86_64_static

echo "building libincremental_aidl-cpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libincremental_aidl-cpp,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_aidl-cpp^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libincremental_aidl-cpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_aidl-cpp^android_x86_x86_64_static

echo "building libservices^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libservices,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/services/libservices^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libservices^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/services/libservices^android_x86_64_shared

echo "building libstorage^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libstorage,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/storage/libstorage^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libstorage^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/storage/libstorage^android_x86_64_static

echo "building libstorage^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libstorage,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/storage/libstorage^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libstorage^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/storage/libstorage^android_x86_x86_64_static

echo "building libtracingproxy^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libtracingproxy,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/tracingproxy/libtracingproxy^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/libtracingproxy^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/tracingproxy/libtracingproxy^android_x86_64_shared

echo "building media_permission-aidl-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja media_permission-aidl-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/base/media_permission-aidl-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/media_permission-aidl-cpp^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_base.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/base/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 frameworks_base.tar.zst --clobber
