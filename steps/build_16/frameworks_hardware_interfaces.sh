...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.cameraservice.common@2.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.displayservice@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/displayservice/1.0/android.frameworks.displayservice@1.0^android_x86_64_shared

echo "building android.frameworks.schedulerservice@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.schedulerservice@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.schedulerservice@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/schedulerservice/1.0/android.frameworks.schedulerservice@1.0^android_x86_64_shared

echo "building android.frameworks.schedulerservice@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.schedulerservice@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.schedulerservice@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/schedulerservice/1.0/android.frameworks.schedulerservice@1.0^android_x86_x86_64_shared

echo "building android.frameworks.sensorservice@1.0^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.sensorservice@1.0,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.sensorservice@1.0^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/sensorservice/1.0/android.frameworks.sensorservice@1.0^android_vendor.31_x86_64_shared

echo "building android.frameworks.sensorservice@1.0^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.sensorservice@1.0,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.sensorservice@1.0^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/sensorservice/1.0/android.frameworks.sensorservice@1.0^android_vendor.31_x86_x86_64_shared

echo "building android.frameworks.stats@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.stats@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.stats@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/stats/1.0/android.frameworks.stats@1.0^android_x86_64_shared

echo "building android.frameworks.stats@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.frameworks.stats@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/hardware/interfaces/android.frameworks.stats@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/stats/1.0/android.frameworks.stats@1.0^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 frameworks_hardware_interfaces.tar.zst --clobber
