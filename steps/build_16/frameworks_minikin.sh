...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libminikin,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/minikin/libminikin^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_64_shared

echo "building libminikin^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libminikin,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/minikin/libminikin^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/minikin/libs/minikin/libminikin^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_minikin.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/minikin/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 frameworks_minikin.tar.zst --clobber
