...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libRSCpuRef,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/rs/libRSCpuRef^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_64_shared

echo "building libRSCpuRef^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libRSCpuRef,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/frameworks/rs/libRSCpuRef^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpu_ref/libRSCpuRef^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 frameworks_rs.tar.zst --clobber
