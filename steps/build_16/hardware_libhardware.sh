...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja audio.r_submix.default,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/hardware/libhardware/audio.r_submix.default^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio_remote_submix/audio.r_submix.default^android_vendor.31_x86_64_shared

echo "building audio.r_submix.default^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja audio.r_submix.default,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/hardware/libhardware/audio.r_submix.default^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/libhardware/modules/audio_remote_submix/audio.r_submix.default^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_libhardware.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/libhardware/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 hardware_libhardware.tar.zst --clobber
