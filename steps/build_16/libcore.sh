...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libopenjdk,android_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/libopenjdk^android_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/libcore/libopenjdk^android_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/libcore/libopenjdk^android_x86_64_shared_apex31

echo "building libopenjdk^android_x86_x86_64_shared_apex31"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libopenjdk,android_x86_x86_64_shared_apex31
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/libopenjdk^android_x86_x86_64_shared_apex31
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/libcore/libopenjdk^android_x86_x86_64_shared_apex31.output . $GITHUB_WORKSPACE/artifacts/libcore/libopenjdk^android_x86_x86_64_shared_apex31

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/libcore/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 libcore.tar.zst --clobber
