...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja dnsresolver_aidl_interface-V7-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 packages_modules_DnsResolver.tar.zst --clobber
