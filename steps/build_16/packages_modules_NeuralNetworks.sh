...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libneuralnetworks_packageinfo,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/packages/modules/NeuralNetworks/libneuralnetworks_packageinfo^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/runtime/packageinfo/libneuralnetworks_packageinfo^android_x86_64_shared

echo "building libneuralnetworks_packageinfo^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libneuralnetworks_packageinfo,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/packages/modules/NeuralNetworks/libneuralnetworks_packageinfo^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/runtime/packageinfo/libneuralnetworks_packageinfo^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 packages_modules_NeuralNetworks.tar.zst --clobber
