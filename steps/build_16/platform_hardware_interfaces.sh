...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.supplicant-V1.0-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/supplicant/1.0/android.hardware.wifi.supplicant-V1.0-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.supplicant-V1.1-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/supplicant/1.1/android.hardware.wifi.supplicant-V1.1-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.supplicant-V1.2-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/supplicant/1.2/android.hardware.wifi.supplicant-V1.2-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.supplicant-V1.3-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/supplicant/1.3/android.hardware.wifi.supplicant-V1.3-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.supplicant-V1.4-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/supplicant/1.4/android.hardware.wifi.supplicant-V1.4-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.hostapd-V1.0-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/hostapd/1.0/android.hardware.wifi.hostapd-V1.0-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.hostapd-V1.1-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/hostapd/1.1/android.hardware.wifi.hostapd-V1.1-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.hostapd-V1.2-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/hostapd/1.2/android.hardware.wifi.hostapd-V1.2-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi.hostapd-V1.3-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/hostapd/1.3/android.hardware.wifi.hostapd-V1.3-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.0-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.0/android.hardware.wifi-V1.0-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.1-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.1/android.hardware.wifi-V1.1-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.2-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.2/android.hardware.wifi-V1.2-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.3-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.3/android.hardware.wifi-V1.3-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.4-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.4/android.hardware.wifi-V1.4-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.wifi-V1.5-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/wifi/1.5/android.hardware.wifi-V1.5-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.tetheroffload.control-V1.0-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/tetheroffload/control/1.0/android.hardware.tetheroffload.control-V1.0-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.tetheroffload.control-V1.1-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/tetheroffload/control/1.1/android.hardware.tetheroffload.control-V1.1-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/platform/hardware/interfaces/android.hardware.tetheroffload.config-V1.0-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/hardware/interfaces/tetheroffload/config/1.0/android.hardware.tetheroffload.config-V1.0-java^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 platform_hardware_interfaces.tar.zst --clobber
