...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbt_common,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/common/libbt_common^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbt_common^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/common/libbt_common^android_x86_64_rlib_rlib-std

echo "building libbt_common^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbt_common,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/common/libbt_common^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbt_common^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/common/libbt_common^android_x86_x86_64_rlib_rlib-std

echo "building libbt_facade_proto^android_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbt_facade_proto,android_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/libbt_facade_proto^android_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbt_facade_proto^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/libbt_facade_proto^android_x86_64_rlib_rlib-std

echo "building libbt_facade_proto^android_x86_x86_64_rlib_rlib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbt_facade_proto,android_x86_x86_64_rlib_rlib-std
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/libbt_facade_proto^android_x86_x86_64_rlib_rlib-std
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbt_facade_proto^android_x86_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/libbt_facade_proto^android_x86_x86_64_rlib_rlib-std

echo "building libbtif^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbtif,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbtif^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_64_static

echo "building libbtif^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libbtif,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/bt/libbtif^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/btif/libbtif^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_bt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/bt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 system_bt.tar.zst --clobber
