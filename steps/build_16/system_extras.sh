...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja liblpdump,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/liblpdump^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/extras/liblpdump^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/liblpdump^android_x86_64_shared

echo "building liblpdump_interface-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja liblpdump_interface-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/aidl/liblpdump_interface-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/extras/liblpdump_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/aidl/liblpdump_interface-cpp^android_x86_64_static

echo "building libprofcollect_libbase_rust^android_x86_64_rlib_dylib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libprofcollect_libbase_rust,android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/extras/libprofcollect_libbase_rust^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libbase/libprofcollect_libbase_rust^android_x86_64_rlib_dylib-std

echo "building libprofcollect_libflags_rust^android_x86_64_rlib_dylib-std"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libprofcollect_libflags_rust,android_x86_64_rlib_dylib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/extras/libprofcollect_libflags_rust^android_x86_64_rlib_dylib-std.output . $GITHUB_WORKSPACE/artifacts/system/extras/profcollectd/libprofcollectd/bindings/libflags/libprofcollect_libflags_rust^android_x86_64_rlib_dylib-std

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 system_extras.tar.zst --clobber
