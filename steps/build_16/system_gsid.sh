...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja gsi_aidl_interface-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_aidl_interface-cpp^android_x86_64_static

echo "building libgsid^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libgsid,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/gsid/libgsid^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/gsid/libgsid^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_gsid.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/gsid/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 system_gsid.tar.zst --clobber
