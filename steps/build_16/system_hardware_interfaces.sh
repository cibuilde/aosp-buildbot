...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.keystore2-V1-cpp,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.keystore2-V1-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-cpp^android_x86_64_static

echo "building android.system.net.netd@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.net.netd@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.net.netd@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/net/netd/1.0/android.system.net.netd@1.0^android_x86_64_shared

echo "building android.system.suspend.control-V1-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend.control-V1-cpp,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend.control-V1-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl/android.system.suspend.control-V1-cpp^android_x86_64_static

echo "building android.system.suspend.control-V1-cpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend.control-V1-cpp,android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend.control-V1-cpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl/android.system.suspend.control-V1-cpp^android_x86_x86_64_static

echo "building android.system.suspend.control.internal-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend.control.internal-cpp,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend.control.internal-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl/android.system.suspend.control.internal-cpp^android_x86_64_static

echo "building android.system.suspend.control.internal-cpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend.control.internal-cpp,android_x86_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend.control.internal-cpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/aidl/android.system.suspend.control.internal-cpp^android_x86_x86_64_static

echo "building android.system.suspend@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/1.0/android.system.suspend@1.0^android_x86_64_shared

echo "building android.system.suspend@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.suspend@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.suspend@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/1.0/android.system.suspend@1.0^android_x86_x86_64_shared

echo "building android.system.wifi.keystore@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja android.system.wifi.keystore@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/android.system.wifi.keystore@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/wifi/keystore/1.0/android.system.wifi.keystore@1.0^android_x86_64_shared

echo "building libwifikeystorehal^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libwifikeystorehal,android_x86_64_static
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/hardware/interfaces/libwifikeystorehal^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/wifi/keystore/1.0/default/libwifikeystorehal^android_x86_64_static
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 system_hardware_interfaces.tar.zst --clobber
