...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libnetd_server,android_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/libnetd_server^android_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/libnetd_server^android_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/libnetd_server^android_x86_64_static_cfi

echo "building libnetdbpf^android_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libnetdbpf,android_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/libnetdbpf^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_64_shared_cfi

echo "building libnetdbpf^android_x86_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja libnetdbpf,android_x86_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/libnetdbpf^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/system/netd/libnetdbpf/libnetdbpf^android_x86_x86_64_shared_cfi

echo "building netd_aidl_interface-V6-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja netd_aidl_interface-V6-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/netd_aidl_interface-V6-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_static

echo "building netd_aidl_interface-V7-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja netd_aidl_interface-V7-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/netd_aidl_interface-V7-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_static

echo "building netd_event_listener_interface-V1-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja netd_event_listener_interface-V1-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/netd_event_listener_interface-V1-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_static

echo "building oemnetd_aidl_interface-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_16.ninja oemnetd_aidl_interface-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_16/system/netd/oemnetd_aidl_interface-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_16 system_netd.tar.zst --clobber
