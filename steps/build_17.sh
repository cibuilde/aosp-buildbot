...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_conscrypt.tar.zst --output external_conscrypt-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/conscrypt
tar xf $GITHUB_WORKSPACE/external_conscrypt-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/conscrypt/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_09 --pattern external_google-fruit.tar.zst --output external_google-fruit-09.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/google-fruit
tar xf $GITHUB_WORKSPACE/external_google-fruit-09.tar.zst -C $GITHUB_WORKSPACE/downloads/external/google-fruit/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_icu.tar.zst --output external_icu-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/icu
tar xf $GITHUB_WORKSPACE/external_icu-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/icu/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern external_libbrillo.tar.zst --output external_libbrillo-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/libbrillo
tar xf $GITHUB_WORKSPACE/external_libbrillo-14.tar.zst -C $GITHUB_WORKSPACE/downloads/external/libbrillo/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_libbrillo.tar.zst --output external_libbrillo-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/libbrillo
tar xf $GITHUB_WORKSPACE/external_libbrillo-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/libbrillo/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_libbrillo.tar.zst --output external_libbrillo-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/libbrillo
tar xf $GITHUB_WORKSPACE/external_libbrillo-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/libbrillo/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_08 --pattern frameworks_hardware_interfaces.tar.zst --output frameworks_hardware_interfaces-08.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/hardware/interfaces
tar xf $GITHUB_WORKSPACE/frameworks_hardware_interfaces-08.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/hardware/interfaces/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern frameworks_rs.tar.zst --output frameworks_rs-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/rs
tar xf $GITHUB_WORKSPACE/frameworks_rs-15.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/rs/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern frameworks_rs.tar.zst --output frameworks_rs-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/rs
tar xf $GITHUB_WORKSPACE/frameworks_rs-16.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/rs/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_10 --pattern hardware_interfaces.tar.zst --output hardware_interfaces-10.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/hardware/interfaces
tar xf $GITHUB_WORKSPACE/hardware_interfaces-10.tar.zst -C $GITHUB_WORKSPACE/downloads/hardware/interfaces/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_07 --pattern packages_modules_Gki.tar.zst --output packages_modules_Gki-07.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/packages/modules/Gki
tar xf $GITHUB_WORKSPACE/packages_modules_Gki-07.tar.zst -C $GITHUB_WORKSPACE/downloads/packages/modules/Gki/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_apex.tar.zst --output system_apex-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/apex
tar xf $GITHUB_WORKSPACE/system_apex-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/apex/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_03 --pattern system_connectivity_wificond.tar.zst --output system_connectivity_wificond-03.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/connectivity/wificond
tar xf $GITHUB_WORKSPACE/system_connectivity_wificond-03.tar.zst -C $GITHUB_WORKSPACE/downloads/system/connectivity/wificond/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_07 --pattern system_hwservicemanager.tar.zst --output system_hwservicemanager-07.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/hwservicemanager
tar xf $GITHUB_WORKSPACE/system_hwservicemanager-07.tar.zst -C $GITHUB_WORKSPACE/downloads/system/hwservicemanager/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_iorap.tar.zst --output system_iorap-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/iorap
tar xf $GITHUB_WORKSPACE/system_iorap-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/iorap/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_netd.tar.zst --output system_netd-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/netd
tar xf $GITHUB_WORKSPACE/system_netd-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/netd/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_06 --pattern system_tools_aidl.tar.zst --output system_tools_aidl-06.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/tools/aidl
tar xf $GITHUB_WORKSPACE/system_tools_aidl-06.tar.zst -C $GITHUB_WORKSPACE/downloads/system/tools/aidl/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_tools_aidl.tar.zst --output system_tools_aidl-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/tools/aidl
tar xf $GITHUB_WORKSPACE/system_tools_aidl-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/tools/aidl/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_07 --pattern system_update_engine.tar.zst --output system_update_engine-07.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/update_engine
tar xf $GITHUB_WORKSPACE/system_update_engine-07.tar.zst -C $GITHUB_WORKSPACE/downloads/system/update_engine/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_update_engine.tar.zst --output system_update_engine-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/update_engine
tar xf $GITHUB_WORKSPACE/system_update_engine-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/update_engine/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_09 --pattern tools_dexter.tar.zst --output tools_dexter-09.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/tools/dexter
tar xf $GITHUB_WORKSPACE/tools_dexter-09.tar.zst -C $GITHUB_WORKSPACE/downloads/tools/dexter/
...
time source steps/build_17/device_google_cuttlefish.sh
time source steps/build_17/external_crosvm.sh
time source steps/build_17/external_rust_crates_android_logger.sh
time source steps/build_17/external_rust_crates_futures-executor.sh
time source steps/build_17/external_rust_crates_rand_chacha.sh
time source steps/build_17/external_rust_crates_zip.sh
time source steps/build_17/frameworks_av.sh
time source steps/build_17/frameworks_base.sh
time source steps/build_17/frameworks_hardware_interfaces.sh
time source steps/build_17/frameworks_native.sh
time source steps/build_17/frameworks_rs.sh
time source steps/build_17/hardware_interfaces.sh
time source steps/build_17/hardware_libhardware_legacy.sh
time source steps/build_17/libcore.sh
time source steps/build_17/packages_modules_NeuralNetworks.sh
time source steps/build_17/packages_modules_StatsD.sh
time source steps/build_17/packages_modules_adb.sh
time source steps/build_17/prebuilts_sdk.sh
time source steps/build_17/system_apex.sh
time source steps/build_17/system_bt.sh
time source steps/build_17/system_connectivity_wificond.sh
time source steps/build_17/system_core.sh
time source steps/build_17/system_extras.sh
time source steps/build_17/system_gsid.sh
time source steps/build_17/system_hardware_interfaces.sh
time source steps/build_17/system_hwservicemanager.sh
time source steps/build_17/system_iorap.sh
time source steps/build_17/system_keymaster.sh
time source steps/build_17/system_libhidl.sh
time source steps/build_17/system_netd.sh
time source steps/build_17/system_security.sh
time source steps/build_17/system_tools_aidl.sh
time source steps/build_17/system_update_engine.sh
time source steps/build_17/system_vold.sh
