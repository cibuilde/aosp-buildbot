...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja suspend_blocker,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/device/google/cuttlefish/suspend_blocker^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/services/suspend_blocker/suspend_blocker^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 device_google_cuttlefish.tar.zst --clobber
