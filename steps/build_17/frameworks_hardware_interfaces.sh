...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja android.frameworks.cameraservice.device@2.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/hardware/interfaces/android.frameworks.sensorservice@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/sensorservice/1.0/android.frameworks.sensorservice@1.0^android_x86_64_shared

echo "building android.frameworks.sensorservice@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja android.frameworks.sensorservice@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/hardware/interfaces/android.frameworks.sensorservice@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/sensorservice/1.0/android.frameworks.sensorservice@1.0^android_x86_x86_64_shared

echo "building android.frameworks.stats-V1-ndk_platform^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja android.frameworks.stats-V1-ndk_platform,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/hardware/interfaces/android.frameworks.stats-V1-ndk_platform^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/stats/aidl/android.frameworks.stats-V1-ndk_platform^android_x86_64_shared

echo "building android.frameworks.stats-V1-ndk_platform^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja android.frameworks.stats-V1-ndk_platform,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/hardware/interfaces/android.frameworks.stats-V1-ndk_platform^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/stats/aidl/android.frameworks.stats-V1-ndk_platform^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 frameworks_hardware_interfaces.tar.zst --clobber
