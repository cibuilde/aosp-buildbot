...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/rs/cpp/libRSDispatch^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/rs/cpp/libRSDispatch^android_x86_x86_64_static/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/hardware/interfaces/renderscript/1.0/android.hardware.renderscript@1.0^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/hardware/interfaces/renderscript/1.0/android.hardware.renderscript@1.0^android_x86_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libRSDriver,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_64_shared

echo "building libRSDriver^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libRSDriver,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/rs/libRSDriver^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRSDriver^android_vendor.31_x86_x86_64_shared

echo "building libRS^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libRS,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/rs/libRS^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS^android_x86_64_shared

echo "building libRS^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libRS,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/frameworks/rs/libRS^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/libRS^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 frameworks_rs.tar.zst --clobber
