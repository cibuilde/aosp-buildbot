...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja android.hardware.neuralnetworks-shim-service-sample,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-shim-service-sample^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_shim/android.hardware.neuralnetworks-shim-service-sample^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 packages_modules_NeuralNetworks.tar.zst --clobber
