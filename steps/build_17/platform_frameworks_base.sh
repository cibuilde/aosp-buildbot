...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/test-api-stubs-docs-non-updatable^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/test-api-stubs-docs-non-updatable^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/system-api-stubs-docs-non-updatable^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/system-api-stubs-docs-non-updatable^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/module-lib-api-stubs-docs-non-updatable^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/module-lib-api-stubs-docs-non-updatable^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs.source.system^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs.source.system^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs.system^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs.system^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs.source^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs.source.module_lib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs.source.module_lib^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/framework-graphics.stubs.module_lib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/hwui/framework-graphics.stubs.module_lib^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/bootanimation^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/bootanimation/bootanimation^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/app_process^android_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/app_process/app_process^android_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/app_process^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/app_process/app_process^android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/api-stubs-docs-non-updatable^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/api-stubs-docs-non-updatable^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/android-non-updatable.stubs.module_lib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs.module_lib^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/platform/frameworks/base/android_module_lib_stubs_current^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android_module_lib_stubs_current^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 platform_frameworks_base.tar.zst --clobber
