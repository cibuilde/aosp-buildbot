...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libfs_mgr_binder,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr_binder^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/core/libfs_mgr_binder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/core/fs_mgr/libfs_mgr_binder^android_x86_64_static

echo "building usbd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja usbd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/core/usbd/usbd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/core/usbd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/core/usbd/usbd^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_core.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/core/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_core.tar.zst --clobber
