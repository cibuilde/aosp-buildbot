...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja hwservicemanager,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/hwservicemanager^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/hwservicemanager/hwservicemanager^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/hwservicemanager^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_hwservicemanager.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/hwservicemanager/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_hwservicemanager.tar.zst --clobber
