...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja iorap.inode2filename,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.inode2filename^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/iorap.inode2filename^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.inode2filename^android_x86_64

echo "building libiorap-compiler^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-compiler,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-compiler^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-compiler^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-compiler^android_x86_64_static

echo "building libiorap-db^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-db,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-db^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-db^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-db^android_x86_64_static

echo "building libiorap-inode2filename^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-inode2filename,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-inode2filename^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-inode2filename^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-inode2filename^android_x86_64_static

echo "building libiorap-maintenance^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-maintenance,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-maintenance^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-maintenance^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-maintenance^android_x86_64_static

echo "building libiorap-manager^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-manager,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-manager^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-manager^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-manager^android_x86_64_static

echo "building libiorap-perfetto^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-perfetto,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-perfetto^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-perfetto^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-perfetto^android_x86_64_static

echo "building libiorap-prefetcher^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-prefetcher,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-prefetcher^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-prefetcher^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-prefetcher^android_x86_64_static

echo "building libiorap-serialize^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libiorap-serialize,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-serialize^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/iorap/libiorap-serialize^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/iorap/libiorap-serialize^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_iorap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/iorap/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_iorap.tar.zst --clobber
