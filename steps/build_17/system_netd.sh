...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja netd_aidl_interface-V6-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/netd/netd_aidl_interface-V6-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V6-cpp^android_x86_64_shared

echo "building netd_aidl_interface-V7-cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja netd_aidl_interface-V7-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/netd/netd_aidl_interface-V7-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-cpp^android_x86_64_shared

echo "building netd_event_listener_interface-V1-cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja netd_event_listener_interface-V1-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/netd/netd_event_listener_interface-V1-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-cpp^android_x86_64_shared

echo "building oemnetd_aidl_interface-cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja oemnetd_aidl_interface-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/netd/oemnetd_aidl_interface-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/oemnetd_aidl_interface-cpp^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_netd.tar.zst --clobber
