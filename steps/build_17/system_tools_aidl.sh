...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja aidl_lazy_test_server,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/tools/aidl/tests/lazy_test/aidl_lazy_test_server^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/tools/aidl/aidl_lazy_test_server^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/tools/aidl/tests/lazy_test/aidl_lazy_test_server^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_tools_aidl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/tools/aidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_tools_aidl.tar.zst --clobber
