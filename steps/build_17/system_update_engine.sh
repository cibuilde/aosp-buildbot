...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libupdate_engine_android,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_android^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/update_engine/libupdate_engine_android^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_android^android_x86_64_static

echo "building libupdate_engine_boot_control^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libupdate_engine_boot_control,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_boot_control^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/update_engine/libupdate_engine_boot_control^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/libupdate_engine_boot_control^android_x86_64_static

echo "building libupdate_engine_stable-V1-cpp^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libupdate_engine_stable-V1-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/update_engine/stable/libupdate_engine_stable-V1-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/update_engine/libupdate_engine_stable-V1-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/stable/libupdate_engine_stable-V1-cpp^android_x86_64_shared

echo "building update_engine_client^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja update_engine_client,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/update_engine/update_engine_client^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/update_engine/update_engine_client^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/update_engine/update_engine_client^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_update_engine.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/update_engine/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_update_engine.tar.zst --clobber
