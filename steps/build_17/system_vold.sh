...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libvold_binder,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/vold/libvold_binder^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_64_static

echo "building libvold_binder^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_17.ninja libvold_binder,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_17/system/vold/libvold_binder^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold_binder^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_vold.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/vold/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_17 system_vold.tar.zst --clobber
