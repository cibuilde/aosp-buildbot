...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libupdate_verifier,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/bootable/recovery/libupdate_verifier^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/update_verifier/libupdate_verifier^android_x86_64_static

echo "building minadbd^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja minadbd,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/minadbd/minadbd^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/bootable/recovery/minadbd^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/minadbd/minadbd^android_recovery_x86_64

echo "building recovery^android_recovery_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja recovery,android_recovery_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery^android_recovery_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/bootable/recovery/recovery^android_recovery_x86_64.output . $GITHUB_WORKSPACE/artifacts/bootable/recovery/recovery^android_recovery_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf bootable_recovery.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/bootable/recovery/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 bootable_recovery.tar.zst --clobber
