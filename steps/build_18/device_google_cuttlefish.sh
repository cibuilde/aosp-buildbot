...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja android.hardware.health@2.1-impl-cuttlefish,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/device/google/cuttlefish/android.hardware.health@2.1-impl-cuttlefish^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/hals/health/android.hardware.health@2.1-impl-cuttlefish^android_vendor.31_x86_64_shared

echo "building android.hardware.health@2.1-impl-cuttlefish^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja android.hardware.health@2.1-impl-cuttlefish,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/device/google/cuttlefish/android.hardware.health@2.1-impl-cuttlefish^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/hals/health/android.hardware.health@2.1-impl-cuttlefish^android_vendor.31_x86_x86_64_shared

echo "building cuttlefish_sensor_injection^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja cuttlefish_sensor_injection,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/device/google/cuttlefish/cuttlefish_sensor_injection^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/device/google/cuttlefish/guest/commands/sensor_injection/cuttlefish_sensor_injection^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 device_google_cuttlefish.tar.zst --clobber
