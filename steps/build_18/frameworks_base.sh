...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/cmds/incidentd/incidentd_section_list^/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/cmds/idmap2/libidmap2_policies^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/cmds/idmap2/libidmap2_protos^android_x86_64_static/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/incident/libincidentpriv^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/incident/libincidentpriv^android_x86_x86_64_shared/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/services/libservices^android_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja incident,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident/incident^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/incident^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incident/incident^android_x86_64

echo "building incidentd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja incidentd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/incidentd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/incidentd/incidentd^android_x86_64

echo "building libidmap2^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libidmap2,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/libidmap2^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/libidmap2^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/libidmap2^android_x86_64_shared

echo "building libincident^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libincident,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/incident/libincident^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/libincident^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/incident/libincident^android_x86_64_shared

echo "building libincident^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libincident,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/incident/libincident^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/libincident^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/libs/incident/libincident^android_x86_x86_64_shared

echo "building libincremental_manager_aidl-cpp^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libincremental_manager_aidl-cpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_manager_aidl-cpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/libincremental_manager_aidl-cpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_manager_aidl-cpp^android_x86_64_static

echo "building libincremental_manager_aidl-cpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libincremental_manager_aidl-cpp,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_manager_aidl-cpp^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/frameworks/base/libincremental_manager_aidl-cpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/libincremental_manager_aidl-cpp^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_base.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/base/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 frameworks_base.tar.zst --clobber
