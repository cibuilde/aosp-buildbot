...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja android.frameworks.cameraservice.device@2.1,android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 frameworks_hardware_interfaces.tar.zst --clobber
