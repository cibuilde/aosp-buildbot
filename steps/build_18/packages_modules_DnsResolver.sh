...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja dnsresolver_aidl_interface-V7-cpp,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V7-cpp^android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 packages_modules_DnsResolver.tar.zst --clobber
