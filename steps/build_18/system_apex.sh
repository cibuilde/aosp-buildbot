...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libapexd,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/apex/libapexd^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd^android_x86_64_static

echo "building libapexd_checkpoint_vold^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libapexd_checkpoint_vold,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd_checkpoint_vold^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/apex/libapexd_checkpoint_vold^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexd_checkpoint_vold^android_x86_64_static

echo "building libapexservice^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libapexservice,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexservice^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/apex/libapexservice^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/apex/apexd/libapexservice^android_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_apex.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/apex/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_apex.tar.zst --clobber
