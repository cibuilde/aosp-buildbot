...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja lpdump,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdump^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/extras/lpdump^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdump^android_x86_64

echo "building lpdumpd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja lpdumpd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdumpd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/extras/lpdumpd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/extras/partition_tools/lpdumpd^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_extras.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/extras/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_extras.tar.zst --clobber
