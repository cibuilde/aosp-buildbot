...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja gsi_tool,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/gsid/gsi_tool^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsi_tool^android_x86_64

echo "building gsid^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja gsid,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/gsid/gsid^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/gsid/gsid^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/gsid/gsid^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_gsid.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/gsid/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_gsid.tar.zst --clobber
