...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja android.system.suspend@1.0-service,android_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/hardware/interfaces/android.system.suspend@1.0-service^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/suspend/1.0/default/android.system.suspend@1.0-service^android_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_hardware_interfaces.tar.zst --clobber
