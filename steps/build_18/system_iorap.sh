...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja iorap.cmd.compiler,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.compiler^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/iorap/iorap.cmd.compiler^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.compiler^android_x86_64

echo "building iorap.cmd.maintenance^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja iorap.cmd.maintenance,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.maintenance^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/iorap/iorap.cmd.maintenance^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.cmd.maintenance^android_x86_64

echo "building iorap.prefetcherd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja iorap.prefetcherd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.prefetcherd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/iorap/iorap.prefetcherd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorap.prefetcherd^android_x86_64

echo "building iorapd^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja iorapd,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/iorap/iorapd^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/iorap/iorapd^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/iorap/iorapd^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_iorap.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/iorap/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_iorap.tar.zst --clobber
