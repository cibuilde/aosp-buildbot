...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libmemtrack,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/memory/libmemtrack/libmemtrack^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_64_shared

echo "building libmemtrack^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libmemtrack,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/system/memory/libmemtrack/libmemtrack^android_x86_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_memory_libmemtrack.tar.zst --clobber
