...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja libvold,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/vold/libvold^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/vold/libvold^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/vold/libvold^android_x86_64_static

echo "building vdc^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja vdc,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/vold/vdc^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/vold/vdc^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/vold/vdc^android_x86_64

echo "building vold_prepare_subdirs^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_18.ninja vold_prepare_subdirs,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/vold/vold_prepare_subdirs^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_18/system/vold/vold_prepare_subdirs^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/vold/vold_prepare_subdirs^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_vold.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/vold/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_18 system_vold.tar.zst --clobber
