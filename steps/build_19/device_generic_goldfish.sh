...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.audio@6.0-impl.ranchu,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/device/generic/goldfish/android.hardware.audio@6.0-impl.ranchu^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/audio/android.hardware.audio@6.0-impl.ranchu^android_vendor.31_x86_64_shared

echo "building android.hardware.audio@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.audio@6.0-impl.ranchu,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/device/generic/goldfish/android.hardware.audio@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/audio/android.hardware.audio@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf device_generic_goldfish.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_19 device_generic_goldfish.tar.zst --clobber
