...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja vulkan.pastel,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/external/swiftshader/vulkan.pastel^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_64_shared

echo "building vulkan.pastel^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja vulkan.pastel,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/external/swiftshader/vulkan.pastel^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/swiftshader/src/vulkan.pastel^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_swiftshader.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/swiftshader/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_19 external_swiftshader.tar.zst --clobber
