...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/cmds/idmap2/libidmap2^android_x86_64_shared/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.os.permissions_aidl-rust,android_x86_64_rlib_rlib-std
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/base/android.os.permissions_aidl-rust^android_x86_64_rlib_rlib-std.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/core/java/android.os.permissions_aidl-rust^android_x86_64_rlib_rlib-std

echo "building idmap2^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja idmap2,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/idmap2^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/base/idmap2^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/idmap2^android_x86_64

echo "building idmap2d^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja idmap2d,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/idmap2d^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/base/idmap2d^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/cmds/idmap2/idmap2d^android_x86_64

echo "building service.incremental^android_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja service.incremental,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/base/service.incremental^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_static

echo "building service.incremental^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja service.incremental,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/base/service.incremental^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_static
