...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.frameworks.bufferhub@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/hardware/interfaces/android.frameworks.bufferhub@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/bufferhub/1.0/android.frameworks.bufferhub@1.0^android_x86_64_shared

echo "building android.frameworks.bufferhub@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.frameworks.bufferhub@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/frameworks/hardware/interfaces/android.frameworks.bufferhub@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/hardware/interfaces/bufferhub/1.0/android.frameworks.bufferhub@1.0^android_x86_x86_64_shared

echo "building android.frameworks.cameraservice.service@2.1^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.frameworks.cameraservice.service@2.1,android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_19 frameworks_hardware_interfaces.tar.zst --clobber
