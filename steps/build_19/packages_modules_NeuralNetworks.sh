...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks-service-sample-all,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-service-sample-all^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_aidl/android.hardware.neuralnetworks-service-sample-all^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks-service-sample-float-fast^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks-service-sample-float-fast,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-service-sample-float-fast^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_aidl/android.hardware.neuralnetworks-service-sample-float-fast^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks-service-sample-float-slow^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks-service-sample-float-slow,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-service-sample-float-slow^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_aidl/android.hardware.neuralnetworks-service-sample-float-slow^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks-service-sample-minimal^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks-service-sample-minimal,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-service-sample-minimal^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_aidl/android.hardware.neuralnetworks-service-sample-minimal^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks-service-sample-quant^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks-service-sample-quant,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks-service-sample-quant^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample_aidl/android.hardware.neuralnetworks-service-sample-quant^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks@1.3-service-sample-all^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks@1.3-service-sample-all,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks@1.3-service-sample-all^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample/android.hardware.neuralnetworks@1.3-service-sample-all^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks@1.3-service-sample-float-fast^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks@1.3-service-sample-float-fast,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks@1.3-service-sample-float-fast^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample/android.hardware.neuralnetworks@1.3-service-sample-float-fast^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks@1.3-service-sample-float-slow^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks@1.3-service-sample-float-slow,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks@1.3-service-sample-float-slow^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample/android.hardware.neuralnetworks@1.3-service-sample-float-slow^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks@1.3-service-sample-minimal^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks@1.3-service-sample-minimal,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks@1.3-service-sample-minimal^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample/android.hardware.neuralnetworks@1.3-service-sample-minimal^android_vendor.31_x86_64

echo "building android.hardware.neuralnetworks@1.3-service-sample-quant^android_vendor.31_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_19.ninja android.hardware.neuralnetworks@1.3-service-sample-quant,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_19/packages/modules/NeuralNetworks/android.hardware.neuralnetworks@1.3-service-sample-quant^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/packages/modules/NeuralNetworks/driver/sample/android.hardware.neuralnetworks@1.3-service-sample-quant^android_vendor.31_x86_64
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_19 packages_modules_NeuralNetworks.tar.zst --clobber
