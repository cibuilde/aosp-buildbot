...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_13 --pattern bionic.tar.zst --output bionic-13.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/bionic
tar xf $GITHUB_WORKSPACE/bionic-13.tar.zst -C $GITHUB_WORKSPACE/downloads/bionic/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_09 --pattern external_fsverity-utils.tar.zst --output external_fsverity-utils-09.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/fsverity-utils
tar xf $GITHUB_WORKSPACE/external_fsverity-utils-09.tar.zst -C $GITHUB_WORKSPACE/downloads/external/fsverity-utils/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_icu.tar.zst --output external_icu-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/icu
tar xf $GITHUB_WORKSPACE/external_icu-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/icu/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_08 --pattern external_jsmn.tar.zst --output external_jsmn-08.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/jsmn
tar xf $GITHUB_WORKSPACE/external_jsmn-08.tar.zst -C $GITHUB_WORKSPACE/downloads/external/jsmn/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_13 --pattern external_minigbm.tar.zst --output external_minigbm-13.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/minigbm
tar xf $GITHUB_WORKSPACE/external_minigbm-13.tar.zst -C $GITHUB_WORKSPACE/downloads/external/minigbm/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_08 --pattern external_mksh.tar.zst --output external_mksh-08.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/mksh
tar xf $GITHUB_WORKSPACE/external_mksh-08.tar.zst -C $GITHUB_WORKSPACE/downloads/external/mksh/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern external_rust_crates_byteorder.tar.zst --output external_rust_crates_byteorder-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/byteorder
tar xf $GITHUB_WORKSPACE/external_rust_crates_byteorder-14.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/byteorder/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_rust_crates_chrono.tar.zst --output external_rust_crates_chrono-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/chrono
tar xf $GITHUB_WORKSPACE/external_rust_crates_chrono-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/chrono/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_crc32fast.tar.zst --output external_rust_crates_crc32fast-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/crc32fast
tar xf $GITHUB_WORKSPACE/external_rust_crates_crc32fast-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/crc32fast/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_rust_crates_flate2.tar.zst --output external_rust_crates_flate2-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/flate2
tar xf $GITHUB_WORKSPACE/external_rust_crates_flate2-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/flate2/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_getrandom.tar.zst --output external_rust_crates_getrandom-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/getrandom
tar xf $GITHUB_WORKSPACE/external_rust_crates_getrandom-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/getrandom/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_libz-sys.tar.zst --output external_rust_crates_libz-sys-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/libz-sys
tar xf $GITHUB_WORKSPACE/external_rust_crates_libz-sys-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/libz-sys/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_macaddr.tar.zst --output external_rust_crates_macaddr-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/macaddr
tar xf $GITHUB_WORKSPACE/external_rust_crates_macaddr-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/macaddr/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_nix.tar.zst --output external_rust_crates_nix-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/nix
tar xf $GITHUB_WORKSPACE/external_rust_crates_nix-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/nix/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_num-integer.tar.zst --output external_rust_crates_num-integer-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/num-integer
tar xf $GITHUB_WORKSPACE/external_rust_crates_num-integer-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/num-integer/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern external_rust_crates_num-traits.tar.zst --output external_rust_crates_num-traits-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/num-traits
tar xf $GITHUB_WORKSPACE/external_rust_crates_num-traits-14.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/num-traits/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern external_rust_crates_ppv-lite86.tar.zst --output external_rust_crates_ppv-lite86-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/ppv-lite86
tar xf $GITHUB_WORKSPACE/external_rust_crates_ppv-lite86-14.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/ppv-lite86/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_18 --pattern external_rust_crates_rand.tar.zst --output external_rust_crates_rand-18.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/rand
tar xf $GITHUB_WORKSPACE/external_rust_crates_rand-18.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/rand/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_17 --pattern external_rust_crates_rand_chacha.tar.zst --output external_rust_crates_rand_chacha-17.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/rand_chacha
tar xf $GITHUB_WORKSPACE/external_rust_crates_rand_chacha-17.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/rand_chacha/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern external_rust_crates_rand_core.tar.zst --output external_rust_crates_rand_core-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/rand_core
tar xf $GITHUB_WORKSPACE/external_rust_crates_rand_core-16.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/rand_core/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_11 --pattern external_rust_crates_shared_child.tar.zst --output external_rust_crates_shared_child-11.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/shared_child
tar xf $GITHUB_WORKSPACE/external_rust_crates_shared_child-11.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/shared_child/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_crates_uuid.tar.zst --output external_rust_crates_uuid-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/uuid
tar xf $GITHUB_WORKSPACE/external_rust_crates_uuid-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/uuid/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_17 --pattern external_rust_crates_zip.tar.zst --output external_rust_crates_zip-17.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/crates/zip
tar xf $GITHUB_WORKSPACE/external_rust_crates_zip-17.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/crates/zip/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern external_rust_cxx.tar.zst --output external_rust_cxx-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/rust/cxx
tar xf $GITHUB_WORKSPACE/external_rust_cxx-15.tar.zst -C $GITHUB_WORKSPACE/downloads/external/rust/cxx/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_10 --pattern external_selinux.tar.zst --output external_selinux-10.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/selinux
tar xf $GITHUB_WORKSPACE/external_selinux-10.tar.zst -C $GITHUB_WORKSPACE/downloads/external/selinux/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern external_toybox.tar.zst --output external_toybox-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/toybox
tar xf $GITHUB_WORKSPACE/external_toybox-14.tar.zst -C $GITHUB_WORKSPACE/downloads/external/toybox/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern frameworks_hardware_interfaces.tar.zst --output frameworks_hardware_interfaces-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/hardware/interfaces
tar xf $GITHUB_WORKSPACE/frameworks_hardware_interfaces-19.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/hardware/interfaces/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_12 --pattern frameworks_opt_net_wifi.tar.zst --output frameworks_opt_net_wifi-12.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/opt/net/wifi
tar xf $GITHUB_WORKSPACE/frameworks_opt_net_wifi-12.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/opt/net/wifi/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_apex.tar.zst --output system_apex-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/apex
tar xf $GITHUB_WORKSPACE/system_apex-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/apex/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_bt.tar.zst --output system_bt-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/bt
tar xf $GITHUB_WORKSPACE/system_bt-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/bt/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_connectivity_wificond.tar.zst --output system_connectivity_wificond-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/connectivity/wificond
tar xf $GITHUB_WORKSPACE/system_connectivity_wificond-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/connectivity/wificond/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_17 --pattern system_connectivity_wificond.tar.zst --output system_connectivity_wificond-17.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/connectivity/wificond
tar xf $GITHUB_WORKSPACE/system_connectivity_wificond-17.tar.zst -C $GITHUB_WORKSPACE/downloads/system/connectivity/wificond/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern system_core.tar.zst --output system_core-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/core
tar xf $GITHUB_WORKSPACE/system_core-15.tar.zst -C $GITHUB_WORKSPACE/downloads/system/core/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_15 --pattern system_extras.tar.zst --output system_extras-15.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/extras
tar xf $GITHUB_WORKSPACE/system_extras-15.tar.zst -C $GITHUB_WORKSPACE/downloads/system/extras/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_extras.tar.zst --output system_extras-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/extras
tar xf $GITHUB_WORKSPACE/system_extras-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/extras/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_extras.tar.zst --output system_extras-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/extras
tar xf $GITHUB_WORKSPACE/system_extras-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/extras/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_09 --pattern system_gatekeeper.tar.zst --output system_gatekeeper-09.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/gatekeeper
tar xf $GITHUB_WORKSPACE/system_gatekeeper-09.tar.zst -C $GITHUB_WORKSPACE/downloads/system/gatekeeper/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_12 --pattern system_gsid.tar.zst --output system_gsid-12.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/gsid
tar xf $GITHUB_WORKSPACE/system_gsid-12.tar.zst -C $GITHUB_WORKSPACE/downloads/system/gsid/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_hardware_interfaces.tar.zst --output system_hardware_interfaces-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/hardware/interfaces
tar xf $GITHUB_WORKSPACE/system_hardware_interfaces-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/hardware/interfaces/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_13 --pattern system_incremental_delivery.tar.zst --output system_incremental_delivery-13.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/incremental_delivery
tar xf $GITHUB_WORKSPACE/system_incremental_delivery-13.tar.zst -C $GITHUB_WORKSPACE/downloads/system/incremental_delivery/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern system_keymaster.tar.zst --output system_keymaster-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/keymaster
tar xf $GITHUB_WORKSPACE/system_keymaster-14.tar.zst -C $GITHUB_WORKSPACE/downloads/system/keymaster/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_keymaster.tar.zst --output system_keymaster-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/keymaster
tar xf $GITHUB_WORKSPACE/system_keymaster-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/keymaster/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_keymaster.tar.zst --output system_keymaster-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/keymaster
tar xf $GITHUB_WORKSPACE/system_keymaster-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/keymaster/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_14 --pattern system_logging.tar.zst --output system_logging-14.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/logging
tar xf $GITHUB_WORKSPACE/system_logging-14.tar.zst -C $GITHUB_WORKSPACE/downloads/system/logging/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_19 --pattern system_nfc.tar.zst --output system_nfc-19.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/nfc
tar xf $GITHUB_WORKSPACE/system_nfc-19.tar.zst -C $GITHUB_WORKSPACE/downloads/system/nfc/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_16 --pattern system_security.tar.zst --output system_security-16.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/security
tar xf $GITHUB_WORKSPACE/system_security-16.tar.zst -C $GITHUB_WORKSPACE/downloads/system/security/
...
time source steps/build_20/device_generic_goldfish.sh
time source steps/build_20/external_crosvm.sh
time source steps/build_20/external_minigbm.sh
time source steps/build_20/frameworks_av.sh
time source steps/build_20/frameworks_base.sh
time source steps/build_20/frameworks_hardware_interfaces.sh
time source steps/build_20/frameworks_native.sh
time source steps/build_20/hardware_interfaces.sh
time source steps/build_20/libcore.sh
time source steps/build_20/packages_apps_Nfc.sh
time source steps/build_20/packages_modules_Virtualization.sh
time source steps/build_20/prebuilts_sdk.sh
time source steps/build_20/system_bt.sh
time source steps/build_20/system_connectivity_wificond.sh
time source steps/build_20/system_core.sh
time source steps/build_20/system_extras.sh
time source steps/build_20/system_keymaster.sh
time source steps/build_20/system_security.sh
