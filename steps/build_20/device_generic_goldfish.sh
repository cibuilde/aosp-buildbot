...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.hardware.audio.legacy@6.0-impl.ranchu,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/device/generic/goldfish/android.hardware.audio.legacy@6.0-impl.ranchu^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/audio/android.hardware.audio.legacy@6.0-impl.ranchu^android_vendor.31_x86_64_shared

echo "building android.hardware.audio.legacy@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.hardware.audio.legacy@6.0-impl.ranchu,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/device/generic/goldfish/android.hardware.audio.legacy@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/audio/android.hardware.audio.legacy@6.0-impl.ranchu^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf device_generic_goldfish.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/device/generic/goldfish/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_20 device_generic_goldfish.tar.zst --clobber
