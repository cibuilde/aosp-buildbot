...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.hardware.graphics.allocator@4.0-service.minigbm,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/external/minigbm/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.allocator@4.0-service.minigbm^android_vendor.31_x86_64

echo "building android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_64_shared

echo "building android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.hardware.graphics.mapper@4.0-impl.minigbm,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/external/minigbm/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/minigbm/cros_gralloc/gralloc4/android.hardware.graphics.mapper@4.0-impl.minigbm^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_minigbm.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/minigbm/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_20 external_minigbm.tar.zst --clobber
