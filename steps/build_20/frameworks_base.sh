...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja service.incremental,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/base/service.incremental^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_64_shared

echo "building service.incremental^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja service.incremental,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/base/service.incremental^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/incremental/service.incremental^android_x86_x86_64_shared
