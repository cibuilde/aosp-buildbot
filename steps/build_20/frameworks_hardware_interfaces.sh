...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja android.frameworks.cameraservice.service@2.2,android_x86_64_shared
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_20 frameworks_hardware_interfaces.tar.zst --clobber
