...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja idlcli,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/idlcli/idlcli^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/idlcli^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/cmds/idlcli/idlcli^android_x86_64

echo "building libgralloctypes^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libgralloctypes,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gralloc/types/libgralloctypes^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libgralloctypes^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gralloc/types/libgralloctypes^android_x86_64_shared

echo "building libgralloctypes^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libgralloctypes,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gralloc/types/libgralloctypes^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libgralloctypes^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/gralloc/types/libgralloctypes^android_x86_x86_64_shared

echo "building libui^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libui,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/ui/libui^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libui^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/ui/libui^android_vendor.31_x86_64_shared

echo "building libui^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libui,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/ui/libui^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libui^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/ui/libui^android_vendor.31_x86_x86_64_shared

echo "building libvibratorservice^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libvibratorservice,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/services/vibratorservice/libvibratorservice^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libvibratorservice^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/vibratorservice/libvibratorservice^android_x86_64_shared

echo "building libvibratorservice^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja libvibratorservice,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/libvibratorservice^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/vibratorservice/libvibratorservice^android_x86_x86_64_shared

echo "building sensorservice^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja sensorservice,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/sensorservice^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/frameworks/native/sensorservice^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/native/services/sensorservice/sensorservice^android_x86_64

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_native.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/native/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_20 frameworks_native.tar.zst --clobber
