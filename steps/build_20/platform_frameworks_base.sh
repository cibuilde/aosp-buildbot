...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja framework-wifi-util-lib,android_common_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-wifi-util-lib^android_common_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/platform/frameworks/base/framework-wifi-util-lib^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-wifi-util-lib^android_common_apex30

echo "building framework-wifi-util-lib^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_20.ninja framework-wifi-util-lib,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-wifi-util-lib^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_20/platform/frameworks/base/framework-wifi-util-lib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-wifi-util-lib^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_20 platform_frameworks_base.tar.zst --clobber
