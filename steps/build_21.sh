...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_08 --pattern external_drm_hwcomposer.tar.zst --output external_drm_hwcomposer-08.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/drm_hwcomposer
tar xf $GITHUB_WORKSPACE/external_drm_hwcomposer-08.tar.zst -C $GITHUB_WORKSPACE/downloads/external/drm_hwcomposer/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_20 --pattern system_bt.tar.zst --output system_bt-20.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/bt
tar xf $GITHUB_WORKSPACE/system_bt-20.tar.zst -C $GITHUB_WORKSPACE/downloads/system/bt/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_20 --pattern system_extras.tar.zst --output system_extras-20.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/extras
tar xf $GITHUB_WORKSPACE/system_extras-20.tar.zst -C $GITHUB_WORKSPACE/downloads/system/extras/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_18 --pattern system_vold.tar.zst --output system_vold-18.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/vold
tar xf $GITHUB_WORKSPACE/system_vold-18.tar.zst -C $GITHUB_WORKSPACE/downloads/system/vold/
...
time source steps/build_21/external_crosvm.sh
time source steps/build_21/external_drm_hwcomposer.sh
time source steps/build_21/external_ipsec-tools.sh
time source steps/build_21/frameworks_av.sh
time source steps/build_21/frameworks_native.sh
time source steps/build_21/hardware_google_camera.sh
time source steps/build_21/hardware_interfaces.sh
time source steps/build_21/libcore.sh
time source steps/build_21/packages_modules_Virtualization.sh
time source steps/build_21/prebuilts_sdk.sh
time source steps/build_21/system_bt.sh
time source steps/build_21/system_extras.sh
time source steps/build_21/system_hardware_interfaces.sh
time source steps/build_21/system_security.sh
time source steps/build_21/system_vold.sh
