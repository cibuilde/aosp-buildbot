...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja hwcomposer.drm,android_vendor.31_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_64_shared

echo "building hwcomposer.drm^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja hwcomposer.drm,android_vendor.31_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/hwcomposer.drm^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_drm_hwcomposer.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/drm_hwcomposer/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_21 external_drm_hwcomposer.tar.zst --clobber
