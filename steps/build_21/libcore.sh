...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja art.module.public.api.stubs.module_lib,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs.module_lib^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/libcore/art.module.public.api.stubs.module_lib^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs.module_lib^android_common

echo "building art.module.public.api.stubs.system^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja art.module.public.api.stubs.system,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs.system^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/libcore/art.module.public.api.stubs.system^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs.system^android_common

echo "building art.module.public.api.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja art.module.public.api.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/libcore/art.module.public.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/art.module.public.api.stubs^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/libcore/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_21 libcore.tar.zst --clobber
