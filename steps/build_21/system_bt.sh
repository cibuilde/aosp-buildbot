...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja libbt_shim_ffi,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/shim/libbt_shim_ffi^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/system/bt/libbt_shim_ffi^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/shim/libbt_shim_ffi^android_x86_64_static

echo "building libbt_shim_ffi^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_21.ninja libbt_shim_ffi,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/shim/libbt_shim_ffi^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_21/system/bt/libbt_shim_ffi^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/system/bt/gd/rust/shim/libbt_shim_ffi^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf system_bt.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/system/bt/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_21 system_bt.tar.zst --clobber
