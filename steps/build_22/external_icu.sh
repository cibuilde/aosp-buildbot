...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja legacy.i18n.module.platform.api.stubs.source,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/legacy.i18n.module.platform.api.stubs.source^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/external/icu/legacy.i18n.module.platform.api.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/legacy.i18n.module.platform.api.stubs.source^android_common

echo "building stable.i18n.module.platform.api.stubs.source^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja stable.i18n.module.platform.api.stubs.source,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/external/icu/stable.i18n.module.platform.api.stubs.source^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/stable.i18n.module.platform.api.stubs.source^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_22 external_icu.tar.zst --clobber
