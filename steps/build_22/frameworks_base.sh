...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja libmedia_jni_utils,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/frameworks/base/libmedia_jni_utils^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_64_shared

echo "building libmedia_jni_utils^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja libmedia_jni_utils,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/frameworks/base/libmedia_jni_utils^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/jni/libmedia_jni_utils^android_x86_x86_64_shared
