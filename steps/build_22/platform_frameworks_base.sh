...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/icu/android_icu4j/i18n.module.public.api.stubs.source^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/appsearch/framework/framework-appsearch.stubs.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/appsearch/framework/framework-appsearch.stubs^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/libs/hwui/framework-graphics.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/media/framework/framework-media.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/media/framework/framework-media.stubs.system^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/IPsec/android.net.ipsec.ike.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/IPsec/android.net.ipsec.ike.stubs.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/IPsec/android.net.ipsec.ike.stubs^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Permission/framework-s/framework-permission-s.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Permission/framework/framework-permission.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Scheduling/framework/framework-scheduling.stubs.module_lib^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/SdkExtensions/framework/framework-sdkextensions.stubs.module_lib^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/SdkExtensions/framework/framework-sdkextensions.stubs.source.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/SdkExtensions/framework/framework-sdkextensions.stubs.source^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/SdkExtensions/framework/framework-sdkextensions.stubs.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/SdkExtensions/framework/framework-sdkextensions.stubs^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Wifi/framework/framework-wifi.stubs.source.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Wifi/framework/framework-wifi.stubs.source^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Wifi/framework/framework-wifi.stubs.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Wifi/framework/framework-wifi.stubs^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/common/tools/conv_classpaths_proto^linux_glibc_x86_64_PY3/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/providers/MediaProvider/apex/framework/framework-mediaprovider.stubs.module_lib^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/providers/MediaProvider/apex/framework/framework-mediaprovider.stubs.source.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/providers/MediaProvider/apex/framework/framework-mediaprovider.stubs.source^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/providers/MediaProvider/apex/framework/framework-mediaprovider.stubs.system^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/providers/MediaProvider/apex/framework/framework-mediaprovider.stubs^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/tools/metalava/private-stub-annotations-jar^android_common/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/metrics-constants-protos^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/proto/metrics-constants-protos^android_common

echo "building frameworks-base-api-system-removed.txt^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja frameworks-base-api-system-removed.txt,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-system-removed.txt^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/frameworks-base-api-system-removed.txt^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-system-removed.txt^

echo "building frameworks-base-api-removed.txt^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja frameworks-base-api-removed.txt,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-removed.txt^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/frameworks-base-api-removed.txt^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-removed.txt^

echo "building frameworks-base-api-current.txt^"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja frameworks-base-api-current.txt,
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-current.txt^
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/frameworks-base-api-current.txt^.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/api/frameworks-base-api-current.txt^

echo "building framework-updatable-stubs-module_libs_api^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja framework-updatable-stubs-module_libs_api,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-updatable-stubs-module_libs_api^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/framework-updatable-stubs-module_libs_api^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/framework-updatable-stubs-module_libs_api^android_common

echo "building android_test_stubs_current^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android_test_stubs_current,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android_test_stubs_current^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android_test_stubs_current^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android_test_stubs_current^android_common

echo "building android_system_stubs_current^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android_system_stubs_current,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android_system_stubs_current^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android_system_stubs_current^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android_system_stubs_current^android_common

echo "building android-non-updatable.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android-non-updatable.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android-non-updatable.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs^android_common

echo "building android_stubs_current^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android_stubs_current,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android_stubs_current^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android_stubs_current^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android_stubs_current^android_common

echo "building android-non-updatable.stubs.test^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android-non-updatable.stubs.test,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs.test^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android-non-updatable.stubs.test^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs.test^android_common

echo "building android-non-updatable.stubs.system^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja android-non-updatable.stubs.system,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs.system^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/android-non-updatable.stubs.system^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/android-non-updatable.stubs.system^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/com.android.appsearch-bootclasspath-fragment^android_common_apex10000.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/appsearch/com.android.appsearch-bootclasspath-fragment^android_common_apex10000

echo "building SettingsLibUtils^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibUtils,android_common_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/Utils/SettingsLibUtils^android_common_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibUtils^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/Utils/SettingsLibUtils^android_common_apex30

echo "building SettingsLibUtils^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibUtils,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/Utils/SettingsLibUtils^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibUtils^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/Utils/SettingsLibUtils^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibSettingsTheme^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/SettingsTheme/SettingsLibSettingsTheme^android_common_apex30

echo "building SettingsLibTwoTargetPreference^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibTwoTargetPreference,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibTwoTargetPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/TwoTargetPreference/SettingsLibTwoTargetPreference^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibSettingsTheme^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/SettingsTheme/SettingsLibSettingsTheme^android_common

echo "building SettingsLibTwoTargetPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibTwoTargetPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibTwoTargetPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/TwoTargetPreference/SettingsLibTwoTargetPreference^android_common

echo "building SettingsLibTopIntroPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibTopIntroPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibTopIntroPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/TopIntroPreference/SettingsLibTopIntroPreference^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibSettingsSpinner^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/SettingsSpinner/SettingsLibSettingsSpinner^android_common

echo "building SettingsLibSearchWidget^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibSearchWidget,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibSearchWidget^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/SearchWidget/SettingsLibSearchWidget^android_common_apex30

echo "building SettingsLibSearchWidget^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibSearchWidget,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibSearchWidget^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/SearchWidget/SettingsLibSearchWidget^android_common

echo "building SettingsLibRestrictedLockUtils^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibRestrictedLockUtils,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibRestrictedLockUtils^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/RestrictedLockUtils/SettingsLibRestrictedLockUtils^android_common_apex30

echo "building SettingsLibRestrictedLockUtils^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibRestrictedLockUtils,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibRestrictedLockUtils^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/RestrictedLockUtils/SettingsLibRestrictedLockUtils^android_common

echo "building SettingsLibRadioButtonPreference^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibRadioButtonPreference,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibRadioButtonPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/RadioButtonPreference/SettingsLibRadioButtonPreference^android_common_apex30

echo "building SettingsLibRadioButtonPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibRadioButtonPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibRadioButtonPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/RadioButtonPreference/SettingsLibRadioButtonPreference^android_common

echo "building SettingsLibProgressBar^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibProgressBar,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibProgressBar^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/ProgressBar/SettingsLibProgressBar^android_common_apex30

echo "building SettingsLibProgressBar^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibProgressBar,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibProgressBar^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/ProgressBar/SettingsLibProgressBar^android_common

echo "building SettingsLibMainSwitchPreference^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibMainSwitchPreference,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibMainSwitchPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/MainSwitchPreference/SettingsLibMainSwitchPreference^android_common_apex30

echo "building SettingsLibMainSwitchPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibMainSwitchPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibMainSwitchPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/MainSwitchPreference/SettingsLibMainSwitchPreference^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibLayoutPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/LayoutPreference/SettingsLibLayoutPreference^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibLayoutPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/LayoutPreference/SettingsLibLayoutPreference^android_common

echo "building SettingsLibHelpUtils^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibHelpUtils,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibHelpUtils^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/HelpUtils/SettingsLibHelpUtils^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibHelpUtils^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/HelpUtils/SettingsLibHelpUtils^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibFooterPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/FooterPreference/SettingsLibFooterPreference^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibFooterPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/FooterPreference/SettingsLibFooterPreference^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibEntityHeaderWidgets^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/EntityHeaderWidgets/SettingsLibEntityHeaderWidgets^android_common

echo "building SettingsLibEmergencyNumber^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibEmergencyNumber,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibEmergencyNumber^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/EmergencyNumber/SettingsLibEmergencyNumber^android_common

echo "building SettingsLibBarChartPreference^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibBarChartPreference,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibBarChartPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/BarChartPreference/SettingsLibBarChartPreference^android_common_apex30

echo "building SettingsLibBarChartPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibBarChartPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibBarChartPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/BarChartPreference/SettingsLibBarChartPreference^android_common

echo "building SettingsLibBannerMessagePreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibBannerMessagePreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibBannerMessagePreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/BannerMessagePreference/SettingsLibBannerMessagePreference^android_common

echo "building SettingsLibAppPreference^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibAppPreference,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibAppPreference^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/AppPreference/SettingsLibAppPreference^android_common_apex30

echo "building SettingsLibAppPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibAppPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibAppPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/AppPreference/SettingsLibAppPreference^android_common

echo "building SettingsLibActionButtonsPreference^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibActionButtonsPreference,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibActionButtonsPreference^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/ActionButtonsPreference/SettingsLibActionButtonsPreference^android_common

echo "building SettingsLibActionBarShadow^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibActionBarShadow,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibActionBarShadow^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/ActionBarShadow/SettingsLibActionBarShadow^android_common_apex30

echo "building SettingsLibActionBarShadow^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLibActionBarShadow,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLibActionBarShadow^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/ActionBarShadow/SettingsLibActionBarShadow^android_common

echo "building SettingsLib-search^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja SettingsLib-search,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/search/SettingsLib-search^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/SettingsLib-search^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SettingsLib/search/SettingsLib-search^android_common

echo "building PluginCoreLib^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_22.ninja PluginCoreLib,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SystemUI/plugin_core/PluginCoreLib^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_22/platform/frameworks/base/PluginCoreLib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/packages/SystemUI/plugin_core/PluginCoreLib^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_22 platform_frameworks_base.tar.zst --clobber
