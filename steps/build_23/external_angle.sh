...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja libGLESv2_angle,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/external/angle/libGLESv2_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_64_shared

echo "building libGLESv2_angle^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja libGLESv2_angle,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/external/angle/libGLESv2_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv2_angle^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_angle.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/angle/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 external_angle.tar.zst --clobber
