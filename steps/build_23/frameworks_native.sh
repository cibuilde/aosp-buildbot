...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja framework-permission-aidl-java,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_23/frameworks/native/framework-permission-aidl-java^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/permission/framework-permission-aidl-java^android_common $GITHUB_WORKSPACE/artifacts/frameworks/native/libs/permission/framework-permission-aidl-java^android_common/addition_copy_files.output
