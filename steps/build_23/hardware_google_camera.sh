...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja android.hardware.camera.provider@2.7-service-google,android_vendor.31_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/hardware/google/camera/android.hardware.camera.provider@2.7-service-google^android_vendor.31_x86_64.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/common/hal/hidl_service/android.hardware.camera.provider@2.7-service-google^android_vendor.31_x86_64

echo "building libgooglecamerahwl_impl^android_vendor.31_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja libgooglecamerahwl_impl,android_vendor.31_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/hardware/google/camera/libgooglecamerahwl_impl^android_vendor.31_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/devices/EmulatedCamera/hwl/libgooglecamerahwl_impl^android_vendor.31_x86_64_shared

echo "building libgooglecamerahwl_impl^android_vendor.31_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja libgooglecamerahwl_impl,android_vendor.31_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/hardware/google/camera/libgooglecamerahwl_impl^android_vendor.31_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/hardware/google/camera/devices/EmulatedCamera/hwl/libgooglecamerahwl_impl^android_vendor.31_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf hardware_google_camera.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/hardware/google/camera/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 hardware_google_camera.tar.zst --clobber
