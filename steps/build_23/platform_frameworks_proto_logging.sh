...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja datastallprotosnano,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/frameworks/proto_logging/datastallprotosnano^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/server/connectivity/datastallprotosnano^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 platform_frameworks_proto_logging.tar.zst --clobber
