...
echo "building service-connectivity-protos^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja service-connectivity-protos,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Connectivity/service-connectivity-protos^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/service/service-connectivity-protos^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 platform_packages_modules_Connectivity.tar.zst --clobber
