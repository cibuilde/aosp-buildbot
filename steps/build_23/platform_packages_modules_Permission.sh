...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Permission/permissioncontroller-statsd^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/PermissionController/permissioncontroller-statsd^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Permission/com.android.permission-bootclasspath-fragment^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Permission/com.android.permission-bootclasspath-fragment^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 platform_packages_modules_Permission.tar.zst --clobber
