...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja wifi-nano-protos,android_common_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/proto/wifi-nano-protos^android_common_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Wifi/wifi-nano-protos^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/proto/wifi-nano-protos^android_common_apex30

echo "building wifi-lite-protos^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja wifi-lite-protos,android_common_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/proto/wifi-lite-protos^android_common_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Wifi/wifi-lite-protos^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/proto/wifi-lite-protos^android_common_apex30

echo "building com.android.wifi-bootclasspath-fragment^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja com.android.wifi-bootclasspath-fragment,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Wifi/com.android.wifi-bootclasspath-fragment^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/apex/com.android.wifi-bootclasspath-fragment^android_common_apex30

echo "building ServiceWifiResources^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_23.ninja ServiceWifiResources,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/packages/modules/Wifi/ServiceWifiResources^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Wifi/service/ServiceWifiResources/ServiceWifiResources^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 platform_packages_modules_Wifi.tar.zst --clobber
