...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/system/netd/netd_event_listener_interface-V1-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/system/netd/netd_event_listener_interface-lateststable-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-lateststable-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/system/netd/netd_aidl_interface-V7-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/system/netd/netd_aidl_interface-lateststable-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-lateststable-java^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_23/platform/system/netd/netd_aidl_interface-V3-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V3-java^android_common_apex30

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_23 platform_system_netd.tar.zst --clobber
