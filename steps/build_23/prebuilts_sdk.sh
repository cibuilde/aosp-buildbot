...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/extras/material-design/android-support-design-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v7-cardview-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v7-cardview^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-animatedvectordrawable-nodeps^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-animatedvectordrawable^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v7-appcompat-nodeps^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v7-appcompat^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-dynamic-animation-nodeps^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v13-nodeps^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v4-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-v4^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-vectordrawable-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-vectordrawable^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-transition-nodeps^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/support/android-support-transition^android_common/ .
