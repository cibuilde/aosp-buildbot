...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja libEGL_angle,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/external/angle/libEGL_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_64_shared

echo "building libEGL_angle^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja libEGL_angle,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/external/angle/libEGL_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libEGL_angle^android_x86_x86_64_shared

echo "building libGLESv1_CM_angle^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja libGLESv1_CM_angle,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/external/angle/libGLESv1_CM_angle^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_64_shared

echo "building libGLESv1_CM_angle^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja libGLESv1_CM_angle,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/external/angle/libGLESv1_CM_angle^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/external/angle/libGLESv1_CM_angle^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_angle.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/angle/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_24 external_angle.tar.zst --clobber
