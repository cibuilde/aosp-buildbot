...
rsync -a -r $GITHUB_WORKSPACE/downloads/libcore/art.module.api.annotations.for.system.modules^android_common/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja art-module-public-api-stubs-system-modules,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/art-module-public-api-stubs-system-modules^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/libcore/art-module-public-api-stubs-system-modules^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/art-module-public-api-stubs-system-modules^android_common

echo "building legacy.core.platform.api.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja legacy.core.platform.api.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/legacy.core.platform.api.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/libcore/legacy.core.platform.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/legacy.core.platform.api.stubs^android_common

echo "building stable.core.platform.api.stubs^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja stable.core.platform.api.stubs,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/stable.core.platform.api.stubs^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/libcore/stable.core.platform.api.stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/libcore/mmodules/core_platform_api/stable.core.platform.api.stubs^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf libcore.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/libcore/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_24 libcore.tar.zst --clobber
