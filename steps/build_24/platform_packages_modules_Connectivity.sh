...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja com.android.tethering-bootclasspath-fragment,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/platform/packages/modules/Connectivity/com.android.tethering-bootclasspath-fragment^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/apex/com.android.tethering-bootclasspath-fragment^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_24 platform_packages_modules_Connectivity.tar.zst --clobber
