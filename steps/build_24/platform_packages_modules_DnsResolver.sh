...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_24.ninja dnsresolver_aidl_interface-V9-java,android_common_apex30
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V9-java^android_common_apex30
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_24/platform/packages/modules/DnsResolver/dnsresolver_aidl_interface-V9-java^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/DnsResolver/dnsresolver_aidl_interface-V9-java^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_24 platform_packages_modules_DnsResolver.tar.zst --clobber
