...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja android.hardware.media.omx@1.0-service,android_vendor.31_x86_x86_64
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/av/android.hardware.media.omx@1.0-service^android_vendor.31_x86_x86_64.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/mediacodec/android.hardware.media.omx@1.0-service^android_vendor.31_x86_x86_64

echo "building com.android.media.swcodec^android_common_cfi_com.android.media.swcodec_image"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja com.android.media.swcodec,android_common_cfi_com.android.media.swcodec_image
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/av/com.android.media.swcodec^android_common_cfi_com.android.media.swcodec_image.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/apex/com.android.media.swcodec^android_common_cfi_com.android.media.swcodec_image

echo "building libaaudio^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja libaaudio,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libaaudio/src/libaaudio^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/av/libaaudio^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libaaudio/src/libaaudio^android_x86_64_shared

echo "building libaaudio^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja libaaudio,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libaaudio/src/libaaudio^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/av/libaaudio^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libaaudio/src/libaaudio^android_x86_x86_64_shared

echo "building libaaudioservice^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja libaaudioservice,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/services/oboeservice/libaaudioservice^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/av/libaaudioservice^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/oboeservice/libaaudioservice^android_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_av.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/av/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 frameworks_av.tar.zst --clobber
