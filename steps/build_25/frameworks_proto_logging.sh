...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja devicepolicyprotosnano,android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/frameworks/proto_logging/devicepolicyprotosnano^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/proto_logging/stats/enums/stats/devicepolicy/devicepolicyprotosnano^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 frameworks_proto_logging.tar.zst --clobber
