...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja statslog-settings,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/statslog-settings^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/apps/Settings/statslog-settings^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/statslog-settings^android_common

echo "building settings-logtags^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja settings-logtags,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/settings-logtags^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/apps/Settings/settings-logtags^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/settings-logtags^android_common

echo "building settings-log-bridge-protos-lite^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja settings-log-bridge-protos-lite,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/protos/settings-log-bridge-protos-lite^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/apps/Settings/settings-log-bridge-protos-lite^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/protos/settings-log-bridge-protos-lite^android_common

echo "building settings-contextual-card-protos-lite^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja settings-contextual-card-protos-lite,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/protos/settings-contextual-card-protos-lite^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/apps/Settings/settings-contextual-card-protos-lite^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/protos/settings-contextual-card-protos-lite^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 platform_packages_apps_Settings.tar.zst --clobber
