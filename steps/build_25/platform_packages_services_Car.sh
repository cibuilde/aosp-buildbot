...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/services/Car/android.car-system-stubs-docs^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/services/Car/car-lib/android.car-system-stubs-docs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/services/Car/android.car-stubs^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/services/Car/car-lib/android.car-stubs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/services/Car/android.car-stubs-docs^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/services/Car/car-lib/android.car-stubs-docs^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/packages/services/Car/android.car-stub-docs^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/services/Car/car-lib/android.car-stub-docs^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 platform_packages_services_Car.tar.zst --clobber
