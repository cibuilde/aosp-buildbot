...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/system/timezone/time_zone_distro^android_common.output . $GITHUB_WORKSPACE/artifacts/system/timezone/distro/core/time_zone_distro^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_25/platform/system/timezone/time_zone_distro_installer^android_common.output . $GITHUB_WORKSPACE/artifacts/system/timezone/distro/installer/time_zone_distro_installer^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 platform_system_timezone.tar.zst --clobber
