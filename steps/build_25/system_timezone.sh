...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja time_zone_distro,android_common
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_25.ninja time_zone_distro_installer,android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_25 system_timezone.tar.zst --clobber
