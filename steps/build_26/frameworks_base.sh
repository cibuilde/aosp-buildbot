...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja combined-removed-dex,
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja SettingsLib,android_common
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja SystemUI-core,android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_26 frameworks_base.tar.zst --clobber
