...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja libRScpp,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_26/frameworks/rs/libRScpp^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_64_static

echo "building libRScpp^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja libRScpp,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_26/frameworks/rs/libRScpp^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/rs/cpp/libRScpp^android_x86_x86_64_static

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_rs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/rs/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_26 frameworks_rs.tar.zst --clobber
