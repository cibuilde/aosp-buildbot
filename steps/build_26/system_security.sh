...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/aidl/android.security.maintenance-rust^android_x86_64_rlib_rlib-std/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/aidl/android.security.metrics-rust^android_x86_64_rlib_rlib-std/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/libkeystore2^android_x86_64_rlib_rlib-std/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/src/km_compat/libkeystore2_km_compat^android_x86_64_rlib_rlib-std/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/src/km_compat/libkm_compat_service^android_x86_64_shared/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/system/security/keystore2/legacykeystore/liblegacykeystore-rust^android_x86_64_rlib_rlib-std/ .

echo "building keystore2^android_x86_64"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_26.ninja keystore2,android_x86_64
mkdir -p $GITHUB_WORKSPACE/artifacts/system/security/keystore2/keystore2^android_x86_64
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_26/system/security/keystore2^android_x86_64.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/keystore2^android_x86_64
