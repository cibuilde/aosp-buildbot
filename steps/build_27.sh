...
download_with_retries android12-gsi_01 frameworks_opt_telephony.tar.zst frameworks_opt_telephony-01.tar.zst
...
download_with_retries android12-gsi_04 frameworks_opt_telephony.tar.zst frameworks_opt_telephony-04.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony
tar xf $GITHUB_WORKSPACE/frameworks_opt_telephony-04.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony/

download_with_retries android12-gsi_06 frameworks_opt_telephony.tar.zst frameworks_opt_telephony-06.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony
tar xf $GITHUB_WORKSPACE/frameworks_opt_telephony-06.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony/

download_with_retries android12-gsi_09 frameworks_opt_telephony.tar.zst frameworks_opt_telephony-09.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony
tar xf $GITHUB_WORKSPACE/frameworks_opt_telephony-09.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony/

download_with_retries android12-gsi_23 frameworks_opt_telephony.tar.zst frameworks_opt_telephony-23.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/opt/telephony
...
download_with_retries android12-gsi_23 packages_services_Telephony.tar.zst packages_services_Telephony-23.tar.zst
