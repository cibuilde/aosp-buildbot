...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libaacextractor,android_x86_64_shared_cfi_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libaacextractor^android_x86_64_shared_cfi_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/aac/libaacextractor^android_x86_64_shared_cfi_com.android.media

echo "building libamrextractor^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libamrextractor,android_x86_64_shared_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/amr/libamrextractor^android_x86_64_shared_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libamrextractor^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/amr/libamrextractor^android_x86_64_shared_cfi_apex29

echo "building libcodec2_hidl_client@1.0^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libcodec2_hidl_client@1.0,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libcodec2_hidl_client@1.0^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/codec2/hidl/1.0/utils/libcodec2_hidl_client@1.0^android_x86_64_shared

echo "building libcodec2_hidl_client@1.0^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libcodec2_hidl_client@1.0,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libcodec2_hidl_client@1.0^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/codec2/hidl/1.0/utils/libcodec2_hidl_client@1.0^android_x86_x86_64_shared

echo "building libflacextractor^android_x86_64_shared_cfi_com.android.media"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libflacextractor,android_x86_64_shared_cfi_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libflacextractor^android_x86_64_shared_cfi_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/flac/libflacextractor^android_x86_64_shared_cfi_com.android.media

echo "building libmedia^android_x86_64_static_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmedia,android_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmedia/libmedia^android_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmedia^android_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmedia/libmedia^android_x86_64_static_cfi

echo "building libmedia^android_x86_x86_64_static_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmedia,android_x86_x86_64_static_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmedia/libmedia^android_x86_x86_64_static_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmedia^android_x86_x86_64_static_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmedia/libmedia^android_x86_x86_64_static_cfi

echo "building libmediaformatshaper^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmediaformatshaper,android_x86_64_shared_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmediaformatshaper^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmediaformatshaper/libmediaformatshaper^android_x86_64_shared_cfi_apex29

echo "building libmediaformatshaper^android_x86_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmediaformatshaper,android_x86_x86_64_shared_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmediaformatshaper^android_x86_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmediaformatshaper/libmediaformatshaper^android_x86_x86_64_shared_cfi_apex29

echo "building libmediatranscoder^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmediatranscoder,android_x86_64_shared_cfi_apex29
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmediatranscoder^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libmediatranscoding/transcoder/libmediatranscoder^android_x86_64_shared_cfi_apex29

echo "building libmidiextractor^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmidiextractor,android_x86_64_shared_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/midi/libmidiextractor^android_x86_64_shared_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmidiextractor^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/midi/libmidiextractor^android_x86_64_shared_cfi_apex29

echo "building libmkvextractor^android_x86_64_shared_cfi_com.android.media"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmkvextractor,android_x86_64_shared_cfi_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmkvextractor^android_x86_64_shared_cfi_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mkv/libmkvextractor^android_x86_64_shared_cfi_com.android.media

echo "building libmp3extractor^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmp3extractor,android_x86_64_shared_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mp3/libmp3extractor^android_x86_64_shared_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmp3extractor^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mp3/libmp3extractor^android_x86_64_shared_cfi_apex29

echo "building libmp4extractor^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmp4extractor,android_x86_64_shared_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mp4/libmp4extractor^android_x86_64_shared_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmp4extractor^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mp4/libmp4extractor^android_x86_64_shared_cfi_apex29

echo "building libmpeg2extractor^android_x86_64_shared_cfi_com.android.media"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libmpeg2extractor,android_x86_64_shared_cfi_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libmpeg2extractor^android_x86_64_shared_cfi_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/mpeg2/libmpeg2extractor^android_x86_64_shared_cfi_com.android.media

echo "building liboggextractor^android_x86_64_shared_cfi_com.android.media"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja liboggextractor,android_x86_64_shared_cfi_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/liboggextractor^android_x86_64_shared_cfi_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/ogg/liboggextractor^android_x86_64_shared_cfi_com.android.media

echo "building libstagefright_omx^android_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libstagefright_omx,android_x86_64_shared_cfi
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/omx/libstagefright_omx^android_x86_64_shared_cfi
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libstagefright_omx^android_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/omx/libstagefright_omx^android_x86_64_shared_cfi

echo "building libstagefright_omx^android_x86_x86_64_shared_cfi"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libstagefright_omx,android_x86_x86_64_shared_cfi
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libstagefright_omx^android_x86_x86_64_shared_cfi.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libstagefright/omx/libstagefright_omx^android_x86_x86_64_shared_cfi

echo "building libwavextractor^android_x86_64_shared_cfi_apex29"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_27.ninja libwavextractor,android_x86_64_shared_cfi_apex29
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/wav/libwavextractor^android_x86_64_shared_cfi_apex29
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_27/frameworks/av/libwavextractor^android_x86_64_shared_cfi_apex29.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/extractors/wav/libwavextractor^android_x86_64_shared_cfi_apex29

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_av.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/av/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_27 frameworks_av.tar.zst --clobber
