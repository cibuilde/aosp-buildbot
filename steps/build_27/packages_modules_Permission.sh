...
clone_depth_platform packages/apps/Car/libs
...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/protobuf/libprotobuf-java-lite^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/ActionBarShadow/SettingsLibActionBarShadow^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/AppPreference/SettingsLibAppPreference^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/BarChartPreference/SettingsLibBarChartPreference^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/CollapsingToolbarBaseActivity/SettingsLibCollapsingToolbarBaseActivity^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/FooterPreference/SettingsLibFooterPreference^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/HelpUtils/SettingsLibHelpUtils^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/LayoutPreference/SettingsLibLayoutPreference^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/ProgressBar/SettingsLibProgressBar^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/RadioButtonPreference/SettingsLibRadioButtonPreference^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/RestrictedLockUtils/SettingsLibRestrictedLockUtils^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/SearchWidget/SettingsLibSearchWidget^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/SettingsTransition/SettingsLibSettingsTransition^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/packages/SettingsLib/TwoTargetPreference/SettingsLibTwoTargetPreference^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/libs/modules-utils/java/com/android/modules/utils/build/modules-utils-build_system^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/libs/systemui/iconloaderlib/iconloader^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/apps/Car/libs/car-ui-lib/car-ui-lib^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/apps/Car/libs/car-ui-lib/car-rotary-lib/car-rotary-lib^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx-legacy/androidx.legacy_legacy-support-core-ui^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx-legacy/androidx.lifecycle_lifecycle-extensions^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx-legacy/androidx.legacy_legacy-preference-v14^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.leanback_leanback-preference^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.lifecycle_lifecycle-common-java8^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.navigation_navigation-fragment-ktx^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.navigation_navigation-ui-ktx-nodeps^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.navigation_navigation-ui-ktx^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.navigation_navigation-ui-nodeps^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/prebuilts/sdk/current/androidx/androidx.navigation_navigation-ui^android_common_apex30/ .
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_27 packages_modules_Permission.tar.zst --clobber
...
if [ ! -f "$GITHUB_WORKSPACE/cache/packages_apps_Car_libs.tar.zst" ]; then
  echo "Compressing packages/apps/Car/libs -> packages_apps_Car_libs.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/packages_apps_Car_libs.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/packages/apps/Car/libs/ .
fi
