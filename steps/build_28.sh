...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_27 --pattern external_kotlinx.atomicfu.tar.zst --output external_kotlinx.atomicfu-27.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/external/kotlinx.atomicfu
tar xf $GITHUB_WORKSPACE/external_kotlinx.atomicfu-27.tar.zst -C $GITHUB_WORKSPACE/downloads/external/kotlinx.atomicfu/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_10 --pattern frameworks_compile_slang.tar.zst --output frameworks_compile_slang-10.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/compile/slang
tar xf $GITHUB_WORKSPACE/frameworks_compile_slang-10.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/compile/slang/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_26 --pattern frameworks_native.tar.zst --output frameworks_native-26.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/native
tar xf $GITHUB_WORKSPACE/frameworks_native-26.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/native/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_27 --pattern frameworks_native.tar.zst --output frameworks_native-27.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/native
tar xf $GITHUB_WORKSPACE/frameworks_native-27.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/native/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_27 --pattern libcore.tar.zst --output libcore-27.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/libcore
tar xf $GITHUB_WORKSPACE/libcore-27.tar.zst -C $GITHUB_WORKSPACE/downloads/libcore/
...
time source steps/build_28/external_kotlinx.coroutines.sh
time source steps/build_28/frameworks_av.sh
time source steps/build_28/frameworks_base.sh
time source steps/build_28/frameworks_native.sh
time source steps/build_28/libcore.sh
time source steps/build_28/prebuilts_sdk.sh
