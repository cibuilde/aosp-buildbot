...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_28.ninja libfilterfw_jni,android_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_28/frameworks/base/libfilterfw_jni^android_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_64_static

echo "building libfilterfw_jni^android_x86_x86_64_static"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_28.ninja libfilterfw_jni,android_x86_x86_64_static
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_x86_64_static
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_28/frameworks/base/libfilterfw_jni^android_x86_x86_64_static.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/media/mca/filterfw/libfilterfw_jni^android_x86_x86_64_static
