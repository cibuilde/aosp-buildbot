...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libaudiopolicyengineconfigurable,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libaudiopolicyengineconfigurable^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/audiopolicy/engineconfigurable/libaudiopolicyengineconfigurable^android_x86_64_shared

echo "building libaudiopolicyengineconfigurable^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libaudiopolicyengineconfigurable,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libaudiopolicyengineconfigurable^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/audiopolicy/engineconfigurable/libaudiopolicyengineconfigurable^android_x86_x86_64_shared

echo "building libaudiopolicyenginedefault^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libaudiopolicyenginedefault,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libaudiopolicyenginedefault^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/audiopolicy/enginedefault/libaudiopolicyenginedefault^android_x86_64_shared

echo "building libcodec2_hidl_client@1.2^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libcodec2_hidl_client@1.2,android_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libcodec2_hidl_client@1.2^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/codec2/hidl/1.2/utils/libcodec2_hidl_client@1.2^android_x86_64_shared

echo "building libcodec2_hidl_client@1.2^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libcodec2_hidl_client@1.2,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libcodec2_hidl_client@1.2^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/codec2/hidl/1.2/utils/libcodec2_hidl_client@1.2^android_x86_x86_64_shared

echo "building libheif^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libheif,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libheif/libheif^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libheif^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libheif/libheif^android_x86_64_shared

echo "building libheif^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libheif,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libheif/libheif^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libheif^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/media/libheif/libheif^android_x86_x86_64_shared

echo "building libmediadrm^android_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libmediadrm,android_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/drm/libmediadrm/libmediadrm^android_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libmediadrm^android_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/drm/libmediadrm/libmediadrm^android_x86_64_shared

echo "building libmediadrm^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libmediadrm,android_x86_x86_64_shared
mkdir -p $GITHUB_WORKSPACE/artifacts/frameworks/av/drm/libmediadrm/libmediadrm^android_x86_x86_64_shared
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libmediadrm^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/drm/libmediadrm/libmediadrm^android_x86_x86_64_shared

echo "building libmediatranscodingservice^android_x86_64_shared_com.android.media"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libmediatranscodingservice,android_x86_64_shared_com.android.media
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libmediatranscodingservice^android_x86_64_shared_com.android.media.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/mediatranscoding/libmediatranscodingservice^android_x86_64_shared_com.android.media

echo "building libresourcemanagerservice^android_x86_x86_64_shared"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja libresourcemanagerservice,android_x86_x86_64_shared
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_29/frameworks/av/libresourcemanagerservice^android_x86_x86_64_shared.output . $GITHUB_WORKSPACE/artifacts/frameworks/av/services/mediaresourcemanager/libresourcemanagerservice^android_x86_x86_64_shared

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf frameworks_av.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/frameworks/av/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_29 frameworks_av.tar.zst --clobber
