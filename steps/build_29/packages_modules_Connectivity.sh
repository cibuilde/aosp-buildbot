...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja framework-connectivity,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja framework-tethering,android_common_apex30
