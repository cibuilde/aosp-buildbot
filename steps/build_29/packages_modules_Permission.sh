...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja framework-permission-s,android_common_apex30
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_29.ninja framework-permission,android_common_apex30
