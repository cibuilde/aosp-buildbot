...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_30.ninja core-repackaged-icu4j,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_30/external/icu/core-repackaged-icu4j^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common

echo "building core-repackaged-icu4j^android_common_apex10000"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_30.ninja core-repackaged-icu4j,android_common_apex10000
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common_apex10000
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_30/external/icu/core-repackaged-icu4j^android_common_apex10000.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-repackaged-icu4j^android_common_apex10000

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_30 external_icu.tar.zst --clobber
