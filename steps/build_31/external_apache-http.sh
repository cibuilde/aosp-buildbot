...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja org.apache.http.legacy,android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 external_apache-http.tar.zst --clobber
