...
rsync -a -r $GITHUB_WORKSPACE/downloads/external/icu/android_icu4j/core-repackaged-icu4j^android_common/ .
...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja core-icu4j,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-icu4j^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/external/icu/core-icu4j^android_common.output . $GITHUB_WORKSPACE/artifacts/external/icu/android_icu4j/core-icu4j^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf external_icu.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/external/icu/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 external_icu.tar.zst --clobber
