...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/external/apache-http/org.apache.http.legacy^android_common.output . $GITHUB_WORKSPACE/artifacts/external/apache-http/org.apache.http.legacy^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 platform_external_apache-http.tar.zst --clobber
