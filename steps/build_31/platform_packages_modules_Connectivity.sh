...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/libs/net/common/net-utils-device-common^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/hardware/interfaces/tetheroffload/config/1.0/android.hardware.tetheroffload.config-V1.0-java^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/hardware/interfaces/tetheroffload/control/1.1/android.hardware.tetheroffload.control-V1.1-java^android_common_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Connectivity/framework/libframework-connectivity-jni^android_x86_64_shared_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Connectivity/framework/libframework-connectivity-jni^android_x86_x86_64_shared_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Connectivity/service/libservice-connectivity^android_x86_64_shared_apex30/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/Connectivity/Tethering/bpf_progs/test.o^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/NetworkStack/NetworkStackApiCurrentShims^android_common_apex30/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/packages/modules/NetworkStack/NetworkStackApiStableShims^android_common_apex30/ .
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/framework-connectivity.impl^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/framework/framework-connectivity.impl^android_common

echo "building service-connectivity-pre-jarjar^android_common_apex30"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja service-connectivity-pre-jarjar,android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/service-connectivity-pre-jarjar^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/service/service-connectivity-pre-jarjar^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/service-connectivity^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/service/service-connectivity^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/framework-tethering.impl^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/common/TetheringLib/framework-tethering.impl^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/Tethering^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/Tethering^android_common_apex30
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/com.android.tethering^android_common_com.android.tethering_image.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/apex/com.android.tethering^android_common_com.android.tethering_image
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/packages/modules/Connectivity/TetheringApiCurrentLib^android_common_apex30.output . $GITHUB_WORKSPACE/artifacts/packages/modules/Connectivity/Tethering/TetheringApiCurrentLib^android_common_apex30
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 platform_packages_modules_Connectivity.tar.zst --clobber
