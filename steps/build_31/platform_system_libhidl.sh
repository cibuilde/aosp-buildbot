...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja android.hidl.manager-V1.0-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager-V1.0-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/libhidl/android.hidl.manager-V1.0-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.0/android.hidl.manager-V1.0-java^android_common

echo "building android.hidl.manager-V1.1-java^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja android.hidl.manager-V1.1-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager-V1.1-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/libhidl/android.hidl.manager-V1.1-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.1/android.hidl.manager-V1.1-java^android_common

echo "building android.hidl.manager-V1.2-java^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja android.hidl.manager-V1.2-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager-V1.2-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/libhidl/android.hidl.manager-V1.2-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/libhidl/transport/manager/1.2/android.hidl.manager-V1.2-java^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_libhidl.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/libhidl/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 platform_system_libhidl.tar.zst --clobber
