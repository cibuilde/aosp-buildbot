...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja netd_event_listener_interface-V1-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/netd/netd_event_listener_interface-V1-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-V1-java^android_common

echo "building netd_event_listener_interface-lateststable-java^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja netd_event_listener_interface-lateststable-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-lateststable-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/netd/netd_event_listener_interface-lateststable-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_event_listener_interface-lateststable-java^android_common

echo "building netd_aidl_interface-V7-java^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja netd_aidl_interface-V7-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/netd/netd_aidl_interface-V7-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-V7-java^android_common

echo "building netd_aidl_interface-lateststable-java^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_31.ninja netd_aidl_interface-lateststable-java,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-lateststable-java^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_31/platform/system/netd/netd_aidl_interface-lateststable-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/netd/server/netd_aidl_interface-lateststable-java^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_system_netd.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/system/netd/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_31 platform_system_netd.tar.zst --clobber
