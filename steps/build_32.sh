...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_23 --pattern frameworks_ex.tar.zst --output frameworks_ex-23.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/ex
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_25 --pattern hardware_interfaces.tar.zst --output hardware_interfaces-25.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/hardware/interfaces
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_28 --pattern packages_apps_Settings.tar.zst --output packages_apps_Settings-28.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/packages/apps/Settings
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_26 --pattern system_hardware_interfaces.tar.zst --output system_hardware_interfaces-26.tar.zst
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_26 --pattern system_security.tar.zst --output system_security-26.tar.zst
