...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/blobstore/service/service-blobstore^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/apex/jobscheduler/service/service-jobscheduler^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/services^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/accessibility/services.accessibility^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/appprediction/services.appprediction^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/appwidget/services.appwidget^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/autofill/services.autofill^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/backup/services.backup^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/backup/backuplib/backuplib^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/companion/services.companion^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/contentcapture/services.contentcapture^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/contentsuggestions/services.contentsuggestions^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/core/services.core.priorityboosted^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/core/services.core^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/core/services.core.unboosted^android_common/ .
...
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/devicepolicy/services.devicepolicy^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/midi/services.midi^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/musicrecognition/services.musicsearch^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/net/services.net^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/people/services.people^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/print/services.print^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/profcollect/services.profcollect^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/restrictions/services.restrictions^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/searchui/services.searchui^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/smartspace/services.smartspace^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/startop/services.startop^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/systemcaptions/services.systemcaptions^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/texttospeech/services.texttospeech^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/translation/services.translation^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/usage/services.usage^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/usb/services.usb^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/uwb/services.uwb^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/voiceinteraction/services.voiceinteraction^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/services/wifi/services.wifi^android_common/ .
rsync -a -r $GITHUB_WORKSPACE/downloads/frameworks/base/startop/iorap/services.startop.iorap^android_common/ .
