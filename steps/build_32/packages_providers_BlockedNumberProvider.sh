...
echo "Preparing for packages/providers/BlockedNumberProvider"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja BlockedNumberProvider,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_32/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common.output $GITHUB_WORKSPACE/artifacts/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common $GITHUB_WORKSPACE/artifacts/packages/providers/BlockedNumberProvider/BlockedNumberProvider^android_common/addition_copy_files.output
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 packages_providers_BlockedNumberProvider.tar.zst --clobber

du -ah -d1 packages_providers_BlockedNumberProvider*.tar.zst | sort -h
