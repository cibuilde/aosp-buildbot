...
echo "Preparing for packages/providers/BookmarkProvider"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja BookmarkProvider,android_common
