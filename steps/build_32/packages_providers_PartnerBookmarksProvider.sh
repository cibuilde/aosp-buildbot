...
echo "Preparing for packages/providers/PartnerBookmarksProvider"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja PartnerBookmarksProvider,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 packages_providers_PartnerBookmarksProvider.tar.zst --clobber

du -ah -d1 packages_providers_PartnerBookmarksProvider*.tar.zst | sort -h
