...
echo "Preparing for packages/services/Mms"
...
prebuilts/build-tools/linux-x86/bin/ninja -j $(nproc) -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja MmsService,android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 packages_services_Mms.tar.zst --clobber

du -ah -d1 packages_services_Mms*.tar.zst | sort -h
