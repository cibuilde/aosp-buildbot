...
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja Settings-core,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/Settings-core^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/packages/apps/Settings/Settings-core^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/Settings-core^android_common

echo "building settings-platform-compat-config^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja settings-platform-compat-config,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/settings-platform-compat-config^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/packages/apps/Settings/settings-platform-compat-config^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/settings-platform-compat-config^android_common

echo "building Settings^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja Settings,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/Settings^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/packages/apps/Settings/Settings^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/apps/Settings/Settings^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 platform_packages_apps_Settings.tar.zst --clobber
