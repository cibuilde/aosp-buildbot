...
clone_depth_platform packages/providers/PartnerBookmarksProvider
clone_depth_platform platform/packages/providers/PartnerBookmarksProvider
...
echo "building PartnerBookmarksProvider^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja PartnerBookmarksProvider,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/providers/PartnerBookmarksProvider/PartnerBookmarksProvider^android_common

rm -rf out

cd $GITHUB_WORKSPACE/
tar -cf platform_packages_providers_PartnerBookmarksProvider.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/artifacts/platform/packages/providers/PartnerBookmarksProvider/ .
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 platform_packages_providers_PartnerBookmarksProvider.tar.zst --clobber

du -ah -d1 platform_packages_providers_PartnerBookmarksProvider*.tar.zst | sort -h
...
if [ ! -f "$GITHUB_WORKSPACE/cache/packages_providers_PartnerBookmarksProvider.tar.zst" ]; then
  echo "Compressing packages/providers/PartnerBookmarksProvider -> packages_providers_PartnerBookmarksProvider.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/packages_providers_PartnerBookmarksProvider.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/packages/providers/PartnerBookmarksProvider/ .
fi
if [ ! -f "$GITHUB_WORKSPACE/cache/platform_packages_providers_PartnerBookmarksProvider.tar.zst" ]; then
  echo "Compressing platform/packages/providers/PartnerBookmarksProvider -> platform_packages_providers_PartnerBookmarksProvider.tar.zst"
  tar -cf $GITHUB_WORKSPACE/cache/platform_packages_providers_PartnerBookmarksProvider.tar.zst --use-compress-program zstdmt -C $GITHUB_WORKSPACE/aosp/platform/packages/providers/PartnerBookmarksProvider/ .
fi
