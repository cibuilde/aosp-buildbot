...
echo "building BuiltInPrintService^android_common"
ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_32.ninja BuiltInPrintService,android_common
mkdir -p $GITHUB_WORKSPACE/artifacts/packages/services/BuiltInPrintService/BuiltInPrintService^android_common
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/packages/services/BuiltInPrintService/BuiltInPrintService^android_common.output . $GITHUB_WORKSPACE/artifacts/packages/services/BuiltInPrintService/BuiltInPrintService^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 platform_packages_services_BuiltInPrintService.tar.zst --clobber
