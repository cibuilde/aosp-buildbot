...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/system/hardware/interfaces/android.system.keystore2-V1-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/hardware/interfaces/keystore2/aidl/android.system.keystore2-V1-java^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 platform_system_hardware_interfaces.tar.zst --clobber
