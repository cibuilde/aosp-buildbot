...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_32/platform/system/security/android.security.remoteprovisioning-java^android_common.output . $GITHUB_WORKSPACE/artifacts/system/security/keystore2/aidl/android.security.remoteprovisioning-java^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_32 platform_system_security.tar.zst --clobber
