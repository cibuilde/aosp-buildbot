...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_13 --pattern external_cbor-java.tar.zst --output external_cbor-java-13.tar.zst
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_31 --pattern frameworks_av.tar.zst --output frameworks_av-31.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/av
tar xf $GITHUB_WORKSPACE/frameworks_av-31.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/av/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_32 --pattern frameworks_libs_net.tar.zst --output frameworks_libs_net-32.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/frameworks/libs/net
tar xf $GITHUB_WORKSPACE/frameworks_libs_net-32.tar.zst -C $GITHUB_WORKSPACE/downloads/frameworks/libs/net/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_31 --pattern packages_modules_Permission.tar.zst --output packages_modules_Permission-31.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/packages/modules/Permission
tar xf $GITHUB_WORKSPACE/packages_modules_Permission-31.tar.zst -C $GITHUB_WORKSPACE/downloads/packages/modules/Permission/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_32 --pattern system_hardware_interfaces.tar.zst --output system_hardware_interfaces-32.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/hardware/interfaces
tar xf $GITHUB_WORKSPACE/system_hardware_interfaces-32.tar.zst -C $GITHUB_WORKSPACE/downloads/system/hardware/interfaces/
...
gh release --repo cibuilde/aosp-buildbot download android12-gsi_32 --pattern system_security.tar.zst --output system_security-32.tar.zst
mkdir -p $GITHUB_WORKSPACE/downloads/system/security
tar xf $GITHUB_WORKSPACE/system_security-32.tar.zst -C $GITHUB_WORKSPACE/downloads/system/security/

gh release --repo cibuilde/aosp-buildbot download android12-gsi_25 --pattern system_timezone.tar.zst --output system_timezone-25.tar.zst
...
time source steps/build_33/frameworks_base.sh
time source steps/build_33/packages_apps_RemoteProvisioner.sh
