...
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja backuplib,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/backuplib^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/backup/backuplib/backuplib^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/backup/backuplib/backuplib^android_common/addition_copy_files.output

echo "building service-blobstore^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja service-blobstore,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services.appwidget^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/appwidget/services.appwidget^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/appwidget/services.appwidget^android_common/addition_copy_files.output

echo "building services.autofill^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja services.autofill,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services.contentsuggestions^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/contentsuggestions/services.contentsuggestions^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/contentsuggestions/services.contentsuggestions^android_common/addition_copy_files.output

echo "building services.core.priorityboosted^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja services.core.priorityboosted,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services.core.priorityboosted^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/services.core.priorityboosted^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/services.core.priorityboosted^android_common/addition_copy_files.output

echo "building services.core.unboosted^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja services.core.unboosted,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services.net^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/net/services.net^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/net/services.net^android_common/addition_copy_files.output

echo "building services.people^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja services.people,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services.searchui^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/searchui/services.searchui^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/searchui/services.searchui^android_common/addition_copy_files.output

echo "building services.smartspace^android_common"
prebuilts/build-tools/linux-x86/bin/ninja -d keepdepfile -f $GITHUB_WORKSPACE/steps/build_33.ninja services.smartspace,android_common
...
python3 $GITHUB_WORKSPACE/copy_symlink.py $GITHUB_WORKSPACE/steps/outputs_33/frameworks/base/services^android_common.output $GITHUB_WORKSPACE/artifacts/frameworks/base/services/services^android_common $GITHUB_WORKSPACE/artifacts/frameworks/base/services/services^android_common/addition_copy_files.output
