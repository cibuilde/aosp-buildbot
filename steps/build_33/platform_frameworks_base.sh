...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.core^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/services.core^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.voiceinteraction^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/voiceinteraction/services.voiceinteraction^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.uwb^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/uwb/services.uwb^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.usb^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/usb/services.usb^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.usage^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/usage/services.usage^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.translation^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/translation/services.translation^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.texttospeech^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/texttospeech/services.texttospeech^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.systemcaptions^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/systemcaptions/services.systemcaptions^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.startop.iorap^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/startop/iorap/services.startop.iorap^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.startop^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/startop/services.startop^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.smartspace^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/smartspace/services.smartspace^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.searchui^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/searchui/services.searchui^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.restrictions^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/restrictions/services.restrictions^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.profcollect^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/profcollect/services.profcollect^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.print^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/print/services.print^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.people^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/people/services.people^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.net^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/net/services.net^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.musicsearch^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/musicrecognition/services.musicsearch^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.midi^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/midi/services.midi^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.devicepolicy^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/devicepolicy/services.devicepolicy^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.core.unboosted^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/services.core.unboosted^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.core.priorityboosted^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/core/services.core.priorityboosted^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.contentsuggestions^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/contentsuggestions/services.contentsuggestions^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.contentcapture^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/contentcapture/services.contentcapture^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.companion^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/companion/services.companion^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.backup^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/backup/services.backup^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.autofill^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/autofill/services.autofill^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.appwidget^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/appwidget/services.appwidget^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.appprediction^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/appprediction/services.appprediction^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services.accessibility^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/accessibility/services.accessibility^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/service-jobscheduler^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/jobscheduler/service/service-jobscheduler^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/services^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/services-platform-compat-config^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/services-platform-compat-config^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/service-blobstore^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/apex/blobstore/service/service-blobstore^android_common
...
rsync -a -r --files-from=$GITHUB_WORKSPACE/steps/outputs_33/platform/frameworks/base/backuplib^android_common.output . $GITHUB_WORKSPACE/artifacts/frameworks/base/services/backup/backuplib/backuplib^android_common
...
gh release --repo cibuilde/aosp-buildbot upload android12-gsi_33 platform_frameworks_base.tar.zst --clobber
