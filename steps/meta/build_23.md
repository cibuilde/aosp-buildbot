##### Tag: android12-gsi_23 Projects: 33 Targets: 141

###### **external/brotli**: 1
`brotli-java^android_common`
###### **external/icing**: 1
`libicing-java^android_common_apex10000`
###### **external/ksoap2**: 1
`ksoap2^android_common_apex30`
###### **external/libtextclassifier**: 4
`TextClassifierNotificationLibNoManifest^android_common_apex30` `TextClassifierServiceLibNoManifest^android_common_apex30` `libtextclassifier-java^android_common_apex30` `textclassifier-statsd^android_common_apex30`
###### **external/nanohttpd**: 1
`libnanohttpd^android_common_apex30`
###### **external/okio**: 1
`okio-lib^android_common`
###### **external/setupdesign**: 1
`setupdesign-strings^android_common`
###### **external/xz-java**: 1
`xz-java^android_common`
###### **frameworks/av**: 3
`av-types-aidl-java^android_common` `mediatranscoding_aidl_interface-java^android_common_apex29` `tv_tuner_frontend_info_aidl_interface-java^android_common`
###### **frameworks/ex**: 2
`android-ex-camera2-portability^android_common` `android-ex-camera2-utils^android_common`
###### **frameworks/libs/modules-utils**: 2
`modules-utils-build_system^android_common_apex30` `modules-utils-build_system^android_common`
###### **frameworks/libs/net**: 4
`net-utils-device-common^android_common_apex30` `net-utils-device-common^android_common` `net-utils-framework-common^android_common_apex30` `net-utils-framework-common^android_common`
###### **frameworks/libs/service_entitlement**: 4
`service-entitlement-api^android_common` `service-entitlement-data^android_common` `service-entitlement-impl^android_common` `service-entitlement^android_common`
###### **frameworks/libs/systemui**: 3
`iconloader^android_common_apex30` `iconloader^android_common` `iconloader_base^android_common`
###### **frameworks/native**: 1
`framework-permission-aidl-java^android_common`
###### **frameworks/opt/chips**: 1
`libchips^android_common`
###### **frameworks/opt/setupwizard**: 1
`setup-wizard-lib^android_common`
###### **frameworks/opt/telephony**: 1
`telephony-protos^android_common`
###### **frameworks/proto_logging**: 1
`datastallprotosnano^android_common`
###### **packages/apps/Car/libs**: 3
`car-rotary-lib^android_common_apex30` `car-rotary-lib^android_common` `car-ui-lib-oem-apis^android_common`
###### **packages/apps/Launcher3**: 3
`LauncherPluginLib^android_common` `launcher_log_protos_lite^android_common` `launcher_quickstep_log_protos_lite^android_common`
###### **packages/apps/PhoneCommon**: 1
`com.android.phone.common-lib^android_common`
###### **packages/modules/Connectivity**: 1
`service-connectivity-protos^android_common_apex30`
###### **packages/modules/IPsec**: 2
`com.android.ipsec-bootclasspath-fragment^android_common_com.android.ipsec` `com.android.ipsec^android_common_com.android.ipsec_image`
###### **packages/modules/NetworkStack**: 5
`captiveportal-lib^android_common` `ipmemorystore-aidl-interfaces-V10-java^android_common_apex30` `netlink-client^android_common_apex30` `netlink-client^android_common` `networkstack-aidl-interfaces-V10-java^android_common_apex30`
...
`sdk^`
###### **system/netd**: 5
`netd_aidl_interface-V3-java^android_common_apex30` `netd_aidl_interface-V7-java^android_common_apex30` `netd_aidl_interface-lateststable-java^android_common_apex30` `netd_event_listener_interface-V1-java^android_common_apex30` `netd_event_listener_interface-lateststable-java^android_common_apex30`
